...
public final class D3DToolkit extends ha_Sub3 {
    ...
    private Component312 aClass53_9787;
    hb aHb9788;
    ...
    private Component246[] aClass209Array9795;
    ...
    private static final int method3955(int i, Component267 class229) {
        ...
        if (Component253.aClass229_3196 != class229) {
            if (class229 != DisplayModeManagerContainer64.aClass229_9011) {
    ...
    final void method3956(byte i, DisplayModeManagerContainer318 class310) {
    ...
    static final int method3958(int i, Component342 class68, DisplayModeManagerContainer42 class304) {
        if (class68 == Component342.aClass68_1183) {
            if (NodeSub45.aClass304_7103 != class304) {
                ...
                if (DefinitionSub38.aClass304_9471 == class304) return 28;
                if (DefinitionSub22.aClass304_9303 == class304) return 50;
                if (class304 == ImageCache.aClass304_2571) return 51;
                if (class304 == Renderable.aClass304_3977) return 77;
            } else return 22;
        }
    ...
    final Component80 method3706(Component80 class299, Component80 class299_32_, float f, Component80 class299_33_) {
    ...
    private D3DToolkit(int i, int i_38_, Canvas canvas, hb var_hb, IDirect3D idirect3d, IDirect3DDevice idirect3ddevice, Component312 class53, D3DPRESENT_PARAMETERS d3dpresent_parameters, D3DCAPS d3dcaps, d var_d, CacheStore class45, int i_39_) {
        ...
        try {
            ...
            aClass209Array9795 = new Component246[this.anInt8090];
    ...
    private static final int method3961(DisplayModeManagerContainer88 class70, int i) {
        ...
        if (DisplayModeManagerContainer343.aClass70_8737 != class70) {
            if (DefinitionSub39.aClass70_9485 == class70) return 3;
        } else return 1;
        throw new IllegalArgumentException();
    }
    ...
    final AbstractShader method3832(int i, byte i_64_) {
        ...
        do {
            do {
                ...
                return new TransparentWaterShader(this, this.aClass45_8039, this.aClass269_7937);
            } while (false);
    ...
    final void method3882(byte i) {
        for (int i_70_ = 0; i_70_ < this.anInt8090; i_70_++) {
            ...
            aClass209Array9795[i_70_] = DisplayModeManagerContainer5.aClass209_1212;
    ...
    final void method3950(int i) {
        ...
        } else if (this.aClass173_8163 == Component325.aClass173_1201) {
            this.anIDirect3DDevice9810.SetRenderState(19, 2);
            this.anIDirect3DDevice9810.SetRenderState(20, 2);
        } else if (Component224.aClass173_5169 == this.aClass173_8163) {
