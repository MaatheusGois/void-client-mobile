 ...
 */ extends Component24 implements Interface19 {
    ...
    private final native int Interface4Impl(long l);

    private final native int M(long l);

    final void method963(int i, int i_25_, Shader var_aa, int i_26_, int i_27_) {
        V(this.nativeid, i, i_25_, ((ShaderImpl) var_aa).nativeid, i_26_, i_27_);
    }
    ...
    private final native void EA(OpenGLToolkit var_oa, int i, int i_28_);
    ...
    final void method983(float f, float f_39_, float f_40_, float f_41_, float f_42_, float f_43_, int i, Shader var_aa, int i_44_, int i_45_) {
    ...
    j(OpenGLToolkit var_oa, int i, int i_57_) {
        EA(var_oa, i, i_57_);
    }
    ...
    j(OpenGLToolkit var_oa, int[] is, int i, int i_66_, int i_67_, int i_68_, boolean bool) {
    ...
    j(OpenGLToolkit var_oa, int[] is, byte[] is_76_, byte[] is_77_, int i, int i_78_, int i_79_, int i_80_) {
    ...
    j(OpenGLToolkit var_oa, int i, int i_88_, int i_89_, int i_90_, boolean bool) {
    ...
    private final native void h(OpenGLToolkit var_oa, int i, int i_99_, int i_100_, int i_101_, boolean bool);
