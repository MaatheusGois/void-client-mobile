/* MatrixSub1 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class MatrixSub1
/**
 * RENAMED from `Class101_Sub1` (JODE-obfuscated).
 ...
 */ extends DisplayModeManagerContainer204 {
    ...
    final void method903(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
        anInt5682++;
        float f = Component323.aFloatArray5876[i_4_ & 0x3fff];
        float f_7_ = Component323.aFloatArray5874[0x3fff & i_4_];
        float f_8_ = Component323.aFloatArray5876[i_5_ & 0x3fff];
        float f_9_ = Component323.aFloatArray5874[0x3fff & i_5_];
        float f_10_ = Component323.aFloatArray5876[0x3fff & i_6_];
    ...
    final void method898(DisplayModeManagerContainer204 class101) {
        anInt5683++;
        MatrixSub1 class101_sub1_14_ = (MatrixSub1) class101;
    ...
    final void method908(int i) {
        ...
        float f_19_ = Component323.aFloatArray5874[i & 0x3fff];
    ...
    final void method900(int i) {
        ...
        float f_24_ = Component323.aFloatArray5874[0x3fff & i];
    ...
    final void method899(int i) {
        ...
        this.aFloat5678 = this.aFloat5664 = Component323.aFloatArray5876[i & 0x3fff];
        this.aFloat5680 = Component323.aFloatArray5874[0x3fff & i];
    ...
    final void method902(int i) {
        ...
        this.aFloat5672 = this.aFloat5678 = Component323.aFloatArray5876[0x3fff & i];
        this.aFloat5655 = Component323.aFloatArray5874[0x3fff & i];
    ...
    final DisplayModeManagerContainer204 method907() {
        anInt5660++;
        MatrixSub1 class101_sub1_31_ = new MatrixSub1();
    ...
    final void method895(int i) {
        ...
        anInt5676++;
        this.aFloat5672 = this.aFloat5664 = Component323.aFloatArray5876[0x3fff & i];
        this.aFloat5669 = Component323.aFloatArray5874[i & 0x3fff];
    ...
    final void method896(int i) {
        anInt5659++;
        float f = Component323.aFloatArray5876[0x3fff & i];
        float f_32_ = Component323.aFloatArray5874[i & 0x3fff];
