/* MatrixSub3 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class MatrixSub3
/**
 * RENAMED from `Class101_Sub3` (JODE-obfuscated).
 ...
 */ extends DisplayModeManagerContainer204 {
    ...
    static Component311 aClass326_5764;
    ...
    final void method902(int i) {
        ...
        this.aFloat5770 = this.aFloat5769 = OggStream.aFloatArray6867[0x3fff & i];
        this.aFloat5761 = OggStream.aFloatArray6865[0x3fff & i];
    ...
    final void method900(int i) {
        anInt5763++;
        float f = OggStream.aFloatArray6867[0x3fff & i];
        float f_11_ = OggStream.aFloatArray6865[0x3fff & i];
    ...
    final void method939(float f, int i, float f_16_, int i_17_, int i_18_, int i_19_, float f_20_) {
        if (i_18_ == 0) {
            ...
            float f_21_ = OggStream.aFloatArray6867[0x3fff & i_18_];
            float f_22_ = OggStream.aFloatArray6865[i_18_ & 0x3fff];
    ...
    final void method903(int i, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_) {
        anInt5782++;
        float f = OggStream.aFloatArray6867[i_32_ & 0x3fff];
        float f_35_ = OggStream.aFloatArray6865[i_32_ & 0x3fff];
        float f_36_ = OggStream.aFloatArray6867[0x3fff & i_33_];
        float f_37_ = OggStream.aFloatArray6865[0x3fff & i_33_];
        float f_38_ = OggStream.aFloatArray6867[0x3fff & i_34_];
        float f_39_ = OggStream.aFloatArray6865[0x3fff & i_34_];
    ...
    final void method908(int i) {
        anInt5774++;
        float f = OggStream.aFloatArray6867[i & 0x3fff];
        float f_42_ = OggStream.aFloatArray6865[i & 0x3fff];
    ...
    final float[] method940(int i) {
        ...
        anInt5777++;
        Component383.aFloatArray8575[i] = this.aFloat5761;
        Component383.aFloatArray8575[6] = this.aFloat5754;
        Component383.aFloatArray8575[4] = this.aFloat5750;
        Component383.aFloatArray8575[10] = this.aFloat5784;
        Component383.aFloatArray8575[8] = this.aFloat5781;
        Component383.aFloatArray8575[14] = this.aFloat5751;
        Component383.aFloatArray8575[13] = this.aFloat5772;
        Component383.aFloatArray8575[2] = this.aFloat5756;
        Component383.aFloatArray8575[5] = this.aFloat5769;
        return Component383.aFloatArray8575;
    }

    final DisplayModeManagerContainer204 method907() {
        anInt5748++;
        MatrixSub3 class101_sub3_47_ = new MatrixSub3();
    ...
    final void method898(DisplayModeManagerContainer204 class101) {
        anInt5758++;
        MatrixSub3 class101_sub3_51_ = (MatrixSub3) class101;
    ...
    final void method895(int i) {
        ...
        this.aFloat5770 = this.aFloat5784 = OggStream.aFloatArray6867[0x3fff & i];
        this.aFloat5781 = OggStream.aFloatArray6865[0x3fff & i];
    ...
    final void method899(int i) {
        ...
        this.aFloat5769 = this.aFloat5784 = OggStream.aFloatArray6867[0x3fff & i];
        this.aFloat5754 = OggStream.aFloatArray6865[0x3fff & i];
    ...
    final void method896(int i) {
        anInt5766++;
        float f = OggStream.aFloatArray6867[i & 0x3fff];
        float f_62_ = OggStream.aFloatArray6865[i & 0x3fff];
    ...
    final float[] method945(boolean bool) {
        ...
        Component383.aFloatArray8575[0] = this.aFloat5770;
        Component383.aFloatArray8575[13] = 0.0F;
        Component383.aFloatArray8575[1] = this.aFloat5761;
        Component383.aFloatArray8575[12] = 0.0F;
        Component383.aFloatArray8575[10] = this.aFloat5784;
        Component383.aFloatArray8575[5] = this.aFloat5769;
        Component383.aFloatArray8575[6] = this.aFloat5754;
        Component383.aFloatArray8575[9] = this.aFloat5762;
