/* GlExtensionManager - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
/**
 * RENAMED from `Class377` (JODE-obfuscated).
 * OpenGL extension manager. Queries and caches GL_ARB_* extension availability (GL_ARB_texture_non_power_of_two, GL_ARB_vertex_buffer_object, GL_ARB_texture_env_combine, GL_ARB_texture_rectangle) for the toolkit; gates feature paths on extension support.
 */
...
final class GlExtensionManager extends GlToolkitSub3 {
    ...
    static Component161 aClass138_9860 = new Component161(15, 0, 1, 0);
    ...
    private final NodeList aClass262_9869 = new NodeList();
    ...
    private NodeList aClass262_9899 = new NodeList();
    static int anInt9900;
    private final NodeList aClass262_9901 = new NodeList();
    private NodeList aClass262_9902 = new NodeList();
    private NodeList aClass262_9903 = new NodeList();
    private final NodeList aClass262_9904 = new NodeList();
    private NodeList aClass262_9905 = new NodeList();
    private long aLong9906;
    private DebugPanicSub1[] aClass285_Sub1Array9907 = new DebugPanicSub1[16];
    ...
    final void method3871(Component22 class113, int i) {
        try {
            if (i == 0) {
                anInt9836++;
                if (class113 == Component324.aClass113_2047) {
    ...
    final Component6 c() {
        ...
        return new Component6(i, "OpenGL", anInt9924, aString9916, 0L);
    }

    final Component80 method3706(Component80 class299, Component80 class299_24_, float f, Component80 class299_25_) {
        try {
            anInt9873++;
    ...
    GlExtensionManager(OpenGL opengl, Canvas canvas, long l, d var_d, CacheStore class45, int i) {
    ...
    final void method3938(Component158 class21, int i, Interface5_Impl2 interface5_impl2, int i_40_, int i_41_, int i_42_, int i_43_) {
        try {
            ...
            int i_44_;
            int i_45_;
            if (Component217.aClass21_3217 == class21) {
                i_44_ = 1;
                i_45_ = i * 2;
            } else if (class21 == GlWaterShader.aClass21_8832) {
                i_45_ = 1 + i;
                i_44_ = 3;
            } else if (class21 == VideoAdDisplay.aClass21_3181) {
                i_44_ = 4;
                i_45_ = i * 3;
    ...
    final void method3899(int i, int i_50_, Component158 class21, boolean bool) {
        try {
            ...
            int i_51_;
            int i_52_;
            if (class21 == Component217.aClass21_3217) {
                i_51_ = 2 * i;
                i_52_ = 1;
            } else if (GlWaterShader.aClass21_8832 == class21) {
                i_51_ = i - -1;
                i_52_ = 3;
            } else if (VideoAdDisplay.aClass21_3181 == class21) {
                i_52_ = 4;
                i_51_ = i * 3;
    ...
    final AbstractShader method3832(int i, byte i_58_) {
        ...
        do {
            do {
                ...
                } else return new OpenGlShader(this, this.aClass45_8039);
                return new AbstractShaderSub2(this, this.aClass45_8039, this.aClass269_7937);
            } while (false);
            ...
            for (int i_77_ = i; i_77_ < class58s.length; i_77_++) {
                ...
                for (int i_80_ = 0; (i_80_ < class58.method538((byte) -119)); i_80_++) {
                    ...
                    if (class325 == ColoredTextBuilder.aClass325_4073) {
                        ...
                        bool_76_ = true;
                    } else if (ColoredTextBuilder.aClass325_4075 == class325) {
                        bool_75_ = true;
                        OpenGL.glNormalPointer(5126, i_79_, (long) i_78_ + l);
                    } else if (class325 == ColoredTextBuilder.aClass325_4076) {
                        OpenGL.glColorPointer(4, 5121, i_79_, (long) i_78_ + l);
                        bool = true;
                    } else if (ColoredTextBuilder.aClass325_4077 == class325) {
                        OpenGL.glClientActiveTexture(33984 + i_74_++);
                        OpenGL.glTexCoordPointer(1, 5126, i_79_, (long) i_78_ + l);
                    } else if (ColoredTextBuilder.aClass325_4078 == class325) {
                    ...
                    } else if (class325 == ColoredTextBuilder.aClass325_4080) {
                        OpenGL.glClientActiveTexture(33984 - -i_74_++);
    ...
    final void method3950(int i) {
        ...
        else if (Component224.aClass173_5169 == this.aClass173_8163) OpenGL.glBlendFunc(774, 1);
