/* AbstractGlTexture - Decompiled by JODE
...
abstract class AbstractGlTexture implements Interface9 {
    ...
    AbstractGlTexture(GlToolkitSub2 var_ha_Sub2, int i, int i_5_, int i_6_, boolean bool) {
        ...
        OpenGL.glGenTextures(1, SpriteAtlasShader.anIntArray6260, 0);
        this.anInt4859 = SpriteAtlasShader.anIntArray6260[0];
        method1954(0, 94);
    }
