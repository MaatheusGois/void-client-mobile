 ...
 */ extends GraphicsToolkit {
    ...
    static StringCache aClass351_7554;
    ...
    private Component265 aClass100_7707;
    static int anInt7708;
    static int anInt7709;
    static int anInt7710;
    private final Component237 aClass233_7711;
    int anInt7712 = 128;
    int anInt7713;
    static int anInt7714;
    static StringCache aClass351_7715;
    static int anInt7716;
    static int anInt7717;
    static int anInt7718;
    static int anInt7719;
    private final DisplayModeManagerContainer220 aClass18_7720;
    private GlWaterShader aClass348_Sub5_Sub1_7721;
    static int anInt7722;
    private final Component160 aClass354_7723;
    static int anInt7724;
    private final MatrixSub3 aClass101_Sub3_7725;
    static int anInt7726;
    static int anInt7727;
    static int anInt7728;
    MatrixSub3 aClass101_Sub3_7729;
    NativeHeap aNativeHeap7730;
    int anInt7731;
    private final NodeList aClass262_7732;
    int anInt7733;
    private boolean aBoolean7734;
    int anInt7735;
    ReliefShader aClass188_7736;
    private final Interface11[] anInterface11Array7737;
    private int anInt7738;
    private DisplayModeManagerContainer105 aClass206_7739;
    ...
    private SpriteSub2 aClass105_Sub2_7744;
    private Interface11 anInterface11_7745;
    private int anInt7746;
    int anInt7747;
    int anInt7748;
    private final NodeList aClass262_7749;
    private int anInt7750;
    private NodeList aClass262_7751;
    private final NodeList aClass262_7752;
    private final NodeList aClass262_7753;
    private final NodeList aClass262_7754;
    private final NodeList aClass262_7755;
    private final NodeList aClass262_7756;
    private long aLong7757;
    private boolean aBoolean7758;
    private boolean aBoolean7759;
    MatrixSub3 aClass101_Sub3_7760;
    private boolean aBoolean7761;
    private int anInt7762;
    private boolean aBoolean7763;
    private int anInt7764;
    private int anInt7765;
    MatrixSub3 aClass101_Sub3_7766;
    MatrixSub3 aClass101_Sub3_7767;
    float aFloat7768;
    private Component40 aClass299_Sub1_7769;
    ...
    private GlRectangleTexture aClass258_Sub3_Sub1_7776;
    int anInt7777;
    DisplayModeManagerContainer105 aClass206_7778;
    private final float[] aFloatArray7779;
    DisplayModeManagerContainer282 aClass64_Sub3_7780;
    float aFloat7781;
    int anInt7782;
    boolean aBoolean7783;
    private boolean aBoolean7784;
    DisplayModeManagerContainer282 aClass64_Sub3_7785;
    ...
    Component182 aClass348_Sub49_Sub1_7798;
    private int anInt7799;
    private float aFloat7800;
    private boolean aBoolean7801;
    DisplayModeManagerContainer282 aClass64_Sub3_7802;
    DisplayModeManagerContainer282 aClass64_Sub3_7803;
    ...
    DisplayModeManagerContainer282 aClass64_Sub3_7821;
    private boolean aBoolean7822;
    float aFloat7823;
    private float aFloat7824;
    float[] aFloatArray7825;
    int anInt7826;
    GlTexture aClass258_Sub3_7827;
    private AbstractGlTexture[] aClass258Array7828;
    private float aFloat7829;
    float aFloat7830;
    boolean aBoolean7831;
    float aFloat7832;
    Component132 aClass123_7833;
    DisplayModeManagerContainer282 aClass64_Sub3_7834;
    float aFloat7835;
    float aFloat7836;
    boolean aBoolean7837;
    DisplayModeManagerContainer282 aClass64_Sub3_7838;
    private int anInt7839;
    DisplayModeManagerContainer282 aClass64_Sub3_7840;
    boolean aBoolean7841;
    private float aFloat7842;
    private boolean aBoolean7843;
    DisplayModeManagerContainer282 aClass64_Sub3_7844;
    private String aString7845;
    boolean aBoolean7846;
    boolean aBoolean7847;
    int anInt7848;
    Component132 aClass123_7849;
    ...
    final void setLightingEnabled(boolean bool, int i) {
    ...
    final DisplayModeManagerContainer370 method3625(DisplayModeManagerContainer77 class124, int i, int i_2_, int i_3_, int i_4_) {
        try {
            anInt7579++;
    ...
    final Interface2 decodedOperation3731(int i, boolean bool, int i_8_, byte[] is, int i_9_) {
        try {
            if (i != 2) decodedOperation3781((byte) -13, 54);
            anInt7530++;
    ...
    final Interface8 decodedOperation3733(int i, int i_14_, int i_15_, byte[] is, boolean bool) {
        try {
            anInt7565++;
    ...
    final NodeSub1 method3690(int i, int i_16_, int i_17_, int i_18_, int i_19_, float f) {
        anInt7559++;
        return new NodeSub1Sub1(i, i_16_, i_17_, i_18_, i_19_, f);
    }

    final void decodedOperation3735(int i) {
        if (i != 9473) method3661(-10, -73, null, null);
        if (anInt7765 != 4) {
            glSetupOrthoProjection(i ^ 0x3201);
            beginFrame(false, 2);
            setLightingEnabled(false, 79);
    ...
    public static void decodedOperation3736(byte i) {
        aClass351_7554 = null;
        aClass351_7715 = null;
    ...
    final void drawTexturedRect(int i, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, Shader var_aa, int i_25_, int i_26_) {
        try {
            anInt7727++;
    ...
    final synchronized void decodedOperation3737(int i, byte i_31_, int i_32_) {
        anInt7676++;
    ...
    final Interface2 decodedOperation3739(int i, Buffer buffer, boolean bool, int i_35_, int i_36_) {
        try {
    ...
    final GlFramebufferTexture decodedOperation3741(int i) {
        anInt7581++;
        ...
        do {
            try {
                ...
                if (class348_sub42_sub12 != null) {
                    ...
                    if ((class348_sub42_sub12.aBoolean9611) || "".equals(class348_sub42_sub12.target)) {
                        class348_sub42_sub13 = new HashNodeSub13(class348_sub42_sub12.target);
                    ...
                    if (!class348_sub42_sub13.decodedOperation3233(class348_sub42_sub12, -21)) break;
                    Component359.decodedOperation1868((byte) -39, class348_sub42_sub13);
                }
            } catch (RuntimeException runtimeexception) {
    ...
    final void decodedOperation3744(float f, int i, float f_45_) {
    ...
    final void method3746(boolean bool, int i, boolean bool_46_, int i_47_) {
        ...
        if (anInt7796 != i || aBoolean7859 == !this.aBoolean7846) {
            GlTexture class258_sub3 = null;
            int i_48_ = 0;
            byte i_49_ = 0;
            int i_50_ = 0;
            byte i_51_ = !this.aBoolean7846 ? (byte) 0 : (byte) 3;
            if (i >= 0) {
                class258_sub3 = aClass354_7723.decodedOperation3467(i, 256);
            ...
            aClass100_7707.decodedOperation884(i_49_, bool, i_51_, i_50_, (byte) 12, bool_46_);
            if (!aClass100_7707.decodedOperation885(i_48_, (byte) -124, class258_sub3)) {
                bindTexture((byte) -86, class258_sub3);
                setTextureEnvMode(0, i_48_);
            }
    ...
    final void drawSprite(int i, boolean bool) {
        anInt7710++;
    ...
    final void Q(int i, int i_57_, int i_58_, int i_59_, int i_60_, int i_61_, byte[] is, int i_62_, int i_63_) {
        try {
            ...
            if (aClass258_Sub3_Sub1_7776 == null || i_58_ > aClass258_Sub3_Sub1_7776.anInt8547 || i_59_ > aClass258_Sub3_Sub1_7776.anInt8551) {
                aClass258_Sub3_Sub1_7776 = Component307.decodedOperation3583(false, is, 6406, i_59_, this, -45, 6406, i_58_);
                aClass258_Sub3_Sub1_7776.decodedOperation1965(false, false, 10243);
                f = aClass258_Sub3_Sub1_7776.aFloat9938;
                f_64_ = (aClass258_Sub3_Sub1_7776.aFloat9937);
            } else {
                aClass258_Sub3_Sub1_7776.decodedOperation1970(0, 0, i_58_, false, 0, i_59_, 6406, 123, is, 0);
    ...
    final void renderModel(Component122 class98) {
        try {
            aClass233_7711.decodedOperation1651(this, (byte) -119, -1, class98);
            anInt7569++;
        } catch (RuntimeException runtimeexception) {
    ...
    final void glTexEnvfv(float f, float f_69_, float f_70_, byte i, float f_71_) {
        ...
        if (i <= 45) decodedOperation3769(-35L, false);
        anInt7576++;
    ...
    final void loadModelviewMatrix(DisplayModeManagerContainer204 class101) {
        do {
            try {
                ...
                this.aClass101_Sub3_7766.decodedOperation942(3128);
                this.aClass101_Sub3_7767.decodedOperation946(this.aClass101_Sub3_7766, -7929);
    ...
    final void draw3DTriangle(int i, int i_72_, int i_73_, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_, int i_80_, int i_81_, int i_82_, int i_83_) {
        enableTexture2D((byte) -123);
        anInt7567++;
        setBlendMode(i_83_, 1);
        OpenGL.glBegin(4);
    ...
    final void method3672() {
        ...
        if (this.aBoolean7820) {
            ...
            aClass206_7739.decodedOperation1500(2983, 0);
            aClass206_7739.decodedOperation1500(2983, 8);
            pushTexture(-422613672, aClass206_7739);
        } else {
    ...
    final void glEnableScissorTest(int i, boolean bool) {
        ...
        if (i <= 106) decodedOperation3765((byte) 118, 75);
        anInt7726++;
    }
    ...
    GlToolkitSub2(Canvas canvas, d var_d, int i) {
        ...
        new HashTable();
        new LruCache(16);
        aClass262_7749 = new NodeList();
        aClass262_7751 = new NodeList();
        aClass262_7752 = new NodeList();
        ...
        this.aClass101_Sub3_7767 = new MatrixSub3();
        anInt7770 = 0;
        aFloat7786 = 0.0F;
        anInt7773 = 0;
        ...
        aClass348_Sub1Array7858 = new NodeSub1[JagTheoraDecoder.anInt984];
        this.anInt7853 = 0;
        anInt7867 = 0;
        ...
        this.anInt7782 = -1;
        this.aClass348_Sub49_Sub1_7798 = new Component182(8192);
        ...
        try {
            ...
            try {
                ...
                Component54.decodedOperation566(false, true, (byte) -128);
                aBoolean7734 = true;
                ...
                if (aClass18_7720.decodedOperation280(1)) {
                    aClass348_Sub5_Sub1_7721 = new GlWaterShader(this);
                    if (!aClass348_Sub5_Sub1_7721.decodedOperation2767((byte) 104)) {
    ...
    final void setBlendMode(int i, int i_103_) {
    ...
    private final void glLoadModelviewMatrix(byte i) {
        ...
        if (i > 77) {
            OpenGL.glLoadIdentity();
            OpenGL.glMultMatrixf(this.aClass101_Sub3_7766.decodedOperation940(1), 0);
    ...
    final void disableTexture2D(int i) {
        if (anInt7865 != 0) {
            anInt7765 &= ~0x1f;
            anInt7865 = 0;
        }
    ...
    final void U(int i, int i_109_, int i_110_, int i_111_, int i_112_) {
        enableTexture2D((byte) -119);
        anInt7525++;
        setBlendMode(i_112_, 1);
    ...
    final void method3696(int i) {
        ...
        this.anInt7712 = i;
        aClass354_7723.decodedOperation3463((byte) -110);
    }
    ...
    final void glPushModelMatrix(boolean bool, MatrixSub3 class101_sub3) {
        try {
            ...
            anInt7653++;
            OpenGL.glMultMatrixf(class101_sub3.decodedOperation940(1), 0);
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.wrapThrowable(runtimeexception, ("qo.WC(" + bool + ',' + (class101_sub3 != null ? "{...}" : "null") + ')'));
        }
    }

    final Component24 method3683(int i, int i_115_, int i_116_, int i_117_, boolean bool) {
        anInt7582++;
    ...
    final synchronized void method3646(int i) {
        ...
        aClass354_7723.decodedOperation3469(8218);
    ...
    final void drawColoredRect(int i, int i_123_, int i_124_, int i_125_, int i_126_, int i_127_) {
        enableTexture2D((byte) -124);
        anInt7611++;
        setBlendMode(i_127_, 1);
    ...
    final void decodedOperation3760(int i) {
    ...
    final void setTextureEnvMode(int i, int i_133_) {
    ...
    final synchronized void decodedOperation3765(byte i, int i_137_) {
        anInt7566++;
        Node class348 = new Node();
        class348.key = i_137_;
        if (i <= 64) renderModelEx(null, -38);
    ...
    final void glLoadModelMatrix(byte i, MatrixSub3 class101_sub3) {
        do {
            try {
                anInt7623++;
                OpenGL.glLoadMatrixf(class101_sub3.decodedOperation940(i + -54), 0);
                if (i == 55) break;
                setCullFace(null, -47);
            } catch (RuntimeException runtimeexception) {
    ...
    final void method3700(float f, float f_138_, float f_139_) {
        DefinitionSub13.aFloat9204 = f_139_;
        DisplayModeManagerContainer216.aFloat5654 = f;
        anInt7685++;
        RadixText.aFloat6120 = f_138_;
    }
    ...
    final void NodeBase(int i, int i_140_, int i_141_, int i_142_, int i_143_) {
        ...
        if (anInt7868 <= i + i_141_ && anInt7855 >= -i_141_ + i && anInt7773 <= i_140_ + i_141_ && i_140_ + -i_141_ <= anInt7787) {
            enableTexture2D((byte) -117);
            setBlendMode(i_143_, 1);
            ...
            if (aFloat7829 > (float) i_145_) {
                ...
                i_146_ = PrimitiveTypeDefinition.decodedOperation3051(i_146_, 4096);
                OpenGL.glVertex2f((float) i_141_ + f, f_144_);
                for (int i_147_ = 16384 + -i_146_; i_147_ > 0; i_147_ -= i_146_)
                    OpenGL.glVertex2f((float) i_141_ * (OggStream.aFloatArray6867[i_147_]) + f, (float) i_141_ * (OggStream.aFloatArray6865[i_147_]) + f_144_);
    ...
    final void release() {
        for (Node class348 = aClass262_7732.first(4); class348 != null; class348 = aClass262_7732.next((byte) 55))
            ((NodeBaseSub1) class348).decodedOperation3440(-82);
        anInt7563++;
        if (aClass18_7720 != null) aClass18_7720.decodedOperation279((byte) -126);
        ...
        if (aBoolean7734) {
            CookieManager.decodedOperation2173(true, 12, false);
            aBoolean7734 = false;
        }
    }
    ...
    final Component80 method3697(int i, int i_151_, int i_152_, int i_153_, int i_154_, int i_155_) {
        anInt7515++;
        if (this.aBoolean7863) return new Component100(this, i, i_151_, i_152_, i_153_, i_154_, i_155_);
        return null;
    }

    final synchronized void decodedOperation3769(long l, boolean bool) {
        try {
    ...
    final void pushTexture(int i, Interface11 interface11) {
        do {
            try {
                anInt7598++;
                if (this.aBoolean7815) {
                    popTextureUnit(8387, interface11);
    ...
    final void bindTexture(byte i, AbstractGlTexture class258) {
        try {
            ...
            AbstractGlTexture class258_156_ = aClass258Array7828[anInt7876];
            if (class258_156_ != class258) {
                if (class258 == null) OpenGL.glDisable(class258_156_.anInt4849);
                    ...
                    OpenGL.glBindTexture(class258.anInt4849, class258.decodedOperation1953(41));
                }
    ...
    final void method3710() {
        if (aClass348_Sub5_Sub1_7721 != null && aClass348_Sub5_Sub1_7721.decodedOperation2760((byte) 1)) {
    ...
    final void drawColoredQuad(int i, int i_157_, int i_158_, int i_159_, int i_160_, int i_161_, int i_162_, int i_163_, int i_164_) {
        anInt7656++;
        if (i_158_ != i || i_157_ != i_159_) {
            enableTexture2D((byte) -119);
            setBlendMode(i_161_, 1);
    ...
    final void popTexture(int i, Interface11 interface11) {
        try {
            anInt7617++;
            if (i != -1) aString7845 = null;
            if (this.aBoolean7815) {
                setCullFace(interface11, 327685);
    ...
    final void drawTexturedQuad(int i, int i_186_, int i_187_, int i_188_, int i_189_, int i_190_, Shader var_aa, int i_191_, int i_192_, int i_193_, int i_194_, int i_195_) {
        try {
            anInt7618++;
    ...
    final Shader method3661(int i, int i_210_, int[] is, int[] is_211_) {
        try {
            anInt7589++;
            return RuntimeException_Sub1.decodedOperation4009(i, is, is_211_, 0, this, i_210_);
        } catch (RuntimeException runtimeexception) {
        ...
        do {
            try {
                ...
                if (this.aBoolean7775) {
                    class348_sub49_sub1.writeFloatBE(-1.0F, (byte) -122);
                    class348_sub49_sub1.writeFloatBE(-1.0F, (byte) -103);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -113);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -112);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -124);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -99);
                    class348_sub49_sub1.writeFloatBE(-1.0F, (byte) -95);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -94);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -118);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -112);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -89);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -102);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -109);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -109);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -112);
                    class348_sub49_sub1.writeFloatBE(-1.0F, (byte) -101);
                    class348_sub49_sub1.writeFloatBE(1.0F, (byte) -93);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -123);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -110);
                    class348_sub49_sub1.writeFloatBE(0.0F, (byte) -113);
                } else {
                    class348_sub49_sub1.writeFloatLE(18291, -1.0F);
                    class348_sub49_sub1.writeFloatLE(18291, -1.0F);
                    class348_sub49_sub1.writeFloatLE(18291, 0.0F);
                    class348_sub49_sub1.writeFloatLE(18291, 0.0F);
                    class348_sub49_sub1.writeFloatLE(18291, 1.0F);
                    class348_sub49_sub1.writeFloatLE(18291, 1.0F);
                    class348_sub49_sub1.writeFloatLE(18291, -1.0F);
                ...
                anInterface2_7797 = decodedOperation3731(2, false, 20, (class348_sub49_sub1.payload), (class348_sub49_sub1.offset));
                ...
                aClass233_7711.decodedOperation1654(643267468, this);
            } catch (RuntimeException runtimeexception) {
    ...
    private final void resetTextureUnits(int i) {
        anInt7609++;
    ...
    final void setLineWidth(int i, int i_219_, int i_220_, int i_221_, int i_222_, int i_223_, int i_224_) {
        anInt7662++;
        OpenGL.glLineWidth((float) i_223_);
        drawColoredRect(i, i_219_, i_220_, i_221_, i_222_, i_224_);
    ...
    private final void resetBlendState(int i) {
        anInt7632++;
    ...
    final Component24 method3711(int[] is, int i, int i_232_, int i_233_, int i_234_, boolean bool) {
        try {
            anInt7522++;
    ...
    private final void enableTexture2D(byte i) {
        if (anInt7765 != 1) {
            glSetupOrthoProjection(5888);
            beginFrame(false, 2);
            setLightingEnabled(false, 48);
    ...
    final synchronized void setDepthTest(int i, int i_235_, int i_236_) {
        anInt7616++;
        NodeSub35 class348_sub35 = new NodeSub35(i);
        class348_sub35.key = i_236_;
        aClass262_7751.addTail(class348_sub35, -20180);
        if (i_235_ != -1) decodedOperation3733(-17, -42, -40, null, true);
    }
    ...
    final int decodedOperation3781(byte i, int i_237_) {
        anInt7613++;
    ...
    final void setCullFace(Interface11 interface11, int i) {
        try {
            anInt7640++;
            if (anInt7738 >= 3) throw new RuntimeException();
            if (i != 327685) setLineWidth(-94, -9, -90, -108, 41, -52, 70);
    ...
    final DisplayModeManagerContainer204 method3654() {
        anInt7716++;
        return new MatrixSub3();
    }

    final boolean method3671() {
        anInt7670++;
        if (aClass348_Sub5_Sub1_7721 != null) {
            if (!aClass348_Sub5_Sub1_7721.decodedOperation2760((byte) 1)) {
                if (!aClass18_7720.decodedOperation274(aClass348_Sub5_Sub1_7721, true)) return false;
                aClass354_7723.decodedOperation3463((byte) -110);
            }
            return true;
        }
    ...
    private final void setupLights(int i) {
        anInt7527++;
        int i_250_;
        for (i_250_ = i; anInt7862 > i_250_; i_250_++) {
            NodeSub1 class348_sub1 = aClass348_Sub1Array7858[i_250_];
            ShaderCompilerSub1.aFloatArray6514[0] = (float) class348_sub1.decodedOperation2724(-1);
            int i_251_ = i_250_ + 16386;
            ShaderCompilerSub1.aFloatArray6514[1] = (float) class348_sub1.decodedOperation2722(127);
            ShaderCompilerSub1.aFloatArray6514[2] = (float) class348_sub1.decodedOperation2717((byte) 77);
            ShaderCompilerSub1.aFloatArray6514[3] = 1.0F;
            OpenGL.glLightfv(i_251_, 4611, ShaderCompilerSub1.aFloatArray6514, 0);
            int i_252_ = class348_sub1.decodedOperation2720(-1);
            float f = class348_sub1.decodedOperation2721(-76) / 255.0F;
            ...
            OpenGL.glLightf(i_251_, 4617, 1.0F / (float) (class348_sub1.decodedOperation2723(-1) * class348_sub1.decodedOperation2723(-1)));
    ...
    final void setColorMask(byte i) {
        if (anInt7765 != 8) {
            method3740(-14388);
            beginFrame(true, 2);
            glEnableScissorTest(114, true);
            drawSprite(i + 62, true);
            setBlendMode(1, 1);
            anInt7765 = 8;
        }
        anInt7665++;
    ...
    final int setStencilOp(int i, int i_253_) {
        anInt7682++;
    ...
    final void renderModelEx(Component122 class98, int i) {
        try {
            aClass233_7711.decodedOperation1651(this, (byte) -116, i, class98);
            anInt7687++;
        } catch (RuntimeException runtimeexception) {
    ...
    private final void initTextures(boolean bool) {
        anInt7630++;
        aClass258Array7828 = new AbstractGlTexture[this.anInt7795];
        this.aClass258_Sub3_7827 = new GlTexture(this, 3553, 6408, 1, 1);
        new GlTexture(this, 3553, 6408, 1, 1);
        new GlTexture(this, 3553, 6408, 1, 1);
        this.aClass64_Sub3_7864 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7838 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7803 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7834 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7840 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7780 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7802 = new DisplayModeManagerContainer282(this);
        this.aClass64_Sub3_7821 = new DisplayModeManagerContainer282(this);
        if (bool == false) {
            this.aClass64_Sub3_7844 = new DisplayModeManagerContainer282(this);
            this.aClass64_Sub3_7785 = new DisplayModeManagerContainer282(this);
            if (this.aBoolean7820) {
                this.aClass206_7778 = new DisplayModeManagerContainer105(this);
                new DisplayModeManagerContainer105(this);
            }
        }
    }
    ...
    final Component6 c() {
        ...
        return new Component6(i, "OpenGL", anInt7789, aString7790, 0L);
    }
    ...
    final void deleteTexture(byte i, float f) {
        if (aFloat7851 != f) {
            aFloat7851 = f;
            if (anInt7865 == 3) glSetProjectionMatrix((byte) -63);
        }
    ...
    final void bindTextureNative(int i, int i_262_, int i_263_) {
        if (i > 94) {
            anInt7724++;
            anInt7867 = i_262_;
            anInt7770 = i_263_;
    ...
    final Component24 method3629(int i, int i_275_, boolean bool) {
        anInt7625++;
        return new SpriteSub2(this, i, i_275_, bool);
    }
    ...
    private final void glResetTextureUnits(int i) {
        ...
        aBoolean7758 = true;
        beginFrame(true, 2);
        setLightingEnabled(true, 71);
        glEnableScissorTest(124, true);
        drawSprite(0, true);
        disableTexture2D(i ^ ~0x651d);
    ...
    final void bindTexture(int i) {
        if (i < 45) resetBlendState(-72);
        if (anInt7765 != 2) {
            glSetupOrthoProjection(5888);
            beginFrame(false, 2);
            setLightingEnabled(false, 66);
    ...
    final boolean method3639() {
        anInt7667++;
        return aClass100_7707.decodedOperation889((byte) -91, 3);
    }

    final boolean method3666() {
        anInt7537++;
        return aClass348_Sub5_Sub1_7721 != null && aClass348_Sub5_Sub1_7721.decodedOperation2760((byte) 1);
    }
    ...
    private final void releaseSurface(int i) {
    ...
    final int createSurface(int i, int i_295_) {
        anInt7698++;
    ...
    final synchronized void swapInterval(int i, int i_299_) {
        anInt7570++;
    ...
    final void method3698() {
        aClass18_7720.decodedOperation272(-53);
        anInt7595++;
    }
    ...
    final Component80 method3706(Component80 class299, Component80 class299_305_, float f, Component80 class299_306_) {
        try {
            anInt7658++;
            if (class299 != null && class299_305_ != null && this.aBoolean7863 && this.aBoolean7820) {
                Component264 class299_sub1_sub2 = null;
                Component40 class299_sub1 = (Component40) class299;
                Component40 class299_sub1_307_ = (Component40) class299_305_;
                GlFramebufferTexture class258_sub2 = class299_sub1.method2256((byte) -121);
                GlFramebufferTexture class258_sub2_308_ = class299_sub1_307_.method2256((byte) -121);
                if (class258_sub2 != null && class258_sub2_308_ != null) {
                    int i = (Math.max(class258_sub2_308_.anInt8538, class258_sub2.anInt8538));
                    if (class299_306_ != class299 && class299_305_ != class299_306_ && class299_306_ instanceof Component264) {
                        Component264 class299_sub1_sub2_309_ = (Component264) class299_306_;
                        if (i == class299_sub1_sub2_309_.decodedOperation2262(65534)) class299_sub1_sub2 = class299_sub1_sub2_309_;
                    }
                    if (class299_sub1_sub2 == null) class299_sub1_sub2 = new Component264(this, i);
                    if (class299_sub1_sub2.decodedOperation2261(class258_sub2, f, 65534, class258_sub2_308_)) return class299_sub1_sub2;
                }
            }
    ...
    final void getError(boolean bool, int i, int i_310_) {
    ...
    static final void getString(int i, int i_315_, int i_316_, int i_317_, int i_318_, int i_319_, int i_320_) {
        anInt7572++;
        ...
        for (int i_322_ = 0; (i_322_ < Component324.anInt2057 + i_321_); i_322_++) {
            ...
            if (i_321_ > i_322_) class318_sub1_sub3_sub3 = (InterfaceRenderer.players[is[i_322_]]);
                ...
                if (class79.anIntArray1377 != null) {
                    class79 = class79.decodedOperation794((DisplayModeManagerContainer58.aClass170_10209), i_316_ + -3);
            ...
            if ((class318_sub1_sub3_sub3.anInt10285 >= 0) && (((class318_sub1_sub3_sub3.anInt10301) == DisplayModeManagerContainer341.anInt6006) || ((Component72.localPlayer.plane) == class318_sub1_sub3_sub3.plane))) {
                NodeSub13.decodedOperation2801(class318_sub1_sub3_sub3.method2426(200), i_318_ >> 1, i_320_, i_319_, i_315_ >> 1, class318_sub1_sub3_sub3, (byte) 100);
                if (Component71.anIntArray6062[0] >= 0) {
                    if ((class318_sub1_sub3_sub3.aString10292) != null && (i_321_ <= i_322_ || NodeBase.anInt7276 == 0 || NodeBase.anInt7276 == 3 || (NodeBase.anInt7276 == 1 && (NodeSub11.decodedOperation2797(((Player) class318_sub1_sub3_sub3).username, (byte) -63)))) && TheoraVideoPlayer.anInt1497 < DisplayModeManagerContainer74.anInt4814) {
                        ...
                        DisplayModeManagerContainer74.anIntArray4806[TheoraVideoPlayer.anInt1497] = class318_sub1_sub3_sub3.anInt10234;
                        DisplayModeManagerContainer74.anIntArray4812[TheoraVideoPlayer.anInt1497] = class318_sub1_sub3_sub3.anInt10264;
                        DisplayModeManagerContainer74.aStringArray4818[TheoraVideoPlayer.anInt1497] = class318_sub1_sub3_sub3.aString10292;
                        TheoraVideoPlayer.anInt1497++;
                    }
                    int i_323_ = Component71.anIntArray6062[1] + i;
                    if (!(class318_sub1_sub3_sub3.aBoolean10309) && (OpenGlShader.clientCycle < class318_sub1_sub3_sub3.anInt10223)) {
                        int i_324_ = -1;
                        int i_325_ = 1;
                        if (i_321_ <= i_322_) {
                        ...
                        if (i_324_ != -1) {
                            ...
                            if (class105s_326_ == null) {
                                Component170[] class207s = Component170.decodedOperation1519(Component158.aClass45_322, i_324_, 0);
                                if (class207s != null) {
                                    class105s_326_ = new Component24[class207s.length];
                                    for (int i_327_ = 0; class207s.length > i_327_; i_327_++)
                                        class105s_326_[i_327_] = (NodeSub8.toolkit.decodedOperation3691(class207s[i_327_], true));
                        ...
                        i_323_ -= Math.max((Component27.aClass143_4962.maxAscent), class105.decodedOperation969());
                        int i_329_ = (Component71.anIntArray6062[0] + (i_317_ + -(class105.decodedOperation971() >> 1)));
                        int i_330_ = (class105.decodedOperation971() * class318_sub1_sub3_sub3.anInt10295 / 255);
                        int i_331_ = class105.decodedOperation969();
                        if (class318_sub1_sub3_sub3.anInt10295 > 0 && i_330_ < 2) i_330_ = 2;
                        class105.drawAt(i_329_, i_323_);
                        NodeSub8.toolkit.T(i_329_, i_323_, i_330_ + i_329_, i_331_ + i_323_);
                        class105_328_.drawAt(i_329_, i_323_);
                        NodeSub8.toolkit.KA(i_317_, i, i_317_ - -i_318_, i_315_ + i);
                        Component103.decodedOperation2663(-5590, i_329_, i_329_ + class105.decodedOperation966(), i_323_, i_323_ + i_331_);
                    } else i_323_ -= Math.max((Component27.aClass143_4962.maxAscent), NodeSub45.aClass105Array7107[0].decodedOperation969());
                    i_323_ -= 2;
                    if (!class318_sub1_sub3_sub3.aBoolean10309) {
                        if (class318_sub1_sub3_sub3.anInt10287 > OpenGlShader.clientCycle) {
                            Component24 class105 = (DisplayModeManagerContainer199.aClass105Array5857[(class318_sub1_sub3_sub3.aBoolean10226 ? 2 : 0)]);
                            Component24 class105_332_ = (DisplayModeManagerContainer199.aClass105Array5857[(!class318_sub1_sub3_sub3.aBoolean10226 ? 1 : 3)]);
                            int i_333_ = -1;
                            ...
                            if (i_333_ != -1) {
                                ...
                                if (class105s == null) {
                                    Component170[] class207s = Component170.decodedOperation1519((Component158.aClass45_322), i_333_, 0);
                                    if (class207s != null) {
                                        class105s = new Component24[class207s.length];
                                        for (int i_334_ = 0; (class207s.length > i_334_); i_334_++)
                                            class105s[i_334_] = (NodeSub8.toolkit.decodedOperation3691(class207s[i_334_], true));
                            ...
                            int i_335_ = (-OpenGlShader.clientCycle + class318_sub1_sub3_sub3.anInt10287);
                            int i_336_;
                            if (i_335_ > class318_sub1_sub3_sub3.anInt10227) {
                                ...
                                i_336_ = (class105.decodedOperation971() * i_337_ / class318_sub1_sub3_sub3.anInt10210);
                            } else i_336_ = class105.decodedOperation971();
                            int i_338_ = class105.decodedOperation969();
                            i_323_ -= i_338_;
                            int i_339_ = (Component71.anIntArray6062[0] + (i_317_ + -(class105.decodedOperation971() >> 1)));
                            class105.drawAt(i_339_, i_323_);
                            NodeSub8.toolkit.T(i_339_, i_323_, i_339_ - -i_336_, i_323_ - -i_338_);
                            class105_332_.drawAt(i_339_, i_323_);
                            NodeSub8.toolkit.KA(i_317_, i, i_318_ + i_317_, i - -i_315_);
                            Component103.decodedOperation2663(-5590, i_339_, class105.decodedOperation966() + i_339_, i_323_, i_338_ + i_323_);
                            i_323_ -= 2;
                        }
                        if (i_322_ < i_321_) {
                            ...
                            if (player.anInt10540 != -1) {
                                i_323_ -= 25;
                                Component24 class105 = (Component141.aClass105Array9959[(player.anInt10540)]);
                                class105.drawAt((-12 + i_317_ + (Component71.anIntArray6062[0])), i_323_);
                                Component103.decodedOperation2663(-5590, i_317_ + (Component71.anIntArray6062[0] + -12), (i_317_ - -Component71.anIntArray6062[0] + (-12 + class105.decodedOperation966())), i_323_, i_323_ + class105.decodedOperation980());
                                i_323_ -= 2;
                            }
                            if (player.anInt10522 != -1) {
                                i_323_ -= 25;
                                Component24 class105 = (Component235.aClass105Array3378[(player.anInt10522)]);
                                class105.drawAt((-12 + i_317_ + (Component71.anIntArray6062[0])), i_323_);
                                Component103.decodedOperation2663(-5590, (-12 + Component71.anIntArray6062[0] + i_317_), (Component71.anIntArray6062[0] + i_317_ - (12 + -class105.decodedOperation966())), i_323_, i_323_ - -class105.decodedOperation980());
                                i_323_ -= 2;
                            }
                        } else if (class79.anInt1375 >= 0 && (class79.anInt1375 < Component235.aClass105Array3378.length)) {
                            Component24 class105 = (Component235.aClass105Array3378[class79.anInt1375]);
                            i_323_ -= 25;
                            class105.drawAt((i_317_ + (Component71.anIntArray6062[0]) + -(class105.decodedOperation971() >> 1)), i_323_);
                            Component103.decodedOperation2663(-5590, (Component71.anIntArray6062[0] + (i_317_ - (class105.decodedOperation971() >> 1))), (Component71.anIntArray6062[0] + (i_317_ - (class105.decodedOperation971() >> 1)) + class105.decodedOperation966()), i_323_, class105.decodedOperation980() + i_323_);
                            i_323_ -= 2;
                        }
                    }
                    if (class318_sub1_sub3_sub3 instanceof Player) {
                        if (i_322_ >= 0) {
                            ...
                            for (int i_341_ = 0; (i_341_ < class302s.length); i_341_++) {
                                Component114 class302 = class302s[i_341_];
                                if (class302 != null && class302.anInt3840 == 10 && (is[i_322_] == class302.anInt3833)) {
                                    ...
                                    if (i_340_ < class105.decodedOperation969()) i_340_ = class105.decodedOperation969();
                                    class105.drawAt(-12 + ((Component71.anIntArray6062[0]) + i_317_), (i_323_ + -class105.decodedOperation969()));
                                    Component103.decodedOperation2663(-5590, -12 + (i_317_ - -(Component71.anIntArray6062[0])), (i_317_ + (Component71.anIntArray6062[0] + -12 - -class105.decodedOperation966())), -class105.decodedOperation969() + i_323_, (i_323_ + -class105.decodedOperation969() - -class105.decodedOperation980()));
                                }
                            }
                        ...
                        for (int i_343_ = 0; class302s.length > i_343_; i_343_++) {
                            Component114 class302 = class302s[i_343_];
                            if (class302 != null && class302.anInt3840 == 1 && (class302.anInt3833 == DisplayModeManagerContainer238.anIntArray1233[i_322_ - i_321_])) {
                                Component24 class105 = (Component379.aClass105Array5933[class302.anInt3831]);
                                if (class105.decodedOperation969() > i_342_) i_342_ = class105.decodedOperation969();
                                if (OpenGlShader.clientCycle % 20 < 10) {
                                    class105.drawAt((-12 + i_317_ + Component71.anIntArray6062[0]), i_323_ + -class105.decodedOperation969());
                                    Component103.decodedOperation2663(-5590, (-12 + i_317_ - -Component71.anIntArray6062[0]), (Component71.anIntArray6062[0] + (i_317_ + -12) - -class105.decodedOperation966()), -class105.decodedOperation969() + i_323_, (-class105.decodedOperation969() + (i_323_ - -class105.decodedOperation980())));
                                }
                            }
                        }
                    ...
                    int i_344_ = 0;
                    for (/**/; i_344_ < Component72.anInt1905; i_344_++) {
                        int i_345_ = (class318_sub1_sub3_sub3.anIntArray10219[i_344_]);
                        int i_346_ = (class318_sub1_sub3_sub3.anIntArray10259[i_344_]);
                        Component82 class31 = null;
                        int i_347_ = 0;
                        if (i_346_ >= 0) {
                            if (i_345_ <= OpenGlShader.clientCycle) continue;
                            class31 = (DisplayModeManagerContainer306.aClass219_4782.decodedOperation1601(46, (class318_sub1_sub3_sub3.anIntArray10259[i_344_])));
                            i_347_ = class31.anInt434;
                        } else if (i_345_ < 0) continue;
                        int i_348_ = (class318_sub1_sub3_sub3.anIntArray10304[i_344_]);
                        Component82 class31_349_ = null;
                        if (i_348_ >= 0) class31_349_ = DisplayModeManagerContainer306.aClass219_4782.decodedOperation1601(46, i_348_);
                        if (-i_347_ + i_345_ <= OpenGlShader.clientCycle) {
                            int i_350_ = (class318_sub1_sub3_sub3.anIntArray10303[i_344_]);
                            if (i_350_ >= 0) {
                                class318_sub1_sub3_sub3.anInt10223 = 300 + OpenGlShader.clientCycle;
                            ...
                            if (class31 == null) class318_sub1_sub3_sub3.anIntArray10219[i_344_] = -1;
                                ...
                                NodeSub13.decodedOperation2801(i_351_, i_318_ >> 1, i_320_, i_319_, i_315_ >> 1, class318_sub1_sub3_sub3, (byte) -107);
                                if (Component71.anIntArray6062[0] > -1) {
                                    Component71.anIntArray6062[0] += Component151.anIntArray1786[i_344_];
                                    Component71.anIntArray6062[1] += KeyStoreLoader.anIntArray1636[i_344_];
                                    Object object = null;
                                    ...
                                    Component24 class105_363_ = null;
                                    Component24 class105_364_ = null;
                                    Component24 class105_365_ = null;
                                    int i_366_ = 0;
                                    int i_367_ = 0;
                                    int i_368_ = 0;
                                    int i_369_ = 0;
                                    ...
                                    int i_373_ = 0;
                                    int i_374_ = 0;
                                    Component24 class105_375_ = class31.decodedOperation327((NodeSub8.toolkit), (byte) -96);
                                    if (class105_375_ != null) {
                                        i_355_ = class105_375_.decodedOperation971();
                                        int i_376_ = class105_375_.decodedOperation969();
                                        class105_375_.method984(DisplayModeManagerContainer346.anIntArray2062);
                                        if (i_374_ < i_376_) i_374_ = i_376_;
                                        i_359_ = DisplayModeManagerContainer346.anIntArray2062[0];
                                    }
                                    Component24 class105_377_ = class31.decodedOperation331((NodeSub8.toolkit), (byte) -75);
                                    if (class105_377_ != null) {
                                        i_356_ = class105_377_.decodedOperation971();
                                        int i_378_ = class105_377_.decodedOperation969();
                                        class105_377_.method984(DisplayModeManagerContainer346.anIntArray2062);
                                        if (i_378_ > i_374_) i_374_ = i_378_;
                                        i_360_ = DisplayModeManagerContainer346.anIntArray2062[0];
                                    }
                                    Component24 class105_379_ = class31.decodedOperation324((NodeSub8.toolkit), true);
                                    if (class105_379_ != null) {
                                        i_357_ = class105_379_.decodedOperation971();
                                        int i_380_ = class105_379_.decodedOperation969();
                                    ...
                                    Component24 class105_381_ = class31.decodedOperation325((NodeSub8.toolkit), 105);
                                    if (class105_381_ != null) {
                                        i_358_ = class105_381_.decodedOperation971();
                                        int i_382_ = class105_381_.decodedOperation969();
                                        class105_381_.method984(DisplayModeManagerContainer346.anIntArray2062);
                                        if (i_374_ < i_382_) i_374_ = i_382_;
                                        i_362_ = DisplayModeManagerContainer346.anIntArray2062[0];
                                    }
                                    if (class31_349_ != null) {
                                        class105 = (class31_349_.decodedOperation327(NodeSub8.toolkit, (byte) 110));
                                        if (class105 != null) {
                                            i_366_ = class105.decodedOperation971();
                                            int i_383_ = class105.decodedOperation969();
                                        ...
                                        class105_363_ = (class31_349_.decodedOperation331(NodeSub8.toolkit, (byte) -80));
                                        if (class105_363_ != null) {
                                            i_367_ = class105_363_.decodedOperation971();
                                            int i_384_ = class105_363_.decodedOperation969();
                                        ...
                                        class105_364_ = (class31_349_.decodedOperation324(NodeSub8.toolkit, true));
                                        if (class105_364_ != null) {
                                            i_368_ = class105_364_.decodedOperation971();
                                            int i_385_ = class105_364_.decodedOperation969();
                                            class105_364_.method984(DisplayModeManagerContainer346.anIntArray2062);
                                            if (i_385_ > i_374_) i_374_ = i_385_;
                                            i_372_ = DisplayModeManagerContainer346.anIntArray2062[0];
                                        }
                                        class105_365_ = (class31_349_.decodedOperation325(NodeSub8.toolkit, i_316_ ^ 0x35));
                                        if (class105_365_ != null) {
                                            i_369_ = class105_365_.decodedOperation971();
                                            int i_386_ = class105_365_.decodedOperation969();
                                            if (i_386_ > i_374_) i_374_ = i_386_;
                                            class105_365_.method984(DisplayModeManagerContainer346.anIntArray2062);
                                            i_373_ = DisplayModeManagerContainer346.anIntArray2062[0];
                                        }
                                    }
                                    BitmapFont class324 = Component49.aClass324_4684;
                                    BitmapFont class324_387_ = Component49.aClass324_4684;
                                    ...
                                    if (i_388_ >= 0) {
                                        BitmapFont class324_390_ = DisplayModeManagerContainer194.decodedOperation232((NodeSub8.toolkit), (byte) -53, true, i_388_);
                                        Component184 class143_391_ = (Component137.decodedOperation1151(-25411, NodeSub8.toolkit, i_388_));
                                    ...
                                    if (class31_349_ != null) {
                                        ...
                                        if (i_388_ >= 0) {
                                            BitmapFont class324_392_ = (DisplayModeManagerContainer194.decodedOperation232(NodeSub8.toolkit, (byte) -53, true, i_388_));
                                            Component184 class143_393_ = (Component137.decodedOperation1151(-25411, NodeSub8.toolkit, i_388_));
                                    ...
                                    boolean bool = false;
                                    int i_395_ = 0;
                                    String string_396_ = (class31.decodedOperation333((class318_sub1_sub3_sub3.anIntArray10229[i_344_]), 0));
                                    int i_397_ = class143.stringWidth(true, string_396_);
                                    if (class31_349_ != null) {
                                        string = (class31_349_.decodedOperation333((class318_sub1_sub3_sub3.anIntArray10284[i_344_]), 0));
                                    ...
                                    int i_413_ = (-OpenGlShader.clientCycle + (class318_sub1_sub3_sub3.anIntArray10219[i_344_]));
                                    ...
                                    int i_416_ = (i_317_ + Component71.anIntArray6062[0] + -(i_400_ >> 1) - -i_414_);
                                    int i_417_ = -12 + (i + ((Component71.anIntArray6062[1]) - -i_415_));
                                    int i_418_ = i_417_;
                                    ...
                                    if (i_426_ >= 0 && i_426_ < 255) {
                                        ...
                                        if (class105_375_ != null) class105_375_.decodedOperation964((-i_359_ + i_401_ + i_416_), i_417_, 0, i_428_, 1);
                                        if (class105_379_ != null) class105_379_.decodedOperation964((-i_361_ + i_402_ + i_416_), i_417_, 0, i_428_, 1);
                                        if (class105_377_ != null) {
                                            for (int i_429_ = 0; (i_398_ > i_429_); i_429_++)
                                                class105_377_.decodedOperation964((i_403_ + (i_416_ + (-i_360_ - -(i_356_ * i_429_)))), i_417_, 0, i_428_, 1);
                                        }
                                        if (class105_381_ != null) class105_381_.decodedOperation964(i_406_ + i_416_ + -i_362_, i_417_, 0, i_428_, 1);
                                        class324.drawText(string_396_, (class31.anInt444 | i_427_), i_420_, i_404_ + i_416_, 0, -124);
                                        if (class31_349_ != null) {
                                            if (class105 != null) class105.decodedOperation964((i_416_ + i_407_ - i_370_), i_417_, 0, i_428_, 1);
                                            if (class105_364_ != null) class105_364_.decodedOperation964(-i_372_ + (i_408_ + i_416_), i_417_, 0, i_428_, 1);
                                            if (class105_363_ != null) {
                                                for (int i_430_ = 0; i_430_ < i_399_; i_430_++)
                                                    class105_363_.decodedOperation964((i_430_ * i_367_ + i_416_ + (i_409_ + -i_371_)), i_417_, 0, i_428_, 1);
                                            }
                                            if (class105_365_ != null) class105_365_.decodedOperation964((i_416_ - -i_410_ + -i_373_), i_417_, 0, i_428_, 1);
                                            class324_387_.drawText(string, (i_427_ | (class31_349_.anInt444)), i_423_, i_416_ + i_411_, 0, -125);
                                        }
                                    } else {
                                        if (class105_375_ != null) class105_375_.drawAt(i_416_ - (-i_401_ + i_359_), i_417_);
                                        if (class105_379_ != null) class105_379_.drawAt(i_416_ - (-i_402_ - -i_361_), i_417_);
                                        if (class105_377_ != null) {
                                            for (int i_431_ = 0; i_431_ < i_398_; i_431_++)
                                                class105_377_.drawAt((i_403_ + i_416_ - (i_360_ - i_431_ * i_356_)), i_417_);
                                        }
                                        if (class105_381_ != null) class105_381_.drawAt(i_406_ + (i_416_ + -i_362_), i_417_);
                                        class324.drawText(string_396_, (class31.anInt444 | ~0xffffff), i_420_, i_416_ + i_404_, 0, i_316_ ^ ~0x74);
                                        if (class31_349_ != null) {
                                            if (class105 != null) class105.drawAt((-i_370_ + i_416_ + i_407_), i_417_);
                                            if (class105_364_ != null) class105_364_.drawAt(i_408_ + (i_416_ + -i_372_), i_417_);
                                            if (class105_363_ != null) {
                                                for (int i_432_ = 0; i_399_ > i_432_; i_432_++)
                                                    class105_363_.drawAt((i_432_ * i_367_ + (-i_371_ + i_416_ + i_409_)), i_417_);
                                            }
                                            if (class105_365_ != null) class105_365_.drawAt(i_410_ + i_416_ - i_373_, i_417_);
                                            class324_387_.drawText(string, (class31_349_.anInt444) | ~0xffffff, i_423_, i_411_ + i_416_, 0, -119);
                                        }
                                    }
                                    Component103.decodedOperation2663(-5590, i_416_, i_416_ + i_400_, i_418_, 1 + i_419_);
                                }
                            }
                        }
                    }
        ...
        for (int i_433_ = 0; i_433_ < CacheStore.anInt669; i_433_++) {
            ...
            ImageCache.decodedOperation1430(--class318_sub1_sub3_sub3.anInt10261, (byte) 119, i_320_, i_315_, i, i_319_, i_318_, i_317_, class318_sub1_sub3_sub3_436_, class318_sub1_sub3_sub3);
        }
        ...
        for (int i_438_ = 0; i_438_ < TheoraVideoPlayer.anInt1497; i_438_++) {
            ...
            int i_441_ = DisplayModeManagerContainer74.anIntArray4819[i_438_];
            boolean bool = true;
            while (bool) {
                bool = false;
                for (int i_442_ = 0; i_438_ > i_442_; i_442_++) {
                    if (i_440_ - -2 > DisplayModeManagerContainer74.anIntArray4813[i_442_] + -i_437_ && (-i_437_ + i_440_ < 2 + DisplayModeManagerContainer74.anIntArray4813[i_442_]) && ((DisplayModeManagerContainer74.anIntArray4822[i_442_] - -DisplayModeManagerContainer74.anIntArray4819[i_442_]) > i_439_ + -i_441_) && ((-DisplayModeManagerContainer74.anIntArray4819[i_442_] + DisplayModeManagerContainer74.anIntArray4822[i_442_]) < i_439_ + i_441_) && (-i_437_ + DisplayModeManagerContainer74.anIntArray4813[i_442_] < i_440_)) {
                        i_440_ = -i_437_ + DisplayModeManagerContainer74.anIntArray4813[i_442_];
                        bool = true;
                    }
                }
            }
            ...
            if (DefinitionSub31.anInt9408 == 0) {
                ...
                if (DisplayModeManagerContainer74.anIntArray4817[i_438_] == 6) i_448_ = (DisplayModeManagerContainer341.anInt6006 % 20 >= 10 ? 16776960 : 16711680);
                if (DisplayModeManagerContainer74.anIntArray4817[i_438_] == 7) i_448_ = DisplayModeManagerContainer341.anInt6006 % 20 < 10 ? 255 : 65535;
                if (DisplayModeManagerContainer74.anIntArray4817[i_438_] == 8) i_448_ = (DisplayModeManagerContainer341.anInt6006 % 20 >= 10 ? 8454016 : 45056);
                if (DisplayModeManagerContainer74.anIntArray4817[i_438_] == 9) {
                    int i_449_ = -DisplayModeManagerContainer74.anIntArray4812[i_438_] + 150;
                ...
                if (DisplayModeManagerContainer74.anIntArray4817[i_438_] == 10) {
                    int i_450_ = 150 - DisplayModeManagerContainer74.anIntArray4812[i_438_];
                    if (i_450_ >= 50) {
                        if (i_450_ >= 100) {
                ...
                if (DisplayModeManagerContainer74.anIntArray4817[i_438_] == 11) {
                    int i_451_ = 150 - DisplayModeManagerContainer74.anIntArray4812[i_438_];
                    if (i_451_ >= 50) {
                ...
                if (DisplayModeManagerContainer74.anIntArray4806[i_438_] == 0) {
                    NodeList.aClass324_3326.drawTextCentred((byte) 115, i_439_ + i_317_, i_452_, string, -16777216, i_440_ + i);
                    i_444_ -= i_443_ >> 1;
                    i_446_ -= i_443_ >> 1;
                }
                if (DisplayModeManagerContainer74.anIntArray4806[i_438_] == 1) {
                    i_446_ -= i_443_ >> 1;
                    i_444_ -= i_443_ >> 1;
                    NodeList.aClass324_3326.decodedOperation2574(i_452_, i_440_ + i, string, i_317_ - -i_439_, -16777216, DisplayModeManagerContainer341.anInt6006, false);
                    i_447_ += 5;
                    i_445_ -= 5;
                }
                if (DisplayModeManagerContainer74.anIntArray4806[i_438_] == 2) {
                    i_447_ += 5;
                    i_446_ -= -5 + (i_443_ >> 1);
                    NodeList.aClass324_3326.decodedOperation2581(string, i_452_, (DisplayModeManagerContainer341.anInt6006), i_440_ + i, (byte) -112, -16777216, i_317_ - -i_439_);
                    i_445_ -= 5;
                    i_444_ -= (i_443_ >> 1) - -5;
                }
                if (DisplayModeManagerContainer74.anIntArray4806[i_438_] == 3) {
                    i_446_ -= i_443_ >> 1;
                    i_444_ -= i_443_ >> 1;
                    i_447_ += 7;
                    NodeList.aClass324_3326.decodedOperation2577(DisplayModeManagerContainer341.anInt6006, i + i_440_, string, i_452_, -16777216, 150 + -DisplayModeManagerContainer74.anIntArray4812[i_438_], i_439_ + i_317_, -20509);
                    i_445_ -= 7;
                }
                ...
                i_444_ -= i_443_ >> 1;
                i_446_ -= i_443_ >> 1;
                NodeList.aClass324_3326.drawTextCentred((byte) 118, i_439_ + i_317_, -256, string, -16777216, i_440_ + i);
            }
            Component103.decodedOperation2663(i_316_ + -5592, i_444_, 1 + i_446_, i_445_, 1 + i_447_);
        }
    }
    ...
    final void getIntegerv(boolean bool, byte i) {
    ...
    final void method3658(int i, int i_459_, int i_460_, int i_461_) {
        aClass18_7720.decodedOperation275(i_460_, i, i_461_, i_459_, -1);
        anInt7651++;
    }

    final void popTextureUnit(int i, Interface11 interface11) {
        try {
            anInt7697++;
    ...
    final Component24 decodedOperation3691(Component170 class207, boolean bool) {
        try {
            ...
            Component24 class105 = this.decodedOperation3662(class207.anInt2702, is, (byte) 94, 0, class207.anInt2702, class207.anInt2696);
    ...
    final void beginFrame(boolean bool, int i) {
        if (i != 2) anInt7814 = -59;
        anInt7517++;
    ...
    final synchronized void clearBuffers(int i, int i_478_, int i_479_) {
        if (i_479_ < -57) {
            anInt7677++;
    ...
    static {
        aClass351_7554 = new StringCache(52, 4);
        aClass351_7715 = new StringCache(58, 4);
        anInt7722 = 0;
    }
}
