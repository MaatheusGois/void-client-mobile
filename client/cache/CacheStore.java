...
final class CacheStore {
    ...
    static int anInt627;
    static int anInt628;
    private ReferenceTable aClass291_629 = null;
    static int anInt630;
    static int anInt631;
    static int anInt632;
    static int anInt633;
    ...
    static int anInt657;
    static int anInt658;
    private Component112 aClass314_659;
    static int anInt660;
    static int anInt661;
    static int anInt662;
    static int anInt663;
    ...
    final byte[] getFile(String string, String string_1_, int i) {
        try {
            ...
            int i_2_ = aClass291_629.aClass316_3723.method2365(1, Component337.method2108(string, -29286));
            if (!method392(i_2_, (byte) -40)) return null;
            if (i != -29832) method392(22, (byte) 12);
            int i_3_ = (aClass291_629.aClass316Array3728[i_2_].method2365(i ^ ~0x7486, Component337.method2108(string_1_, -29286)));
            return method410(-1860, i_2_, i_3_);
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("in.EA(" + (string != null ? "{...}" : "null") + ',' + (string_1_ != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }
    ...
    final byte[] method393(int i, int i_5_, int i_6_, int[] is) {
        ...
        byte[] is_7_ = Cp1252Decoder.method461(false, anObjectArrayArray664[i][i_5_], 53146732);
        if (this.anInt634 == 1) {
    ...
    private final boolean method394(int i, byte i_8_, int[] is, int i_9_) {
        ...
        if (bool) return true;
        byte[] is_14_;
        if (is == null || (is[0] == 0 && is[1] == 0 && is[2] == 0 && is[3] == 0)) is_14_ = Cp1252Decoder.method461(false, anObjectArray656[i_9_], 53146732);
        else {
        ...
        byte[] is_15_;
        try {
            is_15_ = NodeSub41.method3158(is_14_, -120);
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("T3 - " + (is != null) + "," + i_9_ + "," + is_14_.length + "," + Component210.method554(5126, is_14_.length, is_14_) + "," + Component210.method554(5126, -2 + is_14_.length, is_14_) + "," + aClass291_629.anIntArray3729[i_9_] + "," + aClass291_629.anInt3719));
        }
        ...
        if (i_10_ > 1) {
            if (this.anInt634 == 2) {
                ...
                for (int i_40_ = 0; i_40_ < i_31_; i_40_++) {
                    ...
                    for (int i_42_ = 0; i_42_ < i_10_; i_42_++) {
                        ...
                        if (i_43_ == i) {
                            Component313.method1577(is_15_, i_39_, is_38_, i_32_, i_41_);
                            i_32_ += i_41_;
                        }
                        i_39_ += i_41_;
                    }
                ...
                for (int i_25_ = 0; i_25_ < i_17_; i_25_++) {
                    ...
                    for (int i_27_ = 0; i_10_ > i_27_; i_27_++) {
                        ...
                        Component313.method1577(is_15_, i_24_, is_22_[i_27_], is_18_[i_27_], i_26_);
                        i_24_ += i_26_;
                        is_18_[i_27_] += i_26_;
                    }
                }
                for (int i_28_ = 0; i_10_ > i_28_; i_28_++) {
                    ...
                    else objects[i_29_] = BrowserDetector.method1357(is_22_[i_28_], false, (byte) 126);
                }
            }
        } else {
            int i_44_;
            ...
            else objects[i_44_] = BrowserDetector.method1357(is_15_, false, (byte) 104);
        }
        return true;
    }
    ...
    final int method397(String string, int i) {
        ...
        int i_47_ = aClass291_629.aClass316_3723.method2365(1, Component337.method2108(string, i ^ ~0x7265));
    ...
    final boolean method400(int i, String string) {
        ...
        string = string.toLowerCase();
        int i_52_ = aClass291_629.aClass316_3723.method2365(1, Component337.method2108(string, -29286));
        return i_52_ >= 0;
    }
    ...
    private final boolean method403(String string, int i, String string_56_) {
        try {
            ...
            int i_57_ = (aClass291_629.aClass316_3723.method2365(i ^ 0x1c1a, Component337.method2108(string, -29286)));
            if (i != 7195) method403(null, -20, null);
            if (!method392(i_57_, (byte) -40)) return false;
            int i_58_ = aClass291_629.aClass316Array3728[i_57_].method2365(1, Component337.method2108(string_56_, -29286));
            return method420(i + -17694, i_57_, i_58_);
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("in.Q(" + (string != null ? "{...}" : "null") + ',' + i + ',' + (string_56_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    private final void method406(int i, int i_61_) {
        ...
        if (!aBoolean655) anObjectArray656[i] = BrowserDetector.method1357(aClass314_659.method2339(i, (byte) 73), false, (byte) 123);
    ...
    final void method409(String string, boolean bool) {
        ...
        if (bool == true && method399(false)) {
            string = string.toLowerCase();
            int i = aClass291_629.aClass316_3723.method2365(1, Component337.method2108(string, -29286));
            method402((byte) -86, i);
        }
    }
    ...
    final boolean method413(int i, String string) {
        ...
        if (!method399(false)) return false;
        string = string.toLowerCase();
        int i_69_ = aClass291_629.aClass316_3723.method2365(i + -99, Component337.method2108(string, -29286));
    ...
    final int method417(String string, int i) {
        ...
        if (!method399(false)) return -1;
        string = string.toLowerCase();
        int i_72_ = aClass291_629.aClass316_3723.method2365(1, Component337.method2108(string, -29286));
    ...
    final boolean method422(String string, String string_78_, int i) {
        try {
            ...
            if (i > -18) anInt669 = 40;
            string = string.toLowerCase();
            int i_79_ = aClass291_629.aClass316_3723.method2365(1, Component337.method2108(string_78_, -29286));
            if (i_79_ < 0) return false;
            int i_80_ = aClass291_629.aClass316Array3728[i_79_].method2365(1, Component337.method2108(string, -29286));
            return i_80_ >= 0;
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("in.M(" + (string != null ? "{...}" : "null") + ',' + (string_78_ != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }
