 ...
 * Huffman/codeword decoder. Throws 'No codeword for data value' when a bit pattern has no assigned codeword; decodes compressed data streams (wda.C references).
 */
...
final class HuffmanDecoder {
    ...
    final int method2226(byte[] is, int i, byte[] is_3_, int i_4_, int i_5_, int i_6_) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("wda.A(" + (is != null ? "{...}" : "null") + ',' + i + ',' + (is_3_ != null ? "{...}" : "null") + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ')'));
        }
    }
    ...
    final int method2227(int i, int i_11_, int i_12_, byte[] is, int i_13_, byte[] is_14_) {
        try {
            ...
            for (/**/; i > i_11_; i_11_++) {
                ...
                i_16_ += i_19_;
                i_21_ += 24;
                is_14_[i_20_] = (byte) (i_15_ = Component224.method2057(i_15_, i_18_ >>> i_21_));
                if (i_22_ > i_20_) {
                    i_20_++;
                    i_21_ -= 8;
            ...
            throw NpcDefinition.method2929(runtimeexception, ("wda.C(" + i + ',' + i_11_ + ',' + i_12_ + ',' + (is != null ? "{...}" : "null") + ',' + i_13_ + ',' + (is_14_ != null ? "{...}" : "null") + ')'));
        }
    }
            ...
            if (i_26_ != 0) {
                ...
                if ((i_27_ & i_28_) == 0) {
                    for (int i_30_ = -1 + i_26_; i_30_ >= 1; i_30_--) {
                        ...
                        is_23_[i_30_] = Component224.method2057(i_31_, i_32_);
                    }
                    i_29_ = i_27_ | i_28_;
