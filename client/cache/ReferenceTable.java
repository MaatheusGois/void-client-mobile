 ...
 * Archive reference table. Holds child index entries (Component192 aClass316_3723 / aClass316Array3728) plus crc/version/whirlpool arrays (anIntArray3724, anIntArray3725, byte[][] aByteArrayArray3730). Backing data for CacheStore.
 */
...
final class ReferenceTable {
    ...
    int[] anIntArray3722;
    Component192 aClass316_3723;
    int[] anIntArray3724;
    int[] anIntArray3725;
    static int[] anIntArray3726;
    int anInt3727;
    Component192[] aClass316Array3728;
    int[] anIntArray3729;
    ...
    private final void method2200(byte i, byte[] is) {
        anInt3731++;
        Buffer class348_sub49 = new Buffer(NodeSub41.method3158(is, -105));
        ...
        if (bool) {
            ...
            this.aClass316_3723 = new Component192(this.anIntArray3733);
        }
        ...
        if (bool) {
            ...
            this.aClass316Array3728 = new Component192[1 + i_6_];
            for (int i_21_ = 0; i_21_ < this.anInt3727; i_21_++) {
                ...
                this.aClass316Array3728[i_22_] = new Component192(this.anIntArrayArray3735[i_22_]);
            }
        }
    }
    ...
    ReferenceTable(byte[] is, int i, byte[] is_27_) {
        try {
            this.anInt3719 = Component210.method554(5126, is.length, is);
            if (i != this.anInt3719) throw new RuntimeException();
            if (is_27_ != null) {
                if (is_27_.length != 64) throw new RuntimeException();
                aByteArray3740 = NodeSub1Sub2.method2730(4567, 0, is, is.length);
            ...
            throw NpcDefinition.method2929(runtimeexception, ("vw.<init>(" + (is != null ? "{...}" : "null") + ',' + i + ',' + (is_27_ != null ? "{...}" : "null") + ')'));
        }
    }
}
