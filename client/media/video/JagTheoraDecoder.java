/* JagTheoraDecoder - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class55` (JODE-obfuscated).
 * JagTheora OGG/video decoder. abstract class; imports jagtheora.ogg.* (OggPacket/OggPage/OggStreamState/OggSyncState) and loads the native 'jagtheora' library (logs 'Failed to load jagtheora library').
 */
...
abstract class JagTheoraDecoder {
    static int anInt978;
    ...
    static int anInt997;
    static int anInt998;
    private Component179 aClass348_Sub23_Sub4_999;
    static int anInt1000;
    private DisplayModeManagerContainer64 aClass348_Sub23_Sub2_1001;
    ...
    private OggUrlStream aClass348_Sub23_Sub1_1008;
    private String aString1009;
    static float aFloat1010;
    private final LruCache aClass356_1011;

    private final void method504(int i) {
        if (i != 1999) aByteArray995 = null;
        anInt982++;
        for (OggStream class348_sub23 = (OggStream) aClass356_1011.method3484(0); class348_sub23 != null; class348_sub23 = (OggStream) aClass356_1011.method3482(0)) {
    ...
    private final boolean method507(boolean bool) {
        ...
        return d == 0.0 || (double) Component240.method599(-74) >= 1000.0 / d + (double) aClass348_Sub23_Sub2_1001.method2979(30);
    }

    final void method508(int i) {
        anInt989++;
        if (!aBoolean1007) {
            OggStream class348_sub23 = (OggStream) aClass356_1011.method3484(0);
            if (i != 1) aBoolean991 = true;
            for (/**/; class348_sub23 != null; class348_sub23 = (OggStream) aClass356_1011.method3482(i ^ 0x1)) {
    ...
    private final void method511(int i) {
        anInt1003++;
        for (OggStream class348_sub23 = (OggStream) aClass356_1011.method3484(0); class348_sub23 != null; class348_sub23 = (OggStream) aClass356_1011.method3482(i + 2)) {
            ...
            if (!aBoolean1006) {
                while (!aBoolean1007) {
                    ...
                    if (!aBoolean983) {
                        ...
                        aBoolean983 = true;
                    } else class348_sub23 = ((OggStream) (aClass356_1011.method3480(anOggPage981.getSerialNumber(), -6008)));
    ...
    private final OggStream method521(int i) throws IOException {
        ...
        if (!anOggPage981.isBOS()) {
            OggStream class348_sub23 = ((OggStream) aClass356_1011.method3480(i_32_, -6008));
        ...
        if (aClass348_Sub23_Sub2_1001 == null && anOggPacket993.isTheora()) {
            aClass348_Sub23_Sub2_1001 = new DisplayModeManagerContainer64(oggstreamstate);
            class348_sub23 = aClass348_Sub23_Sub2_1001;
        } else if (aClass348_Sub23_Sub1_1008 == null && anOggPacket993.isVorbis()) {
            aClass348_Sub23_Sub1_1008 = new OggUrlStream(oggstreamstate);
            ...
            if (string.equals("kate")) class348_sub23 = new Component179(oggstreamstate);
            else class348_sub23 = new OggStreamReader(oggstreamstate);
        }
