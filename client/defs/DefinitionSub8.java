/* DefinitionSub8 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.awt.*;

final class DefinitionSub8
/**
 * RENAMED from `Class348_Sub40_Sub8` (JODE-obfuscated).
 ...
 */ extends Definition {
    ...
    final void decodedOperation3069(int i, int[] is, byte i_8_) {
        ...
        if (i_8_ > 91) {
            if (this.anInt9150 == 1) {
                ...
                int i_47_ = HelveticaFont.anIntArray2631[i_41_];
                ...
                for (int i_23_ = 1; this.anInt9150 > i_23_; i_23_++) {
                    ...
                    if (i_10_ > 8 || i_10_ < -8) {
                        ...
                        int i_31_ = HelveticaFont.anIntArray2631[i_25_];
    ...
    private final int decodedOperation3070(int i, int i_55_, int i_56_, int i_57_, int i_58_, boolean bool, int i_59_) {
        ...
        int i_65_ = HelveticaFont.anIntArray2631[i_57_];
        int i_66_;
