 ...
 */ extends Definition {
    ...
    static final void decodedOperation3084(int i, byte i_2_, int i_3_) {
        anInt9218++;
        RSARequest class348_sub42_sub15 = FriendLoginMessage.decodedOperation2516(i_3_, (byte) 105, 17);
        class348_sub42_sub15.decodedOperation3246(-25490);
        class348_sub42_sub15.anInt9652 = i;
        int i_4_ = 59 / ((i_2_ - -7) / 49);
    }

    public static void decodedOperation3085(int i) {
        aClass114_9216 = null;
    ...
    static final void decodedOperation3086(int i, BrowserUrlOpener class348_sub16_sub3, int i_5_, CacheStore class45, boolean bool, int i_6_, int i_7_) {
        try {
            anInt9219++;
            if (i != 2) aClass114_9216 = null;
            NodeSub1Sub3.decodedOperation2732(i_6_, i_7_, bool, 96, class45, i_5_);
    ...
    final int[] getMonochromeOutput(int i, int i_8_) {
        ...
        if (this.imageCache.cacheMiss) Component313.decodedOperation1579(is, 0, DefinitionSub6.anInt9139, anInt9220);
        if (i_8_ != 255) decodedOperation3085(63);
        return is;
    }
