...
final class ImageDefinition extends Definition {
    ...
    final int[][] getColourOutput(int i, int i_0_) {
        ...
        if (this.imageCacheStore.cacheMiss) {
            int[][] is_1_ = this.decodedOperation3039((byte) 120, (aBoolean9147 ? -i + DisplayModeManagerContainer356.anInt6325 : i), 0);
            int[] is_2_ = is_1_[0];
            int[] is_3_ = is_1_[1];
            int[] is_4_ = is_1_[2];
            int[] is_5_ = is[0];
        ...
        if (i_0_ != -1564599039) decodedOperation3065(-40, true, 93);
        return is;
    }
            ...
            if (bool_15_ == false) {
                ...
                for (/**/; class46s.length > i_18_; i_18_++) {
                    ...
                    if (class46 != null && (class46.parentId == i_16_ || (i_16_ == -1412584499 && Component156.aClass46_3701 == class46))) {
                        ...
                        if (!client.decodedOperation111(class46)) {
                            if (class46.contentType != 0) NodeSub18.decodedOperation2942(class46, (byte) -36);
                            int i_24_ = i_19_;
                            int i_25_ = i_20_;
                            int i_26_ = 0;
                            int i_27_ = 0;
                            if (Component210.gameCanvasAttached) {
                                i_26_ = BufferCacheSub3.decodedOperation4008((byte) -124);
                                i_27_ = Component110.decodedOperation260(bool_15_);
                            }
                            ...
                            if (i_31_ < i_34_ && i_32_ < i_33_) {
                                if (class46.contentType != 0) {
                                    if ((Component98.anInt5943 == class46.contentType) || (class46.contentType == Component37.anInt3932)) {
                                        Component2.decodedOperation198(class46, false, i_25_, i_24_);
                                        if (!Component210.gameCanvasAttached) {
                                            OutputStream_Sub1.decodedOperation132(124, (Component37.anInt3932 == (class46.contentType)), class46.width, i_24_, class46.height, i_25_);
                                            NodeSub8.toolkit.KA(i, i_12_, i_14_, i_17_);
                                        }
                                    ...
                                    if (class46.contentType == Component200.anInt3717) {
                                        if (class46.decodedOperation425((NodeSub8.toolkit), (byte) 8) != null) {
                                            Component381.decodedOperation3570(false);
                                            HashTable.decodedOperation1007(class46, (NodeSub8.toolkit), i_24_, i_25_, 22960);
                                            DisplayModeManagerContainer259.aBooleanArray3438[i_23_] = true;
                                            NodeSub8.toolkit.KA(i, i_12_, i_14_, i_17_);
                                            if (Component210.gameCanvasAttached) {
                                                if (bool) Component103.decodedOperation2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                                else Component285.decodedOperation503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                            }
                                        }
                                        continue;
                                    }
                                    if (class46.contentType == LibraryCreditsText.anInt5951) {
                                        if (class46.decodedOperation425((NodeSub8.toolkit), (byte) 26) != null) {
                                            DisplayModeManagerContainer220.decodedOperation271(i_25_, class46, (byte) -98, i_24_);
                                            DisplayModeManagerContainer259.aBooleanArray3438[i_23_] = true;
                                            NodeSub8.toolkit.KA(i, i_12_, i_14_, i_17_);
                                            if (Component210.gameCanvasAttached) {
                                                if (!bool) Component285.decodedOperation503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                                else Component103.decodedOperation2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            }
                                        }
                                        continue;
                                    }
                                    ...
                                    if (SceneManager.anInt2861 == class46.contentType) {
                                        CollisionMap.decodedOperation3498(class46.height, NodeSub8.toolkit, i_24_, class46.width, true, i_25_);
                                        InflaterDecompressor.aBooleanArray2076[i_23_] = true;
                                        NodeSub8.toolkit.KA(i, i_12_, i_14_, i_17_);
                                        continue;
                                    }
                                    if (Component257.anInt4793 == class46.contentType) {
                                        if (Component10.fpsOverlayEnabled || ReliefShader.aBoolean2514) {
                                            ...
                                            if (Component10.fpsOverlayEnabled) {
                                                ...
                                                if (i_40_ > 98304) {
                                                    ...
                                                    if (DisplayModeManagerContainer254.aBoolean2151) {
                                                        DisplayModeManagerContainer57.decodedOperation427(-35);
                                                        for (int i_42_ = 0; i_42_ < 10; i_42_++)
                                                            System.gc();
                                                        i_40_ = (int) (((runtime.totalMemory()) - (runtime.freeMemory())) / 1024L);
                                                        if (i_40_ > 65536) DisplayModeManagerContainer213.decodedOperation544("WARNING: Memory usage over 64MB! Please inform whoever is responsible for the content/area you are using/in.", false, 4);
                                                    }
                                                }
                                                ...
                                                String string = ("Cache:" + (Component186.decodedOperation3486(2, true, 0, i_49_, 16980)) + "% (" + i_48_ + "%)");
                                            ...
                                            if (ReliefShader.aBoolean2514) {
                                                ...
                                                Component362.decodedOperation1042((byte) -123);
                                                i_38_ += 12;
                                            }
                                            InflaterDecompressor.aBooleanArray2076[i_23_] = true;
                                        }
                                ...
                                if (class46.type == 0) {
                                    ...
                                    if (class348_sub41 != null) Component146.decodedOperation1252(i_25_, (class348_sub41.anInt7050), i_32_, i_23_, i_24_, i_34_, i_33_, (byte) 60, i_31_);
                                ...
                                if (Component143.aBooleanArray2326[i_23_] || GlToolkitSub3.anInt8045 > 1) {
                                    if (class46.type == 3) {
                                        ...
                                        BitmapFont class324 = class46.decodedOperation426((NodeSub8.toolkit), (byte) 68);
                                        if (class324 == null) {
                                            ...
                                            if (class46.anInt806 != -1) {
                                                string = (WaterSurfaceShader.decodedOperation2157((class46.anInt806), -1431655765));
                                            ...
                                            if (string.trim().length() > 0) {
                                                if (Component29.aBoolean10046) {
                                                    ...
                                                    Component184 class143 = (Component137.decodedOperation1151(-25411, (NodeSub8.toolkit), (class46.fontId)));
                                                    int i_51_ = (class143.decodedOperation1187(string, bool_15_, class46.width, (Component22.aClass105Array1744)));
                                                    int i_52_ = (class143.decodedOperation1185((Component22.aClass105Array1744), 0, class46.lineHeight, class46.width, string));
                                                    if (Component210.gameCanvasAttached) {
                                                        if (!bool) Component285.decodedOperation503(i_25_ + i_52_, i_24_, (byte) -74, (i_24_ - -i_51_), i_25_);
                                                        else Component103.decodedOperation2663(-5590, i_24_, i_51_ + i_24_, i_25_, (i_25_ + i_52_));
                                                    }
                                                }
                                            }
                                        }
                                        ...
                                        if (class46.anInt705 >= 0)
                                            class46.decodedOperation444(bool_15_, Component132.aClass25_1813, ComponentDownloader.aClass84_413).decodedOperation2293(0, NodeSub8.toolkit, (byte) -35, i_24_, class46.width, i_25_, (class46.anInt835 << 3), (class46.anInt759 << 3), 0, class46.height);
                                        else {
                                            Component24 class105;
                                            if (class46.itemId != -1) {
                                                Component101 class154 = ((class46.aBoolean720) ? (Component72.localPlayer.appearance) : null);
                                                class105 = (Exception_Sub1.itemDefinitions.decodedOperation1941((class46.outline), (byte) -74, (class46.itemId), (class46.itemAmount), (~0xffffff | (class46.shadowColour)), (class46.anInt678), NodeSub8.toolkit, class154));
                                            } else if ((class46.anInt806) == -1) class105 = (class46.decodedOperation443(NodeSub8.toolkit, (byte) -57));
                                            else class105 = (Component264.decodedOperation2263(NodeSub8.toolkit, 0, (class46.anInt806)));
                                            if (class105 == null) {
                                                if (HashNodeSub13.aBoolean9616) Component111.markInterfaceDirty(-9343, class46);
                                            } else {
                                                int i_53_ = class105.decodedOperation966();
                                                int i_54_ = class105.decodedOperation980();
                                                    ...
                                                    if ((class46.spriteAngle) != 0) {
                                                        ...
                                                        for (int i_58_ = 0; i_58_ < i_56_; i_58_++) {
                                                            for (int i_59_ = 0; i_59_ < i_57_; i_59_++) {
                                                                if ((class46.colour) == 0) class105.decodedOperation981((((float) i_53_ / 2.0F) + (float) (i_24_ - -(i_53_ * i_58_))), (((float) i_54_ / 2.0F) + (float) (i_59_ * i_54_ + i_25_)), 4096, (class46.spriteAngle));
                                                                else class105.decodedOperation977((((float) i_53_ / 2.0F) + (float) (i_53_ * i_58_ + i_24_)), (((float) i_54_ / 2.0F) + (float) (i_25_ + i_59_ * i_54_)), 4096, (class46.spriteAngle), 0, i_55_, 1);
                                                            }
                                                        }
                                                    } else if ((class46.colour) != 0 || (i_28_ != 0)) class105.method965(i_24_, i_25_, (class46.width), (class46.height), 0, i_55_, 1);
                                                    else class105.decodedOperation972(i_24_, i_25_, (class46.width), (class46.height));
                                                    NodeSub8.toolkit.KA(i, i_12_, i_14_, i_17_);
                                                } else if ((class46.colour) == 0 && i_28_ == 0) {
                                                    if ((class46.spriteAngle) != 0) class105.decodedOperation981(((float) i_24_ + ((float) (class46.width) / 2.0F)), (((float) (class46.height) / 2.0F) + (float) i_25_), (4096 * (class46.width) / i_53_), (class46.spriteAngle));
                                                    else if ((i_53_ == (class46.width)) && ((class46.height) == i_54_)) class105.drawAt(i_24_, i_25_);
                                                    else class105.decodedOperation973(i_24_, i_25_, (class46.width), (class46.height));
                                                } else if (class46.spriteAngle != 0) class105.decodedOperation977(((float) i_24_ + ((float) (class46.width) / 2.0F)), ((float) i_25_ + ((float) (class46.height) / 2.0F)), (4096 * class46.width / i_53_), (class46.spriteAngle), 0, i_55_, 1);
                                                else if (((class46.width) == i_53_) && (class46.height == i_54_)) class105.decodedOperation964(i_24_, i_25_, 0, i_55_, 1);
                                                else class105.decodedOperation970(i_24_, i_25_, (class46.width), (class46.height), 0, i_55_, 1);
                                            }
                                        }
                                        if (Component210.gameCanvasAttached) {
                                            if (!bool) Component285.decodedOperation503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        ...
                                        Component142.decodedOperation3489(115);
                                        ...
                                        if (class46.itemId != -1) {
                                            ...
                                            if (class213 != null) {
                                                class213 = (class213.decodedOperation1560((class46.itemAmount), (byte) 97));
                                                ...
                                                class64 = (class213.decodedOperation1559(class154, class17, NodeSub8.toolkit, 2048, (class46.anInt841), 1, (class46.anInt795), (byte) 88, (class46.anInt730)));
                                            ...
                                            if (i_61_ >= 0 && (i_61_ < 2048)) {
                                                ...
                                                DisplayModeManagerContainer167 class17 = ((class46.anInt699) == -1 ? null : (RunescapeInfo.aClass87_191.getSequence((class46.anInt699), 7)));
                                                if ((player != null) && ((i_61_ == (StringDefinition.anInt9591)) || ((class46.anInt779) == (Component349.decodedOperation2418((player.username), (byte) -50)))))
                                                    class64 = (player.appearance.decodedOperation1226((DisplayModeManagerContainer58.aClass170_10209), null, null, true, (Exception_Sub1.itemDefinitions), 0, class17, class46.anInt730, true, -1, null, 2048, (DefinitionSub25.aClass150_9342), class46.anInt841, (NodeSub8.toolkit), (Component291.aClass278_2529), (RunescapeInfo.aClass87_191), 0, class46.anInt795, 0, (DisplayModeManagerContainer282.aClass261_5558)));
                                            }
                                        ...
                                        if (class64 != null) {
                                            ...
                                            if (class46.aBoolean784) {
                                                ...
                                                Cp1252Decoder.aClass101_5209.decodedOperation891((class46.anInt688), (class46.anInt799), (class46.anInt787));
                                            } else {
                                                ...
                                                Cp1252Decoder.aClass101_5209.decodedOperation891(((class46.anInt808) << 2), (((class46.anInt786) << 2) + (i_66_ + i_60_)), ((class46.anInt786) << 2) + i_67_);
                                                Cp1252Decoder.aClass101_5209.method900((class46.anInt757) << 3);
                                            }
                                            class46.decodedOperation437(-20154, class64, NodeSub8.toolkit, OpenGlShader.clientCycle, Cp1252Decoder.aClass101_5209);
                                            ...
                                            if (!class46.aBoolean784) {
                                                if (!class46.aBoolean689) {
                                                    ...
                                                    if ((class46.aClass318_Sub10_740) != null) NodeSub8.toolkit.renderModel(class46.aClass318_Sub10_740.decodedOperation2539());
                                                } else class64.decodedOperation608((Cp1252Decoder.aClass101_5209), null, ((class46.anInt716) << 2), 1);
                                            } else if (class46.aBoolean689) class64.decodedOperation608((Cp1252Decoder.aClass101_5209), null, (class46.anInt716), 1);
                                            else {
                                                class64.render((Cp1252Decoder.aClass101_5209), null, 1);
                                                if ((class46.aClass318_Sub10_740) != null) NodeSub8.toolkit.renderModel(class46.aClass318_Sub10_740.decodedOperation2539());
                                            }
    ...
    final void decodedOperation3049(Buffer class348_sub49, int i, int i_72_) {
        while_146_:
        do {
            try {
                anInt9146++;
    ...
    static final void decodedOperation3065(int i, boolean bool, int i_74_) {
        Component269.anInt8765++;
        anInt9142++;
        if (bool != false) decodedOperation3065(-42, true, 43);
    ...
    final int[] getMonochromeOutput(int i, int i_75_) {
        ...
        if (this.imageCache.cacheMiss) {
            int[] is_76_ = this.decodedOperation3048((aBoolean9147 ? DisplayModeManagerContainer356.anInt6325 - i : i), i_75_ + 633706082, 0);
            if (aBoolean9140) {
                for (int i_77_ = 0; (i_77_ < DefinitionSub6.anInt9139); i_77_++)
                    is[i_77_] = is_76_[CustomCursorSetting.anInt6076 + -i_77_];
            } else Component313.decodedOperation1578(is_76_, 0, is, 0, DefinitionSub6.anInt9139);
        }
        return is;
    }

    public static void decodedOperation3066(int i) {
