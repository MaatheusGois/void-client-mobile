/* DefinitionSub23 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.util.Random;

final class DefinitionSub23
/**
 * RENAMED from `Class348_Sub40_Sub23` (JODE-obfuscated).
 ...
 */ extends Definition {
    ...
    final int[] getMonochromeOutput(int i, int i_41_) {
        ...
        if (this.imageCache.cacheMiss) {
            ...
            int i_49_ = 0;
            int i_50_ = 0;
            int i_51_ = anInt9317 * DefinitionSub6.anInt9139 >> 12;
            int i_52_ = DefinitionSub6.anInt9139 * anInt9320 >> 12;
            int i_53_ = anInt9322 * ShaderProgramSub2.anInt6212 >> 12;
            int i_54_ = ShaderProgramSub2.anInt6212 * anInt9323 >> 12;
            if (i_54_ <= 1) return is_42_[i];
            anInt9306 = DefinitionSub6.anInt9139 / 8 * anInt9311 >> 12;
            int i_55_ = 1 + DefinitionSub6.anInt9139 / i_51_;
            ...
            for (; ; ) {
                ...
                if (i_60_ > DefinitionSub6.anInt9139) {
                    ...
                    i_58_ = DefinitionSub6.anInt9139 - i_46_;
                }
                int i_61_;
                if (bool_48_) i_61_ = 0;
                else {
                    ...
                    if (i_65_ < 0) i_65_ += DefinitionSub6.anInt9139;
                    if (i_65_ > DefinitionSub6.anInt9139) i_65_ -= DefinitionSub6.anInt9139;
                    for (; ; ) {
                    ...
                    if (i_62_ != i_47_) {
                        ...
                        if (i_67_ < 0) i_67_ += DefinitionSub6.anInt9139;
                        if (DefinitionSub6.anInt9139 < i_67_) i_67_ -= DefinitionSub6.anInt9139;
                            ...
                            if (i_61_ != i_72_) {
                                ...
                                if (i_67_ >= i_65_) {
                                    if (i_73_ == 0) {
                                        ...
                                        i_76_ = DefinitionSub6.anInt9139;
                                    }
                                } else {
                                    i_75_ = Math.max(i_67_, i_73_);
                                    i_76_ = Math.min(i_65_, i_74_);
                ...
                if (ShaderProgramSub2.anInt6212 >= i_59_ + i_61_) bool = false;
                else i_59_ = -i_61_ + ShaderProgramSub2.anInt6212;
                if (i_60_ == DefinitionSub6.anInt9139) {
                    ...
                    i_46_ = 0;
                    int i_80_ = i_43_;
                    if (i_80_ < 0) i_80_ += DefinitionSub6.anInt9139;
                    i_47_ = 0;
                    if (i_80_ > DefinitionSub6.anInt9139) i_80_ -= DefinitionSub6.anInt9139;
                    bool_48_ = false;
                    for (; ; ) {
