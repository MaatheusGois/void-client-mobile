/* DefinitionSub29 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DefinitionSub29
/**
 * RENAMED from `Class348_Sub40_Sub29` (JODE-obfuscated).
 ...
 */ extends Definition {
    ...
    static final boolean decodedOperation3125(int i, int i_16_, int i_17_, int i_18_, int i_19_, byte i_20_, int i_21_, int i_22_, int i_23_, int i_24_) {
        ...
        if (i_16_ < -2000 || i_21_ < -2000 || i_24_ < -2000 || i_23_ < -2000 || i_17_ < -2000 || i < -2000) return false;
        if (Component360.anInt4319 == 2) {
            int i_25_ = i_23_ + i_16_ * Component314.anInt3872;
            if (i_25_ >= 0 && DisplayModeManagerContainer194.anIntArray5091.length > i_25_ && DisplayModeManagerContainer194.anIntArray5091[i_25_] > -38400 + (i_22_ << 8)) return false;
            i_25_ = i_17_ + i_21_ * Component314.anInt3872;
            if (i_25_ >= 0 && DisplayModeManagerContainer194.anIntArray5091.length > i_25_ && ((i_19_ << 8) + -38400 < DisplayModeManagerContainer194.anIntArray5091[i_25_])) return false;
            i_25_ = i + i_24_ * Component314.anInt3872;
            if (i_25_ >= 0 && DisplayModeManagerContainer194.anIntArray5091.length > i_25_ && (DisplayModeManagerContainer194.anIntArray5091[i_25_] > (i_18_ << 8) - 38400)) return false;
        }
        ...
        if (i_16_ > i_21_ || i_24_ < i_16_) {
            if (i_24_ < i_21_) {
                if (Component328.anInt1480 <= i_24_) return true;
                i_18_ = -(i_36_ * i) + ((i_18_ << 8) - -i_36_);
                if (Component328.anInt1480 < i_16_) i_16_ = Component328.anInt1480;
                if (Component328.anInt1480 < i_21_) i_21_ = Component328.anInt1480;
                if (i_21_ > i_16_) {
                    i_17_ = i <<= -1549996884;
                    i_23_ <<= 869809292;
                    if (i_24_ < 0) {
            ...
            if (Component328.anInt1480 <= i_21_) return true;
            i_19_ = i_36_ + -(i_17_ * i_36_) + (i_19_ << 8);
            if (Component328.anInt1480 < i_24_) i_24_ = Component328.anInt1480;
            if (Component328.anInt1480 < i_16_) i_16_ = Component328.anInt1480;
            if (i_24_ >= i_16_) {
                i = i_17_ <<= 1841711244;
                i_23_ <<= -258927156;
        ...
        if (i_16_ >= Component328.anInt1480) return true;
