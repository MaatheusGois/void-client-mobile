/* DefinitionSub35 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DefinitionSub35
/**
 * RENAMED from `Class348_Sub40_Sub35` (JODE-obfuscated).
 * Evidence: subclass of Definition (hierarchy)
 */ extends Definition {
    static int anInt9440;
    static int anInt9441;
    static int anInt9442;
    static DisplayModeManagerContainer254 aClass161_9443;
    ...
    final int[] getMonochromeOutput(int i, int i_4_) {
        ...
        if (this.imageCache.cacheMiss) {
            ...
            for (int i_9_ = 0; DefinitionSub6.anInt9139 > i_9_; i_9_++) {
                ...
                int i_11_ = (i_5_ * (-is_7_[Component287.anInt6076 & i_9_ - -1] + is_7_[-1 + i_9_ & Component287.anInt6076]) >> 12);
                int i_12_ = i_11_ >> 4;
                int i_13_ = i_10_ >> 4;
                ...
                int i_14_ = (DisplayModeManagerContainer57.aByteArray821[i_12_ + (i_13_ * (1 + i_13_) >> 1)] & 0xff);
