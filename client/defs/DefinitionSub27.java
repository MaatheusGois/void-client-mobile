 ...
 */ extends Definition {
    ...
    final int[][] getColourOutput(int i, int i_0_) {
        ...
        if (this.imageCacheStore.cacheMiss) {
            int[] is_1_ = this.decodedOperation3048(i, i_0_ + -2096661920, 2);
            int[][] is_2_ = this.decodedOperation3039((byte) -74, i, 0);
            int[][] is_3_ = this.decodedOperation3039((byte) -58, i, 1);
            int[] is_4_ = is[0];
            int[] is_5_ = is[1];
            int[] is_6_ = is[2];
            int[] is_7_ = is_2_[0];
    ...
    final int[] getMonochromeOutput(int i, int i_16_) {
        ...
        if (this.imageCache.cacheMiss) {
            int[] is_17_ = this.decodedOperation3048(i, i_16_ ^ 0x25c5979e, 0);
            int[] is_18_ = this.decodedOperation3048(i, 633706337, 1);
            int[] is_19_ = this.decodedOperation3048(i, i_16_ + 633706082, 2);
    ...
    public static void decodedOperation3121(byte i) {
        aClipboard9357 = null;
    ...
    final void decodedOperation3049(Buffer class348_sub49, int i, int i_22_) {
        anInt9358++;
