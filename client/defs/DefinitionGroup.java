/* DefinitionGroup - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class348_Sub42_Sub5` (JODE-obfuscated).
 * Group/set of Definitions cached as a HashNode. Holds Definition[] (aClass348_Sub40Array9520) plus parallel int[] index arrays (anIntArray9523/anIntArray9524) and a Component161; aggregates several related Definition entries.
 */

final class DefinitionGroup extends HashNode {
    private final Definition[] aClass348_Sub40Array9520;
    private final Definition aClass348_Sub40_9521;
    ...
    private final Definition aClass348_Sub40_9527;
    private final Definition aClass348_Sub40_9528;
    static int anInt9529;
    static Component161 aClass138_9530 = new Component161(6, 0, 4, 2);
        ...
        try {
            ...
            for (int i_4_ = 0; i_0_ > i_4_; i_4_++) {
                ...
                for (int i_11_ = i - 1; i_11_ >= 0; i_11_--) {
                    ...
                    i_13_ = DisplayModeManagerContainer58.anIntArray10266[i_13_];
                    if (i_14_ < 0) i_14_ = 0;
                    i_12_ = DisplayModeManagerContainer58.anIntArray10266[i_12_];
                    i_14_ = DisplayModeManagerContainer58.anIntArray10266[i_14_];
                    int i_15_;
        ...
        try {
            ...
            for (int i_29_ = 0; i_23_ > i_29_; i_29_++) {
                ...
                for (int i_35_ = i_25_; i_35_ != i_27_; i_35_ += i_26_) {
                    ...
                    i_37_ = DisplayModeManagerContainer58.anIntArray10266[i_37_];
                    i_36_ = DisplayModeManagerContainer58.anIntArray10266[i_36_];
                    if (i_38_ < 0) i_38_ = 0;
                    i_38_ = DisplayModeManagerContainer58.anIntArray10266[i_38_];
    ...
    public DefinitionGroup() {
        ...
        aClass348_Sub40_9528 = new DefinitionSub15(0);
        aClass348_Sub40_9528.anInt7036 = 1;
        aClass348_Sub40_9521 = new DefinitionSub15();
        aClass348_Sub40_9521.anInt7036 = 1;
        aClass348_Sub40_9527 = new DefinitionSub15();
        aClass348_Sub40Array9520 = new Definition[]{aClass348_Sub40_9521, aClass348_Sub40_9527, aClass348_Sub40_9528};
        aClass348_Sub40_9527.anInt7036 = 1;
    }

    DefinitionGroup(Buffer class348_sub49) {
        ...
        for (int i_61_ = 0; i > i_61_; i_61_++) {
            Definition class348_sub40 = aClass348_Sub40Array9520[i_61_];
    ...
    static {
        aClass351_9533 = new StringCache(57, 3);
    }
}
