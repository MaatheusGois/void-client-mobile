/* DefinitionSub24 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DefinitionSub24
/**
 * RENAMED from `Class348_Sub40_Sub24` (JODE-obfuscated).
 * Evidence: subclass of Definition (hierarchy)
 */ extends Definition {
    static Component183 aClass114_9324 = new Component183(85, 4);
        ...
        if (this.aClass191_7032.aBoolean2570) {
            ...
            if (anInt9325 == 0) {
                ...
                for (int i_2_ = 0; i_2_ < DefinitionSub6.anInt9139; i_2_++) {
                    int i_3_ = 0;
                    int i_4_ = 0;
                    int i_5_ = RenderableSub6.anIntArray6432[i_2_];
                    int i_6_ = anInt9325;
                    while_197_:
                    do {
                        do {
