/* DefinitionSub5 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.util.Random;

final class DefinitionSub5
/**
 * RENAMED from `Class348_Sub40_Sub5` (JODE-obfuscated).
 ...
 */ extends Definition {
    ...
    final int[] method3042(int i, int i_0_) {
        ...
        if (this.aClass191_7032.aBoolean2570) {
            ...
            int i_4_ = 0;
            while_140_:
            for (/**/; DefinitionSub6.anInt9139 > i_4_; i_4_++) {
                HashNodeSub20.anInt9715 = ScreenModeManager.anInt2835 = Component335.anInt2023 = DisplayModeManagerContainer136.anInt4715 = 2147483647;
                int i_5_ = 2048 - -(RenderableSub6.anIntArray6432[i_4_] * anInt9129);
                int i_6_ = i_5_ >> 12;
                int i_7_ = i_6_ + 1;
                for (int i_8_ = i_2_ + -1; i_8_ <= i_3_; i_8_++) {
                    ...
                    for (int i_10_ = -1 + i_6_; i_7_ >= i_10_; i_10_++) {
                        ...
                        if (HashNodeSub20.anInt9715 <= i_15_) {
                            if (i_15_ >= ScreenModeManager.anInt2835) {
                                if (i_15_ < Component335.anInt2023) {
                                    DisplayModeManagerContainer136.anInt4715 = Component335.anInt2023;
                                    Component335.anInt2023 = i_15_;
                                } else if (i_15_ < DisplayModeManagerContainer136.anInt4715) DisplayModeManagerContainer136.anInt4715 = i_15_;
                            } else {
                                DisplayModeManagerContainer136.anInt4715 = Component335.anInt2023;
                                Component335.anInt2023 = ScreenModeManager.anInt2835;
                                ScreenModeManager.anInt2835 = i_15_;
                            }
                        } else {
                            DisplayModeManagerContainer136.anInt4715 = Component335.anInt2023;
                            Component335.anInt2023 = ScreenModeManager.anInt2835;
                            ScreenModeManager.anInt2835 = HashNodeSub20.anInt9715;
                            HashNodeSub20.anInt9715 = i_15_;
                        }
                    }
                }
                int i_16_ = anInt9124;
                ...
                do {
                    ...
                    do {
                        do {
                            if (i_16_ == 0) {
                                is[i_4_] = HashNodeSub20.anInt9715;
                                continue while_140_;
                            } else if (i_16_ != 1) {
                                if (i_16_ != 3) {
                                    if (i_16_ != 4) {
                            ...
                            is[i_4_] = ScreenModeManager.anInt2835;
                            continue while_140_;
                        } while (false);
                        is[i_4_] = Component335.anInt2023;
                        continue while_140_;
                    } while (false);
                    is[i_4_] = DisplayModeManagerContainer136.anInt4715;
                    continue while_140_;
                } while (false);
                is[i_4_] = ScreenModeManager.anInt2835 + -HashNodeSub20.anInt9715;
            }
        }
        return is;
    }
