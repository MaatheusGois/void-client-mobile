...
/**
 * RENAMED from `Class348_Sub17` (JODE-obfuscated).
 * NPC definition/config node (extends renamed Node). Holds model/animation data (byte[] vertex/face buffers, short[] indices, Component234 model, NodeSub19Sub1 animation) and a 2048-slot Component135[] array; referenced in NPC-related code.
 */

final class NpcDefinition extends Node {
    ...
    Component234[] aClass23Array6796;
    int anInt6797;
    byte[] aByteArray6798;
    byte[] aByteArray6799;
    ...
    NpcDefinition(byte[] is) {
        ...
        this.aClass348_Sub19_Sub1Array6800 = new NodeSub19Sub1[128];
        this.aClass23Array6796 = new Component234[128];
        ...
        Component234[] class23s = new Component234[i_20_];
        for (int i_24_ = 0; i_24_ < class23s.length; i_24_++) {
            Component234 class23 = class23s[i_24_] = new Component234();
        ...
        for (int i_46_ = 0; i_20_ > i_46_; i_46_++) {
            Component234 class23_47_ = class23s[i_46_];
        ...
        for (int i_52_ = 0; i_52_ < i_20_; i_52_++) {
            Component234 class23_53_ = class23s[i_52_];
        ...
        for (int i_55_ = 0; i_20_ > i_55_; i_55_++) {
            Component234 class23_56_ = class23s[i_55_];
        ...
        for (int i_84_ = 0; i_84_ < i_20_; i_84_++) {
            Component234 class23_85_ = class23s[i_84_];
