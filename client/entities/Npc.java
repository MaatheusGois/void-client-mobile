...
final class Npc extends DisplayModeManagerContainer58 {
    ...
    static final void decodedOperation2441(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        if (i_2_ != -22728) anInt10503 = 121;
        if (i_5_ - i_0_ >= Component27.anInt4960 && Component22.anInt1745 >= i_0_ + i_5_ && -i_0_ + i_3_ >= Component72.anInt1910 && i_3_ + i_0_ <= PauseTimer.anInt513) Component80.decodedOperation2255(i_0_, i_5_, (byte) -68, i_1_, i_3_, i_4_, i);
        else Component275.decodedOperation1496(i, i_3_, i_4_, i_0_, 2, i_1_, i_5_);
        anInt10498++;
    }

    private final boolean decodedOperation2442(int i) {
    ...
    final boolean method2391(GraphicsToolkit var_ha, int i, int i_9_, int i_10_) {
        anInt10514++;
        if (this.definition == null || !decodedOperation2447(97, 131072, var_ha)) return false;
        DisplayModeManagerContainer204 class101 = var_ha.decodedOperation3705();
        int i_11_ = this.aClass264_10217.decodedOperation2019((byte) -78);
    ...
    final void decodedOperation2443(int i, int i_15_, int i_16_) {
        anInt10497++;
        ...
        if (this.anInt10269 != -1) {
            Component63 class368 = (NsnDefinition.aClass319_9245.decodedOperation2543((byte) 118, this.anInt10269));
        ...
        if (this.anInt10291 != -1) {
            Component63 class368 = (NsnDefinition.aClass319_9245.decodedOperation2543((byte) 77, this.anInt10291));
    ...
    final RenderableSub4 method2386(int i, GraphicsToolkit var_ha) {
        anInt10501++;
        if (this.definition == null || !decodedOperation2447(i + 114, 2048, var_ha)) return null;
        DisplayModeManagerContainer204 class101 = var_ha.decodedOperation3705();
        int i_20_ = this.aClass264_10217.decodedOperation2019((byte) -69);
        ...
        class101.decodedOperation891(this.x, (-this.anInt10274 + this.anInt6382 + -20), this.y);
        Component241 class225 = this.getDefinition((byte) 72);
        NpcComposition class79 = (this.definition.anIntArray1377 != null ? this.definition.decodedOperation794(DisplayModeManagerContainer58.aClass170_10209, -1) : this.definition);
        this.aBoolean10324 = false;
        RenderableSub4 class318_sub4 = null;
        if (Component192.preferences.aClass239_Sub21_7270.decodedOperation1812(-32350) == i && class79.aBoolean1369 && class225.aBoolean2913) {
            ...
            DisplayModeManagerContainer370 class64 = (Node.decodedOperation2711(this.anInt10302, i_20_, this.aClass64Array10323[0], this.anInt10208, false, (class17_22_ == null ? this.anInt10267 : this.anInt10245), 0xffff & this.definition.aShort1339, this.definition.anInt1399, this.anInt10252, var_ha, 0xff & this.definition.aByte1353, this.definition.aShort1350 & 0xffff, this.definition.aByte1347 & 0xff, class17_22_ == null ? class17 : class17_22_));
            if (class64 != null) {
                class318_sub4 = (OutputStream_Sub2.decodedOperation136(1 + (this.aClass64Array10323).length, decodedOperation2442(1810797122), false));
                ...
                else class64.decodedOperation608(class101, (class318_sub4.aClass318_Sub3Array6414[(this.aClass64Array10323).length]), Component72.anInt1906, 0);
                var_ha.C(true);
            }
        }
        class101.method895(i_20_);
        class101.decodedOperation891(this.x, (-this.anInt10274 + (-5 + this.anInt6382)), this.y);
        if (class318_sub4 == null) class318_sub4 = OutputStream_Sub2.decodedOperation136((this.aClass64Array10323).length, decodedOperation2442(1810797122), false);
        ...
        if (DisplayModeManagerContainer50.aBoolean3870) {
            for (int i_24_ = 0; (this.aClass64Array10323.length > i_24_); i_24_++) {
                if (this.aClass64Array10323[i_24_] != null) this.aClass64Array10323[i_24_].decodedOperation608(class101, (class318_sub4.aClass318_Sub3Array6414[i_24_]), Component72.anInt1906, 0);
            }
        } else {
    ...
    final int method2421(byte i) {
        ...
        if ((this.definition.anIntArray1377) != null) {
            NpcComposition class79 = this.definition.decodedOperation794(DisplayModeManagerContainer58.aClass170_10209, -1);
            if (class79 != null && class79.anInt1366 != -1) return class79.anInt1366;
        }
        if (i < 113) decodedOperation2448(null, 88);
    ...
    final void decodedOperation2444(int i, boolean bool, int i_26_, int i_27_, int i_28_, int i_29_) {
        this.plane = this.aByte6376 = (byte) i_29_;
        anInt10515++;
        if (NpcComposition.decodedOperation802(i, i_26_, true)) this.aByte6376++;
        if (this.anInt10286 != -1 && RunescapeInfo.aClass87_191.getSequence(this.anInt10286, 7).anInt245 == 1) {
            this.anIntArray10236 = null;
            this.anInt10286 = -1;
        }
        if (this.anInt10269 != -1) {
            Component63 class368 = (NsnDefinition.aClass319_9245.decodedOperation2543((byte) 117, this.anInt10269));
            if (class368.aBoolean4487 && class368.anInt4503 != -1 && (RunescapeInfo.aClass87_191.getSequence(class368.anInt4503, 7).anInt245) == 1) this.anInt10269 = -1;
        }
        if (this.anInt10291 != -1) {
            Component63 class368 = (NsnDefinition.aClass319_9245.decodedOperation2543((byte) 56, this.anInt10291));
            if (class368.aBoolean4487 && class368.anInt4503 != -1 && (RunescapeInfo.aClass87_191.getSequence(class368.anInt4503, 7).anInt245) == 1) this.anInt10291 = -1;
        }
        if (!bool) {
    ...
    final boolean decodedOperation2445(byte i) {
        anInt10500++;
    ...
    final void method2387(GraphicsToolkit var_ha, int i) {
        anInt10509++;
        if (this.definition != null && (this.aBoolean10318 || decodedOperation2447(123, 0, var_ha))) {
            if (i > -125) method2391(null, -2, -103, 34);
            DisplayModeManagerContainer204 class101 = var_ha.decodedOperation3705();
            class101.method895(this.aClass264_10217.decodedOperation2019((byte) -118));
            class101.decodedOperation891(this.x, -20 + this.anInt6382, this.y);
    ...
    static final boolean decodedOperation2446(char c, byte i) {
        if (i != 105) anInt10503 = 124;
        anInt10508++;
        return (c >= 48 && c <= 57) || (c >= 65 && c <= 90) || (c >= 97 && c <= 122);
    }

    private final boolean decodedOperation2447(int i, int i_34_, GraphicsToolkit var_ha) {
        ...
        int i_39_ = this.aClass264_10217.decodedOperation2019((byte) -25);
        DisplayModeManagerContainer370 class64 = (this.aClass64Array10323[0] = (this.definition.decodedOperation800(i_39_, this.aClass182Array10308, RunescapeInfo.aClass87_191, false, class17_36_, this.anInt10203, DisplayModeManagerContainer282.aClass261_5558, this.anInt10267, class17, DisplayModeManagerContainer58.aClass170_10209, var_ha, this.anInt10312, this.anIntArray10296, this.anInt10244, this.anInt10245, i_34_, this.anInt10232)));
        if (class64 == null) return false;
        this.anInt10207 = class64.fa();
        this.anInt10230 = class64.ma();
        this.decodedOperation2439(-125, class64);
        if (i_37_ != 0 || i_38_ != 0) {
        ...
        if (this.anInt10269 == -1 || this.anInt10240 == -1) this.aClass64Array10323[1] = null;
            ...
            Component63 class368 = (NsnDefinition.aClass319_9245.decodedOperation2543((byte) 56, this.anInt10269));
            ...
            DisplayModeManagerContainer370 class64_42_ = (this.aClass64Array10323[1] = (class368.decodedOperation3562(this.anInt10240, var_ha, this.anInt10243, i_41_, this.anInt10283, RunescapeInfo.aClass87_191, (byte) 78)));
            if (class64_42_ != null) {
        ...
        if (this.anInt10291 == -1 || this.anInt10224 == -1) this.aClass64Array10323[2] = null;
            ...
            Component63 class368 = (NsnDefinition.aClass319_9245.decodedOperation2543((byte) 98, this.anInt10291));
            ...
            DisplayModeManagerContainer370 class64_53_ = (this.aClass64Array10323[2] = (class368.decodedOperation3558(this.anInt10273, this.anInt10276, var_ha, i_52_, 3172, RunescapeInfo.aClass87_191, this.anInt10224)));
            if (class64_53_ != null) {
    ...
    final void decodedOperation2448(NpcComposition class79, int i) {
        anInt10511++;
