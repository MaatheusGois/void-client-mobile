...
final class GlWaterShader extends NodeSub5 {
    ...
    final void method2750(GlTexture class258_sub3, GlTexture class258_sub3_2_, int i, byte i_3_) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("rda.H(" + (class258_sub3 != null ? "{...}" : "null") + ',' + (class258_sub3_2_ != null ? "{...}" : "null") + ',' + i + ',' + i_3_ + ')'));
        }
    }
    ...
    final void method2754(int i, byte i_14_, int i_15_) {
        ...
        if (i_14_ >= 7) {
            anInt8843++;
            anInt8841 = i_15_;
            int i_16_ = PrimitiveTypeDefinition.method3051(anInt8841, 4096);
            int i_17_ = PrimitiveTypeDefinition.method3051(anInt8833, 4096);
    ...
    final boolean method2758(int i) {
        ...
        if (this.aHa_Sub2_6618.aBoolean7820 && this.aHa_Sub2_6618.aBoolean7783 && this.aHa_Sub2_6618.aBoolean7818) {
            ...
            this.aHa_Sub2_6618.method3770(-422613672, aClass206_8825);
            aClass337_8842 = (ShaderLinker.method2493(this.aHa_Sub2_6618, -1, (new Component359[]{RSARequest.method3249(35632, 80, this.aHa_Sub2_6618, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n")})));
            aClass337_8824 = (ShaderLinker.method2493(this.aHa_Sub2_6618, -1, (new Component359[]{RSARequest.method3249(35632, -45, this.aHa_Sub2_6618, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n")})));
            aClass337_8836 = (ShaderLinker.method2493(this.aHa_Sub2_6618, -1, (new Component359[]{RSARequest.method3249(35632, -108, this.aHa_Sub2_6618, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n")})));
            aClass337_8822 = (ShaderLinker.method2493(this.aHa_Sub2_6618, -1, (new Component359[]{RSARequest.method3249(35632, -31, this.aHa_Sub2_6618, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n")})));
