/* WaterSurfaceShader - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class286_Sub4` (JODE-obfuscated).
 * Water surface shader. Extends ShaderProgram; GLSL program with normalSampler, waterDepth and sunDir uniforms for lit water surfaces.
 */

import jaggl.OpenGL;

final class WaterSurfaceShader extends ShaderProgram {
    private boolean aBoolean6233;
    private Component244 aClass337_6234;
    ...
    private final Component178 aClass83_6242;
    static int anInt6243;
    static StringCache aClass351_6244 = new StringCache(9, 8);
    ...
    static final int method2154(int i) {
        ...
        if (i_1_ == -1) i_1_ = DisplayModeManagerContainer216.anInt5652 - 1;
        return i_1_;
    }
    ...
    WaterSurfaceShader(GlToolkitSub2 var_ha_Sub2, Component178 class83) {
        ...
        do {
            try {
                ...
                aClass337_6234 = ShaderLinker.method2493((this.aHa_Sub2_3684), -1, (new Component359[]{class242, class242_6_}));
                aBoolean6237 = aClass337_6234 != null;
            } catch (RuntimeException runtimeexception) {
                throw NpcDefinition.method2929(runtimeexception, ("er.<init>(" + (var_ha_Sub2 != null ? "{...}" : "null") + ',' + (class83 != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
