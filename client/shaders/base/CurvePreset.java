/* CurvePreset - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class348_Sub40_Sub14` (JODE-obfuscated).
 * Curve preset config definition. extends Definition; throws 'Curve operation requires at least two markers' when fewer than two control points are present.
 */

final class CurvePreset extends Definition {
        ...
        do {
            do {
                ...
                for (i_2_ = 0; i_2_ < 257; i_2_++) {
                    ...
                    int i_24_ = (-(Component296.anIntArray4654[(i_23_ & 0x1ff6) >> 5]) + 4096 >> 1);
