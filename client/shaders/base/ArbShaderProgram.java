/* ArbShaderProgram - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class286_Sub1` (JODE-obfuscated).
 * ARB assembly-language shader program (ShaderProgram subclass). Builds !!ARBvp1.0 vertex / !!ARBfp1.0 fragment assembly sources and resolves uniform locations via Component47.decodedOperation459.
 */

import jaggl.OpenGL;

final class ArbShaderProgram extends ShaderProgram {
    private boolean aBoolean6183 = false;
    static int anInt6184;
    static int anInt6185;
    static int anInt6186;
    private Component382 aClass171_6187;
    private Component382 aClass171_6188;
    ...
    private GlTexture aClass258_Sub3_6194;
    static int anInt6195;
    private Component382 aClass171_6196;
    ...
    final void method2141(boolean bool) {
        if (bool == false) {
            anInt6192++;
            MatrixSub3 class101_sub3 = (this.aHa_Sub2_3684.aClass101_Sub3_7766);
            ...
            class101_sub3.decodedOperation937(true, 0.0F, 0.0F, -1.0F, (float) (this.aHa_Sub2_3684.anInt7788), DisplayModeManagerContainer23.aFloatArray1528);
            OpenGL.glProgramLocalParameter4fARB(34336, 1, DisplayModeManagerContainer23.aFloatArray1528[0], DisplayModeManagerContainer23.aFloatArray1528[1], DisplayModeManagerContainer23.aFloatArray1528[2], DisplayModeManagerContainer23.aFloatArray1528[3]);
    ...
    public static void decodedOperation2142(byte i) {
        consoleLines = null;
        int i_1_ = 19 % ((i - -67) / 59);
        aClass74_6201 = null;
        anIntArray6189 = null;
