 ...
 * ARB assembly-language shader program (ShaderProgram subclass). Builds !!ARBvp1.0 vertex / !!ARBfp1.0 fragment assembly sources and resolves uniform locations via Component47.method459.
 */
...
final class ArbShaderProgram extends ShaderProgram {
    ...
    final void method2141(boolean bool) {
        if (bool == false) {
            ...
            class101_sub3.method937(true, 0.0F, 0.0F, -1.0F, (float) (this.aHa_Sub2_3684.anInt7788), DisplayModeManagerContainer23.aFloatArray1528);
