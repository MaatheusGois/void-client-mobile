 ...
 */ extends Shader {
    ...
    public static void decodedOperation162(byte i) {
        ignoreLastDisplayNames = null;
        if (i >= -67) aClass161_5199 = null;
        aClass161_5199 = null;
    }

    static final int decodedOperation163(int i) {
        anInt5198++;
        if (i != 512) decodedOperation165(122, 62, -125, 72, -74, 116, 43, (byte) 104, 62, -115);
        return Component44.aClass311_897.getPulseCount((byte) -98);
    }

    static final boolean decodedOperation164(int i, int i_0_, byte i_1_, int i_2_) {
        anInt5195++;
        ...
        if (i_1_ != -97) decodedOperation163(-4);
        if ((ShaderProgramSub7.decodedOperation2169(i_4_ - -1, i_4_ - (-Component148.anInt3465 - -1), 1 + i_5_, 1 + i_4_, -1 + (i_5_ - -Component148.anInt3465), ShaderSub1.aSArray5191[i].getHeight((byte) -86, 1 + i_2_, i_0_), ShaderSub1.aSArray5191[i].getHeight((byte) -86, 1 + i_2_, 1 + i_0_), ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_2_, i_0_), -1 + Component148.anInt3465 + i_5_, false)) && (ShaderProgramSub7.decodedOperation2169(1 + i_4_, Component148.anInt3465 + (i_4_ + -1), i_5_ + 1, Component148.anInt3465 + (i_4_ - 1), i_5_ + Component148.anInt3465 - 1, ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_2_ - -1, 1 + i_0_), ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_2_, i_0_ + 1), ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_2_, i_0_), 1 + i_5_, false))) {
    ...
    static final void decodedOperation165(int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, byte i_12_, int i_13_, int i_14_) {
        anInt5194++;
        if (i_9_ < 512 || i_11_ < 512 || (-2 + AbstractShaderSub4.anInt7319) * 512 < i_9_ || (-2 + ParametricDefinition.anInt9109) * 512 < i_11_) Component71.anIntArray6062[0] = Component71.anIntArray6062[1] = -1;
            ...
            int i_15_ = Component300.decodedOperation2064(i_9_, i, 11219, i_11_) - i_7_;
            if (Component210.gameCanvasAttached) HashTable.decodedOperation1010(false, true);
            else {
                Component270.aClass101_2123.decodedOperation891(i_10_, 0, 0);
            ...
            if (Component210.gameCanvasAttached) DebugPanicSub1.decodedOperation2129((byte) 60);
            else {
                Component270.aClass101_2123.decodedOperation891(-i_10_, 0, 0);
                NodeSub8.toolkit.loadModelviewMatrix(Component270.aClass101_2123);
            }
