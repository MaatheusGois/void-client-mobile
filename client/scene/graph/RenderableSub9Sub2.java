 ...
 */ extends RenderableSub9 {
    ...
    static final void method2519(RenderableObject class318_sub1, int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        boolean bool = true;
        int i_4_ = i_0_;
        int i_5_ = i_0_ + i_2_;
        int i_6_ = i_1_ - 1;
                    ...
                    if (i_9_ >= 0 && i_9_ < StaticElementRenderer.anInt6451) {
                        for (int i_10_ = i_6_; i_10_ <= i_7_; i_10_++) {
                            if (i_10_ >= 0 && i_10_ < NodeSub41.anInt7054 && (!bool || i_9_ >= i_5_ || i_10_ >= i_7_ || i_10_ < i_1_ && i_9_ != i_0_)) {
                                ...
                                if (class357 != null) {
                                    int i_11_ = (((ShaderSub1.aSArray5191[i_8_].method3982((byte) -86, i_10_, i_9_)) + (ShaderSub1.aSArray5191[i_8_].method3982((byte) -86, i_10_, i_9_ + 1)) + (ShaderSub1.aSArray5191[i_8_].method3982((byte) -86, i_10_ + 1, i_9_)) + (ShaderSub1.aSArray5191[i_8_].method3982((byte) -86, i_10_ + 1, i_9_ + 1))) / 4 - ((ShaderSub1.aSArray5191[i].method3982((byte) -86, i_1_, i_0_)) + (ShaderSub1.aSArray5191[i].method3982((byte) -86, i_1_, i_0_ + 1)) + (ShaderSub1.aSArray5191[i].method3982((byte) -86, i_1_ + 1, i_0_)) + (ShaderSub1.aSArray5191[i].method3982((byte) -86, i_1_ + 1, i_0_ + 1))) / 4);
