/* RenderableSub9Sub2 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

class RenderableSub9Sub2
/**
 * RENAMED from `Class318_Sub9_Sub2` (JODE-obfuscated).
 ...
 */ extends RenderableSub9 {
    ...
    public static void decodedOperation2518(int i) {
        if (i == 137) anIntArray8797 = null;
    }

    static final void decodedOperation2519(RenderableObject class318_sub1, int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        boolean bool = true;
        int i_4_ = i_0_;
        int i_5_ = i_0_ + i_2_;
        int i_6_ = i_1_ - 1;
        ...
        for (int i_8_ = i; i_8_ <= i + 1; i_8_++) {
            if (i_8_ != Component291.anInt2524) {
                for (int i_9_ = i_4_; i_9_ <= i_5_; i_9_++) {
                    if (i_9_ >= 0 && i_9_ < StaticElementRenderer.anInt6451) {
                        for (int i_10_ = i_6_; i_10_ <= i_7_; i_10_++) {
                            if (i_10_ >= 0 && i_10_ < NodeSub41.anInt7054 && (!bool || i_9_ >= i_5_ || i_10_ >= i_7_ || i_10_ < i_1_ && i_9_ != i_0_)) {
                                Component186 class357 = (Component335.aClass357ArrayArrayArray2029[i_8_][i_9_][i_10_]);
                                if (class357 != null) {
                                    int i_11_ = (((ShaderSub1.aSArray5191[i_8_].getHeight((byte) -86, i_10_, i_9_)) + (ShaderSub1.aSArray5191[i_8_].getHeight((byte) -86, i_10_, i_9_ + 1)) + (ShaderSub1.aSArray5191[i_8_].getHeight((byte) -86, i_10_ + 1, i_9_)) + (ShaderSub1.aSArray5191[i_8_].getHeight((byte) -86, i_10_ + 1, i_9_ + 1))) / 4 - ((ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_1_, i_0_)) + (ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_1_, i_0_ + 1)) + (ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_1_ + 1, i_0_)) + (ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_1_ + 1, i_0_ + 1))) / 4);
                                    ...
                                    if (class318_sub1_sub4 != null && class318_sub1_sub4.decodedOperation2388(-127))
                                    ...
                                    if (class318_sub1_sub4_12_ != null && class318_sub1_sub4_12_.decodedOperation2388(-100))
                                    ...
                                    for (Component3 class148 = (class357.aClass148_4396); class148 != null; class148 = (class148.aClass148_2038)) {
                                        ...
                                        if (class318_sub1_sub3 != null && class318_sub1_sub3.decodedOperation2388(-111) && (i_9_ == (class318_sub1_sub3.aShort8743) || i_9_ == i_4_) && (i_10_ == (class318_sub1_sub3.aShort8750) || i_10_ == i_6_)) {
