 ...
 */ extends Renderable {
    ...
    static final void decodedOperation2494(int i, int i_0_, int i_1_, GraphicsToolkit var_ha, MenuEntry class348_sub42_sub12, int i_2_, int i_3_, int i_4_, byte i_5_, int i_6_, int i_7_, int i_8_) {
        do {
            try {
                anInt6397++;
                if (i_5_ < 123) decodedOperation2499(27, -8, -96, 71, 72, (byte) 72, -82);
                if (i_8_ > i_7_ && i_7_ + i_2_ > i_8_ && i_3_ > -13 + i_1_ && i_1_ + 3 > i_3_ && (class348_sub42_sub12.aBoolean9610)) i_4_ = i_0_;
                int[] is = null;
                if (!Component3.decodedOperation1197(-12081, class348_sub42_sub12.opcode)) {
                    if ((class348_sub42_sub12.itemId) == -1) {
                        if (WaterShaderSub8.decodedOperation3549((class348_sub42_sub12.opcode), (byte) -119)) {
                        ...
                        } else if (Component71.decodedOperation1813(8806, (class348_sub42_sub12.opcode))) {
                            Object object = null;
                            Component44 class51;
                            ...
                            if (class51.anIntArray945 != null) class51 = (class51.decodedOperation480((DisplayModeManagerContainer58.aClass170_10209), (byte) 47));
                ...
                if (is != null) string += ImageTagText.decodedOperation1273(is, true);
                NodeList.aClass324_3326.decodedOperation2567(i_1_, string, (byte) 116, i_4_, 0, i_7_ - -3, DisplayModeManagerContainer196.aClass105Array4234, Component143.anIntArray2330);
    ...
    public static void decodedOperation2495(byte i) {
        if (i <= 110) anIntArray6393 = null;
        anIntArray6393 = null;
        aClass147Array6400 = null;
    }

    static final boolean decodedOperation2496(int i, int i_9_, boolean bool) {
        if (bool != true) decodedOperation2497(null, (byte) -29, null, 73);
        anInt6396++;
        if (i >= 1000 && i_9_ < 1000) return true;
        if (i < 1000 && i_9_ < 1000) {
            if (DisplayModeManagerContainer74.decodedOperation2308((byte) 26, i_9_)) return true;
            return !DisplayModeManagerContainer74.decodedOperation2308((byte) 26, i);
        }
    ...
    static final int decodedOperation2497(byte[] is, byte i, String string, int i_10_) {
        try {
            anInt6399++;
            int i_11_ = i_10_;
            int i_12_ = string.length();
            int i_13_ = 0;
            if (i != 0) decodedOperation2496(21, -5, true);
            for (/**/; i_12_ > i_13_; i_13_ += 4) {
                int i_14_ = Component134.decodedOperation1399(7, string.charAt(i_13_));
                int i_15_ = (i_12_ > i_13_ - -1 ? Component134.decodedOperation1399(7, string.charAt(1 + i_13_)) : -1);
                int i_16_ = (2 + i_13_ < i_12_ ? Component134.decodedOperation1399(7, string.charAt(i_13_ + 2)) : -1);
                int i_17_ = (i_12_ <= 3 + i_13_ ? -1 : Component134.decodedOperation1399(7, string.charAt(i_13_ + 3)));
    ...
    static final void decodedOperation2498(Component103 class338, GraphicsToolkit var_ha, byte i, int i_18_) {
        try {
            anInt6395++;
            ...
            if (class338.aByte4192 == 1) {
                ...
                if (i_20_ >= 0 && i_20_ <= (Component197.anInt10084 + Component197.anInt10084)) {
                    ...
                    if (bool) {
                        ...
                        if (f < 0.0F) f *= -1.0F;
                        if (!(f < (float) Component53.anInt194) && Component160.decodedOperation3465(0, 1, class338) && Component160.decodedOperation3465(1, 1, class338) && Component160.decodedOperation3465(2, 1, class338) && Component160.decodedOperation3465(3, 1, class338))
                ...
                if (i_26_ >= 0 && i_26_ <= (Component197.anInt10084 - -Component197.anInt10084)) {
                    ...
                    if (i_27_ >= 0 && ((Component197.anInt10084 - -Component197.anInt10084) >= i_27_) && DisplayModeManagerContainer153.aBooleanArrayArray1572[i_26_][i_27_]) {
                        ...
                        if ((!(f < (float) Component53.anInt194) || !((float) Component53.anInt194 > f_28_)) && Component160.decodedOperation3465(0, 1, class338) && Component160.decodedOperation3465(1, 1, class338) && Component160.decodedOperation3465(2, 1, class338) && Component160.decodedOperation3465(3, 1, class338))
                            HashNodeSub19.aClass338Array9700[HashNodeSub10.activeOccluderCount++] = class338;
                    }
                }
                ...
                if (!(f <= (float) GlToolkitSub2.anInt7714)) {
                    ...
                    if (bool && Component160.decodedOperation3465(0, 1, class338) && Component160.decodedOperation3465(1, 1, class338) && Component160.decodedOperation3465(2, 1, class338) && Component160.decodedOperation3465(3, 1, class338)) HashNodeSub19.aClass338Array9700[HashNodeSub10.activeOccluderCount++] = class338;
                }
            }
        } catch (RuntimeException runtimeexception) {
    ...
    static final boolean decodedOperation2499(int i, int i_35_, int i_36_, int i_37_, int i_38_, byte i_39_, int i_40_) {
        anInt6398++;
        ...
        if (i_38_ == i_40_ && i_36_ == i_35_) {
            if (!ShaderSub2.decodedOperation164(i, i_38_, (byte) -97, i_36_)) return false;
            int i_41_ = i_38_ << Component149.anInt4459;
            int i_42_ = i_36_ << Component149.anInt4459;
            if (Component221.decodedOperation1084(i_37_, Component148.anInt3465, i_42_, i_41_, ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_36_, i_38_), Component148.anInt3465, 18507)) {
                DefinitionSub4.occludedCpCount++;
                return true;
            }
            return false;
        }
        if (i_39_ <= 101) decodedOperation2499(66, -39, -55, 105, 96, (byte) 114, -44);
        ...
        if (!Component221.decodedOperation1084(i_37_, (1 + -i_38_ + i_40_) * Component148.anInt3465, i_46_, i_45_, ShaderSub1.aSArray5191[i].getHeight((byte) -86, i_36_, i_38_), Component148.anInt3465 * (i_35_ + -i_36_ + 1), 18507)) return false;
        DefinitionSub4.occludedCpCount++;
        return true;
    }
}
