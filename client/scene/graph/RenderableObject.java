/* RenderableObject - Decompiled by JODE
...
abstract class RenderableObject extends Renderable {
    ...
    RenderableObject aClass318_Sub1_6379;
    int anInt6380;
    byte plane;
    int anInt6382;
    static Component183 aClass114_6383 = new Component183(11, 6);
    ...
    static final void method2383(ha var_ha, int i, DisplayModeManagerContainer57 class46) {
        do {
            try {
                ...
                anInt6385++;
                boolean bool = ((Exception_Sub1.aClass255_112.method1941(class46.anInt672, (byte) -74, class46.anInt812, class46.anInt781, ~0xffffff | class46.anInt809, class46.anInt678, var_ha, (!class46.aBoolean720 ? null : (Component72.localPlayer.aClass154_10536)))) == null);
                if (!bool) break;
                Component305.aClass262_9931.method1999(new NodeSub7(class46.anInt812, class46.anInt781, class46.anInt672, (~0xffffff | class46.anInt809), class46.anInt678, class46.aBoolean720), i ^ 0x4ed2);
                Component111.method1916(-9343, class46);
            } catch (RuntimeException runtimeexception) {
                throw NpcDefinition.method2929(runtimeexception, ("ga.QA(" + (var_ha != null ? "{...}" : "null") + ',' + i + ',' + (class46 != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
            ...
            try {
                ...
                if (i_7_ < -52) {
                    ...
                    if (class42.anInt576 == 1) {
                        ...
                        class143 = Component163.aClass143_3179;
                    }
                ...
                throw NpcDefinition.method2929(runtimeexception, ("ga.KA(" + (class46 != null ? "{...}" : "null") + ',' + i + ',' + (var_aa != null ? "{...}" : "null") + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + (var_ha != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
    ...
    final int method2390(NodeSub1[] class348_sub1s, int i, int i_30_, int i_31_) {
        ...
        for (/**/; l_32_ <= 48; l_32_ += 16L) {
            ...
            if (i_34_ <= 0) break;
            class348_sub1s[i_33_++] = (Component329.aClass211Array5993[i_34_ + -1].aClass348_Sub1_2745);
        }
