/* RenderableSub9Sub2Sub1 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class RenderableSub9Sub2Sub1
/**
 * RENAMED from `Class318_Sub9_Sub2_Sub1` (JODE-obfuscated).
 * Evidence: subclass of RenderableSub9Sub2 (hierarchy)
 */ extends RenderableSub9Sub2 {
    private short aShort10416;
    private int anInt10417;
    private short aShort10418;
    StaticElementRenderer aClass318_Sub7_10419;
    ...
    final void method2522(GraphicsToolkit var_ha, long l) {
        ...
        if (i_1_ > 0 || i_1_ < -262144 || i < 0 || i >= StaticElementRenderer.anInt6451 || i_0_ < 0 || i_0_ >= NodeSub41.anInt7054) method2520();
        else {
            ...
            if (class181.aBoolean2376 && i_5_ == 0 && i_1_ > var_ses[0].method3982((byte) -86, i_0_, i)) method2520();
                ...
                if (class357 == null) {
                    if (i_5_ == 0 || (Component335.aClass357ArrayArrayArray2029[0][i][i_0_] == null)) class357 = Component335.aClass357ArrayArrayArray2029[0][i][i_0_] = new Component186(0);
                    boolean bool = (Component335.aClass357ArrayArrayArray2029[0][i][i_0_].aClass357_4400 != null);
                    if (i_5_ == 3 && bool) {
                        method2520();
                        return;
                    }
                    for (int i_6_ = 1; i_6_ <= i_5_; i_6_++) {
                        if ((Component335.aClass357ArrayArrayArray2029[i_6_][i][i_0_]) == null) {
                            class357 = Component335.aClass357ArrayArrayArray2029[i_6_][i][i_0_] = new Component186(i_6_);
        ...
        if (aShort10420 <= 0) method2520();
            ...
            if (class181.anIntArray2395 != null) {
                ...
                for (int i_64_ = 0; i_64_ < class181.anIntArray2385.length; i_64_++) {
                    RadixParser class174 = (Component248.aClass174Array311[class181.anIntArray2385[i_64_]]);
                    if (class174.anInt2297 == 0) {
    ...
    RenderableSub9Sub2Sub1(StaticElementRenderer class318_sub7, int i, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_, boolean bool, boolean bool_75_) {
        this.aClass318_Sub7_10419 = class318_sub7;
        this.anInt8791 = i << 12;
