/* ParticleShader - Decompiled by JODE
...
final class ParticleShader extends ShaderProgram {
    ...
    final void method2136(int i, int i_0_, byte i_1_) {
        ...
        if (aClass61_6222 != null) {
            ...
            if ((0x40 & i) == 0) {
                ...
                HashNodeSub1.aFloatArray9491[1] = (this.aHa_Sub2_3684.aFloat7768 * (this.aHa_Sub2_3684.aFloat7816));
                OpenGL.glProgramLocalParameter4fvARB(34336, 66, (HashNodeSub1.aFloatArray9491), 0);
                    ...
                    if (strings != null) {
                        for (int i = 4; i >= 0; i--) {
                            if (strings[i] != null && (class79.attackOptionMode == 0 || !(strings[i].equalsIgnoreCase(attack)))) {
                                ...
                                DisplayModeManagerContainer368.addMenuEntry(false, "<col=ffff00>" + string, 0, (byte) -93, false, 0, -1, true, i_16_, npc.anInt10290, strings[i], npc.anInt10290, i_17_);
                            }
                        }
                    }
    ...
    static final void method2152(boolean bool) {
        ...
        for (int i = 0; Component291.anInt2524 > i; i++) {
            for (int i_20_ = 0; i_20_ < StaticElementRenderer.anInt6451; i_20_++) {
                for (int i_21_ = 0; (i_21_ < NodeSub41.anInt7054); i_21_++) {
                    Component186 class357 = (Component335.aClass357ArrayArrayArray2029[i][i_21_][i_20_]);
                    if (class357 != null) {
        ...
        for (int i = 0; Component291.anInt2524 > i; i++) {
            for (int i_22_ = 0; i_22_ < StaticElementRenderer.anInt6451; i_22_++) {
                for (int i_23_ = 0; NodeSub41.anInt7054 > i_23_; i_23_++) {
                    Component186 class357 = (Component335.aClass357ArrayArrayArray2029[i][i_23_][i_22_]);
                    if (class357 != null) {
                        boolean bool_24_ = ((Component335.aClass357ArrayArrayArray2029[0][i_23_][i_22_]) != null && (Component335.aClass357ArrayArrayArray2029[0][i_23_][i_22_].aClass357_4400) != null);
