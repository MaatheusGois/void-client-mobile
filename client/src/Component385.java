/* Component385 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component385
/**
 ...
 */ {
    ...
    static Component183 aClass114_2196 = new Component183(111, -1);
    int anInt2197;
    ...
    static Component267 aClass229_2207 = new Component267();
    static CacheStore aClass45_2208;
    MatrixSub1 aClass101_Sub1_2209;
    int anInt2210;
    int anInt2211;
    int[] anIntArray2212;
    int[] anIntArray2213;
    ...
    int[] anIntArray2217;
    int[] anIntArray2218;
    DisplayModeManagerContainer164 aClass64_Sub1_2219;
    Component8 aClass109_2220;
    int anInt2221;
    int[] anIntArray2222;
    DisplayModeManagerContainer164 aClass64_Sub1_2223;
    DisplayModeManagerContainer164 aClass64_Sub1_2224;
    DisplayModeManagerContainer164 aClass64_Sub1_2225;
    float[] aFloatArray2226;
    DisplayModeManagerContainer164 aClass64_Sub1_2227;
    int[] anIntArray2228;
    int anInt2229;
    int[] anIntArray2230;
    DisplayModeManagerContainer164 aClass64_Sub1_2231;
    int[] anIntArray2232;
    DisplayModeManagerContainer164 aClass64_Sub1_2233;
    int[] anIntArray2234;
    int[] anIntArray2235;
    int[] anIntArray2236;
    int[] anIntArray2237;
    int[] anIntArray2238;
    DisplayModeManagerContainer164 aClass64_Sub1_2239;
    int[] anIntArray2240;
    int[] anIntArray2241;
    int[] anIntArray2242;
    DisplayModeManagerContainer164 aClass64_Sub1_2243;
    int[] anIntArray2244;
    int[] anIntArray2245;
    ...
    static final void method1295(RenderableObject[] class318_sub1s, int i, int i_1_) {
        if (i < i_1_) {
            int i_2_ = (i + i_1_) / 2;
            int i_3_ = i;
            RenderableObject class318_sub1 = class318_sub1s[i_2_];
            ...
            for (int i_5_ = i; i_5_ < i_1_; i_5_++) {
                if (class318_sub1s[i_5_].anInt6389 < i_4_ + (i_5_ & 0x1)) {
                    RenderableObject class318_sub1_6_ = class318_sub1s[i_5_];
    ...
    Component385(ha_Sub1 var_ha_Sub1) {
        ...
        this.anInt2211 = 0;
        this.aClass101_Sub1_2209 = new MatrixSub1();
        this.anIntArray2213 = new int[DisplayModeManagerContainer164.anInt5350];
        this.anIntArray2214 = new int[DisplayModeManagerContainer164.anInt5350];
        this.anIntArray2212 = new int[64];
        this.aFloatArray2226 = new float[2];
        this.anIntArray2216 = new int[10000];
        this.anIntArray2222 = new int[DisplayModeManagerContainer164.anInt5350];
        this.anIntArray2232 = new int[64];
        this.anIntArray2218 = new int[8];
        this.anIntArray2237 = new int[DisplayModeManagerContainer164.anInt5350];
        this.anIntArray2236 = new int[10000];
        this.anIntArray2230 = new int[DisplayModeManagerContainer164.anInt5350];
        ...
        this.anIntArray2244 = new int[DisplayModeManagerContainer164.anInt5350];
        this.anIntArray2247 = new int[10];
        this.anIntArray2234 = new int[DisplayModeManagerContainer164.anInt5350];
        aHa_Sub1_2191 = var_ha_Sub1;
        this.anInt2210 = aHa_Sub1_2191.anInt7494 + -255;
        this.aClass109_2220 = new Component8(var_ha_Sub1, this);
        this.aClass64_Sub1_2243 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2224 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2219 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2239 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2233 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2231 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2223 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2227 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2246 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.aClass64_Sub1_2225 = new DisplayModeManagerContainer164(aHa_Sub1_2191);
        this.anIntArray2242 = new int[DisplayModeManagerContainer164.anInt5346];
        for (int i = 0; DisplayModeManagerContainer164.anInt5346 > i; i++)
