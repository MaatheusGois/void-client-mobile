 ...
 */ extends Node {
    ...
    NodeSub14(long l) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, "ij.<init>(" + l + ')');
        }
    }
    ...
    static final ParticleSystem method2807(int i, int i_2_, byte i_3_, int i_4_) {
        ...
        if (i_4_ == 0) {
            class348_sub47 = ParticleShader.method2148(DisplayModeManagerContainer51.aClass351_2495, DisplayModeManagerContainer64.aClass77_9029, -100);
            NodeSub46.anInt7112++;
        }
        if (i_4_ == 1) {
            class348_sub47 = ParticleShader.method2148(Component281.aClass351_3825, DisplayModeManagerContainer64.aClass77_9029, -93);
        ...
        try {
            ...
            for (int i_16_ = i_5_; i_16_ < i_5_ - -104; i_16_ += RuntimeException_Sub1.anInt4600) {
                for (int i_17_ = i_6_; i_17_ < i_6_ - -104; i_17_ += RuntimeException_Sub1.anInt4600) {
                    ...
                    var_ha.fillRect(i_18_, i_19_, 4 * RuntimeException_Sub1.anInt4600, RuntimeException_Sub1.anInt4600 * 4, i_15_, 2);
            ...
            if (!Component121.aBoolean4542) {
                ...
                if (r_Sub2.aClass252_10488 != null) {
                    ...
                    Component181.aClass45_1541.method412((byte) -126);
                }
            }
            return true;
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("ij.E(" + i + ',' + (var_ha != null ? "{...}" : "null") + ',' + bool + ')'));
        }
    }
}
