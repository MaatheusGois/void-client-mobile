/* Component294 - Decompiled by JODE
...
final class Component294
/**
 * RENAMED from `Class310_Sub2` (JODE-obfuscated).
 * Evidence: subclass of DisplayModeManagerContainer318 (hierarchy)
 */ extends DisplayModeManagerContainer318 implements Interface18_Impl3 {
    ...
    Component294(D3DToolkit class378, int i, int i_0_, boolean bool, int[] is, int i_1_, int i_2_) {
        super(class378, Component83.aClass304_1662, Component342.aClass68_1183, bool && class378.aBoolean9798, i_0_ * i);
        if (this.aClass378_3893.aBoolean9792) {
            anInt6331 = i_0_;
            anInt6333 = i;
        } else {
            anInt6333 = Component373.method340(i, (byte) 108);
            anInt6331 = Component373.method340(i_0_, (byte) 108);
        }
    ...
    Component294(D3DToolkit class378, DisplayModeManagerContainer42 class304, Component342 class68, int i, int i_6_) {
        ...
        if (this.aClass378_3893.aBoolean9792) {
            ...
            anInt6333 = Component373.method340(i, (byte) 108);
            anInt6331 = Component373.method340(i_6_, (byte) 108);
        }
    ...
    public final void method65(int i, int[] is, int i_8_, int i_9_, int i_10_, byte i_11_, int i_12_) {
        if (Component83.aClass304_1662 != this.aClass304_3896 || this.aClass68_3895 != Component342.aClass68_1183) throw new RuntimeException();
    ...
    Component294(D3DToolkit class378, DisplayModeManagerContainer42 class304, int i, int i_16_, boolean bool, byte[] is, int i_17_, int i_18_) {
        super(class378, class304, Component342.aClass68_1183, bool && class378.aBoolean9798, i * i_16_);
        if (this.aClass378_3893.aBoolean9792) {
            anInt6333 = i;
            anInt6331 = i_16_;
        } else {
            anInt6333 = Component373.method340(i, (byte) 108);
            anInt6331 = Component373.method340(i_16_, (byte) 108);
        }
    ...
    public final void method68(int i, int i_22_, int[] is, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
        if (this.aClass304_3896 != Component83.aClass304_1662 || this.aClass68_3895 != Component342.aClass68_1183) throw new RuntimeException();
        PixelBuffer pixelbuffer = (this.aClass378_3893.aPixelBuffer9803);
    ...
    public final void method70(int i, int i_31_, byte i_32_, int i_33_, int i_34_, int i_35_, int i_36_, byte[] is, DisplayModeManagerContainer42 class304) {
        if (this.aClass304_3896 != class304 || this.aClass68_3895 != Component342.aClass68_1183) throw new RuntimeException();
        if (i_32_ < -4) {
            PixelBuffer pixelbuffer = (this.aClass378_3893.aPixelBuffer9803);
