/* Component54 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component54
/**
 * RENAMED from `Class59_Sub2_Sub1` (JODE-obfuscated).
 * Evidence: subclass of Component185 (hierarchy)
 */ extends Component185 {
    static CacheStore aClass45_8667;
    static int anInt8668;
    static int anInt8669;
    static CacheStore aClass45_8670;
