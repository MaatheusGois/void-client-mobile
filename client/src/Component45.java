/* Component45 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import jaggl.OpenGL;

final class Component45
/**
 * RENAMED from `Class353` (JODE-obfuscated).
 ...
 */ {
    ...
    static NodeCache aClass60_4346 = new NodeCache(4);
    int anInt4347;
    short aShort4348;
    int anInt4349;
    ...
    Component45(int i, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_, boolean bool, boolean bool_42_, int i_43_) {
