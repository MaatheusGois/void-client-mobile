...
final class GnpPositionLogger {
    ...
    static final void decodedOperation855(int i, int i_0_, int i_1_) {
        anInt1520++;
        RSARequest class348_sub42_sub15 = FriendLoginMessage.decodedOperation2516(i_1_, (byte) 105, i);//6
        class348_sub42_sub15.decodedOperation3246(i ^ ~0x6397);
        class348_sub42_sub15.anInt9652 = i_0_;
    }

    static final void decodedOperation856(byte i) {
        Component142.anInt4411 = 0;
        DisplayModeManagerContainer204.anInt1597 = 0;
        anInt1522++;
        OggStreamReader.anInt9041++;
        GpsOverlay.decodedOperation1165(1);
        BuildInfo.decodedOperation204(-724138005);
        DisplayModeManagerContainer292.decodedOperation1318(-65536);
        boolean bool = false;
        for (int i_2_ = 0; i_2_ < Component142.anInt4411; i_2_++) {
            ...
            if (Component364.aBoolean8335 && HashNodeSub1.decodedOperation3169(i_3_, 0)) ShaderProgramSub2.decodedOperation2146((byte) 84);
            if (OggStreamReader.anInt9041 != (npc.anInt10306)) {
                if (npc.definition.decodedOperation793(0)) Component298.decodedOperation181(true, npc);
    ...
    public static void decodedOperation857(int i) {
        anIntArray1521 = null;
        aClass82_1523 = null;
        aClass74_1519 = null;
        if (i < 121) decodedOperation856((byte) -72);
    }
