    ...
    static final void method856(byte i) {
        ...
        for (int i_2_ = 0; i_2_ < Component142.anInt4411; i_2_++) {
            ...
            if (OggStreamReader.anInt9041 != (npc.anInt10306)) {
                if (npc.aClass79_10505.method793(0)) Component298.method181(true, npc);
        ...
        if (DefinitionSub25.anInt9341 != Component80.aClass348_Sub49_Sub2_3813.anInt7197) throw new RuntimeException("gnp1 pos:" + (Component80.aClass348_Sub49_Sub2_3813.anInt7197) + " psize:" + DefinitionSub25.anInt9341);
        if (i <= 47) aClass74_1519 = null;
        for (int i_4_ = 0; Component324.anInt2057 > i_4_; i_4_++) {
            if (Component21.aClass356_3654.method3480(DisplayModeManagerContainer238.anIntArray1233[i_4_], -6008) == null) throw new RuntimeException("gnp2 pos:" + i_4_ + " size:" + Component324.anInt2057);
        }
        ...
        for (int i_5_ = 0; i_5_ < NodeSub32.anInt6930; i_5_++) {
            if (DefinitionSub23.aClass348_Sub22Array9319[i_5_].aNpc_6859.anInt10306 != OggStreamReader.anInt9041) throw new RuntimeException("gnp4 uk:" + (DefinitionSub23.aClass348_Sub22Array9319[i_5_].aNpc_6859.anInt10290));
        }
    }
