 ...
 */ extends Component339 {
    ...
    static final int method1781(int i, int i_1_, int i_2_) {
        ...
        try {
            ...
            Component149.method3511(true, Applet_Sub1.aClass324_20, Component163.aClass143_3179, FriendsIgnoreList.aClass274_3496.method2063(ObjectDeserializer.anInt6967, 544), 2, NodeSub8.aHa6654);
            DisplayModeManagerContainer77 class124 = Component189.method2277(0, aa_Sub3.aClass45_5207, Sprite.anInt6923, -1);
            long l = Component240.method599(-88);
            NodeSub8.aHa6654.la();
            ...
            NodeSub8.aHa6654.DA(dimension.width / 2, dimension.height / 2, 512, 512);
            NodeSub8.aHa6654.xa(1.0F);
            if (i_1_ >= -66) aClass190_5990 = null;
            NodeSub8.aHa6654.ZA(16777215, 0.5F, 0.5F, 20.0F, -50.0F, 30.0F);
            DisplayModeManagerContainer370 class64 = NodeSub8.aHa6654.method3625(class124, 2048, 64, 64, 768);
            int i_3_ = 0;
            while_80_:
            for (int i_4_ = 0; i_4_ < 500; i_4_++) {
                ...
                for (int i_5_ = 15; i_5_ >= 0; i_5_--) {
                    for (int i_6_ = 0; i_6_ <= i_5_; i_6_++) {
                        ...
                        if (Component240.method599(-105) + -l >= (long) i_2_) break while_80_;
                    }
                }
            }
            NodeSub8.aHa6654.method3633();
            long l_7_ = (long) (1000 * i_3_) / (Component240.method599(-86) + -l);
            NodeSub8.aHa6654.GA(0);
            NodeSub8.aHa6654.ya();
            return (int) l_7_;
