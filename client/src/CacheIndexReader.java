 ...
 * Cache index-file reader. Holds two SeekableFile handles (aClass78_1933/aClass78_1938); method1161(byte,int) seeks to a 6-byte index entry (6*i) and reads the header + data block; method1160/method1162 write/read cache sectors.
 */

final class CacheIndexReader {
    static int anInt1931;
    private int anInt1932;
    private SeekableFile aClass78_1933 = null;
    static int anInt1934;
    static int anInt1935;
    static int anInt1936;
    static int anInt1937;
    private SeekableFile aClass78_1938 = null;
    ...
    final byte[] method1161(byte i, int i_2_) {
        ...
        synchronized (aClass78_1933) {
            try {
                ...
                aClass78_1938.method788(0, Component339.aByteArray3144, 6, i + -16713);
                ...
                while (i_3_ > i_5_) {
                    ...
                    aClass78_1933.method788(0, Component339.aByteArray3144, 8 + i_7_, i ^ 0x414f);
        ...
        synchronized (aClass78_1933) {
            try {
                ...
                if (bool) {
                    ...
                    aClass78_1938.method788(0, Component339.aByteArray3144, 6, -16717);
                ...
                aClass78_1938.method783(0, 6, true, Component339.aByteArray3144);
                int i_16_ = 0;
                ...
                while (i_16_ < i_14_) {
                    ...
                    if (bool) {
                        ...
                        try {
                            aClass78_1933.method788(0, Component339.aByteArray3144, 8, -16717);
                    ...
                    aClass78_1933.method783(0, 8, true, Component339.aByteArray3144);
