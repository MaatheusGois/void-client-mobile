/* TeleportHandler - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class361` (JODE-obfuscated).
 * Teleport handler. Processes 'tele ' commands/requests to move the player to a target location.
 */

final class TeleportHandler {
