 ...
 */ extends Component327 implements Interface10 {
    ...
    Component29(ha var_ha, Component44 class51, int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        ...
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("fea.<init>(" + (var_ha != null ? "{...}" : "null") + ',' + (class51 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + bool + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ',' + i_10_ + ')'));
        }
    }
    ...
    final boolean method2391(ha var_ha, int i, int i_11_, int i_12_) {
        ...
        if (!DisplayModeManagerContainer50.aBoolean3870) return class64.method628(i_11_, i, class101, false, 0);
        return class64.method623(i_11_, i, class101, false, 0, Component72.anInt1906);
    }
    ...
    final RenderableSub4 method2386(int i, ha var_ha) {
        ...
        if (aClass30_10051 != null) DisplayModeManagerContainer320.method1935(this.y, this.anInt6382, aClass30_10051, class64, false, this.x);
    ...
    final void method2380(ha var_ha, int i, boolean bool, RenderableObject class318_sub1, int i_14_, byte i_15_, int i_16_) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("fea.N(" + (var_ha != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + (class318_sub1 != null ? "{...}" : "null") + ',' + i_14_ + ',' + i_15_ + ',' + i_16_ + ')'));
        }
    }
