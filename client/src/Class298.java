...
final class Class298 {
    ...
    static final boolean method2252(boolean bool, int i, int i_4_, byte i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        anInt3808++;
        int i_11_ = (Class132.localPlayer.anIntArray10320[0]);
        int i_12_ = (Class132.localPlayer.anIntArray10317[0]);
        ...
        int i_13_ = (Class59_Sub2_Sub2.method574(i, Class132.localPlayer.method2436((byte) 70), i_6_, Class348_Sub40_Sub11.anIntArray9185, bool, (byte) 120, i_9_, i_11_, i_12_, Class348_Sub42_Sub14.anIntArray9626, i_4_, (Class348_Sub45.aClass361Array7108[Class132.localPlayer.plane]), i_8_, i_7_, i_10_));
