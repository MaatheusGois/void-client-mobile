/* Component361 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component361
/**
 * RENAMED from `Class25` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    private NodeCache aClass60_360 = new NodeCache(16);
    static int anInt361;
    static int anInt362;
    static int anInt363;
    static StringCache aClass351_364 = new StringCache(12, 3);
    static int anInt365;
    private CacheStore aClass45_366;
