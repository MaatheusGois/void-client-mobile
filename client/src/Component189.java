...
/**
 * RENAMED from `Class300` (JODE-obfuscated).
 ...
 */ {
    ...
    static final ParticleSystem method2273(byte i) {
        anInt3824++;
    ...
    static final int method2274(String string, int i) {
        ...
        if (i >= -41) return 97;
        for (int i_0_ = 0; (i_0_ < DefinitionSub30.anInt9383); i_0_++) {
            if (string.equalsIgnoreCase(Component178.aStringArray1441[i_0_])) return i_0_;
        }
        return -1;
    }

    final void method2275(Buffer class348_sub49, byte i) {
        anInt3818++;
        for (; ; ) {
    ...
    private final void method2276(int i, Buffer class348_sub49, int i_3_) {
    ...
    static final DisplayModeManagerContainer77 method2277(int i, CacheStore class45, int i_5_, int i_6_) {
