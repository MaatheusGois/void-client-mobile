...
final class Canvas_Sub1 extends Canvas {
    ...
    static final DisplayModeManagerContainer370 getCachedModel(int i, int i_13_, int i_14_, int i_15_, int i_16_, byte i_17_, GraphicsToolkit var_ha) {
        ...
        if (class64 == null) {
            ...
            if (class124.anInt1830 < 13) class124.decodedOperation1092(2, 105);
    ...
    static final void loadAndBuildScene(int i) {
        anInt63++;
        Component156.decodedOperation2193(false, (byte) -125);
        ...
        if (bool) {
            ...
            for (int i_20_ = 0; i_20_ < DisplayModeManagerContainer322.aByteArrayArray4281.length; i_20_++) {
                ...
                if (is != null) {
                    ...
                    bool &= NodeSub41.decodedOperation3154(AbstractShaderSub4.anInt7319, i_21_, (ParametricDefinition.anInt9109), i_22_, is, (byte) 39);
                }
                ...
                if (is != null) {
                    ...
                    bool &= NodeSub41.decodedOperation3154(AbstractShaderSub4.anInt7319, i_23_, (ParametricDefinition.anInt9109), i_24_, is, (byte) 39);
                }
            }
            if (bool) {
                if (Component129.anInt489 != 0) Component149.decodedOperation3511(true, Applet_Sub1.aClass324_20, Component163.aClass143_3179, ((FriendsIgnoreList.aClass274_3495.getLocalized(ObjectDeserializer.languageId, 544)) + "<br>(100%)"), 2, NodeSub8.toolkit);
                Component381.decodedOperation3570(false);
                NodeSub18.decodedOperation2938((byte) 102);
                Component205.decodedOperation1772(i ^ 0x41);
                boolean bool_25_ = false;
                if (NodeSub8.toolkit.method3639() && Component192.preferences.aClass239_Sub18_7259.decodedOperation1800(-32350) == 2) {
                ...
                int i_27_;
                if (Component192.preferences.aClass239_Sub16_7247.decodedOperation1789(-32350) != 1) i_27_ = JaclibLoader.anIntArray168[ColorTagNode.anInt6769];
                ...
                HashNodeSub2.decodedOperation3171(NodeSub8.toolkit, Component25.anInt6012, 9, 4, AbstractShaderSub4.anInt7319, ParametricDefinition.anInt9109, i_27_, bool_25_, NodeSub8.toolkit.method3704() > 0);
                NodeSub32.decodedOperation3018(Component171.anInt10096);
                ...
                for (int i_28_ = 0; i_28_ < 4; i_28_++)
                    NodeSub45.aClass361Array7108[i_28_].decodedOperation3500(i ^ 0x2bc);
                RSACipher.decodedOperation491((byte) -86);
                MatrixSub2.decodedOperation921((byte) 99, false);
                ...
                Component129.decodedOperation354(2);
                ReferenceTable.anInt3720 = Component192.preferences.aClass239_Sub7_7238.decodedOperation1748(-32350);
                HuffmanDecoder.aBoolean3767 = Component127.anInt2964 >= 96;
                Component27.aBoolean4972 = Component192.preferences.aClass239_Sub18_7259.decodedOperation1800(-32350) == 2;
                DisplayModeManagerContainer51.aBoolean2492 = Component192.preferences.aClass239_Sub28_7230.decodedOperation1845(i + -32350) == 1;
                OutputStream_Sub2.anInt101 = Component192.preferences.aClass239_Sub27_7261.decodedOperation1840(-32350) == 1 ? -1 : Component385.anInt2204;
                IOException_Sub1.aBoolean86 = Component192.preferences.aClass239_Sub9_7256.decodedOperation1759(-32350) == 1;
                DisplayModeManagerContainer32.aBoolean845 = Component192.preferences.aClass239_Sub24_7235.decodedOperation1820(i ^ ~0x7e5d) == 1;
                Component103.aClass237_Sub1_4197 = new Component251(4, AbstractShaderSub4.anInt7319, ParametricDefinition.anInt9109, false);
                if (Component37.anInt3931 != 0) Component352.decodedOperation385(false, Component103.aClass237_Sub1_4197, DisplayModeManagerContainer322.aByteArrayArray4281);
                else NodeSub1Sub1.decodedOperation2727((byte) -65, Component103.aClass237_Sub1_4197, (DisplayModeManagerContainer322.aByteArrayArray4281));
                Component83.decodedOperation1015(AbstractShaderSub4.anInt7319 >> 4, (ParametricDefinition.anInt9109 >> 4), true);
                HashNodeSub3.decodedOperation3175((byte) -77);
                if (bool_25_) {
                    ...
                    if (Component37.anInt3931 == 0) {
                        NodeSub1Sub1.decodedOperation2727((byte) -44, (DisplayModeManagerContainer292.aClass237_Sub1_5067), (Component30.aByteArrayArray1887));
                        Component156.decodedOperation2193(true, (byte) -119);
                    } else {
                        Component352.decodedOperation385(false, DisplayModeManagerContainer292.aClass237_Sub1_5067, Component30.aByteArrayArray1887);
                        Component156.decodedOperation2193(true, (byte) -125);
                    }
                    DisplayModeManagerContainer292.aClass237_Sub1_5067.decodedOperation1679(0, 0, (Component103.aClass237_Sub1_4197.anIntArrayArrayArray3122[0]));
                    DisplayModeManagerContainer292.aClass237_Sub1_5067.decodedOperation1685(NodeSub8.toolkit, null, 21407, null);
                    Component315.decodedOperation1879(false);
                }
                Component103.aClass237_Sub1_4197.decodedOperation1685(NodeSub8.toolkit, (!bool_25_ ? null : (DisplayModeManagerContainer292.aClass237_Sub1_5067.anIntArrayArrayArray3122)), 21407, NodeSub45.aClass361Array7108);
                if (Component37.anInt3931 == 0) {
                    Component156.decodedOperation2193(true, (byte) -128);
                    DisplayModeManagerContainer145.decodedOperation1090(WorldNameText.aByteArrayArray8642, i + 65536, Component103.aClass237_Sub1_4197);
                    if (NodeSub50.aByteArrayArray7212 != null) DisplayModeManagerContainer23.decodedOperation859(i ^ ~0x7e);
                } else {
                    Component156.decodedOperation2193(true, (byte) -121);
                    MatrixSub3.decodedOperation944(i + -8212, WorldNameText.aByteArrayArray8642, Component103.aClass237_Sub1_4197);
                }
                NodeSub18.decodedOperation2938((byte) 66);
                if (Component127.anInt2964 < 96) Component201.decodedOperation2271(31268);
                Component156.decodedOperation2193(true, (byte) -119);
                Component103.aClass237_Sub1_4197.decodedOperation1680(null, (byte) -125, (!bool_25_ ? null : (Component9.aSArray4142[0])), NodeSub8.toolkit);
                Component103.aClass237_Sub1_4197.decodedOperation1697(false, NodeSub8.toolkit, -36);
                Component156.decodedOperation2193(true, (byte) -122);
                if (bool_25_) {
                    Component315.decodedOperation1879(true);
                    Component156.decodedOperation2193(true, (byte) -124);
                    if (Component37.anInt3931 != 0) MatrixSub3.decodedOperation944(-8212, (OggUrlStream.aByteArrayArray8996), DisplayModeManagerContainer292.aClass237_Sub1_5067);
                    else DisplayModeManagerContainer145.decodedOperation1090((OggUrlStream.aByteArrayArray8996), i + 65536, DisplayModeManagerContainer292.aClass237_Sub1_5067);
                    NodeSub18.decodedOperation2938((byte) 73);
                    Component156.decodedOperation2193(true, (byte) -121);
                    DisplayModeManagerContainer292.aClass237_Sub1_5067.decodedOperation1680((NodeSub1Sub1.aSArray8801[0]), (byte) -127, null, (NodeSub8.toolkit));
                    DisplayModeManagerContainer292.aClass237_Sub1_5067.decodedOperation1697(true, NodeSub8.toolkit, i + -60);
                    Component156.decodedOperation2193(true, (byte) -126);
                    Component315.decodedOperation1879(false);
                }
                NodeSub50.decodedOperation3419(13022);
                ...
                if (Component192.preferences.aClass239_Sub27_7261.decodedOperation1840(-32350) == 0) DisplayModeManagerContainer26.decodedOperation824(i_29_);
                else DisplayModeManagerContainer26.decodedOperation824(0);
                for (int i_30_ = 0; i_30_ < 4; i_30_++) {
                    for (int i_31_ = 0; AbstractShaderSub4.anInt7319 > i_31_; i_31_++) {
                        for (int i_32_ = 0; ParametricDefinition.anInt9109 > i_32_; i_32_++)
                            DisplayModeManagerContainer351.decodedOperation1479(i_32_, (byte) -126, i_31_, i_30_);
                    }
                }
                DefinitionSub9.decodedOperation3072((byte) -99);
                Component381.decodedOperation3570(false);
                Component126.decodedOperation3514((byte) -105);
                NodeSub18.decodedOperation2938((byte) 62);
                DisplayModeManagerContainer273.decodedOperation1131(99);
                ...
                NodeSub1.decodedOperation2718(-106);
                Component381.decodedOperation3570(false);
