/* Component225 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.awt.*;

final class Component225
/**
 * RENAMED from `Class34` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    static int anInt462;
    static NodeCache aClass60_463 = new NodeCache(8);
    ...
    private final void method344(int i, Buffer class348_sub49, byte i_10_) {
        if (i != 1) {
            if (i == 2) {
    ...
    static final void method349(int i) {
        ...
        for (int i_33_ = 0; i_33_ < i_32_; i_33_++) {
            Player player = InterfaceRenderer.aPlayerArray5058[is[i_33_]];
