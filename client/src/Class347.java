...
final class Class347 {
    ...
    static final void method2708(int i) {
        ...
        if (!Class50_Sub1.aBoolean5221 || !Class127_Sub1.aBoolean8386) {
            ...
            int i_2_ = i_0_ + Class258_Sub4.mouseHandler.getCursorX(true);
            int i_3_ = i_1_ + Class258_Sub4.mouseHandler.getCursorY((byte) 80);
            ...
            if (i == -30206) {
                ...
                if (Class258_Sub4.mouseHandler.isAnyButtonDown(94)) {
                    ...
                    } else if ((Class318_Sub1_Sub5.anInt8770 == 1 || Class318_Sub1_Sub5.method2485(-113)) && Class73.menuEntryCount > 2) Class5_Sub2.method191(true, (ha_Sub3.anInt8001 + Class318_Sub4.anInt6411), (Class219.anInt2872 - -(Class348_Sub40_Sub13.anInt9203)));
