...
final class DummyClass extends Component76 {
    ...
    static final void method3575(byte i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
        if (i_3_ <= PauseTimer.anInt513 && i_2_ >= Component72.anInt1910) {
            ...
            else MenuOpener.method1156(-27, i_0_, DisplayModeManagerContainer167.anIntArrayArray255[i_3_++], i_4_, i_1_);
            if (PauseTimer.anInt513 >= i_2_) MenuOpener.method1156(-27, i_0_, DisplayModeManagerContainer167.anIntArrayArray255[i_2_--], i_4_, i_1_);
    ...
    static final void method3578(byte i, Object object, ReflectionInvoker class297) {
        do {
            try {
                anInt10178++;
                if (class297.anEventQueue3799 != null) {
                    ...
                    for (/**/; i_12_ < 50 && class297.anEventQueue3799.peekEvent() != null; i_12_++)
                        SpriteAtlasShader.method2161((byte) 30, 1L);
                    try {
                ...
                throw NpcDefinition.method2929(runtimeexception, ("fu.F(" + i + ',' + (object != null ? "{...}" : "null") + ',' + (class297 != null ? "{...}" : "null") + ')'));
            }
        } while (false);
    }
    ...
    DummyClass(Component85 class221, DisplayModeManagerContainer196 class341, int i, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_) {
        ...
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("fu.<init>(" + (class221 != null ? "{...}" : "null") + ',' + (class341 != null ? "{...}" : "null") + ',' + i + ',' + i_13_ + ',' + i_14_ + ',' + i_15_ + ',' + i_16_ + ',' + i_17_ + ',' + i_18_ + ',' + i_19_ + ',' + i_20_ + ',' + i_21_ + ',' + i_22_ + ',' + i_23_ + ',' + i_24_ + ',' + i_25_ + ')'));
        }
    }
}
