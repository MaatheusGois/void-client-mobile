/* TransparentWaterShader - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
/**
 * RENAMED from `Class367_Sub6` (JODE-obfuscated).
 * Transparent water shader. Extends AbstractShader; GLSL program implementing the 'transparent_water' effect.
 */

import jagdx.IDirect3DDevice;
import jagdx.IDirect3DVertexShader;

final class TransparentWaterShader extends AbstractShader {
    private static final float[] aFloatArray7338 = new float[16];
    private Component209 aClass269_7339;
    private D3DToolkit aClass378_7340;
    ...
    TransparentWaterShader(D3DToolkit class378, CacheStore class45, Component209 class269) {
        super(class378);
