...
final class Class268 {
    ...
    static final void method2035(int i, int i_4_) {
        anInt3445++;
        int i_5_ = Class367_Sub11.clientCycle - Class348_Sub49_Sub1.anInt9751;
        if (i_5_ >= 100) {
            ...
            Class17.method268(i_6_, -200 + (Class275.method2064((Class132.localPlayer.x), Class355.anInt4372, 11219, (Class132.localPlayer.y))), i_7_, Class192.anInt2578, i, -19360, Class130_Sub1.anInt5799, 3 * (i_6_ >> 3) + 600 << 2);
