...
final class CacheFileStore {
    private final Component253 aClass248_4212;
    private final BigInteger aBigInteger4213;
    static int anInt4214;
    private Buffer aClass348_Sub49_4215;
    private Component219[] aClass314_Sub1Array4216;
    private DisplayModeManagerContainer67 aClass112_4217;
    private final BigInteger aBigInteger4218;
    static int anInt4219;
    private HashNodeSub16Sub1 aClass348_Sub42_Sub16_Sub1_4220;
    ...
    final Component219 method2673(CacheIndexReader class137, int i, CacheIndexReader class137_3_, int i_4_) {
        try {
            anInt4219++;
            if (i_4_ != 255) method2671(-43);
            return method2675((byte) -123, true, i, class137, class137_3_);
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("eb.D(" + (class137 != null ? "{...}" : "null") + ',' + i + ',' + (class137_3_ != null ? "{...}" : "null") + ',' + i_4_ + ')'));
        }
    }
    ...
    final boolean method2674(int i) {
        ...
        aClass314_Sub1Array4216 = new Component219[idxCount];
        return true;
    }

    private final Component219 method2675(byte i, boolean bool, int i_10_, CacheIndexReader class137, CacheIndexReader class137_11_) {
        try {
            anInt4221++;
            ...
            throw NpcDefinition.method2929(runtimeexception, ("eb.E(" + i + ',' + bool + ',' + i_10_ + ',' + (class137 != null ? "{...}" : "null") + ',' + (class137_11_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    CacheFileStore(Component253 class248, DisplayModeManagerContainer67 class112, BigInteger biginteger, BigInteger biginteger_14_) {
        do {
            try {
                ...
                throw NpcDefinition.method2929(runtimeexception, ("eb.<init>(" + (class248 != null ? "{...}" : "null") + ',' + (class112 != null ? "{...}" : "null") + ',' + (biginteger != null ? "{...}" : "null") + ',' + (biginteger_14_ != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
