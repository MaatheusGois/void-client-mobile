...
final class LoadingManager {
    ...
    static final int pulseLoading(int i) {
        if (Component192.preferences.aClass239_Sub11_7265.decodedOperation1768(i + -3690) == 0) {
        ...
        if (LoadingState.aClass56_1023 == RSARequest.currentLoadingState) {
            ...
            ShaderProgramSub7.aClass45_6277 = Component14.decodedOperation3571(false, (ShaderProgramSub7.aBoolean6289 ? 34 : 32), (byte) -23, 1);
            DefinitionSub17Sub1.aClass45_10426 = Component14.decodedOperation3571(false, 33, (byte) -23, 1);
            Component65.aClass45_1627 = Component14.decodedOperation3571(false, 13, (byte) -23, 1);
        }
        if (LoadingState.aClass56_1024 == RSARequest.currentLoadingState) {
            ...
            int i_3_ = Component192.preferences.aClass239_Sub19_7257.decodedOperation1805(i ^ 0x11ae);
            ...
            int[] is = Component134.aClass111_5813.decodedOperation1046(i_3_, 0);
            if (is.length == 0) is = Component134.aClass111_5813.decodedOperation1046(0, 0);
            ...
            if (is.length > 0) {
                ...
                for (int i_4_ = 0; (Component280.anInterface16Array2447.length > i_4_); i_4_++)
                    Component280.anInterface16Array2447[i_4_] = new Component195(Component134.aClass111_5813.decodedOperation1043(is[i_4_], (byte) 102), class106);
            }
        }
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1026) HashNodeSub3.decodedOperation3178(Component65.aClass45_1627, -81, Component364.decodedOperation184(1084489728), ShaderProgramSub7.aClass45_6277);
        if (LoadingState.aClass56_1027 == RSARequest.currentLoadingState) {
            int i_5_ = NodeSub50.decodedOperation3420(0);
            int i_6_ = HashNodeSub16.decodedOperation3256(2);
        ...
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1028) {
            if (Component280.anInterface16Array2447 != null && (Component280.anInterface16Array2447.length > 0)) {
                ...
                if (Component280.anInterface16Array2447.length > 1 && Component134.aClass111_5813.decodedOperation1044(86) && (Component280.anInterface16Array2447[1].method60(i + 9581) < 100)) return 0;
            }
        ...
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1029) {
            for (int i_7_ = 0; i_7_ < 4; i_7_++)
                NodeSub45.aClass361Array7108[i_7_] = SpriteSub1.decodedOperation988(ParametricDefinition.anInt9109, 1, AbstractShaderSub4.anInt7319);
        }
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1030) {
            Component158.aClass45_322 = Component14.decodedOperation3571(false, 8, (byte) -23, 1);
            NodeSub29.aClass45_6909 = Component14.decodedOperation3571(false, 0, (byte) -23, 1);
            DisplayModeManagerContainer51.aClass45_2490 = Component14.decodedOperation3571(false, 1, (byte) -23, 1);
            Component181.aClass45_1541 = Component14.decodedOperation3571(false, 2, (byte) -23, 1);
            NodeSub35.aClass45_6980 = Component14.decodedOperation3571(false, 3, (byte) -23, 1);
            Component30.aClass45_1878 = Component14.decodedOperation3571(false, 4, (byte) -23, 1);
            SoftwareFallbackShader.aClass45_7382 = Component14.decodedOperation3571(true, 5, (byte) -23, 1);
            Component54.aClass45_8667 = Component14.decodedOperation3571(true, 6, (byte) -23, 1);
            ShaderSub3.aClass45_5207 = Component14.decodedOperation3571(false, 7, (byte) -23, 1);
            Component14.aClass45_8589 = Component14.decodedOperation3571(false, 9, (byte) -23, 1);
            Component110.aClass45_233 = Component14.decodedOperation3571(false, 10, (byte) -23, 1);
            DisplayModeManagerContainer64.aClass45_9033 = Component14.decodedOperation3571(false, 11, (byte) -23, 1);
            Component22.aClass45_1743 = Component14.decodedOperation3571(false, 12, (byte) -23, 1);
            Component323.aClass45_5878 = Component14.decodedOperation3571(false, 14, (byte) -23, 1);
            Component132.aClass45_1815 = Component14.decodedOperation3571(false, 15, (byte) -23, 1);
            Component97.aClass45_1538 = Component14.decodedOperation3571(false, 16, (byte) -23, 1);
            VideoAdDisplay.aClass45_3183 = Component14.decodedOperation3571(false, 17, (byte) -23, 1);
            Component43.aClass45_4975 = Component14.decodedOperation3571(false, 18, (byte) -23, 1);
            RadixParser.aClass45_2306 = Component14.decodedOperation3571(false, 19, (byte) -23, 1);
            CacheNodeSub2.aClass45_10480 = Component14.decodedOperation3571(false, 20, (byte) -23, 1);
            SeekableFile.aClass45_1322 = Component14.decodedOperation3571(false, 21, (byte) -23, 1);
            BrowserUrlOpener.aClass45_8926 = Component14.decodedOperation3571(false, 22, (byte) -23, 1);
            NodeSub32.aClass45_6950 = Component14.decodedOperation3571(true, 23, (byte) -23, 1);
            Component387.aClass45_1897 = Component14.decodedOperation3571(false, 24, (byte) -23, 1);
            CommandHandler.aClass45_1434 = Component14.decodedOperation3571(false, 25, (byte) -23, 1);
            NodeSub11.aClass45_4770 = Component14.decodedOperation3571(true, 26, (byte) -23, 1);
            Component339.aClass45_3146 = Component14.decodedOperation3571(false, 27, (byte) -23, 1);
            WaterShaderSub8.aClass45_7362 = Component14.decodedOperation3571(true, 28, (byte) -23, 1);
            NodeList.aClass45_3323 = Component14.decodedOperation3571(false, 29, (byte) -23, 1);
            Component380.aClass45_4984 = Component14.decodedOperation3571(true, 30, (byte) -23, 1);
            Component257.aClass45_4796 = Component14.decodedOperation3571(true, 31, (byte) -23, 1);
            Component334.aClass45_2015 = Component14.decodedOperation3571(true, 36, (byte) -23, 2);
        }
        if (LoadingState.aClass56_1031 == RSARequest.currentLoadingState) {
            ...
            SpriteAtlasShader.decodedOperation2159((byte) -109, Component158.aClass45_322);
            HashNodeSub3.decodedOperation3178(Component65.aClass45_1627, -124, Component364.decodedOperation184(i ^ ~0x40a46ff3), Component158.aClass45_322);
        }
        if (LoadingState.aClass56_1032 == RSARequest.currentLoadingState) {
            ...
            CacheNodeSub1.decodedOperation3290(56);
            Buffer.setClientState(2, 2);
        }
        if (LoadingState.aClass56_1033 == RSARequest.currentLoadingState) ComponentDownloader.decodedOperation323(Component380.aClass45_4984, OggUrlStream.aClass297_8992, (byte) 95);
        if (LoadingState.aClass56_1034 == RSARequest.currentLoadingState) {
            int i_10_ = LibraryCreditsText.decodedOperation1770((byte) -25);
            if (i_10_ < 100) return i_10_;
            Component309.decodedOperation2013(WaterShaderSub8.aClass45_7362.getSingletonFile((byte) 73, 1), (byte) 112);
            RuntimeException_Sub1.decodedOperation4012(WaterShaderSub8.aClass45_7362.getSingletonFile((byte) 73, 3), (byte) -111);
        }
        if (i != -28660) return 2;
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1035) {
            ...
            Component304.decodedOperation699(Component65.aClass45_1627, (byte) -100, NodeSub35.aClass45_6980, Component158.aClass45_322, ShaderSub3.aClass45_5207);
            ...
            Component324.decodedOperation1202(0);
            GradientPreset.aClass263_9195.decodedOperation2008(i + 28539, Component192.preferences.aClass239_Sub27_7261.decodedOperation1840(i + -3690) == 0);
            DisplayModeManagerContainer58.aClass170_10209 = new DisplayModeManagerContainer292();
            Definition.decodedOperation3038(-1);
            RuntimeException_Sub1.decodedOperation4011(i + 29684, Component339.aClass45_3146);
        ...
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1037) {
            int i_11_ = (NpcNode.decodedOperation2958(22388, Component158.aClass45_322) + DisplayModeManagerContainer207.decodedOperation3405(2012104999, true));
            int i_12_ = (Component383.decodedOperation2188(-30477) - -HashNodeSub16.decodedOperation3256(2));
        ...
        if (LoadingState.aClass56_1039 == RSARequest.currentLoadingState) {
            ...
            for (int i_13_ = 0; Component329.aClass259_5995.anInt3305 + 1000 > i_13_; i_13_++) {
                if (Component329.aClass259_5995.decodedOperation1976(i_13_, i ^ ~0x6fc0).anInt2135 == 0) {
        ...
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1040) {
            if (!Component233.decodedOperation2547(DebugPanic.anInt4737, (byte) 84)) return 0;
            boolean bool = true;
        ...
        if (LoadingState.aClass56_1041 == RSARequest.currentLoadingState) CacheNode.decodedOperation3198(true, (byte) -45);
        if (RSARequest.currentLoadingState == LoadingState.aClass56_1042) {
            Component44.aClass311_897.decodedOperation2319((byte) -56);
            try {
            ...
            DisplayModeManagerContainer64.aBoolean9038 = Component192.preferences.aClass239_Sub11_7265.decodedOperation1768(-32350) == 1;
            Component192.preferences.applyPreference((byte) 74, (Component192.preferences.aClass239_Sub11_7265), 1);
            ...
            if (DisplayModeManagerContainer64.aBoolean9038) SoftwareFallbackShader.decodedOperation3553(false, (byte) 108, 0);
            else SoftwareFallbackShader.decodedOperation3553(false, (byte) 102, Component192.preferences.aClass239_Sub25_7251.getPreferenceValue(-32350));
            ...
            LogicError.decodedOperation830(3, 800, (byte) 102, false, 600);
            DisplayModeManagerContainer292.decodedOperation1311(5139, NodeSub8.toolkit);
            Component27.decodedOperation3568(NodeSub8.toolkit, i ^ ~0x6ff7);
        ...
        return DefinitionSub6.decodedOperation3063(false);
    }
