 ...
 */ extends Node {
    ...
    final DisplayModeManagerContainer370 method2803(DisplayModeManagerContainer167 class17, Component101 class154, int i, int i_10_, int i_11_, int i_12_, int i_13_, ha var_ha, boolean bool, int i_14_) {
        try {
            ...
            HashNodeSub17 class348_sub42_sub17_25_ = null;
            if (class17 != null) {
            ...
            if (class64 == null || var_ha.method3667(class64.ua(), i_15_) != 0) {
                ...
                class64 = var_ha.method3625(class124, i_28_, HashNodeSub1.anInt9488, 64, 850);
                if (class154 != null) {
                    for (int i_39_ = 0; i_39_ < 5; i_39_++) {
                        for (int i_40_ = 0; i_40_ < (AbstractShaderSub2.aShortArrayArrayArray7290).length; i_40_++) {
                            if (class154.anIntArray2095[i_39_] < (AbstractShaderSub2.aShortArrayArrayArray7290[i_40_][i_39_]).length) class64.ia((Component257.aShortArrayArray4791[i_40_][i_39_]), (AbstractShaderSub2.aShortArrayArrayArray7290[i_40_][i_39_][(class154.anIntArray2095[i_39_])]));
                        }
                    }
                }
