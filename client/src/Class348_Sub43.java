...
final class Class348_Sub43 extends Class348 {
    ...
    static final void method3298(byte i, boolean bool, Player player) {
        ...
        if (Class73.menuEntryCount < 400) {
            if (Class132.localPlayer == player) {
                if (r.aBoolean9722 && (Class38.anInt500 & 0x10) != 0) {
                    Class32.anInt450++;
                    Class50_Sub3.addMenuEntry(false, (Class28.aString5000 + " -> <col=ffffff>" + Class274.aClass274_3520.method2063(Class348_Sub33.anInt6967, 544)), 0, (byte) -109, false, 0, -1, true, 50, player.anInt10290, Class28.aString5001, 0L, Class348_Sub49_Sub1.anInt9747);
                }
            } else {
                String string;
                if (player.anInt10564 == 0) {
                    boolean bool_0_ = true;
                    if ((Class132.localPlayer.anInt10561) != -1 && player.anInt10561 != -1) {
                        int i_1_ = (Math.max(player.anInt10516, (Class132.localPlayer.anInt10516)));
                        int i_2_ = (Math.min((Class132.localPlayer.anInt10561), player.anInt10561));
                        int i_3_ = 5 - (-(10 * i_1_ / 100) + -i_2_);
                        int i_4_ = (-player.anInt10516 + (Class132.localPlayer.anInt10516));
                        if (i_4_ < 0) i_4_ = -i_4_;
                    ...
                    if (player.anInt10516 >= player.anInt10557)
                        string = (player.method2456(true, 255) + (!bool_0_ ? "<col=ffffff>" : (Class14_Sub4.method250((Class132.localPlayer.anInt10516), true, (player.anInt10516)))) + " (" + string_5_ + player.anInt10516 + ")");
                    else
                        string = (player.method2456(true, 255) + (bool_0_ ? (Class14_Sub4.method250((Class132.localPlayer.anInt10516), true, (player.anInt10516))) : "<col=ffffff>") + " (" + string_5_ + player.anInt10516 + "+" + (-player.anInt10516 + player.anInt10557) + ")");
                ...
                if (r.aBoolean9722 && !bool && (0x8 & Class38.anInt500) != 0) {
                    Class50_Sub3.addMenuEntry(false, Class28.aString5000 + " -> <col=ffffff>" + string, 0, (byte) -109, false, 0, -1, true, 51, player.anInt10290, Class28.aString5001, player.anInt10290, Class348_Sub49_Sub1.anInt9747);
                    Class341.anInt4228++;
                }
                if (i <= 89) anInt7068 = -113;
                if (bool) Class50_Sub3.addMenuEntry(true, "", 0, (byte) -115, false, 0, 0, false, -1, player.anInt10290, "<col=cccccc>" + string, 0L, -1);
                else {
                    for (int i_6_ = 7; i_6_ >= 0; i_6_--) {
                        if (Class318_Sub1_Sub2_Sub1.aStringArray10195[i_6_] != null) {
                            ...
                            if ((Class348_Sub42_Sub8_Sub2.aClass230_10434 != Class10.aClass230_186) || !(Class318_Sub1_Sub2_Sub1.aStringArray10195[i_6_].equalsIgnoreCase(Class274.aClass274_3506.method2063(Class348_Sub33.anInt6967, 544)))) {
                                ...
                                if ((Class132.localPlayer.anInt10516) < (player.anInt10516)) i_7_ = (short) 2000;
                                if ((Class132.localPlayer.anInt10542) != 0 && (player.anInt10542) != 0) {
                                    if ((player.anInt10542) != (Class132.localPlayer.anInt10542)) i_7_ = (short) 0;
                            ...
                            Class50_Sub3.addMenuEntry(false, "<col=ffffff>" + string, 0, (byte) -105, false, 0, -1, true, i_8_, player.anInt10290, (Class318_Sub1_Sub2_Sub1.aStringArray10195[i_6_]), player.anInt10290, i_9_);
                            Canvas_Sub1.anInt69++;
                        }
                    }
                }
                if (!bool) {
                    for (MenuEntry class348_sub42_sub12 = (MenuEntry) Class348_Sub40_Sub4.menuEntries.method1995(4); class348_sub42_sub12 != null; class348_sub42_sub12 = ((MenuEntry) Class348_Sub40_Sub4.menuEntries.method1990((byte) 105))) {
