...
final class ParticleSystem extends Node {
    DisplayModeManagerContainer207 aClass348_Sub49_Sub2_7116;
    ...
    static final boolean method3325(int i, int i_2_, boolean bool) {
        ...
        anInt7121++;
        return (((0x2000 & i) != 0 | ClientErrorReporter.method1241(i_2_, i, -118) | Component175.method1722(i, i_2_, (byte) 94)) & aa_Sub3.method166((byte) 105, i_2_, i));
    }
