/* Component107 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component107
/**
 * RENAMED from `Class343` (JODE-obfuscated).
 ...
 */ {
    ...
    final void method2688(float[] fs, int i, boolean bool) {
        for (int i_0_ = 0; i_0_ < i; i_0_++)
            fs[i_0_] = 0.0F;
        if (!bool) {
            int i_1_ = (NodeSub10.aClass370Array6718[anInt4261].anInt4514);
                ...
                while (i_5_ < i_3_) {
                    ...
                    for (int i_8_ = 0; i_8_ < i_1_; i_8_++) {
                        ...
                        if (i_10_ >= 0) {
                            ...
                            Component367 class370 = NodeSub10.aClass370Array6718[i_10_];
                            if (anInt4257 == 0) {
