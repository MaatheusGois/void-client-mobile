/* WaterShader - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class367_Sub9` (JODE-obfuscated).
 * Water shader. Extends AbstractShader; GLSL program for the environment-mapped water effect (environment_mapped_water_v / environment_mapped_water_f stages).
 */

import jaggl.OpenGL;

final class WaterShader extends AbstractShader {
    static int anInt7366;
    static Component183 aClass114_7367 = new Component183(37, 7);
    static int anInt7368;
    private Component84 aClass89_7369;
    static int anInt7370;
    static CacheStore aClass45_7371;
    static int anInt7372;
    private boolean aBoolean7373;
    static int anInt7374;
    private Component209 aClass269_7375;
    ...
    WaterShader(GlExtensionManager class377, CacheStore class45, Component209 class269) {
        super(class377);
        try {
            aClass269_7375 = class269;
            if (class45 != null && class377.aBoolean9921 && class377.aBoolean9922) {
                DisplayModeManagerContainer271 class39 = (ShaderCompiler.method2608(class377, class45.method391("gl", "environment_mapped_water_v", -29832), -108, 35633));
                DisplayModeManagerContainer271 class39_13_ = (ShaderCompiler.method2608(class377, class45.method391("gl", "environment_mapped_water_f", -29832), -122, 35632));
