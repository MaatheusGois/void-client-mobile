/* Component230 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component230
/**
 * RENAMED from `Class50_Sub4` (JODE-obfuscated).
 ...
 */ extends Component47 {
    ...
    static DisplayModeManagerContainer32 aClass47_5262;
    ...
    Component230(int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_) {
        super(-1, i_13_, i_14_);
        anInt5258 = i_12_;
        anInt5264 = i_11_;
        anInt5255 = i;
