/* DisplayModeManagerContainer164 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer164
/**
 * RENAMED from `Class64_Sub1` (JODE-obfuscated).
 ...
 */ extends DisplayModeManagerContainer370 {
    ...
    private int[] vertexZ;
    private Component242[] aClass360Array5313;
    ...
    private DisplayModeManagerContainer164 aClass64_Sub1_5319;
    private MatrixSub1 aClass101_Sub1_5320;
    ...
    private DisplayModeManagerContainer164 aClass64_Sub1_5328;
    ...
    private DisplayModeManagerContainer173[] aClass342Array5335;
    private Component385 aClass167_5336;
    private int[] anIntArray5337;
    private int anInt5338;
    private DisplayModeManagerContainer164 aClass64_Sub1_5339;
    ...
    private DisplayModeManagerContainer164 aClass64_Sub1_5347;
    ...
    private Component242[] aClass360Array5360;
    private BuildInfo[] aClass6Array5361;
    private int[] anIntArray5362;
    private Component360[] aClass350Array5363;
    private short[] aShortArray5364;
    private short aShort5365;
    private int[] anIntArray5366;
    private Component385 aClass167_5367;
    ...
    private DisplayModeManagerContainer164 aClass64_Sub1_5374;
    private int anInt5375;
    private DisplayModeManagerContainer164 aClass64_Sub1_5376;
    private int[] anIntArray5377;
    private DisplayModeManagerContainer164 aClass64_Sub1_5378;
    private int[][] anIntArrayArray5379;
    private boolean aBoolean5380;
    private int[] anIntArray5381;
    private boolean aBoolean5382;
    private Component8 aClass109_5383;
    private int[] anIntArray5384;
    private Component106[] aClass41Array5385;
    private byte[] aByteArray5386;
    private int anInt5387;
    private short[] aShortArray5388;
    private int anInt5389;
    private DisplayModeManagerContainer164 aClass64_Sub1_5390;
    ...
    private DisplayModeManagerContainer164 aClass64_Sub1_5396;
    private DisplayModeManagerContainer164 aClass64_Sub1_5397;
    ...
    private final DisplayModeManagerContainer370 copyTo(DisplayModeManagerContainer164 class64_sub1_7_, DisplayModeManagerContainer164 class64_sub1_8_, int i, boolean bool, boolean bool_9_) {
        ...
        if (bool_11_ || bool_12_ || bool_13_) {
            if (bool_11_) {
                if (class64_sub1_8_.vertexX == null || class64_sub1_8_.vertexX.length < anInt5340) class64_sub1_7_.vertexX = class64_sub1_8_.vertexX = new int[anInt5340];
                else class64_sub1_7_.vertexX = class64_sub1_8_.vertexX;
                for (int i_14_ = 0; i_14_ < anInt5340; i_14_++)
                    class64_sub1_7_.vertexX[i_14_] = vertexX[i_14_];
            } else class64_sub1_7_.vertexX = vertexX;
            if (bool_12_) {
                if (class64_sub1_8_.vertexY == null || class64_sub1_8_.vertexY.length < anInt5340) class64_sub1_7_.vertexY = class64_sub1_8_.vertexY = new int[anInt5340];
                else class64_sub1_7_.vertexY = class64_sub1_8_.vertexY;
                for (int i_15_ = 0; i_15_ < anInt5340; i_15_++)
                    class64_sub1_7_.vertexY[i_15_] = vertexY[i_15_];
            } else class64_sub1_7_.vertexY = vertexY;
            if (bool_13_) {
                if (class64_sub1_8_.vertexZ == null || class64_sub1_8_.vertexZ.length < anInt5340) class64_sub1_7_.vertexZ = class64_sub1_8_.vertexZ = new int[anInt5340];
                else class64_sub1_7_.vertexZ = class64_sub1_8_.vertexZ;
                for (int i_16_ = 0; i_16_ < anInt5340; i_16_++)
                    class64_sub1_7_.vertexZ[i_16_] = vertexZ[i_16_];
            } else class64_sub1_7_.vertexZ = vertexZ;
        } else {
            class64_sub1_7_.vertexX = vertexX;
            class64_sub1_7_.vertexY = vertexY;
            class64_sub1_7_.vertexZ = vertexZ;
        }
        if ((i & 0x84080) != 0) {
        ...
        if ((i & 0x8) != 0 || (i & 0x10) != 0) {
            if (class64_sub1_8_.aClass360Array5360 == null || class64_sub1_8_.aClass360Array5360.length < anInt5387) {
                int i_24_ = anInt5387;
                class64_sub1_7_.aClass360Array5360 = class64_sub1_8_.aClass360Array5360 = new Component242[i_24_];
            ...
            if (aClass360Array5360 != null) {
                for (int i_25_ = 0; i_25_ < anInt5387; i_25_++)
                    class64_sub1_7_.aClass360Array5360[i_25_] = new Component242(aClass360Array5360[i_25_]);
            ...
            if (aClass41Array5385 != null) {
                if (class64_sub1_8_.aClass41Array5385 == null || class64_sub1_8_.aClass41Array5385.length < anInt5351) {
                    int i_26_ = anInt5351;
                    class64_sub1_7_.aClass41Array5385 = class64_sub1_8_.aClass41Array5385 = new Component106[i_26_];
        ...
        class64_sub1_7_.faceVertexIndices = faceVertexIndices;
    ...
    final void method605(int i, int[] is, int i_44_, int i_45_, int i_46_, int i_47_, boolean bool) {
        ...
        if (i == 0) {
            ...
            for (int i_51_ = 0; i_51_ < i_48_; i_51_++) {
                int i_52_ = is[i_51_];
                if (i_52_ < faceVertexIndices.length) {
                    int[] is_53_ = faceVertexIndices[i_52_];
            ...
            for (int i_57_ = 0; i_57_ < i_48_; i_57_++) {
                int i_58_ = is[i_57_];
                if (i_58_ < faceVertexIndices.length) {
                    int[] is_59_ = faceVertexIndices[i_58_];
            ...
            for (int i_62_ = 0; i_62_ < i_48_; i_62_++) {
                int i_63_ = is[i_62_];
                if (i_63_ < faceVertexIndices.length) {
                    int[] is_64_ = faceVertexIndices[i_63_];
                    if ((i_47_ & 0x1) == 0) {
                        for (int i_65_ = 0; i_65_ < is_64_.length; i_65_++) {
                            ...
                            if (i_46_ != 0) {
                                int i_67_ = DisplayModeManagerContainer88.anIntArray1207[i_46_];
                                int i_68_ = DisplayModeManagerContainer88.anIntArray1204[i_46_];
                                int i_69_ = ((vertexY[i_66_] * i_67_ + vertexX[i_66_] * i_68_ + 16383) >> 14);
                                vertexY[i_66_] = (vertexY[i_66_] * i_68_ - vertexX[i_66_] * i_67_ + 16383) >> 14;
                                vertexX[i_66_] = i_69_;
                            }
                            if (i_44_ != 0) {
                                int i_70_ = DisplayModeManagerContainer88.anIntArray1207[i_44_];
                                int i_71_ = DisplayModeManagerContainer88.anIntArray1204[i_44_];
                                int i_72_ = ((vertexY[i_66_] * i_71_ - vertexZ[i_66_] * i_70_ + 16383) >> 14);
                                vertexZ[i_66_] = (vertexY[i_66_] * i_70_ + vertexZ[i_66_] * i_71_ + 16383) >> 14;
                                vertexY[i_66_] = i_72_;
                            }
                            if (i_45_ != 0) {
                                int i_73_ = DisplayModeManagerContainer88.anIntArray1207[i_45_];
                                int i_74_ = DisplayModeManagerContainer88.anIntArray1204[i_45_];
                        ...
                        for (int i_76_ = 0; i_76_ < is_64_.length; i_76_++) {
                            ...
                            if (i_44_ != 0) {
                                int i_78_ = DisplayModeManagerContainer88.anIntArray1207[i_44_];
                                int i_79_ = DisplayModeManagerContainer88.anIntArray1204[i_44_];
                                int i_80_ = ((vertexY[i_77_] * i_79_ - vertexZ[i_77_] * i_78_ + 16383) >> 14);
                                vertexZ[i_77_] = (vertexY[i_77_] * i_78_ + vertexZ[i_77_] * i_79_ + 16383) >> 14;
                                vertexY[i_77_] = i_80_;
                            }
                            if (i_46_ != 0) {
                                int i_81_ = DisplayModeManagerContainer88.anIntArray1207[i_46_];
                                int i_82_ = DisplayModeManagerContainer88.anIntArray1204[i_46_];
                                int i_83_ = ((vertexY[i_77_] * i_81_ + vertexX[i_77_] * i_82_ + 16383) >> 14);
                                vertexY[i_77_] = (vertexY[i_77_] * i_82_ - vertexX[i_77_] * i_81_ + 16383) >> 14;
                                vertexX[i_77_] = i_83_;
                            }
                            if (i_45_ != 0) {
                                int i_84_ = DisplayModeManagerContainer88.anIntArray1207[i_45_];
                                int i_85_ = DisplayModeManagerContainer88.anIntArray1204[i_45_];
            ...
            for (int i_87_ = 0; i_87_ < i_48_; i_87_++) {
                int i_88_ = is[i_87_];
                if (i_88_ < faceVertexIndices.length) {
                    int[] is_89_ = faceVertexIndices[i_88_];
            ...
            if (anIntArrayArray5330 != null && aByteArray5325 != null) {
                ...
                if (aClass6Array5361 != null) {
                    for (int i_98_ = 0; i_98_ < anInt5389; i_98_++) {
                        BuildInfo class6 = aClass6Array5361[i_98_];
                        Component360 class350 = aClass350Array5363[i_98_];
                ...
                for (int i_109_ = 0; i_109_ < i_48_; i_109_++) {
                    ...
                    if (i_110_ < anIntArrayArray5379.length) {
                        ...
                        for (int i_112_ = 0; i_112_ < is_111_.length; i_112_++) {
                            Component360 class350 = aClass350Array5363[is_111_[i_112_]];
                ...
                for (int i_113_ = 0; i_113_ < i_48_; i_113_++) {
                    ...
                    if (i_114_ < anIntArrayArray5379.length) {
                        ...
                        for (int i_116_ = 0; i_116_ < is_115_.length; i_116_++) {
                            Component360 class350 = aClass350Array5363[is_115_[i_116_]];
            ...
            for (int i_117_ = 0; i_117_ < i_48_; i_117_++) {
                ...
                if (i_118_ < anIntArrayArray5379.length) {
                    ...
                    for (int i_120_ = 0; i_120_ < is_119_.length; i_120_++) {
                        Component360 class350 = aClass350Array5363[is_119_[i_120_]];
    ...
    final void FA(int i) {
        ...
        int i_121_ = DisplayModeManagerContainer88.anIntArray1207[i];
        int i_122_ = DisplayModeManagerContainer88.anIntArray1204[i];
        synchronized (this) {
    ...
    final void I(int i, int[] is, int i_125_, int i_126_, int i_127_, boolean bool, int i_128_, int[] is_129_) {
        ...
        if (i == 0) {
            ...
            for (int i_133_ = 0; i_133_ < i_130_; i_133_++) {
                ...
                if (i_134_ < faceVertexIndices.length) {
                    int[] is_135_ = faceVertexIndices[i_134_];
            ...
            for (int i_142_ = 0; i_142_ < i_130_; i_142_++) {
                ...
                if (i_143_ < faceVertexIndices.length) {
                    int[] is_144_ = faceVertexIndices[i_143_];
            ...
            if (is_129_ == null) {
                for (int i_196_ = 0; i_196_ < i_130_; i_196_++) {
                    ...
                    if (i_197_ < faceVertexIndices.length) {
                        int[] is_198_ = faceVertexIndices[i_197_];
                        for (int i_199_ = 0; i_199_ < is_198_.length; i_199_++) {
                            ...
                            if (aShortArray5333 == null || (i_128_ & aShortArray5333[i_200_]) != 0) {
                                ...
                                if (i_127_ != 0) {
                                    int i_201_ = DisplayModeManagerContainer88.anIntArray1207[i_127_];
                                    int i_202_ = DisplayModeManagerContainer88.anIntArray1204[i_127_];
                                ...
                                if (i_125_ != 0) {
                                    int i_204_ = DisplayModeManagerContainer88.anIntArray1207[i_125_];
                                    int i_205_ = DisplayModeManagerContainer88.anIntArray1204[i_125_];
                                ...
                                if (i_126_ != 0) {
                                    int i_207_ = DisplayModeManagerContainer88.anIntArray1207[i_126_];
                                    int i_208_ = DisplayModeManagerContainer88.anIntArray1204[i_126_];
                ...
                int i_158_ = DisplayModeManagerContainer88.anIntArray1204[i_125_];
                int i_159_ = DisplayModeManagerContainer88.anIntArray1207[i_125_];
                int i_160_ = DisplayModeManagerContainer88.anIntArray1204[i_126_];
                int i_161_ = DisplayModeManagerContainer88.anIntArray1207[i_126_];
                int i_162_ = DisplayModeManagerContainer88.anIntArray1204[i_127_];
                int i_163_ = DisplayModeManagerContainer88.anIntArray1207[i_127_];
                ...
                for (int i_188_ = 0; i_188_ < i_130_; i_188_++) {
                    ...
                    if (i_189_ < faceVertexIndices.length) {
                        int[] is_190_ = faceVertexIndices[i_189_];
            ...
            if (is_129_ == null) {
                for (int i_249_ = 0; i_249_ < i_130_; i_249_++) {
                    ...
                    if (i_250_ < faceVertexIndices.length) {
                        int[] is_251_ = faceVertexIndices[i_250_];
                ...
                for (int i_241_ = 0; i_241_ < i_130_; i_241_++) {
                    ...
                    if (i_242_ < faceVertexIndices.length) {
                        int[] is_243_ = faceVertexIndices[i_242_];
            ...
            if (anIntArrayArray5330 != null && aByteArray5325 != null) {
                ...
                if (aClass6Array5361 != null) {
                    for (int i_260_ = 0; i_260_ < anInt5389; i_260_++) {
                        BuildInfo class6 = aClass6Array5361[i_260_];
                        Component360 class350 = aClass350Array5363[i_260_];
                        class350.anInt4313 = (class350.anInt4313 & 0xffffff | (255 - (aByteArray5325[class6.anInt144] & 0xff)) << 24);
                    }
                }
            }
                ...
                for (int i_271_ = 0; i_271_ < i_130_; i_271_++) {
                    ...
                    if (i_272_ < anIntArrayArray5379.length) {
                        ...
                        for (int i_274_ = 0; i_274_ < is_273_.length; i_274_++) {
                            Component360 class350 = aClass350Array5363[is_273_[i_274_]];
                ...
                for (int i_275_ = 0; i_275_ < i_130_; i_275_++) {
                    ...
                    if (i_276_ < anIntArrayArray5379.length) {
                        ...
                        for (int i_278_ = 0; i_278_ < is_277_.length; i_278_++) {
                            Component360 class350 = aClass350Array5363[is_277_[i_278_]];
            ...
            for (int i_279_ = 0; i_279_ < i_130_; i_279_++) {
                ...
                if (i_280_ < anIntArrayArray5379.length) {
                    ...
                    for (int i_282_ = 0; i_282_ < is_281_.length; i_282_++) {
                        Component360 class350 = aClass350Array5363[is_281_[i_282_]];
    ...
    final void transformVertices(DisplayModeManagerContainer204 class101) {
        MatrixSub1 class101_sub1 = (MatrixSub1) class101;
        if (aClass129Array5322 != null) {
            for (int i = 0; i < aClass129Array5322.length; i++) {
                Component30 class129 = aClass129Array5322[i];
                Component30 class129_285_ = class129;
                if (class129.aClass129_1888 != null) class129_285_ = class129.aClass129_1888;
                class129_285_.anInt1882 = (int) (class101_sub1.aFloat5686 + ((class101_sub1.aFloat5672 * (float) (vertexX[class129.anInt1881])) + (class101_sub1.aFloat5673 * (float) (vertexY[(class129.anInt1881)])) + (class101_sub1.aFloat5669 * (float) (vertexZ[(class129.anInt1881)]))));
                class129_285_.anInt1891 = (int) (class101_sub1.aFloat5685 + ((class101_sub1.aFloat5655 * (float) (vertexX[class129.anInt1881])) + (class101_sub1.aFloat5678 * (float) (vertexY[(class129.anInt1881)])) + (class101_sub1.aFloat5666 * (float) (vertexZ[(class129.anInt1881)]))));
                class129_285_.anInt1889 = (int) (class101_sub1.aFloat5681 + ((class101_sub1.aFloat5662 * (float) (vertexX[class129.anInt1881])) + (class101_sub1.aFloat5680 * (float) (vertexY[(class129.anInt1881)])) + (class101_sub1.aFloat5664 * (float) (vertexZ[(class129.anInt1881)]))));
                class129_285_.anInt1883 = (int) (class101_sub1.aFloat5686 + ((class101_sub1.aFloat5672 * (float) (vertexX[class129.anInt1877])) + (class101_sub1.aFloat5673 * (float) (vertexY[(class129.anInt1877)])) + (class101_sub1.aFloat5669 * (float) (vertexZ[(class129.anInt1877)]))));
                class129_285_.anInt1890 = (int) (class101_sub1.aFloat5685 + ((class101_sub1.aFloat5655 * (float) (vertexX[class129.anInt1877])) + (class101_sub1.aFloat5678 * (float) (vertexY[(class129.anInt1877)])) + (class101_sub1.aFloat5666 * (float) (vertexZ[(class129.anInt1877)]))));
                class129_285_.anInt1880 = (int) (class101_sub1.aFloat5681 + ((class101_sub1.aFloat5662 * (float) (vertexX[class129.anInt1877])) + (class101_sub1.aFloat5680 * (float) (vertexY[(class129.anInt1877)])) + (class101_sub1.aFloat5664 * (float) (vertexZ[(class129.anInt1877)]))));
                class129_285_.anInt1876 = (int) (class101_sub1.aFloat5686 + ((class101_sub1.aFloat5672 * (float) (vertexX[class129.anInt1892])) + (class101_sub1.aFloat5673 * (float) (vertexY[(class129.anInt1892)])) + (class101_sub1.aFloat5669 * (float) (vertexZ[(class129.anInt1892)]))));
                class129_285_.anInt1874 = (int) (class101_sub1.aFloat5685 + ((class101_sub1.aFloat5655 * (float) (vertexX[class129.anInt1892])) + (class101_sub1.aFloat5678 * (float) (vertexY[(class129.anInt1892)])) + (class101_sub1.aFloat5666 * (float) (vertexZ[(class129.anInt1892)]))));
                class129_285_.anInt1884 = (int) (class101_sub1.aFloat5681 + ((class101_sub1.aFloat5662 * (float) (vertexX[class129.anInt1892])) + (class101_sub1.aFloat5680 * (float) (vertexY[(class129.anInt1892)])) + (class101_sub1.aFloat5664 * (float) (vertexZ[(class129.anInt1892)]))));
            }
        }
        if (aClass342Array5335 != null) {
            for (int i = 0; i < aClass342Array5335.length; i++) {
                DisplayModeManagerContainer173 class342 = aClass342Array5335[i];
                DisplayModeManagerContainer173 class342_286_ = class342;
                ...
                class342_286_.anInt4238 = (int) (class101_sub1.aFloat5686 + ((class101_sub1.aFloat5672 * (float) (vertexX[class342.anInt4244])) + (class101_sub1.aFloat5673 * (float) (vertexY[(class342.anInt4244)])) + (class101_sub1.aFloat5669 * (float) (vertexZ[(class342.anInt4244)]))));
                class342_286_.anInt4239 = (int) (class101_sub1.aFloat5685 + ((class101_sub1.aFloat5655 * (float) (vertexX[class342.anInt4244])) + (class101_sub1.aFloat5678 * (float) (vertexY[(class342.anInt4244)])) + (class101_sub1.aFloat5666 * (float) (vertexZ[(class342.anInt4244)]))));
                class342_286_.anInt4240 = (int) (class101_sub1.aFloat5681 + ((class101_sub1.aFloat5662 * (float) (vertexX[class342.anInt4244])) + (class101_sub1.aFloat5680 * (float) (vertexY[(class342.anInt4244)])) + (class101_sub1.aFloat5664 * (float) (vertexZ[(class342.anInt4244)]))));
            }
        }
    }
    ...
    final boolean NA() {
        if (faceVertexIndices == null) return false;
        anInt5338 = 0;
        anInt5375 = 0;
        anInt5342 = 0;
        return true;
    ...
    final void P(int i, int i_338_, int i_339_, int i_340_) {
        if (i == 0) {
            ...
            for (int i_344_ = 0; i_344_ < anInt5340; i_344_++) {
                ...
                if (i_340_ != 0) {
                    int i_345_ = DisplayModeManagerContainer88.anIntArray1207[i_340_];
                    int i_346_ = DisplayModeManagerContainer88.anIntArray1204[i_340_];
                ...
                if (i_338_ != 0) {
                    int i_348_ = DisplayModeManagerContainer88.anIntArray1207[i_338_];
                    int i_349_ = DisplayModeManagerContainer88.anIntArray1204[i_338_];
                ...
                if (i_339_ != 0) {
                    int i_351_ = DisplayModeManagerContainer88.anIntArray1207[i_339_];
                    int i_352_ = DisplayModeManagerContainer88.anIntArray1204[i_339_];
            ...
            if (aClass6Array5361 != null) {
                for (int i_357_ = 0; i_357_ < anInt5389; i_357_++) {
                    BuildInfo class6 = aClass6Array5361[i_357_];
                    Component360 class350 = aClass350Array5363[i_357_];
                    class350.anInt4313 = (class350.anInt4313 & 0xffffff | 255 - (aByteArray5325[class6.anInt144] & 0xff) << 24);
                }
            }
        } else if (i == 7) {
            ...
            for (int i_364_ = 0; i_364_ < anInt5389; i_364_++) {
                Component360 class350 = aClass350Array5363[i_364_];
                class350.anInt4316 += i_338_;
                class350.anInt4317 += i_339_;
            }
        } else if (i == 10) {
            for (int i_365_ = 0; i_365_ < anInt5389; i_365_++) {
                Component360 class350 = aClass350Array5363[i_365_];
            ...
            for (int i_366_ = 0; i_366_ < anInt5389; i_366_++) {
                Component360 class350 = aClass350Array5363[i_366_];
    ...
    final void VA(int i) {
        ...
        int i_574_ = DisplayModeManagerContainer88.anIntArray1207[i];
        int i_575_ = DisplayModeManagerContainer88.anIntArray1204[i];
        synchronized (this) {
    ...
    final void method613(DisplayModeManagerContainer370 class64, int i, int i_584_, int i_585_, boolean bool) {
        ...
        for (int i_589_ = 0; i_589_ < anInt5387; i_589_++) {
            Component242 class360 = aClass360Array5360[i_589_];
                    ...
                    if (i_591_ >= class64_sub1_586_.aShort5395 && i_591_ <= class64_sub1_586_.aShort5393) {
                        ...
                        if (i_592_ >= class64_sub1_586_.aShort5352 && i_592_ <= class64_sub1_586_.aShort5331) {
                            for (int i_593_ = 0; i_593_ < i_588_; i_593_++) {
                                Component242 class360_594_ = (class64_sub1_586_.aClass360Array5360[i_593_]);
                                if (i_591_ == is[i_593_] && i_592_ == (class64_sub1_586_.vertexZ[i_593_]) && i_590_ == (class64_sub1_586_.vertexY[i_593_]) && (class360_594_.anInt4429 != 0)) {
                                    if (aClass360Array5313 == null) aClass360Array5313 = new Component242[anInt5387];
                                    if (class64_sub1_586_.aClass360Array5313 == null) class64_sub1_586_.aClass360Array5313 = new Component242[i_588_];
                                    Component242 class360_595_ = aClass360Array5313[i_589_];
                                    if (class360_595_ == null) class360_595_ = aClass360Array5313[i_589_] = new Component242(class360);
                                    Component242 class360_596_ = (class64_sub1_586_.aClass360Array5313[i_593_]);
                                    if (class360_596_ == null) class360_596_ = class64_sub1_586_.aClass360Array5313[i_593_] = new Component242(class360_594_);
    ...
    private final void buildScene() {
        ...
        for (int i = 0; i < anInt5351; i++) {
            ...
            if (i_612_ == 0) {
                Component242 class360 = aClass360Array5360[i_599_];
                ...
                if (aClass41Array5385 == null) aClass41Array5385 = new Component106[anInt5351];
                Component106 class41 = aClass41Array5385[i] = new Component106();
    ...
    private final void method654(DisplayModeManagerContainer204 class101, RenderableSub3 class318_sub3, int i, int i_632_) {
        if (anInt5387 >= 1) {
            aClass101_Sub1_5320 = (MatrixSub1) class101;
            MatrixSub1 class101_sub1 = aHa_Sub1_5353.aClass101_Sub1_7492;
            if (!aBoolean5323) computeBoundingBox();
                ...
                if (i == -1) {
                    ...
                    if (aClass6Array5361 != null) {
                        for (int i_669_ = 0; i_669_ < anInt5389; i_669_++) {
                            BuildInfo class6 = aClass6Array5361[i_669_];
                            Component360 class350 = aClass350Array5363[i_669_];
                    ...
                    if (aClass6Array5361 != null) {
                        for (int i_686_ = 0; i_686_ < anInt5389; i_686_++) {
                            BuildInfo class6 = aClass6Array5361[i_686_];
                            Component360 class350 = aClass350Array5363[i_686_];
    ...
    private final void applyFaceTransform(int i) {
        if (aClass167_5367.aBoolean2195) {
            ...
            if (aShortArray5388 == null || aShortArray5388[i] == -1) {
                if (anIntArray5366[i] == -1)
                    aClass109_5383.method1027((float) anIntArray5343[i_777_], (float) anIntArray5343[i_778_], (float) anIntArray5343[i_779_], (float) anIntArray5321[i_777_], (float) anIntArray5321[i_778_], (float) anIntArray5321[i_779_], (float) anIntArray5355[i_777_], (float) anIntArray5355[i_778_], (float) anIntArray5355[i_779_], BuildInfo.blendArgb((Component380.anIntArray4983[anIntArray5368[i] & 0xffff]), (i_780_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[anIntArray5368[i] & 0xffff]), (i_781_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[anIntArray5368[i] & 0xffff]), (i_782_ << 24 | (aClass167_5367.anInt2192)), 255));
                else
                    aClass109_5383.method1027((float) anIntArray5343[i_777_], (float) anIntArray5343[i_778_], (float) anIntArray5343[i_779_], (float) anIntArray5321[i_777_], (float) anIntArray5321[i_778_], (float) anIntArray5321[i_779_], (float) anIntArray5355[i_777_], (float) anIntArray5355[i_778_], (float) anIntArray5355[i_779_], BuildInfo.blendArgb((Component380.anIntArray4983[anIntArray5368[i] & 0xffff]), (i_780_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[anIntArray5337[i] & 0xffff]), (i_781_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[anIntArray5366[i] & 0xffff]), (i_782_ << 24 | (aClass167_5367.anInt2192)), 255));
            } else {
                int i_783_ = -16777216;
            ...
            if (i_774_ != 765) {
                if (i_774_ == 0) drawFace(i);
                    ...
                    if (aShortArray5388 == null || aShortArray5388[i] == -1) {
                        if (anIntArray5366[i] == -1)
                            aClass109_5383.method1027((float) anIntArray5343[i_768_], (float) anIntArray5343[i_769_], (float) anIntArray5343[i_770_], (float) anIntArray5321[i_768_], (float) anIntArray5321[i_769_], (float) anIntArray5321[i_770_], (float) anIntArray5355[i_768_], (float) anIntArray5355[i_769_], (float) anIntArray5355[i_770_], BuildInfo.blendArgb((Component380.anIntArray4983[(anIntArray5368[i] & 0xffff)]), (i_771_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[(anIntArray5368[i] & 0xffff)]), (i_772_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[(anIntArray5368[i] & 0xffff)]), (i_773_ << 24 | (aClass167_5367.anInt2192)), 255));
                        else
                            aClass109_5383.method1027((float) anIntArray5343[i_768_], (float) anIntArray5343[i_769_], (float) anIntArray5343[i_770_], (float) anIntArray5321[i_768_], (float) anIntArray5321[i_769_], (float) anIntArray5321[i_770_], (float) anIntArray5355[i_768_], (float) anIntArray5355[i_769_], (float) anIntArray5355[i_770_], BuildInfo.blendArgb((Component380.anIntArray4983[(anIntArray5368[i] & 0xffff)]), (i_771_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[(anIntArray5337[i] & 0xffff)]), (i_772_ << 24 | (aClass167_5367.anInt2192)), 255), BuildInfo.blendArgb((Component380.anIntArray4983[(anIntArray5366[i] & 0xffff)]), (i_773_ << 24 | (aClass167_5367.anInt2192)), 255));
                    } else {
                        int i_775_ = -16777216;
    ...
    DisplayModeManagerContainer164(GlToolkitSub1 var_ha_Sub1, DisplayModeManagerContainer77 class124, int i, int i_785_, int i_786_, int i_787_) {
        ...
        if (class124.aClass162Array1832 != null) {
            ...
            for (int i_800_ = 0; i_800_ < class124.aClass162Array1832.length; i_800_++) {
                ...
                aClass350Array5363[i_800_] = new Component360(i_801_);
            }
        }
                ...
                if (i_805_ == -1) {
                    ...
                    if (i_810_ == 0) {
                        ...
                        if (i_810_ == 1) {
                            ...
                            fs_807_[0] = fs[0];
                            fs_808_[0] = fs[1];
                            NodeList.method1991(f_852_, f, fs_847_, vertexZ[i_842_], i_846_, false, i_848_, i_844_, vertexX[i_842_], vertexY[i_842_], f_851_, fs, i_845_, i_868_);
                            fs_807_[1] = fs[0];
                            fs_808_[1] = fs[1];
                            NodeList.method1991(f_852_, f, fs_847_, vertexZ[i_843_], i_846_, false, i_848_, i_844_, vertexX[i_843_], vertexY[i_843_], f_851_, fs, i_845_, i_868_);
                            fs_807_[2] = fs[0];
                            fs_808_[2] = fs[1];
                        } else if (i_810_ == 3) {
