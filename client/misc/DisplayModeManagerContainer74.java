 ...
 */ implements Interface7 {
    ...
    public final int method31(int i) {
        int i_9_ = 88 % ((-43 - i) / 62);
        anInt4821++;
        int i_10_ = DisplayModeManagerContainer213.method547(aString4807, 7468);
                ...
                if (!NodeSub1Sub1.aBoolean8805) {
                    for (NodeSub21 class348_sub21 = (NodeSub21) class262.first(4); class348_sub21 != null; class348_sub21 = ((NodeSub21) class262.next((byte) 104))) {
                        ...
                        if (NodeCache.method589(class42, -4)) {
                            ...
                            if (bool) DisplayModeManagerContainer213.method549((byte) -43, class348_sub21, var_ha, class42);
                        }
                    }
                    if (i == -13084) break;
                    aStringArray4818 = null;
