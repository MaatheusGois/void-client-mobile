 ...
 */ {
    ...
    public static void decodedOperation2682(int i) {
        WTI = null;
    ...
    static final void decodedOperation2683(FontGlyphCache class323, NodeSub21 class348_sub21, int i, int i_0_, int i_1_, GraphicsToolkit var_ha, int i_2_, int i_3_, Component274 class42) {
        try {
            if (i_0_ == 64) {
                anInt4242++;
                int i_4_ = -5 + i - i_3_ / 2;
                int i_5_ = i_2_ - -2;
                if (class42.anInt602 != 0) var_ha.decodedOperation3675(i_3_ + 10, (byte) -125, i_4_, i_5_, (i_2_ - -(class323.getLineHeight() * i_1_) - (i_5_ - 1)), class42.anInt602);
                if (class42.anInt604 != 0) var_ha.decodedOperation3668(i_3_ + 10, i_5_, class42.anInt604, i_4_, (i_1_ * class323.getLineHeight() + i_2_ - (i_5_ + -1)), 92);
    ...
    static final float decodedOperation2684(int i, float f) {
        if (i != 6) aClass70_4247 = null;
        anInt4251++;
        return (f * (6.0F * f - 15.0F) + 10.0F) * (f * (f * f));
    }

    final RadixParser decodedOperation2685(byte i) {
        if (i != -13) decodedOperation2683(null, null, -120, 35, -33, null, 90, 71, null);
        anInt4243++;
        return Component52.decodedOperation1943(false, this.anInt4245);
    }

    static final void decodedOperation2686() {
            ...
            for (int i_8_ = 0; i_8_ < StaticElementRenderer.anInt6451; i_8_++) {
                for (int i_9_ = 0; i_9_ < NodeSub41.anInt7054; i_9_++) {
                    ...
                    if (class357 != null) {
                        ...
                        if (class318_sub1_sub4 != null && class318_sub1_sub4.decodedOperation2388(-121)) {
                            RenderableSub9Sub2.decodedOperation2519(class318_sub1_sub4, i, i_8_, i_9_, 1, 1);
                            if (class318_sub1_sub4_10_ != null && class318_sub1_sub4_10_.decodedOperation2388(-125)) {
                                RenderableSub9Sub2.decodedOperation2519(class318_sub1_sub4_10_, i, i_8_, i_9_, 1, 1);
                        ...
                        for (Component3 class148 = class357.aClass148_4396; class148 != null; class148 = class148.aClass148_2038) {
                            ...
                            if (class318_sub1_sub3 != null && class318_sub1_sub3.decodedOperation2388(-71)) {
                                RenderableSub9Sub2.decodedOperation2519(class318_sub1_sub3, i, i_8_, i_9_, (class318_sub1_sub3.aShort8751 - class318_sub1_sub3.aShort8743 + 1), (class318_sub1_sub3.aShort8747 - class318_sub1_sub3.aShort8750 + 1));
                                class318_sub1_sub3.method2392(true);
                            }
                        }
                        DisplayModeManagerContainer28 class318_sub1_sub1 = class357.aClass318_Sub1_Sub1_4402;
                        if (class318_sub1_sub1 != null && class318_sub1_sub1.decodedOperation2388(-85)) {
                            NodeList.decodedOperation1992(class318_sub1_sub1, i, i_8_, i_9_);
    ...
    final DisplayModeManagerContainer173 decodedOperation2687(byte i, int i_11_) {
        anInt4241++;
        if (i < 61) return null;
