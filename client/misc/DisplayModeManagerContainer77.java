/* DisplayModeManagerContainer77 - Decompiled by JODE
...
final class DisplayModeManagerContainer77
/**
 * RENAMED from `Class124` (JODE-obfuscated).
 ...
 */ {
    ...
    DisplayModeManagerContainer133[] aClass162Array1832;
    byte[] aByteArray1833;
    byte[] aByteArray1834;
    ...
    Component30[] aClass129Array1846;
    int[] anIntArray1847;
    static CacheStore aClass45_1848;
    ...
    int[] anIntArray1865;
    DisplayModeManagerContainer173[] aClass342Array1866;
    int[] anIntArray1867;
    int[] anIntArray1868;
    ...
    private final void method1103(int i, byte[] is) {
        ...
        Buffer class348_sub49_53_ = new Buffer(is);
        Buffer class348_sub49_54_ = new Buffer(is);
        Buffer class348_sub49_55_ = new Buffer(is);
        Buffer class348_sub49_56_ = new Buffer(is);
        class348_sub49.offset = -18 + is.length;
        ...
        class348_sub49.offset = i_67_;
        i_66_ += i_64_;
        class348_sub49_53_.offset = i_77_;
        class348_sub49_54_.offset = i_78_;
        class348_sub49_55_.offset = i_79_;
        class348_sub49_56_.offset = i_72_;
        int i_80_ = 0;
        int i_81_ = 0;
        int i_82_ = 0;
        for (int i_83_ = 0; i_83_ < this.anInt1836; i_83_++) {
            ...
            int i_85_ = 0;
            if ((i_84_ & 0x1) != 0) i_85_ = class348_sub49_53_.readSmartSigned((byte) 77);
            int i_86_ = 0;
            if ((i_84_ & 0x2) != 0) i_86_ = class348_sub49_54_.readSmartSigned((byte) 77);
            int i_87_ = 0;
            if ((0x4 & i_84_) != 0) i_87_ = class348_sub49_55_.readSmartSigned((byte) 77);
        ...
        class348_sub49_54_.offset = i_69_;
        class348_sub49_55_.offset = i_73_;
        class348_sub49_56_.offset = i_70_;
        ...
        this.anInt1821 = -1;
        class348_sub49_53_.offset = i_68_;
        short i_90_ = 0;
        short i_91_ = 0;
        short i_92_ = 0;
        int i_93_ = 0;
        for (int i_94_ = 0; i_94_ < this.anInt1817; i_94_++) {
            ...
            if (i_95_ == 1) {
                i_90_ = (short) (i_93_ + class348_sub49.readSmartSigned((byte) 77));
                i_93_ = i_90_;
                i_91_ = (short) (class348_sub49.readSmartSigned((byte) 77) + i_93_);
                i_93_ = i_91_;
                i_92_ = (short) (i_93_ + class348_sub49.readSmartSigned((byte) 77));
            ...
            if (i_95_ == 2) {
                i_91_ = i_92_;
                i_92_ = (short) (class348_sub49.readSmartSigned((byte) 77) + i_93_);
                this.aShortArray1863[i_94_] = i_90_;
                i_93_ = i_92_;
                this.aShortArray1835[i_94_] = i_91_;
                this.aShortArray1855[i_94_] = i_92_;
    ...
    private final void method1106(byte[] is, byte i) {
        ...
        Buffer class348_sub49_119_ = new Buffer(is);
        Buffer class348_sub49_120_ = new Buffer(is);
        Buffer class348_sub49_121_ = new Buffer(is);
        Buffer class348_sub49_122_ = new Buffer(is);
        Buffer class348_sub49_123_ = new Buffer(is);
        class348_sub49.offset = -23 + is.length;
        ...
        class348_sub49.offset = i_144_;
        if (i_131_ == 1) this.aShortArray1822 = new short[this.anInt1817];
        class348_sub49_118_.offset = i_155_;
        class348_sub49_119_.offset = i_156_;
        class348_sub49_120_.offset = i_157_;
        class348_sub49_121_.offset = i_149_;
        int i_166_ = 0;
        int i_167_ = 0;
        int i_168_ = 0;
        for (int i_169_ = 0; this.anInt1836 > i_169_; i_169_++) {
            ...
            int i_171_ = 0;
            if ((i_170_ & 0x1) != 0) i_171_ = class348_sub49_118_.readSmartSigned((byte) 77);
            int i_172_ = 0;
            if ((i_170_ & 0x2) != 0) i_172_ = class348_sub49_119_.readSmartSigned((byte) 77);
            int i_173_ = 0;
            if ((0x4 & i_170_) != 0) i_173_ = class348_sub49_120_.readSmartSigned((byte) 77);
        ...
        class348_sub49.offset = i_154_;
        class348_sub49_118_.offset = i_145_;
        class348_sub49_119_.offset = i_147_;
        class348_sub49_120_.offset = i_150_;
        class348_sub49_121_.offset = i_148_;
        class348_sub49_122_.offset = i_152_;
        class348_sub49_123_.offset = i_153_;
        ...
        class348_sub49.offset = i_151_;
        this.anInt1821 = -1;
        class348_sub49_118_.offset = i_146_;
        short i_175_ = 0;
        short i_176_ = 0;
        short i_177_ = 0;
        int i_178_ = 0;
        for (int i_179_ = 0; (i_179_ < this.anInt1817); i_179_++) {
            ...
            if (i_180_ == 1) {
                i_175_ = (short) (class348_sub49.readSmartSigned((byte) 77) + i_178_);
                i_178_ = i_175_;
                i_176_ = (short) (class348_sub49.readSmartSigned((byte) 77) + i_178_);
                i_178_ = i_176_;
                i_177_ = (short) (i_178_ + class348_sub49.readSmartSigned((byte) 77));
                i_178_ = i_177_;
            ...
            if (i_180_ == 2) {
                i_176_ = i_177_;
                i_177_ = (short) (class348_sub49.readSmartSigned((byte) 77) + i_178_);
                this.aShortArray1863[i_179_] = i_175_;
                i_178_ = i_177_;
                this.aShortArray1835[i_179_] = i_176_;
                this.aShortArray1855[i_179_] = i_177_;
        ...
        class348_sub49.offset = i_158_;
        this.anInt1821++;
        class348_sub49_118_.offset = i_159_;
        class348_sub49_119_.offset = i_161_;
        class348_sub49_120_.offset = i_162_;
        class348_sub49_121_.offset = i_163_;
        class348_sub49_122_.offset = i_164_;
        ...
        class348_sub49.offset = i_165_;
        if (bool_125_) {
            int i_184_ = class348_sub49.readUnsignedByte(255);
            if (i_184_ > 0) {
                this.aClass129Array1846 = new Component30[i_184_];
                for (int i_185_ = 0; i_184_ > i_185_; i_185_++) {
                    ...
                    this.aClass129Array1846[i_185_] = (new Component30(i_186_, this.aShortArray1863[i_187_], this.aShortArray1835[i_187_], this.aShortArray1855[i_187_], i_188_));
                }
            }
            int i_189_ = class348_sub49.readUnsignedByte(255);
            if (i_189_ > 0) {
                this.aClass342Array1866 = new DisplayModeManagerContainer173[i_189_];
                for (int i_190_ = 0; i_189_ > i_190_; i_190_++) {
                    ...
                    this.aClass342Array1866[i_190_] = new DisplayModeManagerContainer173(i_191_, i_192_);
                }
            }
        }
        if (bool_126_) {
            ...
            if (i_193_ > 0) {
                this.aClass162Array1832 = new DisplayModeManagerContainer133[i_193_];
                for (int i_194_ = 0; i_193_ > i_194_; i_194_++) {
                    ...
                    this.aClass162Array1832[i_194_] = new DisplayModeManagerContainer133(i_195_, i_196_, i_197_, i_198_);
                }
            }
        }
    }
    ...
    final void method1107(int i, int i_199_, int i_200_, int i_201_) {
        ...
        anInt1837++;
        if (i_201_ != 0) {
            int i_206_ = DisplayModeManagerContainer88.anIntArray1207[i_201_];
            int i_207_ = DisplayModeManagerContainer88.anIntArray1204[i_201_];
        ...
        if (i_199_ != 0) {
            int i_210_ = DisplayModeManagerContainer88.anIntArray1207[i_199_];
            int i_211_ = DisplayModeManagerContainer88.anIntArray1204[i_199_];
    ...
    public DisplayModeManagerContainer77() {
        this.anInt1817 = 0;
    ...
    DisplayModeManagerContainer77(byte[] is) {
        this.anInt1817 = 0;
        this.aByte1851 = (byte) 0;
        this.anInt1821 = 0;
        this.anInt1818 = 0;
    ...
    DisplayModeManagerContainer77(int i, int i_214_, int i_215_) {
        this.anInt1817 = 0;
        this.aByte1851 = (byte) 0;
        this.anInt1821 = 0;
        this.anInt1818 = 0;
    ...
    DisplayModeManagerContainer77(DisplayModeManagerContainer77[] class124s, int i) {
        this.anInt1817 = 0;
        this.aByte1851 = (byte) 0;
        this.anInt1821 = 0;
        this.anInt1818 = 0;
        ...
        for (int i_224_ = 0; i > i_224_; i_224_++) {
            DisplayModeManagerContainer77 class124_225_ = class124s[i_224_];
        ...
        if (bool) this.aByteArray1843 = new byte[this.anInt1817];
        if (i_218_ > 0) this.aClass162Array1832 = new DisplayModeManagerContainer133[i_218_];
        if (i_217_ > 0) this.aClass342Array1866 = new DisplayModeManagerContainer173[i_217_];
        ...
        this.anIntArray1841 = new int[this.anInt1836];
        this.anIntArray1847 = new int[this.anInt1836];
        if (i_216_ > 0) this.aClass129Array1846 = new Component30[i_216_];
        this.aShortArray1855 = new short[this.anInt1817];
        ...
        for (int i_226_ = 0; i > i_226_; i_226_++) {
            ...
            DisplayModeManagerContainer77 class124_228_ = class124s[i_226_];
        ...
        for (int i_238_ = 0; i > i_238_; i_238_++) {
            ...
            DisplayModeManagerContainer77 class124_240_ = class124s[i_238_];
