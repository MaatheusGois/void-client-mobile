/* DisplayModeManagerContainer365 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer365
/**
 * RENAMED from `Class72` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    private static Component24 aClass105_1215;
    private final int anInt1216;
    private int anInt1217;
    private final int anInt1218;
    private int anInt1219;
    private int anInt1220;
    private Component24 aClass105_1221;
    ...
    private static DisplayModeManagerContainer370 aClass64_1227;
    private static Component24 aClass105_1228;
    ...
    private final void method735(GraphicsToolkit var_ha, DisplayModeManagerContainer365 class72_19_) {
        ...
        var_ha.NativeHandle();
        var_ha.fillRect2D(0, 0, anInt1220, anInt1220, ~0xffffff | anInt1222, 0);
        int i = 0;
        int i_20_ = 0;
        int i_21_ = 256;
        if (class72_19_ != null) {
        ...
        if (anInt1231 != 0) {
            int i_22_ = DisplayModeManagerContainer88.anIntArray1207[anInt1231];
            int i_23_ = DisplayModeManagerContainer88.anIntArray1204[anInt1231];
            int i_24_ = i_20_ * i_23_ - i_21_ * i_22_ >> 14;
            i_21_ = i_20_ * i_22_ + i_21_ * i_23_ >> 14;
            i_20_ = i_24_;
        }
        if (anInt1219 != 0) {
            int i_25_ = DisplayModeManagerContainer88.anIntArray1207[anInt1219];
            int i_26_ = DisplayModeManagerContainer88.anIntArray1204[anInt1219];
    ...
    private static final void method738(GraphicsToolkit var_ha) {
        if (aClass64_1227 == null) {
            ...
            for (int i = 0; i <= 24; i++) {
                ...
                int i_43_ = DisplayModeManagerContainer88.anIntArray1204[i_41_];
    ...
    DisplayModeManagerContainer365(int i, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_, boolean bool) {
        anInt1225 = i_55_;
        anInt1216 = i_56_;
        anInt1229 = i_57_;
        aBoolean1223 = bool;
    ...
    private final void method740(GraphicsToolkit var_ha, DisplayModeManagerContainer365 class72_60_) {
        ...
        if (class124 != null) {
            ...
            if (anInt1231 != 0) {
                ...
                int i_64_ = DisplayModeManagerContainer88.anIntArray1207[i_63_];
                int i_65_ = DisplayModeManagerContainer88.anIntArray1204[i_63_];
            ...
            if (anInt1219 != 0) {
                ...
                int i_68_ = DisplayModeManagerContainer88.anIntArray1207[i_67_];
                int i_69_ = DisplayModeManagerContainer88.anIntArray1204[i_67_];
