/* DisplayModeManagerContainer5 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer5
/**
 * RENAMED from `Class71` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    static DisplayModeManagerContainer154 aClass76_1208;
    static int anInt1209;
    static DisplayModeManagerContainer154 aClass76_1210;
    static boolean aBoolean1211 = false;
    static Component246 aClass209_1212;
    ...
    static final void decodedOperation729(int i, int i_0_, byte i_1_, DisplayModeManagerContainer58 class318_sub1_sub3_sub3, int i_2_) {
        ...
        if (i != -1) {
            if ((class318_sub1_sub3_sub3.anInt10275 == -1) || (i_3_ < 10240 && i_3_ > 2048)) {
                ...
                int i_4_ = 0x3fff & (RunescapeInfo.anIntArray187[i_2_] - class318_sub1_sub3_sub3.aClass264_10217.anInt3370);
                if (i != 2 || class225.anInt2919 == -1) {
                    if (i == 0 && (class225.anInt2940 != -1)) {
    ...
    static {
        aClass76_1208 = aClass76_1210 = new DisplayModeManagerContainer154(false);
        aClass209_1212 = new Component246();
        aClass138_1213 = new Component161(11, 0, 1, 2);
