 ...
 */ extends DisplayModeManagerContainer370 {
    ...
    private final void method678(boolean bool, byte i) {
        if (6 * anInt5537 > (aHa_Sub2_5598.aClass348_Sub49_Sub1_7798.aByteArray7154).length) aHa_Sub2_5598.aClass348_Sub49_Sub1_7798 = new Component182(6 * (anInt5537 - -100));
    ...
    private final boolean method684(boolean bool, int i, int i_108_, int i_109_, int i_110_, int i_111_, DisplayModeManagerContainer204 class101) {
        try {
            anInt5641++;
    ...
    private final DisplayModeManagerContainer370 method686(DisplayModeManagerContainer282 class64_sub3_211_, int i, int i_212_, boolean bool, DisplayModeManagerContainer282 class64_sub3_213_, boolean bool_214_) {
        try {
            anInt5628++;
    ...
    private final void method688(int i, boolean bool) {
        ...
        if (i == 5) {
            ...
            if (i_295_ != 0) {
                if (anInt5529 * i_295_ > (aHa_Sub2_5598.aClass348_Sub49_Sub1_7798.aByteArray7154).length) aHa_Sub2_5598.aClass348_Sub49_Sub1_7798 = new Component182(i_295_ * (100 + anInt5529));
                else aHa_Sub2_5598.aClass348_Sub49_Sub1_7798.anInt7197 = 0;
                Component182 class348_sub49_sub1 = aHa_Sub2_5598.aClass348_Sub49_Sub1_7798;
                if (bool_293_) {
                    if (aHa_Sub2_5598.aBoolean7775) {
    ...
    static final void method690(byte i, int i_378_) {
        anInt5565++;
        ColorTagNode class348_sub15 = ((ColorTagNode) DisplayModeManagerContainer91.aClass356_389.method3480(i_378_, -6008));
    ...
    private final void method691(byte i) {
        ...
        if (aBoolean5555) {
            ...
            if (aClass129Array5640 == null && aClass342Array5541 == null && aClass118Array5621 == null) {
                if (anIntArray5543 != null && !Component244.method2659((byte) 123, anInt5648, anInt5556)) {
                    if (aClass123_5605 == null || (aClass123_5605.anInterface2_1811 != null)) {
                        if (!aBoolean5527) method692((byte) -123);
                        anIntArray5543 = null;
                ...
                if (anIntArray5644 != null && !Component62.method1221(-3157, anInt5648, anInt5556)) {
                    if (aClass123_5605 == null || (aClass123_5605.anInterface2_1811 != null)) {
                        if (!aBoolean5527) method692((byte) -123);
                        anIntArray5644 = null;
                    } else aBoolean5555 = true;
