/* DisplayModeManagerContainer159 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer159
/**
 * RENAMED from `Class211` (JODE-obfuscated).
 ...
 */ {
    ...
    static final boolean method1538(int i, byte i_0_, DisplayModeManagerContainer207 class348_sub49_sub2) {
        ...
        if (i_1_ == 1) {
            ...
            int i_11_ = NpcDefinition.aClass359Array6802[i].anInt4420;
            NpcDefinition.aClass359Array6802[i].anInt4420 = (0xfffffff & i_11_) + (((i_11_ >> 28) + i_10_ & 0x3) << 28);
            return false;
        }
        if (i_1_ == 2) {
            ...
            int i_13_ = i_12_ >> 3;
            int i_14_ = 0x7 & i_12_;
            int i_15_ = NpcDefinition.aClass359Array6802[i].anInt4420;
            ...
            NpcDefinition.aClass359Array6802[i].anInt4420 = i_18_ + ((i_16_ << 28) + (i_17_ << 14));
            return false;
        }
        ...
        int i_23_ = NpcDefinition.aClass359Array6802[i].anInt4420;
        int i_24_ = 0x3 & (i_23_ >> 28) - -i_20_;
        int i_25_ = i_21_ + (i_23_ >> 14) & 0xff;
        if (i_0_ != 105) anIntArray2744 = null;
        int i_26_ = 0xff & i_23_ + i_22_;
        NpcDefinition.aClass359Array6802[i].anInt4420 = i_26_ + (i_24_ << 28) - -(i_25_ << 14);
        return false;
    }
                ...
                do {
                    ...
                    do {
                        ...
                        do {
                            do {
                                if (i_42_ == 1) {
                                    i_40_ = ((DisplayModeManagerContainer88.anIntArray1207[i_41_ << 3]) >> 4) + 1024;
                                    break while_74_;
                                } else if (i_42_ != 3) {
                                    if (i_42_ != 4) {
                                        if (i_42_ != 2) {
                                ...
                                i_40_ = (ReferenceTable.anIntArray3726[i_41_] >> 1);
                                break while_74_;
                            } while (false);
                            i_40_ = i_41_ >> 10 << 11;
                            break while_74_;
