/* DisplayModeManagerContainer370 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

abstract class DisplayModeManagerContainer370
/**
 * RENAMED from `Class64` (JODE-obfuscated).
 ...
 */ {
    ...
    private final void method602(int i, ObjectDeserializer class348_sub33, int i_5_, boolean bool, int i_6_, Component376 class4, int i_7_, int[] is, boolean[] bools, Component376 class4_8_, int i_9_, boolean bool_10_) {
        try {
            anInt1130++;
    ...
    abstract DisplayModeManagerContainer173[] method604();
    ...
    static final void decodedOperation606(int i, boolean bool, String string) {
        ...
        DisplayModeManagerContainer154.anInt1285 = i_52_;
    ...
    abstract void method613(DisplayModeManagerContainer370 class64_77_, int i, int i_78_, int i_79_, boolean bool);
    ...
    abstract Component30[] method619();
            ...
            if (i_104_ != -1) {
                ...
                if (bools == null || i_105_ == -1) decodedOperation617(i_104_, i, class348_sub42_sub17, 0, class348_sub42_sub17_107_, false, bool, i_108_, i_106_);
                    ...
                    if (NA()) {
                        ...
                        Component376 class4_113_ = (class348_sub42_sub17_103_.aClass4Array9673[i_105_]);
                        Component376 class4_114_ = null;
    ...
    final void decodedOperation626(int i, int i_116_, int i_117_, int i_118_, int i_119_, int i_120_, int i_121_, s var_s, int i_122_) {
        ...
        int i_125_ = -i / 2;
        int i_126_ = -i_119_ / 2;
        int i_127_ = var_s.getInterpolatedHeight(i_118_ + i_125_, i_126_ + i_122_, (byte) 10);
        int i_128_ = i / 2;
        int i_129_ = -i_119_ / 2;
        int i_130_ = var_s.getInterpolatedHeight(i_128_ + i_118_, i_122_ - -i_129_, (byte) -116);
        int i_131_ = -i / 2;
        int i_132_ = i_119_ / 2;
        int i_133_ = var_s.getInterpolatedHeight(i_118_ + i_131_, i_122_ - -i_132_, (byte) -111);
        int i_134_ = i / 2;
        if (i_116_ != 10947) EA();
        int i_135_ = i_119_ / 2;
        int i_136_ = var_s.getInterpolatedHeight(i_118_ + i_134_, i_135_ + i_122_, (byte) 50);
    ...
    public DisplayModeManagerContainer370() {
        /* empty */
    }
