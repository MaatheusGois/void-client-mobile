/* DisplayModeManagerContainer207 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer207
/**
 * RENAMED from `Class348_Sub49_Sub2` (JODE-obfuscated).
 ...
 */ extends Buffer {
    ...
    private DisplayModeManagerContainer123 aClass77_9756;
    ...
    final int readBits(byte i, int i_9_) {
        ...
        for (/**/; i_11_ < i_9_; i_11_ = 8) {
            i_12_ += (this.payload[i_10_++] & NodeSub34.anIntArray6972[i_11_]) << i_9_ - i_11_;
            i_9_ -= i_11_;
        }
        if (i_11_ != i_9_) i_12_ += (this.payload[i_10_] >> i_11_ - i_9_) & NodeSub34.anIntArray6972[i_9_];
        else i_12_ += (NodeSub34.anIntArray6972[i_11_] & this.payload[i_10_]);
        return i_12_;
    }
    ...
    DisplayModeManagerContainer207(int i) {
        super(i);
    }
