/* DisplayModeManagerContainer56 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.awt.*;

final class DisplayModeManagerContainer56
/**
 * RENAMED from `Class190` (JODE-obfuscated).
 ...
 */ {
    ...
    int anInt2538;
    static StringCache aClass351_2539 = new StringCache(26, 7);
    int anInt2540;
    Component80 aClass299_2541;
    ...
    static final boolean decodedOperation1422(int i, int i_0_, int i_1_, int i_2_) {
        anInt2550++;
        DefinitionSub4.aClass101_9114.method897(i_1_, i, i_0_, ShaderLinker.anIntArray10172);
        int i_3_ = ShaderLinker.anIntArray10172[2];
        if (i_3_ < 50) return false;
        ShaderLinker.anIntArray10172[2] = i_3_;
        ShaderLinker.anIntArray10172[0] = (Component211.anInt1962 * ShaderLinker.anIntArray10172[0] / i_3_) + Component325.anInt1202;
        ShaderLinker.anIntArray10172[1] = (DisplayModeManagerContainer207.anInt9759 + (ShaderLinker.anIntArray10172[1] * DebugPanicSub2.anInt8498 / i_3_));
        if (i_2_ != -7596) aRectangleArray2554 = null;
        return true;
    }

    final void decodedOperation1423(int i, Buffer class348_sub49) {
        anInt2553++;
    ...
    final boolean decodedOperation1424(DisplayModeManagerContainer56 class190_4_, byte i) {
        anInt2543++;
    ...
    static final boolean decodedOperation1425(byte i, Component274 class42, NodeSub21 class348_sub21, int i_5_, GraphicsToolkit var_ha, int i_6_) {
        try {
            anInt2537++;
            int i_7_ = 2147483647;
            int i_8_ = -2147483648;
            ...
            if (class42.anIntArray591 != null) {
                i_8_ = (DisplayModeManagerContainer229.anInt1272 + ((-DisplayModeManagerContainer229.anInt1274 + (class348_sub21.anInt6852 + class42.anInt595)) * (DisplayModeManagerContainer229.anInt1276 - DisplayModeManagerContainer229.anInt1272) / (-DisplayModeManagerContainer229.anInt1274 + DisplayModeManagerContainer229.anInt1265)));
                i_9_ = (-((-DisplayModeManagerContainer229.anInt1262 + DisplayModeManagerContainer229.anInt1268) * (class42.anInt570 + (class348_sub21.anInt6851 - DisplayModeManagerContainer229.anInt1257)) / (DisplayModeManagerContainer229.anInt1277 + -DisplayModeManagerContainer229.anInt1257)) + DisplayModeManagerContainer229.anInt1268);
                i_10_ = (-((-DisplayModeManagerContainer229.anInt1262 + DisplayModeManagerContainer229.anInt1268) * (class348_sub21.anInt6851 + (class42.anInt607 + -DisplayModeManagerContainer229.anInt1257)) / (DisplayModeManagerContainer229.anInt1277 - DisplayModeManagerContainer229.anInt1257)) + DisplayModeManagerContainer229.anInt1268);
                i_7_ = (((-DisplayModeManagerContainer229.anInt1272 + DisplayModeManagerContainer229.anInt1276) * (-DisplayModeManagerContainer229.anInt1274 + class348_sub21.anInt6852 + class42.anInt603) / (-DisplayModeManagerContainer229.anInt1274 + DisplayModeManagerContainer229.anInt1265)) + DisplayModeManagerContainer229.anInt1272);
            }
            ...
            if (class42.anInt578 != -1) {
                if (class348_sub21.aBoolean6848 && class42.anInt605 != -1) class105 = class42.decodedOperation374(true, var_ha, (byte) 127);
                else class105 = class42.decodedOperation374(false, var_ha, (byte) 127);
                if (class105 != null) {
                    i_11_ = (class348_sub21.anInt6853 + -(class105.decodedOperation966() - -1 >> 1));
                    i_12_ = (class348_sub21.anInt6853 + (1 + class105.decodedOperation966() >> 1));
                    if (i_11_ < i_7_) i_7_ = i_11_;
                    if (i_12_ > i_8_) i_8_ = i_12_;
                    i_13_ = (class348_sub21.anInt6855 - (class105.decodedOperation980() - -1 >> 1));
                    if (i_13_ < i_9_) i_9_ = i_13_;
                    i_14_ = (class348_sub21.anInt6855 + (1 + class105.decodedOperation980() >> 1));
                    if (i_14_ > i_10_) i_10_ = i_14_;
                }
            }
            FontGlyphCache class323 = null;
            int i_15_ = 0;
            int i_16_ = 0;
            int i_17_ = 0;
            int i_18_ = 0;
            ...
            if (class42.aString597 != null) {
                ...
                if (class323 != null) {
                    ...
                    else i_17_ -= ((class105.decodedOperation980() >> 1) - -(i_15_ * class323.getLineHeight()));
            ...
            if (class105 != null) {
                if (WaterShader.anInt7379 > 0 && ((DefinitionSub30.anInt9399 != -1 && (DefinitionSub30.anInt9399 == class348_sub21.anInt6847)) || (Component225.anInt481 != -1 && (class42.anInt596 == Component225.anInt481)))) {
                    int i_25_;
                    if (LoadingManager.anInt2173 <= 50) i_25_ = 2 * LoadingManager.anInt2173;
                    else i_25_ = -(LoadingManager.anInt2173 * 2) + 200;
                    int i_26_ = 0xffff00 | i_25_ << 24;
                    var_ha.decodedOperation3656((byte) -105, i_26_, class105.decodedOperation971() / 2 - -7, (class348_sub21.anInt6853), (class348_sub21.anInt6855));
                    var_ha.decodedOperation3656((byte) -120, i_26_, class105.decodedOperation971() / 2 - -5, (class348_sub21.anInt6853), (class348_sub21.anInt6855));
                    var_ha.decodedOperation3656((byte) -126, i_26_, 3 + class105.decodedOperation971() / 2, (class348_sub21.anInt6853), (class348_sub21.anInt6855));
                    var_ha.decodedOperation3656((byte) -112, i_26_, 1 + class105.decodedOperation971() / 2, (class348_sub21.anInt6853), (class348_sub21.anInt6855));
                    var_ha.decodedOperation3656((byte) -123, i_26_, class105.decodedOperation971() / 2, (class348_sub21.anInt6853), (class348_sub21.anInt6855));
                }
                class105.drawAt((class348_sub21.anInt6853 + -(class105.decodedOperation966() >> 1)), (class348_sub21.anInt6855 + -(class105.decodedOperation980() >> 1)));
            }
            if (class42.aString597 != null && class323 != null) DisplayModeManagerContainer173.decodedOperation2683(class323, class348_sub21, i_16_, 64, i_15_, var_ha, i_17_, i_18_, class42);
            if (class42.anInt578 != -1 || class42.aString597 != null) {
                NodeSub12 class348_sub12 = new NodeSub12(class348_sub21);
    ...
    public static void decodedOperation1426(int i) {
        aClass351_2539 = null;
    ...
    public DisplayModeManagerContainer56() {
        this.anInt2535 = -50;
        this.aFloat2536 = 1.2F;
        this.aClass299_2541 = HashNodeSub10.aClass299_9571;
        this.anInt2546 = 0;
        this.anInt2549 = DisplayModeManagerContainer259.anInt3444;
        this.anInt2548 = -60;
        this.anInt2538 = -50;
        this.aFloat2544 = 0.69921875F;
        this.anInt2540 = DisplayModeManagerContainer259.anInt3439;
        this.aFloat2547 = 1.1523438F;
    }

    DisplayModeManagerContainer56(Buffer class348_sub49) {
        int i = class348_sub49.readUnsignedByte(255);
        if (Component192.preferences.aClass239_Sub28_7230.decodedOperation1845(-32350) != 1 || NodeCache.aHa1098.method3704() <= 0) {
            ...
            else this.anInt2540 = DisplayModeManagerContainer259.anInt3439;
        ...
        if ((0x20 & i) == 0) this.anInt2549 = DisplayModeManagerContainer259.anInt3444;
        ...
        if ((0x80 & i) != 0) {
            ...
            this.aClass299_2541 = GameType.decodedOperation1636(i_31_, i_30_, i_27_, i_32_, i_28_, -1, i_29_);
