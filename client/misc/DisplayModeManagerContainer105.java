/* DisplayModeManagerContainer105 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import jaggl.OpenGL;

final class DisplayModeManagerContainer105
/**
 * RENAMED from `Class206` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ implements Interface11 {
    ...
    static Component246 aClass209_4874;
        ...
        for (int i_4_ = 0; i_4_ < Component335.anInt2021; i_4_++) {
            ...
            if (class10.aClass348_Sub16_Sub5_176 == null) {
                ...
                if (class10.anInt188 >= (!class10.method220((byte) -66) ? -10 : -1500)) {
                    ...
                    if (class10.anInt188 < 0) {
                        int i_5_ = 8192;
                        int i_6_;
                        if (class10.anInt178 == 0) i_6_ = ((class10.anInt184 * (class10.aByte180 == 3 ? Component192.aClass348_Sub51_3959.aClass239_Sub26_7215.method1838(-32350) : Component192.aClass348_Sub51_3959.aClass239_Sub26_7272.method1838(-32350))) >> 2);
                        else {
                            ...
                            if ((Component72.localPlayer.plane) == i_7_) {
                                ...
                                int i_13_ = (256 + (i_12_ << 9) - ((Component72.localPlayer.y) - i_9_));
                                ...
                                if (i_14_ < 0) i_14_ = 0;
                                i_6_ = ((i_8_ + -i_14_) * (Component192.aClass348_Sub51_3959.aClass239_Sub26_7234.method1838(-32350) * class10.anInt184) / i_8_) >> 2;
                                ...
                                if (i_11_ != 0 || i_13_ != 0) {
                                    int i_17_ = (0x3fff & (-4096 + -Component298.anInt4638 + -(int) (2607.5945876176133 * (Math.atan2(i_11_, i_13_)))));
                        ...
                        if (i_6_ > 0) {
                            ...
                            } else class348_sub19_sub1 = class10.aClass317_183.method2369().method2944(DisplayModeManagerContainer115.aClass163_1050);
            ...
            if (bool) {
                ...
                for (int i_19_ = i_4_; Component335.anInt2021 > i_19_; i_19_++)
                    GlFramebufferTexture.aClass10Array8531[i_19_] = GlFramebufferTexture.aClass10Array8531[i_19_ - -1];
                i_4_--;
            }
        }
        anInt4890++;
        if (DisplayModeManagerContainer238.aBoolean1236 && !Component385.method1296(true)) {
            if (Component192.aClass348_Sub51_3959.aClass239_Sub26_7260.method1838(-32350) != 0 && Component119.anInt3428 != -1) {
                if (Component246.aClass348_Sub16_Sub3_2718 != null) DefinitionSub15.method3086(2, Component246.aClass348_Sub16_Sub3_2718, Component192.aClass348_Sub51_3959.aClass239_Sub26_7260.method1838(-32350), Component54.aClass45_8667, false, 0, Component119.anInt3428);
                else NodeSub1Sub3.method2732(0, Component119.anInt3428, false, 124, Component54.aClass45_8667, Component192.aClass348_Sub51_3959.aClass239_Sub26_7260.method1838(-32350));
            }
    ...
    private final void method1502(int i, byte i_20_, GlFramebufferTexture class258_sub2, int i_21_, int i_22_) {
        anInt4876++;
    ...
    final void method1503(int i, byte i_24_) {
        ...
        if (anInt4873 == -1) throw new RuntimeException();
        OpenGL.glDrawBuffer(Component185.anIntArray5306[i]);
    }
    ...
    private final void method1506(int i, GlTexture class258_sub3, int i_27_, int i_28_) {
        anInt4892++;
        if (anInt4873 == -1) throw new RuntimeException();
        int i_29_ = 1 << i_27_;
    ...
    DisplayModeManagerContainer105(GlToolkitSub2 var_ha_Sub2) {
        ...
        OpenGL.glGenFramebuffersEXT(1, KeyStoreLoader.anIntArray1635, 0);
        anInt4891 = KeyStoreLoader.anIntArray1635[0];
    }

    static {
        aClass209_4874 = new Component246();
        anInt4889 = 0;
    }
}
