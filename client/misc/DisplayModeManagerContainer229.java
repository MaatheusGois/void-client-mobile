 ...
 */ {
    ...
    private static final int method759(d var_d, int i, int i_105_, int i_106_) {
        ...
        } else if (i_107_ >= 0) i_108_ = (~0xffffff | (Component380.anIntArray4983[(Component361.method303(Component243.method353(96, -85, (var_d.method3(i_107_, -6662).aShort208)), 30)) & 0xffff]));
