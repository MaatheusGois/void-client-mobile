/* DisplayModeManagerContainer194 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import jaggl.OpenGL;

abstract class DisplayModeManagerContainer194
/**
 * RENAMED from `Class14` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ implements Interface18 {
    GlExtensionManager aClass377_5082;
    static int anInt5083;
    DisplayModeManagerContainer42 aClass304_5084;
    static int anInt5085;
    static int anInt5086;
    static int anInt5087;
    Component342 aClass68_5088;
    ...
    private Component246 aClass209_5101 = DisplayModeManagerContainer5.aClass209_1212;
    ...
    final int method228(int i) {
        ...
        if (Component342.aClass68_1183 != this.aClass68_5088) {
            if (Component342.aClass68_1186 == this.aClass68_5088) {
                if (this.aClass304_5084 == NodeSub45.aClass304_7103) return 34843;
                if (Component83.aClass304_1662 == this.aClass304_5084) return 34842;
                if (this.aClass304_5084 != DefinitionSub38.aClass304_9471) {
                    if (this.aClass304_5084 != DefinitionSub22.aClass304_9303) {
                        if (ImageCache.aClass304_2571 != this.aClass304_5084) {
                            if (this.aClass304_5084 == Renderable.aClass304_3977) return 6145;
                        } else return 34847;
                    } else return 34846;
                } else return 34844;
            } else if (this.aClass68_5088 == Component342.aClass68_1187) {
                if (NodeSub45.aClass304_7103 != this.aClass304_5084) {
                    if (this.aClass304_5084 == Component83.aClass304_1662) return 34836;
                    if (this.aClass304_5084 != DefinitionSub38.aClass304_9471) {
                        if (DefinitionSub22.aClass304_9303 == this.aClass304_5084) return 34840;
                        if (ImageCache.aClass304_2571 != this.aClass304_5084) {
                            if (Renderable.aClass304_3977 == this.aClass304_5084) return 6145;
                        } else return 34841;
                    } else return 34838;
                } else return 34837;
            }
        } else if (this.aClass304_5084 != NodeSub45.aClass304_7103) {
            if (this.aClass304_5084 != Component83.aClass304_1662) {
                if (this.aClass304_5084 != DefinitionSub38.aClass304_9471) {
                    if (DefinitionSub22.aClass304_9303 == this.aClass304_5084) return 6409;
                    if (this.aClass304_5084 == ImageCache.aClass304_2571) return 6410;
                    if (this.aClass304_5084 == Renderable.aClass304_3977) return 6145;
                } else return 6406;
            } else return 6408;
        } else return 6407;
    ...
    DisplayModeManagerContainer194(GlExtensionManager class377, int i, DisplayModeManagerContainer42 class304, Component342 class68, int i_66_, boolean bool) {
        try {
            anInt5090 = i_66_;
            ...
            aBoolean5099 = bool;
            this.anInt5093 = i;
            OpenGL.glGenTextures(1, Component258.anIntArray1975, 0);
            anInt5096 = Component258.anIntArray1975[0];
            method229(true);
