 ...
 */ {
    ...
    public static void decodedOperation296(byte i) {
        if (i != -99) decodedOperation298(false, 24, -128, 22, -7);
        aClass60_355 = null;
        aByteArrayArray358 = null;
        aClass318_Sub1_Sub3Array357 = null;
    }

    static final void decodedOperation297(boolean bool) {
        if (bool != false) aClass60_355 = null;
        Component298.aClass60_4636.clear(0);
        anInt356++;
    }

    static final void decodedOperation298(boolean bool, int i, int i_0_, int i_1_, int i_2_) {
        anInt354++;
        if (Component192.preferences.aClass239_Sub25_7271.getPreferenceValue(-32350) == 0) HashNodeSub3.decodedOperation3177(-98, false);
        else {
            Component331.anInt1720 = Component192.preferences.aClass239_Sub25_7271.getPreferenceValue(-32350);
            SoftwareFallbackShader.decodedOperation3553(true, (byte) 103, 0);
        }
        ...
        if (i_2_ > -41) decodedOperation297(true);
    }
}
