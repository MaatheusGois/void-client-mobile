 ...
 * Also parks a static sprite-atlas warm-up ({@link #decodedOperation1933}) used at login.
 */ {
    ...
    static final DisplayModeManagerContainer238[] decodedOperation1929(byte i) {
        if (i != -19) decodedOperation1933(null, null, false);
        anInt3280++;
    ...
    final void decodedOperation1930(int i) {
        synchronized (this.aClass60_3287) {
            this.aClass60_3287.clear(0);
            if (i != -21804) decodedOperation1930(-35);
        }
        anInt3275++;
    }

    public static void decodedOperation1931(boolean bool) {
        anIntArray3273 = null;
    ...
    final Component24 decodedOperation1932(GraphicsToolkit var_ha, int i, int i_0_, BitmapFont class324, Component101 class154, int i_1_, boolean bool, byte i_2_, GraphicsToolkit var_ha_3_, int i_4_, boolean bool_5_, int i_6_) {
        try {
            anInt3266++;
            Component24 class105 = decodedOperation1941(i_6_, (byte) -74, i_4_, i_0_, i, i_1_, var_ha_3_, class154);
            ...
            if (i_2_ != 83) decodedOperation1935(-83, -37, null, null, false, -49);
            int[] is = class213.decodedOperation1562(i_0_, bool_5_, i, var_ha_3_, var_ha, class324, class154, i_1_, (byte) -102, i_6_);
            if (is == null) return null;
            Component24 class105_9_;
            if (bool) class105_9_ = var_ha.decodedOperation3662(36, is, (byte) 94, 0, 36, 32);
            else class105_9_ = var_ha_3_.decodedOperation3662(36, is, (byte) 94, 0, 36, 32);
            if (!bool) {
                ...
                this.aClass175_3288.decodedOperation1348(70, class105_9_, class126);
            }
            return class105_9_;
    ...
    static final void decodedOperation1933(CacheStore class45, GraphicsToolkit var_ha, boolean bool) {
        try {
            anInt3279++;
            Component170[] class207s = Component170.decodedOperation1519(class45, NpcNode.anInt6862, 0);
            RequestProcessor.aClass105Array2260 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                RequestProcessor.aClass105Array2260[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, KeyStoreLoader.anInt1639, 0);
            NodeSub45.aClass105Array7107 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                NodeSub45.aClass105Array7107[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, BasicMouseHandler.anInt7429, 0);
            DisplayModeManagerContainer199.aClass105Array5857 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                DisplayModeManagerContainer199.aClass105Array5857[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, GraphicsToolkit.anInt4562, 0);
            Component141.aClass105Array9959 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Component141.aClass105Array9959[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, CommandHandler.anInt1435, 0);
            Component235.aClass105Array3378 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Component235.aClass105Array3378[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, Component95.anInt1756, 0);
            Component379.aClass105Array5933 = new Component24[class207s.length];
            for (int i = 0; i < class207s.length; i++)
                Component379.aClass105Array5933[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, ReferenceTable.anInt3739, 0);
            Component210.aClass105Array5294 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Component210.aClass105Array5294[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, Component328.anInt1481, 0);
            Component361.aClass105Array367 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Component361.aClass105Array367[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, Component98.anInt5948, 0);
            DefinitionSub37.aClass105Array9467 = new Component24[class207s.length];
            for (int i = 0; i < class207s.length; i++)
                DefinitionSub37.aClass105Array9467[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, Component22.anInt1742, 0);
            NodeSub12.aClass105Array6742 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                NodeSub12.aClass105Array6742[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, NamedInteger.anInt4469, 0);
            Component49.aClass105Array4679 = new Component24[class207s.length];
            for (int i = 0; i < class207s.length; i++)
                Component49.aClass105Array4679[i] = var_ha.decodedOperation3691(class207s[i], true);
            class207s = Component170.decodedOperation1519(class45, DefinitionSub38.anInt9473, 0);
            Component22.aClass105Array1744 = new Component24[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Component22.aClass105Array1744[i] = var_ha.decodedOperation3691(class207s[i], true);
            NpcComposition.aClass105_1365 = var_ha.decodedOperation3691(Component170.decodedOperation1521(class45, RSACipher.anInt4895, 0), bool);
            ColoredText.aClass105_6097 = var_ha.decodedOperation3691(Component170.decodedOperation1521(class45, (Component134.anInt5814), 0), true);
            class207s = Component170.decodedOperation1519(class45, DisplayModeManagerContainer89.anInt8370, 0);
            Component33.aClass105Array2640 = new Component24[class207s.length];
            for (int i = 0; i < class207s.length; i++)
                Component33.aClass105Array2640[i] = var_ha.decodedOperation3691(class207s[i], true);
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.wrapThrowable(runtimeexception, ("ub.N(" + (class45 != null ? "{...}" : "null") + ',' + (var_ha != null ? "{...}" : "null") + ',' + bool + ')'));
        }
    }

    final void decodedOperation1934(byte i, boolean bool) {
        if (i != 11) decodedOperation1935(97, -31, null, null, false, 53);
        anInt3276++;
    ...
    static final void decodedOperation1935(int i, int i_10_, ComponentDownloader class30, DisplayModeManagerContainer370 class64, boolean bool, int i_11_) {
        try {
            anInt3270++;
            if (class64 != null) {
                if (bool != false) decodedOperation1929((byte) 106);
                class30.decodedOperation320(class64.EA(), class64.fa(), (byte) -4, i_11_, class64.ShaderImpl(), i, class64.V(), class64.G(), class64.HA(), i_10_, class64.RA());
            }
        } catch (RuntimeException runtimeexception) {
    ...
    final void decodedOperation1936(int i) {
        anInt3281++;
        synchronized (this.aClass175_3288) {
            this.aClass175_3288.decodedOperation1345((byte) -126);
            int i_12_ = -63 / ((21 - i) / 50);
        }
    }

    final void decodedOperation1937(int i, boolean bool) {
        anInt3274++;
        ...
        synchronized (this.aClass175_3288) {
            this.aClass175_3288.decodedOperation1346(-1491, i);
        }
    }

    final void decodedOperation1938(int i) {
        anInt3272++;
        synchronized (aClass60_3278) {
        ...
        synchronized (this.aClass175_3288) {
            this.aClass175_3288.decodedOperation1344((byte) -124);
        }
    ...
    final void method1939(int i) {
        ...
        synchronized (this.aClass175_3288) {
            this.aClass175_3288.decodedOperation1345((byte) 47);
        }
    }
    ...
    final ItemDefinition getItemDefinition(int i, int i_13_) {
        ...
        synchronized (aClass45_3267) {
            is = aClass45_3267.getFile(-1860, Component285.decodedOperation500(7, i_13_), Component111.lowByte(-23590, i_13_));
        }
        ...
        if (is != null) class213.decodedOperation1569(768, new Buffer(is));
        class213.decodedOperation1563((byte) 92);
        int i_14_ = 4 / ((i - 13) / 59);
        if (class213.anInt2833 != -1) class213.decodedOperation1570(1, getItemDefinition(90, class213.anInt2758), getItemDefinition(101, class213.anInt2833));
        if (class213.anInt2812 != -1) class213.decodedOperation1556(getItemDefinition(-58, class213.anInt2778), (byte) -29, getItemDefinition(-82, class213.anInt2812));
        if (!aBoolean3269 && class213.aBoolean2783) {
            ...
            if (class213.aClass356_2757 != null) {
                ...
                for (Node class348 = class213.aClass356_2757.first(0); class348 != null; class348 = class213.aClass356_2757.next(0)) {
                    Component355 class254 = aClass326_3292.decodedOperation2600((int) class348.key, 28364);
    ...
    final Component24 decodedOperation1941(int i, byte i_15_, int i_16_, int i_17_, int i_18_, int i_19_, GraphicsToolkit var_ha, Component101 class154) {
        try {
            ...
            return (Component24) this.aClass175_3288.decodedOperation1340(123, aClass126_3289);
        } catch (RuntimeException runtimeexception) {
    ...
    final void decodedOperation1942(int i, byte i_20_) {
        this.anInt3291 = i;
        anInt3284++;
        synchronized (this.aClass60_3287) {
            this.aClass60_3287.clear(0);
