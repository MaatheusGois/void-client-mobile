 ...
 */ extends Component125 implements Interface2 {
    ...
    public final long method12(byte i) {
        if (i != 42) decodedOperation1077(null, (byte) -124);
        anInt4704++;
        return this.aBuffer1792.getAddress();
    }

    static final void decodedOperation1077(GraphicsToolkit var_ha, byte i) {
        anInt4700++;
        if ((DisplayModeManagerContainer306.menuEntryCount >= 2 || r.aBoolean9722) && Component156.aClass46_3701 == null) {
            if (i >= -71) decodedOperation1077(null, (byte) -41);
            String string;
            if (r.aBoolean9722 && DisplayModeManagerContainer306.menuEntryCount < 2) string = (DisplayModeManagerContainer332.aString5001 + FriendsIgnoreList.aClass274_3515.getLocalized(ObjectDeserializer.languageId, 544) + DisplayModeManagerContainer332.aString5000 + " ->");
                ...
                if (!Component3.decodedOperation1197(-12081, class348_sub42_sub12.opcode)) {
                    if (class348_sub42_sub12.itemId != -1) is = Exception_Sub1.itemDefinitions.getItemDefinition(98, (class348_sub42_sub12.itemId)).anIntArray2772;
                    else if (WaterShaderSub8.decodedOperation3549((class348_sub42_sub12.opcode), (byte) 107)) {
                        ...
                        Object object = null;
                        Component44 class51;
                        if ((class348_sub42_sub12.opcode) != 1001) class51 = (GradientPreset.aClass263_9195.getDefinition(0, (int) ((class348_sub42_sub12.identifier) >>> 32 & 0x7fffffffL)));
            ...
            if (NodeSub36.aClass46_6990 != null) {
                BitmapFont class324 = NodeSub36.aClass46_6990.decodedOperation426(var_ha, (byte) 68);
                if (class324 == null) class324 = NodeList.aClass324_3326;
                class324.decodedOperation2585(Component143.anIntArray2330, NodeSub36.aClass46_6990.width, DisplayModeManagerContainer196.aClass105Array4234, NodeSub36.aClass46_6990.yTextAlign, NodeSub36.aClass46_6990.colour, NodeSub36.aClass46_6990.height, NodeSub36.aClass46_6990.shadowColour, OutputStream_Sub1.aRandom93, NodeSub36.aClass46_6990.xTextAlign, Component299.anInt451, LruCache.anInt4383, -33, Component9.anInt4141, string, Component195.anIntArray5007);
                Component354.decodedOperation226(Component195.anIntArray5007[0], Component195.anIntArray5007[2], Component195.anIntArray5007[1], 0, Component195.anIntArray5007[3]);
            } else if (Component158.aClass46_323 != null && (PacketReader.currentGameType == RunescapeInfo.RUNESCAPE)) {
                int i_1_ = (NodeList.aClass324_3326.decodedOperation2571(-1, LruCache.anInt4383, Component143.anIntArray2330, string, 16777215, 0, DisplayModeManagerContainer196.aClass105Array4234, 16 + TcpSocketStream.anInt5832, 4 + Component247.anInt4911, OutputStream_Sub1.aRandom93));
                Component354.decodedOperation226(Component247.anInt4911 - -4, (Component27.aClass143_4962.stringWidth(true, string) + i_1_), TcpSocketStream.anInt5832, 0, 16);
            }
        }
    }
    ...
    public final void method11(int i, int i_2_, byte[] is, int i_3_) {
        anInt4705++;
        this.decodedOperation1076(is, i_2_);
        anInt4697 = i;
