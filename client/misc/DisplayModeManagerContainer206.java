 ...
 */ {
    ...
    int anInt1363;
    int anInt1364;
    static Component24 aClass105_1365;
    int anInt1366;
                                                                                    ...
                                                                                    if (i == 164) {
                                                                                        ...
                                                                                        if (i == 249) {
                                                                                            ...
                                                                                            for (int i_19_ = 0; i_17_ > i_19_; i_19_++) {
                                                                                                ...
                                                                                                else class348 = new NodeSub50(class348_sub49.readString((byte) -120));
    ...
    static final void method797(int i, int i_29_, byte i_30_) {
        ...
        if (ShaderProgramSub2.anInt6212 != i) {
            if (DefinitionSub6.anInt9139 != i) {
                Component302.anIntArray6035 = new int[i];
                for (int i_32_ = 0; i_32_ < i; i_32_++)
                    Component302.anIntArray6035[i_32_] = (i_32_ << 12) / i;
            } else Component302.anIntArray6035 = RenderableSub6.anIntArray6432;
            ShaderProgramSub2.anInt6212 = i;
            DisplayModeManagerContainer356.anInt6325 = -1 + i;
        }
    }
    ...
    final DisplayModeManagerContainer370 method800(int i, Component280[] class182s, Component344 class87, boolean bool, DisplayModeManagerContainer167 class17, int i_34_, DisplayModeManagerContainer1 class261, int i_35_, DisplayModeManagerContainer167 class17_36_, Interface17 interface17, ha var_ha, int i_37_, int[] is, int i_38_, int i_39_, int i_40_, int i_41_) {
        try {
                ...
                if (class182s[i_50_] != null) {
                    ...
                    if (class17_51_.anIntArray237 != null) {
                        ...
                        if ((class17_51_.aBoolean241 || DisplayModeManagerContainer332.aBoolean5002) && i_53_ != -1 && i_53_ < (class17_51_.anIntArray237).length) {
                            ...
                            VideoAdPlayer.anIntArray4648[i_50_] = 0;
                            HashNodeSub17.aClass348_Sub42_Sub17Array9672[i_50_] = null;
                            Component191.anIntArray2466[i_50_] = -1;
                        }
                    }
                }
            }
            ...
            HashNodeSub17 class348_sub42_sub17_59_ = null;
            int i_60_ = -1;
            int i_61_ = -1;
            int i_62_ = 0;
            HashNodeSub17 class348_sub42_sub17_63_ = null;
            HashNodeSub17 class348_sub42_sub17_64_ = null;
            if (bool_44_) {
                i_43_ |= 0x20;
                if (class17_36_ != null) {
            ...
            synchronized (this.aClass278_1348.aClass60_3590) {
                class64 = (DisplayModeManagerContainer370) this.aClass278_1348.aClass60_3590.method583(l, 80);
            }
            ...
            if (class64 == null || i_43_ != (i_43_ & class64.ua())) {
                ...
                DisplayModeManagerContainer77[] class124s = new DisplayModeManagerContainer77[anIntArray1402.length];
                ...
                else class124 = new DisplayModeManagerContainer77(class124s, class124s.length);
                ...
                if (aShortArray1328 != null) {
                    for (int i_80_ = 0; (i_80_ < aShortArray1328.length); i_80_++) {
                        ...
                        else class64.ia(aShortArray1328[i_80_], (HashNodeSub3.aShortArray9502[aByteArray1374[i_80_] & 0xff]));
                    }
                }
            ...
            for (int i_91_ = 0; i_49_ > i_91_; i_91_++) {
                ...
                ImageTagText.aClass17Array2169[i_91_] = null;
            }
    ...
    final String method801(byte i, int i_92_, String string) {
        ...
        NodeSub50 class348_sub50 = ((NodeSub50) aClass356_1386.method3480(i_92_, i + -6025));
    ...
    final DisplayModeManagerContainer370 method803(Interface17 interface17, ha var_ha, int i, int i_94_, DisplayModeManagerContainer167 class17, Component344 class87, int i_95_, int i_96_, int i_97_) {
        try {
            ...
            synchronized (this.aClass278_1348.aClass60_3592) {
                class64 = ((DisplayModeManagerContainer370) (this.aClass278_1348.aClass60_3592.method583(var_ha.anInt4567 << 16 | this.anInt1344, 64)));
            }
            if (class64 == null || i_99_ != (class64.ua() & i_99_)) {
                ...
                if (aShortArray1328 != null) {
                    for (int i_104_ = 0; (aShortArray1328.length > i_104_); i_104_++) {
                        if (aByteArray1374 != null && aByteArray1374.length > i_104_) class64.ia(aShortArray1328[i_104_], (HashNodeSub3.aShortArray9502[0xff & aByteArray1374[i_104_]]));
    ...
    final int method805(int i, int i_106_, int i_107_) {
        ...
        NodeSub35 class348_sub35 = (NodeSub35) aClass356_1386.method3480(i_106_, -6008);
