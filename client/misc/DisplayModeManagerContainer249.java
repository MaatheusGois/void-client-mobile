 ...
 */ implements Interface1 {
    ...
    public final void method9(byte i, boolean bool) {
        if (bool) NodeSub8.aHa6654.fillRect(0, 0, Component236.anInt4017, PacketReader.anInt10432, aClass52_4671.anInt4899, 0);
        anInt4668++;
    ...
    static final void method1352(int i, int i_0_, int i_1_, byte i_2_) {
        ...
        i_0_ = (i_0_ * Component192.aClass348_Sub51_3959.aClass239_Sub26_7260.method1838(-32350) >> 8);
        if (i_0_ != 0 && i != -1) {
