/* DisplayModeManagerContainer220 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import jaggl.OpenGL;

final class DisplayModeManagerContainer220
/**
 * RENAMED from `Class18` (JODE-obfuscated).
 ...
 */ {
    ...
    static int anInt280;
    private DisplayModeManagerContainer105 aClass206_281;
    static int anInt282;
    static int anInt283;
    private DisplayModeManagerContainer105 aClass206_284;
    private DisplayModeManagerContainer105 aClass206_285;
    ...
    private GlTexture[] aClass258_Sub3Array295;
    private HashNodeSub2 aClass348_Sub42_Sub2_296;
    private boolean aBoolean297;
    private HashNodeSub2 aClass348_Sub42_Sub2_298;
    private boolean aBoolean299;
    private GlTexture aClass258_Sub3_300;
    ...
    private final boolean decodedOperation276(boolean bool) {
        if (aBoolean293) {
            ...
            if (aClass206_285 != null) aClass348_Sub42_Sub2_298 = new HashNodeSub2(aHa_Sub2_290, 6402, anInt286, anInt275, (aHa_Sub2_290.anInt7713));
            if (aBoolean303) aClass258_Sub3_300 = new GlTexture(aHa_Sub2_290, 34037, 6402, anInt286, anInt275);
            else if (aClass348_Sub42_Sub2_298 == null) aClass348_Sub42_Sub2_298 = new HashNodeSub2(aHa_Sub2_290, 6402, anInt286, anInt275);
            aBoolean293 = false;
            aBoolean294 = true;
            aBoolean299 = true;
        }
        ...
        if (aBoolean297) {
            ...
            if (aClass206_285 != null) aClass348_Sub42_Sub2_296 = new HashNodeSub2(aHa_Sub2_290, anInt301, anInt286, anInt275, (aHa_Sub2_290.anInt7713));
            aClass258_Sub3Array295[0] = new GlTexture(aHa_Sub2_290, 34037, anInt301, anInt286, anInt275);
            aClass258_Sub3Array295[1] = anInt302 > 1 ? new GlTexture(aHa_Sub2_290, 34037, anInt301, anInt286, anInt275) : null;
            aBoolean294 = true;
            aBoolean299 = true;
            aBoolean297 = false;
        }
    ...
    final void method278(NodeSub5 class348_sub5, boolean bool) {
        anInt280++;
        if (bool == true) {
    ...
    DisplayModeManagerContainer220(GlToolkitSub2 var_ha_Sub2) {
        ...
        aBoolean293 = true;
        aClass258_Sub3Array295 = new GlTexture[2];
        aBoolean297 = true;
        aBoolean294 = true;
        aBoolean299 = true;
        anInt302 = 0;
        ...
        if (aHa_Sub2_290.aBoolean7820 && aHa_Sub2_290.aBoolean7837) {
            aClass206_284 = aClass206_281 = new DisplayModeManagerContainer105(aHa_Sub2_290);
            if (aHa_Sub2_290.anInt7713 > 1 && aHa_Sub2_290.aBoolean7815 && aHa_Sub2_290.aBoolean7807) aClass206_284 = aClass206_285 = new DisplayModeManagerContainer105(aHa_Sub2_290);
        }
    }
}
