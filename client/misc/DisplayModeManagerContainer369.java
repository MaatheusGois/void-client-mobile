/* DisplayModeManagerContainer369 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer369
/**
 * RENAMED from `Class223` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    static Component85 aClass221_2893;
    ...
    DisplayModeManagerContainer369(int i, int i_1_) {
        this.anInt2896 = i_1_;
    }
    ...
    static final void method1614(int i, Npc npc, int i_2_, int i_3_, int i_4_, Player player, Component44 class51, int i_5_) {
        try {
            ...
            SceneNode class348_sub9 = new SceneNode();
    ...
    static {
        aClass221_2893 = new Component85();
