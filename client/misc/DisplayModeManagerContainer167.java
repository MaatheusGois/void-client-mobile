/* DisplayModeManagerContainer167 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class DisplayModeManagerContainer167
/**
 ...
 */ {
    ...
    int anInt248;
    int anInt249;
    static Component183 aClass114_250 = new Component183(4, 1);
    Component344 aClass87_251;
    ...
    private final void method264(Buffer class348_sub49, int i, int i_10_) {
        if (i_10_ == -14861) {
            if (i == 1) {
    ...
    static final void decodedOperation268(int i, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_) {
        ...
        int i_44_ = (i_43_ * (-OggStreamReader.aShort9044 + Component233.aShort3992) / 100 + OggStreamReader.aShort9044);
        i_42_ = i_42_ * i_44_ >> 8;
        Component72.anInt1906 = Component72.anInt1911 * i_44_ >> 8;
        ...
        int i_49_ = i_42_;
        if (i_45_ != 0) {
            i_48_ = -i_49_ * DisplayModeManagerContainer88.anIntArray1207[i_45_] >> 14;
            i_49_ = DisplayModeManagerContainer88.anIntArray1204[i_45_] * i_49_ >> 14;
        }
        if (i_46_ != 0) {
            i_47_ = DisplayModeManagerContainer88.anIntArray1207[i_46_] * i_49_ >> 14;
            i_49_ = i_49_ * DisplayModeManagerContainer88.anIntArray1204[i_46_] >> 14;
        }
        Component298.anInt4638 = i_37_;
        Component103.anInt4186 = 0;
        Component317.anInt8685 = i_38_ - i_49_;
        DisplayModeManagerContainer50.anInt3855 = -i_48_ + i_36_;
        WaterSurfaceShader.anInt6246 = -i_47_ + i_41_;
    ...
    final DisplayModeManagerContainer370 decodedOperation269(int i, DisplayModeManagerContainer370 class64, int i_50_, int i_51_, int i_52_, int i_53_) {
        ...
        HashNodeSub17 class348_sub42_sub17_58_ = null;
        int i_59_ = 0;
        int i_60_ = 0;
    ...
    public DisplayModeManagerContainer167() {
        this.anInt238 = -1;
