/* RadixParser - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class174` (JODE-obfuscated).
 * Radix/number parser. Throws 'Invalid radix:' when a numeric string is parsed with an unsupported base; converts text to integers with an explicit radix.
 */

final class RadixParser {
    ...
    int anInt2303;
    int anInt2304;
    static Component183 aClass114_2305 = new Component183(57, 10);
    static CacheStore aClass45_2306;
    static DisplayModeManagerContainer369 aClass223_2307 = new DisplayModeManagerContainer369(7, 2);
    ...
    private final void method1335(Buffer class348_sub49, int i, byte i_8_) {
        anInt2287++;
