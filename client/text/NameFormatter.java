...
final class NameFormatter {
    ...
    static final void queueSoundEffect(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        ...
        if (Component192.preferences.aClass239_Sub26_7272.decodedOperation1838(-32350) != 0 && i != 0 && Component335.anInt2021 < 50 && i_7_ != -1) GlFramebufferTexture.aClass10Array8531[Component335.anInt2021++] = new RunescapeInfo((byte) 1, i_7_, i, i_4_, i_5_, i_3_, i_6_, null);
        anInt490++;
    }
