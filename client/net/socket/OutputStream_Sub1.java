...
final class OutputStream_Sub1 extends OutputStream {
    ...
    static final void decodedOperation132(int i, boolean bool, int i_0_, int i_1_, int i_2_, int i_3_) {
        anInt94++;
        if (Component335.aClass357ArrayArrayArray2029 == null) NodeSub8.toolkit.decodedOperation3675(i_0_, (byte) -125, i_1_, i_3_, i_2_, -16777216);
            ...
            NodeSub8.toolkit.decodedOperation3675(i_0_, (byte) -125, i_1_, i_3_, i_2_, -16777216);
        else {
            ...
            if (Component72.localPlayer != null && Component253.anInt3203 == (Component72.localPlayer.x + -(256 * Component72.localPlayer.getSize((byte) 90)) - -256) >> 9 && Component263.anInt1548 == (Component72.localPlayer.y + 256 + -(256 * Component72.localPlayer.getSize((byte) 112))) >> 9) {
                ...
                Component264.decodedOperation2264(false);
            }
            Component353.decodedOperation1434(-14988);
            if (!bool) Component21.decodedOperation2109(512);
            Component83.decodedOperation1014(-4);
            HashNodeSub3.decodedOperation3174(i_1_, i_3_, i_0_, true, (byte) -82, i_2_);
            ...
            if (DefinitionSub21.cameraMode == 1) {
                ...
                DisplayModeManagerContainer167.decodedOperation268(i_4_, -200 + (Component300.decodedOperation2064((Component72.localPlayer.x), Component117.anInt4372, 11219, (Component72.localPlayer.y))), i_5_, Component353.cameraFocusZ, i_2_, -19360, DisplayModeManagerContainer273.cameraFocusX, (i_4_ >> 3) * 3 + 600 << 2);
                ...
                DisplayModeManagerContainer167.decodedOperation268(i_6_, -200 + Component300.decodedOperation2064(NodederUtil.anInt6633, Component117.anInt4372, 11219, NodeSub7.anInt6652), i_7_, Component353.cameraFocusZ, i_2_, -19360, DisplayModeManagerContainer273.cameraFocusX, 600 - -((i_6_ >> 3) * 3) << 2);
            } else if (DefinitionSub21.cameraMode == 5) DisplayModeManagerContainer259.decodedOperation2035(i_2_, 0);
            ...
            StringDefinition.decodedOperation3225(114);
            HashNodeSub3.decodedOperation3175((byte) -107);
            NodeSub8.toolkit.KA(i_1_, i_3_, i_1_ - -i_0_, i_3_ + i_2_);
            Component127.decodedOperation1626(1, true);
            if (Component210.gameCanvasAttached) {
                MatrixSub3.decodedOperation941(124, Component38.anInt2500);
                ...
                if (Component293.aClass305_3304 != null) Component293.aClass305_3304.decodedOperation2293(Component316.anInt2481 << 3, NodeSub8.toolkit, (byte) -72, i_1_, i_0_, i_3_, Component298.anInt4638, HashNodeSub19.anInt9701, i_15_, i_2_);
            ...
            if (i >= 80) {
                ...
                ComponentDownloader.decodedOperation319(Component263.anInt1550 << 1, Component263.anInt1550 << 1, (byte) -18, i_1_ + i_0_ / 2, i_3_ + i_2_ / 2);
                HashNodeSub20.decodedOperation3282(0x3fff & -(HashNodeSub19.anInt9701), Component317.anInt8685, DisplayModeManagerContainer50.anInt3855, 0, -Component298.anInt4638 & 0x3fff, WaterSurfaceShader.anInt6246, -Component103.anInt4186 & 0x3fff);
                byte i_16_ = (Component192.preferences.aClass239_Sub14_7264.decodedOperation1778(-32350) != 2 ? (byte) 1 : (byte) DisplayModeManagerContainer341.anInt6006);
                if (Component210.gameCanvasAttached) {
                    Component158.decodedOperation289(-15902, 0x3fff & -Component298.anInt4638, -Component103.anInt4186 & 0x3fff, (-HashNodeSub19.anInt9701 & 0x3fff));
                    GameType.decodedOperation1634(DisplayModeManagerContainer370.anIntArray1127, -2, Component156.aByteArrayArrayArray3700, (Component72.localPlayer.y) >> 9, (Component72.localPlayer.plane) - -1, DisplayModeManagerContainer363.anIntArray4097, WaterSurfaceShader.anInt6246, Component317.anInt8685, Component192.preferences.aClass239_Sub1_7246.decodedOperation1720(-32350) == 0, DisplayModeManagerContainer50.anInt3855, (Component72.localPlayer.x) >> 9, ClientErrorReporter.anIntArray2117, DefinitionSub19.anIntArray9259, i_16_, LoadingState.anIntArray1045, OpenGlShader.clientCycle, true, Component72.anInt1906);
                } else
                    AbstractGlTextureSub1.decodedOperation1960(OpenGlShader.clientCycle, WaterSurfaceShader.anInt6246, DisplayModeManagerContainer50.anInt3855, Component317.anInt8685, Component156.aByteArrayArrayArray3700, DisplayModeManagerContainer363.anIntArray4097, ClientErrorReporter.anIntArray2117, DefinitionSub19.anIntArray9259, LoadingState.anIntArray1045, DisplayModeManagerContainer370.anIntArray1127, (Component72.localPlayer.plane) - -1, i_16_, (Component72.localPlayer.x) >> 9, (Component72.localPlayer.y) >> 9, Component192.preferences.aClass239_Sub1_7246.decodedOperation1720(-32350) == 0, true, !DisplayModeManagerContainer50.aBoolean3870 ? -1 : Component72.anInt1906, 0, false);
                Component381.decodedOperation3570(false);
                if (Component49.clientState == 10) {
                    Component248.decodedOperation283(-127, i_0_, 256, i_2_, i_1_, i_3_, 256);
                    GlToolkitSub2.getString(i_3_, i_2_, 2, i_1_, i_0_, 256, 256);
                    Component212.decodedOperation2403(i_1_, 256, i_3_, i_0_, 19206, i_2_, 256);
                    CursorDefinitionCache.decodedOperation1289(i_2_, i_0_, i_3_, 8, i_1_);
                }
                StringDefinition.decodedOperation3223();
                ...
                if (TcpSocketStream.aBoolean5840) {
                    NodeSub8.toolkit.decodedOperation3675(i_0_, (byte) -125, i_1_, i_3_, i_2_, -16777216);
                    Component149.decodedOperation3511(false, Applet_Sub1.aClass324_20, Component163.aClass143_3179, (FriendsIgnoreList.aClass274_3495.getLocalized(ObjectDeserializer.languageId, 544)), 2, NodeSub8.toolkit);
                }
    ...
    public static void decodedOperation133(byte i) {
        anIntArray100 = null;
        anIntArray99 = null;
    ...
    static final void decodedOperation134(byte i) {
        if (i != -126) decodedOperation132(-95, true, 10, 28, 45, 100);
        if (Component117.anObject4366 == null) {
            Component350 class59_sub1_sub1 = new Component350();
            byte[] is = class59_sub1_sub1.decodedOperation559(128, 128, (byte) 106, 16);
        ...
        if (Component150.anObject2969 == null) {
            ...
            byte[] is = class59_sub2_sub2.decodedOperation571(128, (byte) -38, 16, 128);
