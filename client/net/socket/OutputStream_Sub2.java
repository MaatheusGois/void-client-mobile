...
final class OutputStream_Sub2 extends OutputStream {
    ...
    static final byte[] decodedOperation135(byte i, byte[] is, int i_0_) {
        anInt103++;
        if (i < 101) decodedOperation139(34);
        byte[] is_1_ = new byte[i_0_];
        Component313.arraycopy(is, 0, is_1_, 0, i_0_);
        return is_1_;
    }

    static final RenderableSub4 decodedOperation136(int i, boolean bool, boolean bool_2_) {
        anInt105++;
        synchronized (Renderable.aClass243Array3974) {
            RenderableSub4 class318_sub4;
            if (Renderable.aClass243Array3974.length > i && !Renderable.aClass243Array3974[i].decodedOperation1871((byte) 111)) {
                class318_sub4 = (RenderableSub4) Renderable.aClass243Array3974[i].decodedOperation1870(-104);
    ...
    static final boolean decodedOperation137(int i, int i_4_, int i_5_) {
        anInt102++;
        int i_6_ = -114 / ((i_4_ - 36) / 55);
        return (0x70000 & i_5_) != 0 | DefinitionSub9.decodedOperation3073(i, i_5_, (byte) 50) || Component235.decodedOperation2015(i_5_, i, 7);
    }

    static final int decodedOperation138(MenuEntry class348_sub42_sub12, boolean bool) {
        anInt107++;
        ...
        if (!Component3.decodedOperation1197(-12081, (class348_sub42_sub12.opcode))) {
            if (class348_sub42_sub12.itemId == -1) {
                if (WaterShaderSub8.decodedOperation3549(class348_sub42_sub12.opcode, (byte) -44)) {
        ...
        if (class348_sub42_sub12.aBoolean9597) i += ColoredText.aClass105_6097.decodedOperation971() + 4;
        return i;
    }
    ...
    public static void decodedOperation139(int i) {
