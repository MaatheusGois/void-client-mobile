 ...
 */ extends HashNode {
    ...
    static final void method3180(int i, DisplayModeManagerContainer57[] class46s, int i_0_) {
        if (i_0_ == 24235) {
            for (int i_1_ = 0; i_1_ < class46s.length; i_1_++) {
                ...
                if (class46 != null && i == class46.parentId && !client.decodedOperation111(class46)) {
                    if (class46.type == 0) {
                        ...
                        if (class348_sub41 != null) DisplayModeManagerContainer216.decodedOperation769(class348_sub41.anInt7050, (byte) 116);
                    }
                    if (class46.type == 6 && class46.anInt699 != -1) {
                        ...
                        if (class17 != null) {
                            ...
                            if (i_2_ != class46.anInt795) Component235.decodedOperation2017((class46.anInt795), class17, 98);
                        }
                    }
                }
            }
    ...
    public static void decodedOperation3181(byte i) {
        if (i != 2) anInt9511 = 63;
        anIntArray9519 = null;
    }

    final long decodedOperation3182(int i) {
