 ...
 */ extends Node {
    ...
    public static void decodedOperation2805(byte i) {
        aClass351_6766 = null;
        int i_1_ = -14 % ((i - 72) / 32);
        aClass351_6764 = null;
    }

    static final int decodedOperation2806(boolean bool, int i) {
        anInt6760++;
        if (bool != false) decodedOperation2807(-36, 35, (byte) -71, -71);
        return 0x3ff & i;
    }
    ...
    static final ParticleSystem decodedOperation2807(int i, int i_2_, byte i_3_, int i_4_) {
        anInt6761++;
    ...
    static final boolean decodedOperation2808(int i, GraphicsToolkit var_ha, boolean bool) {
        try {
            anInt6763++;
            ...
            for (int i_8_ = i_5_; i_8_ < 104 + i_5_; i_8_++) {
                for (int i_9_ = i_6_; i_6_ + 104 > i_9_; i_9_++) {
                    for (int i_10_ = i; i_10_ <= 3; i_10_++) {
                        if (Component255.decodedOperation536(i_9_, false, i_8_, i, i_10_)) {
                            int i_11_ = i_10_;
                            if (NpcComposition.decodedOperation802(i_9_, i_8_, true)) i_11_--;
                            if (i_11_ >= 0) bool_7_ &= DisplayModeManagerContainer389.decodedOperation245(i_11_, i_8_, i_9_, (byte) 75);
                        }
                    }
                }
            }
            ...
            for (int i_12_ = 0; is.length > i_12_; i_12_++)
                is[i_12_] = -16777216;
            Component83.aClass105_1664 = var_ha.decodedOperation3662(512, is, (byte) 94, 0, 512, 512);
            Component142.decodedOperation3489(-3);
                    ...
                    for (int i_24_ = i; i_24_ <= 3; i_24_++) {
                        for (int i_25_ = 0; i_25_ <= RuntimeException_Sub1.anInt4600; i_25_++) {
                            for (int i_26_ = 0; (i_26_ <= RuntimeException_Sub1.anInt4600); i_26_++)
                                bools[i_25_][i_26_] = Component255.decodedOperation536(i_21_ + i_26_, false, i_20_ + i_25_, i, i_24_);
                        }
                        ...
                        if (!Component121.aBoolean4542) {
                            for (int i_27_ = -4; i_27_ < RuntimeException_Sub1.anInt4600; i_27_++) {
                                for (int i_28_ = -4; i_28_ < RuntimeException_Sub1.anInt4600; i_28_++) {
                                    ...
                                    if (i_5_ <= i_29_ && i_6_ <= i_30_ && Component255.decodedOperation536(i_30_, false, i_29_, i, i_24_)) {
                                        int i_31_ = i_24_;
                                        if (NpcComposition.decodedOperation802(i_30_, i_29_, true)) i_31_--;
                                        if (i_31_ >= 0) NodeSub41.decodedOperation3159(i_14_, ((-i_28_ + (RuntimeException_Sub1.anInt4600)) * 4 + i_19_ + -4), false, i_31_, i_30_, i_29_, var_ha, 4 * i_27_ + i_18_, i_13_);
                                    }
                                }
                            }
                        }
                    ...
                    if (Component121.aBoolean4542) {
                        ...
                        for (int i_32_ = 0; i_32_ < RuntimeException_Sub1.anInt4600; i_32_++) {
                            for (int i_33_ = 0; (RuntimeException_Sub1.anInt4600 > i_33_); i_33_++) {
                                ...
                                if ((0x40240000 & i_36_) != 0) var_ha.decodedOperation3675(4, (byte) -125, i_32_ * 4 + i_18_, -4 + (RuntimeException_Sub1.anInt4600 + -i_33_) * 4 + i_19_, 4, -1713569622);
                                else if ((0x800000 & i_36_) == 0) {
                                    if ((i_36_ & 0x2000000) != 0) var_ha.decodedOperation3660(3 + (i_18_ - -(i_32_ * 4)), -1713569622, 4, (-4 + (4 * (-i_33_ + (RuntimeException_Sub1.anInt4600)) + i_19_)), true);
                                    else if ((i_36_ & 0x8000000) != 0) var_ha.decodedOperation3649((byte) -126, 4, 3 + (i_19_ + ((RuntimeException_Sub1.anInt4600) - i_33_) * 4) + -4, -1713569622, i_18_ + 4 * i_32_);
                                    else if ((0x20000000 & i_36_) != 0) var_ha.decodedOperation3660(i_18_ + 4 * i_32_, -1713569622, 4, (4 * (-i_33_ + (RuntimeException_Sub1.anInt4600)) + (i_19_ - 4)), bool);
                                } else var_ha.decodedOperation3649((byte) -113, 4, (-4 + i_19_ + 4 * (-i_33_ + (RuntimeException_Sub1.anInt4600))), -1713569622, i_32_ * 4 + i_18_);
                            }
                        }
                    }
            ...
            var_ha.la();
            var_ha.GA(-16777215);
            Component160.decodedOperation3466(-86);
            ...
            if (!Component121.aBoolean4542) {
                for (int i_37_ = i_5_; 104 + i_5_ > i_37_; i_37_++) {
                    for (int i_38_ = i_6_; 104 + i_6_ > i_38_; i_38_++) {
                        for (int i_39_ = i; i_39_ <= 1 + i && i_39_ <= 3; i_39_++) {
                            if (Component255.decodedOperation536(i_38_, !bool, i_37_, i, i_39_)) {
                                Interface10 interface10 = ((Interface10) BrowserUrlOpener.decodedOperation2878(i_39_, i_37_, i_38_));
                                if (interface10 == null) interface10 = ((Interface10) (DisplayModeManagerContainer249.decodedOperation1353(i_39_, i_37_, i_38_, (aClass6767 != null ? aClass6767 : (aClass6767 = Interface10.class)))));
                                if (interface10 == null) interface10 = ((Interface10) CacheNodeSub2.decodedOperation3297(i_39_, i_37_, i_38_));
                                if (interface10 == null) interface10 = ((Interface10) (DefinitionSub32.decodedOperation3135(i_39_, i_37_, i_38_)));
                                if (interface10 != null) {
                                    Component44 class51 = (GradientPreset.aClass263_9195.getDefinition(0, interface10.decodedOperation42(-99)));
                                    if (!class51.aBoolean942 || Component387.aBoolean1900) {
                                        ...
                                        if (i_40_ >= 0) {
                                            ...
                                            if (i_40_ >= 0) {
                                                Component274 class42 = (DisplayModeManagerContainer64.aClass153_9031.decodedOperation1225(i_40_, (byte) 126));
                ...
                if (CacheNodeSub2.aClass252_10488 != null) {
                    ...
                    DisplayModeManagerContainer64.aClass153_9031.decodedOperation1220((byte) 116, 64, 1024);
                    for (int i_51_ = 0; i_51_ < CacheNodeSub2.aClass252_10488.anInt3241; i_51_++) {
                        ...
                        if ((Component72.localPlayer.plane) == i_52_ >> 28) {
                            ...
                            if (i_53_ >= 0 && i_53_ < AbstractShaderSub4.anInt7319 && i_54_ >= 0 && (ParametricDefinition.anInt9109 > i_54_)) Component289.aClass262_10125.addTail(new NodeSub35(i_51_), -20180);
                                ...
                                Component274 class42 = (DisplayModeManagerContainer64.aClass153_9031.decodedOperation1225((CacheNodeSub2.aClass252_10488.anIntArray3239[i_51_]), (byte) 120));
                    ...
                    DisplayModeManagerContainer64.aClass153_9031.decodedOperation1220((byte) 13, 64, 128);
