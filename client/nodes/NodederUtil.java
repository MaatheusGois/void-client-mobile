/* NodederUtil - Decompiled by JODE
 ...
 */ extends Node {
    ...
    static final boolean method2769(Class var_class, byte i, String string) {
        try {
            ...
            File file = null;
            if (file == null) file = (File) Component300.aHashtable3548.get(string);
            if (i != 20) anInt6633 = -118;
            if (file != null) {
                try {
                    System.load(file.getPath());
                    Player.aHashtable10565.put(string, (aClass6640 != null ? aClass6640 : (aClass6640 = Component330.class)));
                    return true;
    ...
    static final void method2770(int i) {
        ...
        for (int i_5_ = 0; i_5_ < 65536; i_5_++) {
            ...
            RunescapeInfo.anIntArray179[i_5_] = i_20_;
        }
        if (i != 2) anInt6634 = 92;
    }
