 ...
 */ extends Node {
    ...
    static final void decodedOperation3030(int i, GlToolkitSub2 var_ha_Sub2) {
        anInt6999++;
        if (Component244.anObject4177 == null) {
            DisplayModeManagerContainer34 class59_sub1_sub2 = new DisplayModeManagerContainer34();
            byte[] is = class59_sub1_sub2.decodedOperation562(128, 128, (byte) 121, 16);
        ...
        if (Component144.anObject3985 == null) {
            ...
            byte[] is = class59_sub2_sub1.decodedOperation567(128, (byte) 111, 16, 128);
            Component144.anObject3985 = BrowserDetector.wrapSoft(is, false, (byte) 103);
        }
        if (i != 8) decodedOperation3031(-39, null);
        ReliefShader class188 = var_ha_Sub2.aClass188_7736;
        if (class188.decodedOperation1414(35632) && Component14.anObject8592 == null) {
    ...
    static final Definition decodedOperation3031(int i, Buffer class348_sub49) {
        anInt6996++;
        class348_sub49.readUnsignedByte(255);
        int i_0_ = class348_sub49.readUnsignedByte(255);
        Definition class348_sub40 = Component350.decodedOperation557(i_0_, (byte) -84);
        ...
        for (int i_2_ = 0; i_1_ > i_2_; i_2_++) {
            ...
            class348_sub40.decodedOperation3049(class348_sub49, i_3_, 31015);
        }
