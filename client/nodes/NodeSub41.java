 ...
 */ extends Node {
    ...
    static final boolean decodedOperation3154(int i, int i_0_, int i_1_, int i_2_, byte[] is, byte i_3_) {
        anInt7047++;
            ...
            for (; ; ) {
                if (bool_7_) {
                    ...
                    if (i_13_ > 0 && i_14_ > 0 && i_13_ < -1 + i && -1 + i_1_ > i_14_) {
                        ...
                        if (i_12_ != 22 || Component192.preferences.aClass239_Sub4_7220.decodedOperation1737(-32350) != 0 || class51.anInt874 != 0 || (class51.anInt920 == 1) || class51.aBoolean947) {
                            bool_7_ = true;
                            if (!class51.decodedOperation485(9773)) {
    ...
    public static void decodedOperation3155(int i) {
        aString7048 = null;
        aClass114_7052 = null;
    ...
    static final void decodedOperation3157(int i, byte i_15_, int i_16_, int i_17_, boolean bool) {
        anInt7049++;
        if (bool || i_16_ != GraphicsToolkit.anInt4581 || DisplayModeManagerContainer363.anInt4095 != i || (Component117.anInt4372 != Component385.anInt2204 && Component192.preferences.aClass239_Sub27_7261.decodedOperation1840(-32350) != 1)) {
            GraphicsToolkit.anInt4581 = i_16_;
            DisplayModeManagerContainer363.anInt4095 = i;
            Component385.anInt2204 = Component117.anInt4372;
            if (Component192.preferences.aClass239_Sub27_7261.decodedOperation1840(-32350) == 1) Component385.anInt2204 = 0;
            Buffer.setClientState(2, i_17_);
            Component149.decodedOperation3511(true, Applet_Sub1.aClass324_20, Component163.aClass143_3179, FriendsIgnoreList.aClass274_3495.getLocalized(ObjectDeserializer.languageId, 544), 2, NodeSub8.toolkit);
            ...
            if (i_17_ == 11) {
                ...
                for (int i_27_ = 0; (NodeSub32.anInt6930 > i_27_); i_27_++) {
                    ...
                    if (class348_sub22 != null) {
                        ...
                        if ((npc.x) < 0 || i_25_ < (npc.x) || (npc.y) < 0 || i_26_ < (npc.y)) {
                            npc.decodedOperation2448(null, -2);
                ...
                if (bool_24_) {
                    ...
                    Component21.aClass356_3654.decodedOperation3477(3, DefinitionSub23.aClass348_Sub22Array9319);
                }
            }
            if (i_15_ > 122) {
                ...
                if (i_17_ != 11) {
                    ...
                    if ((AbstractShaderSub4.anInt7319 < Math.abs(i_20_)) || Math.abs(i_21_) > ParametricDefinition.anInt9109) DisplayModeManagerContainer154.decodedOperation773(true);
                ...
                AudioMixer.decodedOperation1911((byte) 99);
            }
        }
    }
    ...
    static final void decodedOperation3159(int i, int i_42_, boolean bool, int i_43_, int i_44_, int i_45_, GraphicsToolkit var_ha, int i_46_, int i_47_) {
        anInt7051++;
        Interface10 interface10 = (Interface10) CacheNodeSub2.decodedOperation3297(i_43_, i_45_, i_44_);
        if (interface10 != null) {
            Component44 class51 = GradientPreset.aClass263_9195.getDefinition(0, interface10.decodedOperation42(-124));
            ...
            if (class51.anInt875 == -1) {
                ...
                if (i_49_ == 0 || i_49_ == 2) {
                    if (i_48_ != 0) {
                        if (i_48_ == 1) var_ha.decodedOperation3649((byte) -79, 4, i_42_, i_50_, i_46_);
                        else if (i_48_ == 2) var_ha.decodedOperation3660(3 + i_46_, i_50_, 4, i_42_, true);
                        else if (i_48_ == 3) var_ha.decodedOperation3649((byte) -121, 4, i_42_ + 3, i_50_, i_46_);
                    } else var_ha.decodedOperation3660(i_46_, i_50_, 4, i_42_, !bool);
                }
                if (i_49_ == 3) {
                    if (i_48_ != 0) {
                        if (i_48_ == 1) var_ha.decodedOperation3675(1, (byte) -125, 3 + i_46_, i_42_, 1, i_50_);
                        else if (i_48_ != 2) {
                            if (i_48_ == 3) var_ha.decodedOperation3675(1, (byte) -125, i_46_, 3 + i_42_, 1, i_50_);
                        } else var_ha.decodedOperation3675(1, (byte) -125, 3 + i_46_, 3 + i_42_, 1, i_50_);
                    } else var_ha.decodedOperation3675(1, (byte) -125, i_46_, i_42_, 1, i_50_);
                }
                if (i_49_ == 2) {
                    if (i_48_ != 0) {
                        if (i_48_ == 1) var_ha.decodedOperation3660(3 + i_46_, i_50_, 4, i_42_, true);
                        else if (i_48_ != 2) {
                            if (i_48_ == 3) var_ha.decodedOperation3660(i_46_, i_50_, 4, i_42_, true);
                        } else var_ha.decodedOperation3649((byte) -106, 4, 3 + i_42_, i_50_, i_46_);
                    } else var_ha.decodedOperation3649((byte) -96, 4, i_42_, i_50_, i_46_);
                }
            } else Component119.decodedOperation2028(i_46_, class51, i_42_, var_ha, i_48_, 126);
        }
        if (bool != false) anInt7054 = 122;
        interface10 = ((Interface10) DisplayModeManagerContainer249.decodedOperation1353(i_43_, i_45_, i_44_, (aClass7056 != null ? aClass7056 : (aClass7056 = Interface10.class))));
        if (interface10 != null) {
            Component44 class51 = GradientPreset.aClass263_9195.getDefinition(0, interface10.decodedOperation42(-88));
            int i_51_ = interface10.method41(-32228) & 0x3;
            int i_52_ = interface10.method39(-126);
            if (class51.anInt875 != -1) Component119.decodedOperation2028(i_46_, class51, i_42_, var_ha, i_51_, -86);
            else if (i_52_ == 9) {
                int i_53_ = -1118482;
                if (class51.anInt874 > 0) i_53_ = -1179648;
                if (i_51_ != 0 && i_51_ != 2) var_ha.decodedOperation3645(i_42_, i_46_, 3 + i_46_, -8003, i_53_, i_42_ + 3);
                else var_ha.decodedOperation3645(i_42_ + 3, i_46_, 3 + i_46_, -8003, i_53_, i_42_);
            }
        }
        interface10 = (Interface10) BrowserUrlOpener.decodedOperation2878(i_43_, i_45_, i_44_);
        if (interface10 != null) {
            Component44 class51 = GradientPreset.aClass263_9195.getDefinition(0, interface10.decodedOperation42(-118));
            int i_54_ = interface10.method41(-32228) & 0x3;
            if (class51.anInt875 != -1) Component119.decodedOperation2028(i_46_, class51, i_42_, var_ha, i_54_, -5);
        }
    }
