...
class Node {
    ...
    static final boolean decodedOperation2709(int i, int i_0_, int i_1_) {
        anInt4287++;
        if (i_1_ != -1) decodedOperation2711(-42, 89, null, -113, true, -22, -35, 27, -109, null, 74, -94, -119, null);
        return (0x21 & i_0_) != 0;
    }

    static final int decodedOperation2710(int i, int i_2_) {
        anInt4289++;
        if (i_2_ < 96) return 0;
    ...
    static final DisplayModeManagerContainer370 decodedOperation2711(int i, int i_3_, DisplayModeManagerContainer370 class64, int i_4_, boolean bool, int i_5_, int i_6_, int i_7_, int i_8_, GraphicsToolkit var_ha, int i_9_, int i_10_, int i_11_, DisplayModeManagerContainer167 class17) {
        try {
            anInt4298++;
            ...
            if (class17 != null) {
                i_12_ |= class17.decodedOperation263(-1, 103, i_5_, false);
                i_12_ &= ~0x200;
            }
            ...
            if (class64_13_ == null || (var_ha.method3667(class64_13_.ua(), i_12_) != 0)) {
                ...
                int i_16_ = class124.decodedOperation1101(0, 0, 0, -44);
                ...
                for (int i_18_ = 0; i_18_ < i_15_; i_18_++) {
                    ...
                    for (int i_21_ = 0; i_14_ > i_21_; i_21_++) {
                        ...
                        is_17_[i_18_][i_21_] = class124.decodedOperation1101(0, i_24_, i_23_, 123);
                    }
                }
                for (int i_25_ = 0; i_15_ > i_25_; i_25_++) {
                    ...
                    for (int i_30_ = 0; i_30_ < i_14_; i_30_++) {
                        if (i_25_ == 0) class124.decodedOperation1102(i_16_, (byte) 1, (byte) -1, (short) -1, (byte) 45, i_29_, is_17_[0][(1 + i_30_) % i_14_], i_28_, is_17_[0][i_30_]);
                        else {
                            class124.decodedOperation1102(is_17_[i_25_ - 1][i_30_], (byte) 1, (byte) -1, (short) -1, (byte) 48, i_29_, is_17_[i_25_ + -1][(1 + i_30_) % i_14_], i_28_, is_17_[i_25_][(1 + i_30_) % i_14_]);
                            class124.decodedOperation1102(is_17_[-1 + i_25_][i_30_], (byte) 1, (byte) -1, (short) -1, (byte) 100, i_29_, (is_17_[i_25_][(1 + i_30_) % i_14_]), i_28_, is_17_[i_25_][i_30_]);
                        }
                    }
                }
            ...
            if (class17 != null) {
                ...
                class348_sub42_sub17 = RunescapeInfo.aClass87_191.decodedOperation839(i_5_ >> 16, 3);
                i_5_ &= 0xffff;
            }
            if (class348_sub42_sub17 == null) {
                ...
                class64_13_.H(i_32_ + i_31_ >> 1, 0, i_34_ + i_33_ >> 1);
                class64_13_.decodedOperation611(i_5_, -8700, class348_sub42_sub17);
            }
    ...
    public static void decodedOperation2713(int i) {
        aClass45_4286 = null;
        aClass318_Sub1Array4293 = null;
        if (i != 0) decodedOperation2711(-47, 87, null, 85, false, -126, -116, -51, -44, null, 75, -69, 87, null);
        anIntArray4288 = null;
    }

    static final boolean decodedOperation2714(int i, int i_35_) {
        if (i != 7351) decodedOperation2709(-15, 59, 58);
        anInt4296++;
