/* HashNodeSub10 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class HashNodeSub10
/**
 * RENAMED from `Class348_Sub42_Sub10` (JODE-obfuscated).
 ...
 */ extends HashNode {
    ...
    int[] anIntArray9566;
    Component117 aClass355_9567;
    static int anInt9568;
    static int anInt9569;
    static int anInt9570;
    static Component80 aClass299_9571;
    ...
    private final void method3214(int i, Buffer class348_sub49, int i_6_) {
        if (i_6_ == 60) {
            if (i != 1) {
                if (i == 2) {
