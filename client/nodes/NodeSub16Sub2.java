/* NodeSub16Sub2 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class NodeSub16Sub2
/**
 * RENAMED from `Class348_Sub16_Sub2` (JODE-obfuscated).
 * Evidence: subclass of NodeSub16 (hierarchy)
 */ extends NodeSub16 {
    static int anInt8860;
    private NodeList aClass262_8861 = new NodeList();
    ...
    final void decodedOperation2827(int i, int i_0_) {
        anInt8885 = i_0_;
        anInt8887 = i_0_;
        if (i != -17708) decodedOperation2830(-93);
        anInt8880++;
    }

    private final synchronized HashNodeSub4 decodedOperation2828(int i) {
    ...
    final synchronized int decodedOperation2829(int i) {
        anInt8871++;
        if (i >= -33) method2831((byte) 84);
        return anInt8888;
    }

    public static void decodedOperation2830(int i) {
        if (i != 0) decodedOperation2834((byte) 68, null);
        anIntArray8862 = null;
    }
    ...
    private final synchronized void method2831(byte i) {
        anInt8875++;
        int i_1_ = -13 / ((-66 - i) / 49);
        HashNodeSub4 class348_sub42_sub4 = decodedOperation2828(-23076);
        if (class348_sub42_sub4 != null) {
            class348_sub42_sub4.unlink((byte) 71);
            anInt8888--;
            anInt8883 = 0;
            DefinitionSub10.aClass308_9180.decodedOperation2305(class348_sub42_sub4.decodedOperation3182(90), class348_sub42_sub4, -1);
        }
    }

    static final void decodedOperation2832(int[] is, long[] ls, int i) {
        try {
    ...
    final synchronized void synthesizeSamples(int[] is, int i, int i_2_) {
        anInt8863++;
        if (!aBoolean8886) {
            if (decodedOperation2828(-23076) == null) {
                if (aBoolean8884) {
                    this.unlink((byte) 23);
                    DefinitionSub10.aClass308_9180.decodedOperation2303(true);
                }
            } else {
                int i_3_ = i - -i_2_;
    ...
    final synchronized void decodedOperation2833(int i, boolean bool) {
        if (i != 1) aDouble8869 = -2.8743710633758983;
        aBoolean8886 = bool;
        anInt8878++;
    }

    static final Component27 decodedOperation2834(byte i, Buffer class348_sub49) {
        anInt8876++;
        Component85 class221 = HeapDumpHelper.decodedOperation1248(15)[class348_sub49.readUnsignedByte(255)];
        ...
        return new Component27(class221, class341, i_7_, i_8_, i_9_, i_10_, i_11_, i_12_, i_13_);
    }

    final synchronized void decodedOperation2835(HashNodeSub4 class348_sub42_sub4, int i) {
    ...
    final synchronized void decodedOperation2836(int i) {
        aBoolean8884 = true;
        if (i != -1) aClass262_8861 = null;
        anInt8865++;
    }

    final synchronized double decodedOperation2837(int i) {
        anInt8868++;
    ...
    final HashNodeSub4 decodedOperation2838(int i, double d, int i_14_) {
        anInt8860++;
        long l = i | anInt8879 << 0;
        HashNodeSub4 class348_sub42_sub4 = ((HashNodeSub4) DefinitionSub10.aClass308_9180.decodedOperation2302(l, (byte) -31));
        if (i_14_ != 1401320384) return null;
        if (class348_sub42_sub4 == null) class348_sub42_sub4 = new HashNodeSub4(new short[anInt8879][i], d);
        else {
            class348_sub42_sub4.aDouble9512 = d;
            DefinitionSub10.aClass308_9180.method2304(-121, l);
        }
