 ...
 */ extends RenderableObject {
    ...
    static final int decodedOperation2483(int i, int i_0_) {
    ...
    public static void decodedOperation2484(int i) {
        if (i != 0) decodedOperation2487(-24);
        aClass144_8766 = null;
    }

    static final boolean decodedOperation2485(int i) {
        anInt8776++;
    ...
    final boolean method2382(byte i) {
        anInt8774++;
        if (i >= -51) decodedOperation2486(-102, 81, -103, -31, -95, -90);
        return Component15.decodedOperation1110((this.y >> Component149.anInt4459), this.method2394(true), this.aByte6376, (byte) -79, (this.x >> Component149.anInt4459));
    }
    ...
    static final void decodedOperation2486(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
        if (i_8_ >= Component27.anInt4960 && i_5_ <= Component22.anInt1745 && Component72.anInt1910 <= i_9_ && PauseTimer.anInt513 >= i_7_) Component15.decodedOperation1111(i_7_, i, i_5_, i_8_, i_9_, i_6_);
        else Component25.decodedOperation1792(i_9_, i_8_, i_7_, i_5_, (byte) -114, i_6_);
        if (i != 0) anInt8780 = 42;
        anInt8777++;
    }
    ...
    static final Component362 decodedOperation2487(int i) {
        anInt8778++;
        NodeSub36.anInt6985 = 0;
        if (i >= -91) anInt8775 = -63;
        return Component245.decodedOperation170(true);
    }
}
