/* Component11 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component11
/**
 * RENAMED from `Class277` (JODE-obfuscated).
 ...
 */ {
    ...
    DisplayModeManagerContainer259 aClass268_3562;
    int anInt3563;
    int anInt3564 = 8;
    static int anInt3565;
    boolean aBoolean3566;
    static int anInt3567;
    static CacheIndexReader aClass137_3568;
    int anInt3569;
    int anInt3570;
    static int anInt3571;
    static Component158 aClass21_3572 = new Component158();
    int anInt3573;
    int anInt3574;
    int anInt3575;
    ...
    private final void method2069(int i, Buffer class348_sub49, int i_1_) {
        anInt3567++;
        if (i == -1) {
            if (i_1_ != 1) {
