 ...
 */ {
    ...
    private LruCache aClass356_881;
    ...
    int anInt895;
    boolean aBoolean896;
    static ResourceLoader aClass311_897;
    static int anInt898;
    static int anInt899;
    ...
    boolean aBoolean903;
    int[] anIntArray904;
    static DisplayModeManagerContainer204 aClass101_905;
    boolean aBoolean906;
    ...
    final String decodedOperation475(String string, int i, int i_3_) {
        ...
        NodeSub50 class348_sub50 = (NodeSub50) aClass356_881.get(i, -6008);
    ...
    final Component245 decodedOperation476(GraphicsToolkit var_ha, s var_s, int i, int i_4_, int i_5_, boolean bool, s var_s_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        try {
            ...
            synchronized (this.aClass263_933.aClass60_3361) {
                class2 = (Component245) this.aClass263_933.aClass60_3361.get(l, i_10_ + -25);
            }
            DisplayModeManagerContainer370 class64 = class2 == null ? null : class2.aClass64_119;
            r var_r = null;
            if (class64 == null || var_ha.method3667(class64.ua(), i_11_) != 0) {
                ...
                class2.aR118 = var_r;
                synchronized (this.aClass263_933.aClass60_3361) {
                    this.aClass263_933.aClass60_3361.putOne(class2, l, (byte) -120);
                }
            } else {
            ...
            throw NpcDefinition.wrapThrowable(runtimeexception, ("iv.B(" + (var_ha != null ? "{...}" : "null") + ',' + (var_s != null ? "{...}" : "null") + ',' + i + ',' + i_4_ + ',' + i_5_ + ',' + bool + ',' + (var_s_6_ != null ? "{...}" : "null") + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ',' + i_10_ + ')'));
        }
    }
    ...
    private final DisplayModeManagerContainer370 decodedOperation477(int i, GraphicsToolkit var_ha, int i_15_, int i_16_, int i_17_) {
        ...
        if (i_23_ > 0) {
            ...
            synchronized (this.aClass263_933.aClass60_3360) {
                class64 = (DisplayModeManagerContainer370) this.aClass263_933.aClass60_3360.get(l, 78);
            }
            if (class64 != null) {
            ...
            if (class64 == null || var_ha.method3667(class64.ua(), i_17_) != 0) {
                ...
                if (class64 != null) i_25_ = var_ha.bitwiseOr(i_25_, class64.ua());
                DisplayModeManagerContainer77 class124 = null;
                synchronized (DisplayModeManagerContainer196.aClass124Array4236) {
                ...
                synchronized (this.aClass263_933.aClass60_3360) {
                    this.aClass263_933.aClass60_3360.putOne(class64, l, (byte) -95);
                }
            }
        }
        ...
        if (aShortArray940 != null) {
            for (int i_28_ = 0; aShortArray940.length > i_28_; i_28_++) {
                if (aByteArray872 != null && aByteArray872.length > i_28_) class64_27_.ia(aShortArray940[i_28_], (Request.aShortArray6889[0xff & aByteArray872[i_28_]]));
            ...
            for (int i_31_ = 0; aByteArray885.length > i_31_; i_31_++) {
                if (aByteArray885[i_31_] == i) {
                    for (int i_32_ = 0; (anIntArrayArray907[i_31_].length > i_32_); i_32_++) {
                        if (!this.aClass263_933.aClass45_3345.isFileReady(i_30_ ^ 0x5061, anIntArrayArray907[i_31_][i_32_], 0)) return false;
                    }
                    return true;
                }
            }
                                                                                                            ...
                                                                                                            if (i != 170) {
                                                                                                                if (i == 171) this.anInt953 = class348_sub49.readSmart(-121);
                                                                                                                    ...
                                                                                                                    if (aClass356_881 == null) {
                                                                                                                        int i_43_ = Component373.nextPowerOfTwo(i_42_, (byte) 108);
                                                                                                                        aClass356_881 = new LruCache(i_43_);
                                                                                                                    }
                                                                                                                    for (int i_44_ = 0; i_44_ < i_42_; i_44_++) {
                                                                                                                        ...
                                                                                                                        else class348 = new NodeSub50(class348_sub49.readString((byte) -87));
                                                                                                                        aClass356_881.put((byte) 86, i_45_, class348);
                                                                                                                    }
                                                                                                                }
    ...
    final DisplayModeManagerContainer370 decodedOperation483(int i, int i_63_, int i_64_, int i_65_, GraphicsToolkit var_ha, int i_66_, int i_67_, byte i_68_, s var_s, int i_69_, int i_70_, int i_71_, DisplayModeManagerContainer167 class17, s var_s_72_) {
        try {
            ...
            synchronized (this.aClass263_933.aClass60_3362) {
                class64 = (DisplayModeManagerContainer370) this.aClass263_933.aClass60_3362.get(l, 100);
            }
            ...
            throw NpcDefinition.wrapThrowable(runtimeexception, ("iv.L(" + i + ',' + i_63_ + ',' + i_64_ + ',' + i_65_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_66_ + ',' + i_67_ + ',' + i_68_ + ',' + (var_s != null ? "{...}" : "null") + ',' + i_69_ + ',' + i_70_ + ',' + i_71_ + ',' + (class17 != null ? "{...}" : "null") + ',' + (var_s_72_ != null ? "{...}" : "null") + ')'));
        }
    }
        ...
        synchronized (this.aClass263_933.aClass45_3345) {
            for (int i_77_ = 0; i_77_ < anIntArrayArray907.length; i_77_++) {
                for (int i_78_ = 0; (anIntArrayArray907[i_77_].length > i_78_); i_78_++)
                    bool &= (this.aClass263_933.aClass45_3345.isFileReady(-10499, anIntArrayArray907[i_77_][i_78_], 0));
            }
        }
        return bool;
    }
    ...
    final int decodedOperation487(int i, int i_79_, int i_80_) {
        ...
        NodeSub35 class348_sub35 = (NodeSub35) aClass356_881.get(i, -6008);
