 ...
 */ {
    ...
    NodeCache aClass60_3360;
    NodeCache aClass60_3361;
    ...
    static final boolean method2007(int i, int i_1_, int i_2_, TeleportHandler class361, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
        anInt3354++;
        int i_10_ = i_8_;
        int i_11_ = i_4_;
        int i_12_ = 64;
        ...
        int i_17_ = 0;
        Component275.anIntArray2694[i_16_++] = i_11_;
        int[][] is = class361.anIntArrayArray4438;
        while (i_16_ != i_17_) {
            i_11_ = Component275.anIntArray2694[i_17_];
            i_10_ = OpenGlShader.anIntArray7397[i_17_];
            i_17_ = 0xfff & 1 + i_17_;
            i_12_ = i_10_ - i_14_;
            i_13_ = -i_15_ + i_11_;
            ...
            i_20_ = DisplayModeManagerContainer369.anIntArrayArray2900[i_12_][i_13_] + 1;
            if (i_12_ > 0 && r.anIntArrayArray9723[i_12_ + -1][i_13_] == 0 && (0x43a40000 & is[i_18_ - 1][i_19_]) == 0 && (0x4e240000 & is[i_18_ - 1][1 + i_19_]) == 0) {
                OpenGlShader.anIntArray7397[i_16_] = -1 + i_10_;
                Component275.anIntArray2694[i_16_] = i_11_;
                r.anIntArrayArray9723[-1 + i_12_][i_13_] = 2;
                i_16_ = i_16_ + 1 & 0xfff;
                DisplayModeManagerContainer369.anIntArrayArray2900[i_12_ + -1][i_13_] = i_20_;
            }
            ...
            if (i_12_ > 0 && i_13_ > 0 && r.anIntArrayArray9723[-1 + i_12_][i_13_ + -1] == 0 && (is[i_18_ + -1][i_19_] & 0x4fa40000) == 0 && (is[i_18_ - 1][i_19_ - 1] & 0x43a40000) == 0 && (is[i_18_][i_19_ - 1] & 0x63e40000) == 0) {
                ...
                DisplayModeManagerContainer369.anIntArrayArray2900[-1 + i_12_][-1 + i_13_] = i_20_;
            }
            if (i_12_ < 126 && i_13_ > 0 && (r.anIntArrayArray9723[i_12_ + 1][-1 + i_13_] == 0) && (is[i_18_ - -1][i_19_ + -1] & 0x63e40000) == 0 && (0x60e40000 & is[2 + i_18_][-1 + i_19_]) == 0 && (is[i_18_ - -2][i_19_] & 0x78e40000) == 0) {
                ...
                i_16_ = 0xfff & i_16_ - -1;
                DisplayModeManagerContainer369.anIntArrayArray2900[i_12_ - -1][i_13_ - 1] = i_20_;
            }
            if (i_12_ > 0 && i_13_ < 126 && r.anIntArrayArray9723[i_12_ - 1][1 + i_13_] == 0 && (is[i_18_ - 1][1 + i_19_] & 0x4fa40000) == 0 && (0x4e240000 & is[i_18_ - 1][2 + i_19_]) == 0 && (is[i_18_][i_19_ - -2] & 0x7e240000) == 0) {
                OpenGlShader.anIntArray7397[i_16_] = i_10_ - 1;
                Component275.anIntArray2694[i_16_] = i_11_ + 1;
    ...
    static final void method2013(byte[] is, byte i) {
        ...
        for (; ; ) {
            ...
            if (i_23_ == 0) break;
            if (i_23_ == 1) {
                int[] is_28_ = Component268.anIntArray1432 = new int[6];
                ...
                Component66.anIntArray6021 = new int[i_26_];
                for (int i_27_ = 0; i_27_ < i_26_; i_27_++) {
                    Component66.anIntArray6021[i_27_] = class348_sub49.readUnsignedShort(842397944);
                    if (Component66.anIntArray6021[i_27_] == 65535) Component66.anIntArray6021[i_27_] = -1;
                }
            }
        }
    }
    ...
    Component309(DisplayModeManagerContainer124 class230, int i, boolean bool, CacheStore class45, CacheStore class45_29_) {
        ...
        this.aClass60_3362 = new NodeCache(50);
        do {
            try {
                this.aBoolean3359 = bool;
