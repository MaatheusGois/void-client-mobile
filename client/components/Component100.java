/* Component100 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component100
/**
 * RENAMED from `Class299_Sub1_Sub1` (JODE-obfuscated).
 * Evidence: subclass of Component40 (hierarchy)
 */ extends Component40 {
    private final int anInt8686;
    static int anInt8687;
    private GlFramebufferTexture aClass258_Sub2_8688;
    ...
    final GlFramebufferTexture method2256(byte i) {
        ...
        if (aClass258_Sub2_8688 == null) {
            ...
            Component17.anIntArray3883[5] = anInt8697;
            Component17.anIntArray3883[1] = anInt8695;
            Component17.anIntArray3883[0] = anInt8689;
            boolean bool = false;
            int i_0_ = 0;
    ...
    static final void method2260(int i, int i_4_, long l, int i_5_, boolean bool, CacheStore class45, byte i_6_, int i_7_) {
        do {
            try {
                Component329.anInt5994 = 10000;
                DisplayModeManagerContainer77.aClass45_1848 = class45;
                Component255.anInt1059 = i_7_;
                Component197.anInt10074 = i;
                InputHandler.aBoolean4275 = bool;
                DebugPanic.aClass348_Sub16_Sub3_4743 = null;
                Renderable.anInt3971 = i_4_;
                anInt8687++;
                Component205.aLong5971 = l;
                PlayerState.anInt7068 = 1;
                DefinitionSub35.anInt9444 = i_5_;
                if (i_6_ >= 54) break;
