/* Component7 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component7
/**
 * RENAMED from `Class220` (JODE-obfuscated).
    ...
    static final void decodedOperation1605(int i) {
        if (Component366.anIntArray3068 == null || Component296.anIntArray4654 == null) {
            ...
            for (int i_0_ = 0; i_0_ < 256; i_0_++) {
                ...
                Component366.anIntArray3068[i_0_] = (int) (4096.0 * Math.sin(d));
                Component296.anIntArray4654[i_0_] = (int) (4096.0 * Math.cos(d));
            }
        }
        anInt2878++;
