 ...
 */ extends Component339 {
    ...
    final int decodedOperation1778(int i) {
    ...
    final void validateValue(boolean bool) {
        if (this.preferences.aClass239_Sub3_7222.decodedOperation1735(bool) && this.preferenceValue == 2) this.preferenceValue = 1;
        anInt5988++;
    ...
    static final void decodedOperation1779(byte i) {
        anInt5985++;
    ...
    public static void decodedOperation1780(int i) {
        aClass114_5992 = null;
    ...
    static final int decodedOperation1781(int i, int i_1_, int i_2_) {
        anInt5983++;
        if (Sprite.anInt6923 == -1) return 1;
        if (i != Component192.preferences.aClass239_Sub25_7271.getPreferenceValue(-32350)) {
            GlRectangleTexture.decodedOperation1971(-2, FriendsIgnoreList.aClass274_3496.getLocalized(ObjectDeserializer.languageId, 544), true, i);
        ...
        try {
            ...
            Component149.decodedOperation3511(true, Applet_Sub1.aClass324_20, Component163.aClass143_3179, FriendsIgnoreList.aClass274_3496.getLocalized(ObjectDeserializer.languageId, 544), 2, NodeSub8.toolkit);
            ...
            NodeSub8.toolkit.la();
            Component270.aClass101_2123.decodedOperation894(0, DisplayModeManagerContainer64.anInt9037, 0);
            ...
            for (int i_4_ = 0; i_4_ < 500; i_4_++) {
                ...
                for (int i_5_ = 15; i_5_ >= 0; i_5_--) {
                    for (int i_6_ = 0; i_6_ <= i_5_; i_6_++) {
                        Cp1252Decoder.aClass101_5209.decodedOperation894((int) ((-((float) i_5_ / 2.0F) + (float) i_6_) * (float) Component148.anInt3465), 0, (i_5_ + 1) * Component148.anInt3465);
                        i_3_++;
