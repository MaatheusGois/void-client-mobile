 ...
 */ {
    ...
    final Interface18_Impl3 method3587(byte i, int i_0_) {
        ...
        Component319 class12 = aD4528.method3(i_0_, -6662);
        ...
        if (class12.aBoolean218 && aHa_Sub3_4526.method3666()) {
            ...
            interface18_impl3 = aHa_Sub3_4526.method3891(fs, i_1_, i_1_, Component83.aClass304_1662, -109, class12.aByte205 != 0);
        } else {
            int[] is;
            if (class12.anInt200 == 2 || !Component111.method1915((byte) 4, class12.aByte213)) is = aD4528.method6(-21540, i_1_, 0.7F, i_0_, false, i_1_);
    ...
    Component86(GlToolkitSub3 var_ha_Sub3, d var_d) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("fw.<init>(" + (var_ha_Sub3 != null ? "{...}" : "null") + ',' + (var_d != null ? "{...}" : "null") + ')'));
        }
    }
}
