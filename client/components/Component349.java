 ...
 */ extends Component327 implements Interface10 {
    ...
    public final void method44(int i, ha var_ha) {
        ...
        if (aR10036 != null || !aBoolean10003) {
            ...
            Component245 class2 = method2417(0, var_ha, 262144, true);
    ...
    Component349(ha var_ha, Component44 class51, int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, boolean bool_10_) {
        ...
        do {
            try {
                ...
                throw NpcDefinition.method2929(runtimeexception, ("dm.<init>(" + (var_ha != null ? "{...}" : "null") + ',' + (class51 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + bool + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ',' + bool_10_ + ')'));
            }
            break;
        } while (false);
    }
    ...
    final boolean method2391(ha var_ha, int i, int i_12_, int i_13_) {
        ...
        if (class64 != null) {
            ...
            if (DisplayModeManagerContainer50.aBoolean3870) return class64.method623(i_12_, i, class101, false, 0, Component72.anInt1906);
            return class64.method628(i_12_, i, class101, false, 0);
        }
        return false;
    }

    private final DisplayModeManagerContainer370 method2414(int i, ha var_ha, int i_14_) {
        ...
        Component245 class2 = method2417(0, var_ha, i_14_, false);
    ...
    final void method2380(ha var_ha, int i, boolean bool, RenderableObject class318_sub1, int i_16_, byte i_17_, int i_18_) {
        do {
            try {
                anInt10034++;
                ...
                throw NpcDefinition.method2929(runtimeexception, ("dm.N(" + (var_ha != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + (class318_sub1 != null ? "{...}" : "null") + ',' + i_16_ + ',' + i_17_ + ',' + i_18_ + ')'));
            }
            break;
        } while (false);
    }
    ...
    private final Component245 method2417(int i, ha var_ha, int i_20_, boolean bool) {
        anInt10007++;
    ...
    public final void method43(ha var_ha, int i) {
        ...
        r var_r;
        if (aR10036 == null && aBoolean10003) {
            Component245 class2 = method2417(i + 14218, var_ha, 262144, true);
            var_r = class2 != null ? class2.aR118 : null;
        } else {
            var_r = aR10036;
            aR10036 = null;
    ...
    final RenderableSub4 method2386(int i, ha var_ha) {
        ...
        DisplayModeManagerContainer204 class101 = var_ha.method3705();
        class101.method894(this.x, this.anInt6382, this.y);
        RenderableSub4 class318_sub4 = OutputStream_Sub2.method136(i, aBoolean10014, false);
        if (!DisplayModeManagerContainer50.aBoolean3870) this.aClass64_10028.method615(class101, class318_sub4.aClass318_Sub3Array6414[0], 0);
        else this.aClass64_10028.method608(class101, class318_sub4.aClass318_Sub3Array6414[0], Component72.anInt1906, 0);
