 ...
 */ extends Component327 implements Interface10 {
    ...
    Component29(GraphicsToolkit var_ha, Component44 class51, int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        super(i, i_0_, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_, class51.anInt895 == 1, Component7.decodedOperation1606(i_9_, -27939, i_8_));
        try {
    ...
    final int method2379(int i) {
        ...
        anInt10061++;
        return this.aClass235_10045.decodedOperation1664(i ^ 0x6462);
    }
    ...
    final RenderableSub4 method2386(int i, GraphicsToolkit var_ha) {
        ...
        DisplayModeManagerContainer204 class101 = var_ha.decodedOperation3705();
        class101.decodedOperation894(this.x, this.anInt6382, this.y);
        RenderableSub4 class318_sub4 = OutputStream_Sub2.decodedOperation136(i, aBoolean10056, false);
        this.aClass235_10045.decodedOperation1670(this.aShort8751, class101, this.aShort8747, var_ha, this.aShort8743, class64, true, (byte) -73, this.aShort8750);
        ...
        if ((this.aClass235_10045.aClass318_Sub10_3081) != null) {
            Component122 class98 = this.aClass235_10045.aClass318_Sub10_3081.decodedOperation2525();
        ...
        if (aClass30_10051 != null) ItemDefinitionProvider.decodedOperation1935(this.y, this.anInt6382, aClass30_10051, class64, false, this.x);
        else aClass30_10051 = (OggUrlStream.decodedOperation2967(this.x, class64, this.y, this.anInt6382, 2));
    ...
    public final void method44(int i, GraphicsToolkit var_ha) {
        ...
        anInt10059++;
        this.aClass235_10045.decodedOperation1667((byte) 116, var_ha);
    }
    ...
    public final boolean decodedOperation38(int i) {
        ...
        anInt10043++;
        return this.aClass235_10045.decodedOperation1665(2);
    }
    ...
    final void method2387(GraphicsToolkit var_ha, int i) {
        ...
        if (class64 != null) {
            DisplayModeManagerContainer204 class101 = var_ha.decodedOperation3705();
            class101.decodedOperation894(this.x, this.anInt6382, this.y);
            this.aClass235_10045.decodedOperation1670(this.aShort8751, class101, this.aShort8747, var_ha, this.aShort8743, class64, false, (byte) -73, this.aShort8750);
        }
    ...
    final int method2394(boolean bool) {
        ...
        anInt10038++;
        return this.aClass235_10045.decodedOperation1663(80);
    }
}
