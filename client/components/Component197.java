 ...
 */ extends Component269 implements Interface10 {
    ...
    Component197(GraphicsToolkit var_ha, Component44 class51, int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, boolean bool_6_) {
        ...
        do {
            try {
                ...
                throw NpcDefinition.method2929(runtimeexception, ("ge.<init>(" + (var_ha != null ? "{...}" : "null") + ',' + (class51 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + bool + ',' + i_4_ + ',' + i_5_ + ',' + bool_6_ + ')'));
            }
            break;
        } while (false);
    }
    ...
    final boolean method2391(GraphicsToolkit var_ha, int i, int i_9_, int i_10_) {
        ...
        if (class64 != null) {
            ...
            if (DisplayModeManagerContainer50.aBoolean3870) return class64.method623(i_9_, i, class101, false, 0, Component72.anInt1906);
    ...
    final void method2380(GraphicsToolkit var_ha, int i, boolean bool, RenderableObject class318_sub1, int i_11_, byte i_12_, int i_13_) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("ge.N(" + (var_ha != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + (class318_sub1 != null ? "{...}" : "null") + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ')'));
        }
    }
