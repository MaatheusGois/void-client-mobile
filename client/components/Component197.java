 ...
 */ extends Component269 implements Interface10 {
    ...
    Component197(GraphicsToolkit var_ha, Component44 class51, int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, boolean bool_6_) {
        super(i_1_, i_2_, i_3_, i, i_0_, ShaderProgramSub9.decodedOperation2175(i_5_, (byte) -34, i_4_));
        do {
            try {
                ...
                aBoolean10064 = (var_ha.method3682() && class51.aBoolean894 && !aBoolean10066 && Component192.preferences.aClass239_Sub7_7238.decodedOperation1748(-32350) != 0);
                int i_7_ = 2048;
                if (aBoolean10090) i_7_ |= 0x10000;
                Component245 class2 = decodedOperation2481(aBoolean10064, i_7_, -4, var_ha);
    ...
    public final void method40(int i) {
        ...
        if (i != -12031) decodedOperation38(-122);
    }

    final boolean method2391(GraphicsToolkit var_ha, int i, int i_9_, int i_10_) {
        anInt10070++;
        DisplayModeManagerContainer370 class64 = decodedOperation2482(var_ha, (byte) 126, 131072);
    ...
    final void method2387(GraphicsToolkit var_ha, int i) {
        if (i > -125) decodedOperation42(115);
        anInt10067++;
    }
    ...
    final ComponentDownloader method2381(GraphicsToolkit var_ha, int i) {
        anInt10075++;
        if (aClass30_10082 == null) aClass30_10082 = (OggUrlStream.decodedOperation2967(this.x, decodedOperation2482(var_ha, (byte) 117, 0), this.y, this.anInt6382, i + -5));
    ...
    final void method2380(GraphicsToolkit var_ha, int i, boolean bool, RenderableObject class318_sub1, int i_11_, byte i_12_, int i_13_) {
        try {
            if (i_12_ > -106) decodedOperation2388(-102);
    ...
    public final void method44(int i, GraphicsToolkit var_ha) {
        ...
        if (aR10094 == null && aBoolean10064) {
            Component245 class2 = decodedOperation2481(true, 262144, -4, var_ha);
    ...
    private final Component245 decodedOperation2481(boolean bool, int i, int i_15_, GraphicsToolkit var_ha) {
        ...
        return class51.decodedOperation476(var_ha, var_s, aByte10079, i, this.x, bool, var_s_16_, this.anInt6382, this.y, aByte10062, i_15_ + 132);
    }
    ...
    final RenderableSub4 method2386(int i, GraphicsToolkit var_ha) {
        ...
        DisplayModeManagerContainer204 class101 = var_ha.decodedOperation3705();
        class101.decodedOperation894(this.x, this.anInt6382, this.y);
        RenderableSub4 class318_sub4 = OutputStream_Sub2.decodedOperation136(i, aBoolean10076, false);
        ...
        else this.aClass64_10071.decodedOperation608(class101, class318_sub4.aClass318_Sub3Array6414[0], Component72.anInt1906, 0);
        return class318_sub4;
    }

    private final DisplayModeManagerContainer370 decodedOperation2482(GraphicsToolkit var_ha, byte i, int i_17_) {
        ...
        Component245 class2 = decodedOperation2481(false, i_17_, -4, var_ha);
    ...
    final boolean method2376(int i) {
        if (i >= -12) decodedOperation2388(-68);
        anInt10085++;
