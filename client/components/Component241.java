/* Component241 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component241
/**
 * RENAMED from `Class225` (JODE-obfuscated).
 ...
 */ {
    ...
    int anInt2923;
    int anInt2924;
    private DisplayModeManagerContainer204[] aClass101Array2925;
    int anInt2926;
    int anInt2927;
    int anInt2928;
    int[] anIntArray2929;
    private int anInt2930;
    static Component241 aClass225_2931 = new Component241();
    int anInt2932;
    ...
    final DisplayModeManagerContainer204[] method1618(ha var_ha, int i) {
        ...
        aClass101Array2925 = new DisplayModeManagerContainer204[this.anIntArrayArray2939.length];
        for (int i_0_ = i; (this.anIntArrayArray2939.length > i_0_); i_0_++) {
            ...
            if (i_1_ != 0 || i_2_ != 0 || i_3_ != 0 || i_4_ != 0 || i_5_ != 0 || i_6_ != 0) {
                DisplayModeManagerContainer204 class101 = aClass101Array2925[i_0_] = var_ha.method3654();
    ...
    private final void method1622(Buffer class348_sub49, int i, int i_12_) {
        anInt2903++;
        if (i_12_ == 1) {
    ...
    static {
        aClass173_2944 = new Component75();
        anInt2955 = 0;
        aClass243_2957 = new Component315();
    }
}
