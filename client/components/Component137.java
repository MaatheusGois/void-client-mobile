/* Component137 - Decompiled by JODE
...
abstract class Component137
/**
 * RENAMED from `Class135` (JODE-obfuscated).
 ...
 */ {
    ...
    Component137(GlToolkitSub2 var_ha_Sub2, int i, byte[] is, int i_4_, boolean bool) {
        try {
            aBoolean1923 = bool;
            this.aHa_Sub2_1927 = var_ha_Sub2;
            anInt1930 = i;
            anInt1921 = i_4_;
            OpenGL.glGenBuffersARB(1, CacheNodeSub1.anIntArray10478, 0);
            this.anInt1929 = CacheNodeSub1.anIntArray10478[0];
            method1152(-111);
    ...
    Component137(GlToolkitSub2 var_ha_Sub2, int i, Buffer buffer, int i_5_, boolean bool) {
        try {
            anInt1930 = i;
            anInt1921 = i_5_;
            this.aHa_Sub2_1927 = var_ha_Sub2;
