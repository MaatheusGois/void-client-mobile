 ...
 */ {
    ...
    static final Component184 method1151(int i, ha var_ha, int i_3_) {
        anInt1924++;
    ...
    Component137(ha_Sub2 var_ha_Sub2, int i, byte[] is, int i_4_, boolean bool) {
        try {
            aBoolean1923 = bool;
    ...
    Component137(ha_Sub2 var_ha_Sub2, int i, Buffer buffer, int i_5_, boolean bool) {
        try {
            anInt1930 = i;
            anInt1921 = i_5_;
            this.aHa_Sub2_1927 = var_ha_Sub2;
