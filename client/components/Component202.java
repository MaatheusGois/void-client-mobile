/* Component202 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.util.Random;

final class Component202
/**
 * RENAMED from `Class80` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    int anInt1407 = 0;
    private Component108 aClass197_1408;
    ...
    private Component108 aClass197_1413;
    private Component108 aClass197_1414;
    private Component108 aClass197_1415;
    private static int[] anIntArray1416 = new int[32768];
    private Component108 aClass197_1417;
    private Component108 aClass197_1418;
    private Component13 aClass349_1419;
    private Component108 aClass197_1420;
    int anInt1421;
    private int anInt1422 = 100;
    private Component108 aClass197_1423;
    private static int[] anIntArray1424;
    private Component108 aClass197_1425;
        ...
        if (aClass349_1419.anIntArray4299[0] > 0 || aClass349_1419.anIntArray4299[1] > 0) {
            ...
            if (i >= i_30_ + i_31_) {
                ...
                for (/**/; i_32_ < i_33_; i_32_++) {
                    int i_34_ = (int) (((long) anIntArray1409[i_32_ + i_30_] * (long) Component13.anInt4303) >> 16);
                    for (int i_35_ = 0; i_35_ < i_30_; i_35_++)
                        i_34_ += (int) (((long) (anIntArray1409[i_32_ + i_30_ - 1 - i_35_]) * (long) (Component13.anIntArrayArray4301[0][i_35_])) >> 16);
                ...
                for (; ; ) {
                    if (i_33_ > i - i_30_) i_33_ = i - i_30_;
                    for (/**/; i_32_ < i_33_; i_32_++) {
                        int i_37_ = (int) (((long) anIntArray1409[i_32_ + i_30_] * (long) Component13.anInt4303) >> 16);
                        for (int i_38_ = 0; i_38_ < i_30_; i_38_++)
                            i_37_ += (int) (((long) (anIntArray1409[i_32_ + i_30_ - 1 - i_38_]) * (long) (Component13.anIntArrayArray4301[0][i_38_])) >> 16);
                ...
                for (/**/; i_32_ < i; i_32_++) {
                    ...
                    for (int i_41_ = i_32_ + i_30_ - i; i_41_ < i_30_; i_41_++)
                        i_40_ += (int) (((long) (anIntArray1409[i_32_ + i_30_ - 1 - i_41_]) * (long) (Component13.anIntArrayArray4301[0][i_41_])) >> 16);
