 ...
 */ {
    ...
    static final void decodedOperation1372(int i) {
        RuntimeException_Sub1.anInt4596 = i;
        Component205.anInt5969 = 1;
        anInt2452++;
        long l = 0L;
        if (OggStreamReader.aString9043 == null) {
            WorldNameText.decodedOperation254(35, (byte) -101);
            return;
        } else {
            Buffer class348_sub49 = new Buffer(Component122.decodedOperation878((Component362.decodedOperation1039((OggStreamReader.aString9043), true)), -125));
            l = class348_sub49.readLong(-456577760);
            ObjectDeserializer.userHash = class348_sub49.readLong(-456577760);
        }
        Component72.decodedOperation1138(DisplayModeManagerContainer91.decodedOperation313(l, -100), true, "", (byte) -115);
    }

    static final void decodedOperation1373(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        anInt2450++;
        if (Component233.decodedOperation2547(i, (byte) 84) && i_5_ == -1391) {
    ...
    static final Component230 decodedOperation1374(int i, Buffer class348_sub49) {
    ...
    public static void decodedOperation1375(int i) {
