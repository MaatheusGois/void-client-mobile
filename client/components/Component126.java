 ...
 */ {
    ...
    static final void decodedOperation3513(int i) {
    ...
    static final void decodedOperation3514(byte i) {
        anInt4465++;
        for (NodeSub27 class348_sub27 = ((NodeSub27) HashNodeSub20.aClass262_9711.first(4)); class348_sub27 != null; class348_sub27 = (NodeSub27) HashNodeSub20.aClass262_9711.next((byte) 57)) {
            if (class348_sub27.anInt6893 == -1) {
                ...
                if ((class348_sub27.anInt6905 >= 0) && class348_sub27.anInt6896 >= 0 && (class348_sub27.anInt6905 < AbstractShaderSub4.anInt7319) && (class348_sub27.anInt6896 < ParametricDefinition.anInt9109)) Component357.decodedOperation1387(i + 26, class348_sub27);
            } else class348_sub27.unlink((byte) 39);
        }
        if (i != -105) decodedOperation3516(-128);
    }

    static final void decodedOperation3515(int i) {
        int i_2_ = 52 / ((33 - i) / 40);
        Definition.containers.clear(0);
        anInt4464++;
    }

    public static void decodedOperation3516(int i) {
        consoleInput = null;
