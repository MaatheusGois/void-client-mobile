 ...
 */ {
    ...
    public static void decodedOperation1325(int i) {
        friendRanks = null;
        if (i <= -123) aClass114_2279 = null;
    }

    static final BrowserUrlOpener decodedOperation1326(BrowserUrlOpener class348_sub16_sub3, int i) {
        anInt2278++;
    ...
    static final int decodedOperation1327(int i) {
        if (i <= 17) friendRanks = null;
        anInt2277++;
        return Sprite.anInt6924;
    }

    static final void decodedOperation1328(int i) {
