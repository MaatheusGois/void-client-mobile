/* Component163 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

abstract class Component163
/**
 * RENAMED from `Class246` (JODE-obfuscated).
 ...
 */ {
    ...
    static final void decodedOperation1885(int i, int i_0_, int i_1_, int i_2_, int i_3_, float[] fs, int i_4_, float f, int i_5_, int i_6_, float f_7_, float[] fs_8_) {
        try {
            ...
            throw NpcDefinition.wrapThrowable(runtimeexception, ("ca.D(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + (fs != null ? "{...}" : "null") + ',' + i_4_ + ',' + f + ',' + i_5_ + ',' + i_6_ + ',' + f_7_ + ',' + (fs_8_ != null ? "{...}" : "null") + ')'));
        }
    }
