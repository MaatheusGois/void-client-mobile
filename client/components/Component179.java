/* Component179 - Decompiled by JODE
...
final class Component179
/**
 * RENAMED from `Class348_Sub23_Sub4` (JODE-obfuscated).
 * Evidence: subclass of OggStream (hierarchy)
 */ extends OggStream {
    ...
    Component179(OggStreamState oggstreamstate) {
    ...
    static final void method2987(int i, int i_7_, int i_8_, int i_9_, int i_10_) {
        ...
        if (i_7_ == 8 || i_7_ == 16) {
            ...
            Component186 class357 = Component335.aClass357ArrayArrayArray2029[i][i_10_][i_8_];
            if (class357 != null) {
                if (i_7_ != 1) {
    ...
    static final void method2988(boolean bool) {
        NodeCache.aHa1098.xa(((float) Component192.aClass348_Sub51_3959.aClass239_Sub10_7232.method1764(-32350) * 0.1F + 0.7F) * Component214.aFloat2137);
        anInt9049++;
        NodeCache.aHa1098.ZA(DisplayModeManagerContainer96.anInt4703, Component283.aFloat4626, TeleportHandler.aFloat4455, (float) (Component158.anInt325 << 2), (float) (Component349.anInt10023 << 2), (float) (Component169.anInt2601 << 2));
