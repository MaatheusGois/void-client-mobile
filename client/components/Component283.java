/* Component283 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component283
/**
 * RENAMED from `Class244` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ implements d {
    static int anInt4609 = -1;
    static int anInt4610;
    private final Component319[] aClass12Array4611;
    ...
    public final Component319 method3(int i, int i_3_) {
        anInt4621++;
    ...
    Component283(CacheStore class45, CacheStore class45_12_, CacheStore class45_13_) {
        try {
            ...
            for (int i = 0; anInt4625 > i; i++) {
                if (class348_sub49.readUnsignedByte(255) == 1) aClass12Array4611[i] = new Component319();
            }
