 ...
 */ {
    ...
    static final GlRectangleTexture decodedOperation3583(boolean bool, byte[] is, int i, int i_0_, GlToolkitSub2 var_ha_Sub2, int i_1_, int i_2_, int i_3_) {
        try {
            anInt4521++;
            if (i_1_ > -17) return null;
            if (var_ha_Sub2.aBoolean7793 || Component353.decodedOperation1436(-58, i_3_) && Component353.decodedOperation1436(-68, i_0_)) return new GlRectangleTexture(var_ha_Sub2, 3553, i_2_, i_3_, i_0_, bool, is, i);
    ...
    static final boolean decodedOperation3584(int i, int i_4_) {
