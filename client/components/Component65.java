/* Component65 - Decompiled by JODE
...
final class Component65
/**
 * RENAMED from `Class104` (JODE-obfuscated).
 ...
 */ {
    ...
    static CacheStore aClass45_1627;
    ...
    private final void method952(int i, int i_13_, int i_14_, int i_15_, int i_16_) {
        ...
        if (aClass232ArrayArray1623 != null) {
            ...
            for (int i_21_ = i_17_; i_18_ >= i_21_; i_21_++) {
                Component228[] class232s = aClass232ArrayArray1623[i_21_];
        ...
        if (bool) {
            ...
            for (int i_39_ = 0; anInt1625 > i_39_; i_39_++) {
                ...
                for (int i_42_ = 0; anInt1618 > i_42_; i_42_++) {
                    ...
                    Component182 class348_sub49_sub1 = aHa_Sub2_1616.aClass348_Sub49_Sub1_7798;
    ...
    final void method957(int i) {
        ...
        for (int i_59_ = i; i_59_ < anInt1625; i_59_++) {
            for (int i_60_ = 0; anInt1618 > i_60_; i_60_++)
                aClass232ArrayArray1623[i_60_][i_59_] = new Component228(aHa_Sub2_1616, this, aS_Sub2_1622, i_60_, i_59_, anInt1613, 1 + 128 * i_60_, 128 * i_59_ + 1);
        }
    }
