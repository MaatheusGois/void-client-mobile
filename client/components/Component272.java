 ...
 */ extends Component339 {
    ...
    final int decodedOperation1727(int i) {
        if (i != -32350) anInt5871 = 39;
        anInt5869++;
        return this.preferenceValue;
    }

    static final void decodedOperation1728(int i, int i_2_, int i_3_, boolean bool, int i_4_) {
        anInt5860++;
        if (Component233.decodedOperation2547(i_3_, (byte) 84)) AbstractShaderSub1.decodedOperation3534(false, i_2_, i_4_, bool, i, (DefinitionSub33.openInterfaces[i_3_]));
    }
    ...
    final boolean decodedOperation1729(int i) {
        if (i <= 85) return true;
        anInt5861++;
        return true;
    }

    static final void decodedOperation1730(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_) {
        if (i_10_ != -128) decodedOperation1730(-6, -95, 101, -81, 56, 14, -29, -19);
        anInt5868++;
        int i_12_ = -i_9_ + i_5_;
        int i_13_ = i_9_ + i_6_;
    ...
    static final void decodedOperation1731(int i) {
        anInt5863++;
        ...
        if (i != 1) decodedOperation1734(-88, null, (byte) -126, false);
    }

    static final boolean decodedOperation1732(byte i, int i_21_) {
        anInt5865++;
        int i_22_ = i & 0xff;
    ...
    final void validateValue(boolean bool) {
        anInt5864++;
        if (decodedOperation1735(bool)) {
            if (this.preferences.aClass239_Sub25_7271.decodedOperation1830((byte) -97) && !DisplayModeManagerContainer346.decodedOperation1210((byte) -94, this.preferences.aClass239_Sub25_7271.getPreferenceValue(-32350))) this.preferenceValue = 1;
            if (this.preferences.aClass239_Sub8_7254.decodedOperation1751(-32350) == 1) this.preferenceValue = 1;
        }
    ...
    static final void decodedOperation1733(byte i, int i_23_) {
        anInt5870++;
        if (i != -78) decodedOperation1732((byte) 80, -38);
        RSARequest class348_sub42_sub15 = FriendLoginMessage.decodedOperation2516(i_23_, (byte) 105, 11);
        class348_sub42_sub15.decodedOperation3251(-16058);
    }

    final int getValue(int i, int i_24_) {
        anInt5866++;
        if (NodeCache.decodedOperation576(i_24_, 29)) {
            if (this.preferences.aClass239_Sub25_7271.decodedOperation1830((byte) -97) && !DisplayModeManagerContainer346.decodedOperation1210((byte) -113, this.preferences.aClass239_Sub25_7271.getPreferenceValue(-32350))) return 3;
            if (this.preferences.aClass239_Sub8_7254.decodedOperation1751(-32350) == 1) return 3;
        }
        if (i_24_ == i) return 3;
        if (NodeCache.decodedOperation576(i_24_, i ^ 0x56)) return 2;
        return 1;
    }

    static final Component48 decodedOperation1734(int i, GraphicsToolkit var_ha, byte i_25_, boolean bool) {
        try {
            anInt5859++;
            if (i == -1) return null;
            ...
            if (class352 != null) {
                if (bool && class352.aClass143_4333 == null) {
                    Component184 class143 = Component98.decodedOperation1766((byte) -76, i, s.aClass45_4585);
            ...
            Component170[] class207s = Component170.decodedOperation1523(DisplayModeManagerContainer271.aClass45_518, i);
            if (class207s == null) return null;
            Component184 class143 = Component98.decodedOperation1766((byte) -39, i, s.aClass45_4585);
            if (class143 == null) return null;
    ...
    final boolean decodedOperation1735(boolean bool) {
        if (bool != false) anInt5871 = -86;
        anInt5858++;
        return NodeCache.decodedOperation576(this.preferenceValue, 29);
    }
}
