/* Component350 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component350
/**
 * RENAMED from `Class59_Sub1_Sub1` (JODE-obfuscated).
                                                                                                                ...
                                                                                                                do {
                                                                                                                    ...
                                                                                                                    do {
                                                                                                                        ...
                                                                                                                        do {
                                                                                                                                                        ...
                                                                                                                                                        do {
                                                                                                                                                            ...
                                                                                                                                                            do {
                                                                                                                                                                do {
                                                                                                                                                                    ...
                                                                                                                                                                    } else return new DefinitionSub15();
                                                                                                                                                                    return new NsnDefinition();
                                                                                                                                                                } while (false);
                                                                                                                                                                return new DefinitionSub19();
                                                                                                                                                            } while (false);
                                                                                                                                                            return new DefinitionSub4();
                                                                                                                                                        } while (false);
                                                                                                                                                        return new DefinitionSub22();
                                                                                                                                                    } while (false);
                                                                                                                                                    return new DefinitionSub37();
                                                                                                                                                } while (false);
                                                                                                                                                return new DefinitionSub38();
                                                                                                                                            } while (false);
                                                                                                                                            return new ToolbarRefreshDefinition();
                                                                                                                                        } while (false);
                                                                                                                            ...
                                                                                                                            return new DefinitionSub26();
                                                                                                                        } while (false);
                                                                                                                        return new DefinitionSub36();
                                                                                                                    } while (false);
                                                                                                                    return new DefinitionSub20();
                                                                                                                } while (false);
                                                                                                                return new DefinitionSub11();
                                                                                                            } while (false);
                                                                                                            return new DefinitionSub5();
                                                                                                        } while (false);
                                                                                                        return new DefinitionSub2();
                                                                                                    } while (false);
                                                                                                    return new DefinitionSub30();
                                                                                                } while (false);
                                                                                                return new DefinitionSub17Sub1();
                                                                                            } while (false);
                                                                                            return new DefinitionSub6();
                                                                                        } while (false);
                                                                                        return new DefinitionSub31();
                                                                                    } while (false);
                                                                                    return new DefinitionSub27();
                                                                                } while (false);
                                                                                return new DefinitionSub32();
                                                                            } while (false);
                                                                            return new DefinitionSub33();
                                                                        } while (false);
                                                                        return new DefinitionSub13();
                                                                    } while (false);
                                                                    return (new PrimitiveTypeDefinition());
                                                                } while (false);
                                                                return (new ParametricDefinition());
                                                            } while (false);
                                                            return (new DefinitionSub24());
                                                        } while (false);
                                                        return (new DefinitionSub23());
                                                    } while (false);
                                                    return (new DefinitionSub39());
                                                } while (false);
                                                return (new DefinitionSub10());
                                            } while (false);
                                            return new DefinitionSub25();
                                        } while (false);
                                        return new DefinitionSub35();
                                    } while (false);
                                    return new LoggedOutDefinition();
                                } while (false);
                                return new DefinitionSub8();
                            } while (false);
                            return new DefinitionSub9();
                        } while (false);
                        return new DefinitionSub29();
                    } while (false);
                    return new DefinitionSub21();
                } while (false);
                return new DefinitionSub28();
            } while (false);
            return new DefinitionSub17();
        } while (false);
        return null;
    }
