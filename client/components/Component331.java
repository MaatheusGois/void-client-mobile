/* Component331 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import java.util.Random;

final class Component331
/**
 * RENAMED from `Class111` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    private final int anInt1715;
    static int anInt1716;
    static int anInt1717;
    private final CacheStore aClass45_1718;
    static int anInt1719;
    static int anInt1720 = -1;
    static int anInt1721;
    static Component183 aClass114_1722 = new Component183(8, -2);
