/* Component187 - Decompiled by JODE
 ...
 */ {
    ...
    private static final void method1549(DisplayModeManagerContainer172 class40) {
        ...
        int[] is = ParticleShader.anIntArray6228;
        ...
        ParticleShader.anIntArray6228 = is;
    ...
    private static final void method1550(DisplayModeManagerContainer172 class40) {
        class40.anInt541 = 0;
        for (int i = 0; i < 256; i++) {
    ...
    private static final void method1552(DisplayModeManagerContainer172 class40) {
        boolean bool = false;
        ...
        while (bool_50_) {
            ...
            while (i_86_ != i_74_) {
                if (i_86_ == 0 || i_86_ == 1) {
                    ...
                    for (/**/; i_87_ > 0; i_87_--) {
                        ParticleShader.anIntArray6228[i_81_] = i_52_ & 0xff;
                        i_81_++;
                    }
                } else {
                    int i_90_ = i_86_ - 1;
                    ...
                    ParticleShader.anIntArray6228[i_81_] = (class40.aByteArray528[i_51_ & 0xff] & 0xff);
                    i_81_++;
                    if (i_76_ == 0) {
                        i_75_++;
                        i_76_ = 50;
            ...
            for (int i_102_ = 0; i_102_ < i_81_; i_102_++) {
                i_52_ = (byte) (ParticleShader.anIntArray6228[i_102_] & 0xff);
                ParticleShader.anIntArray6228[(class40.anIntArray557[i_52_ & 0xff])] |= i_102_ << 8;
                class40.anIntArray557[i_52_ & 0xff]++;
            }
            class40.anInt552 = (ParticleShader.anIntArray6228[class40.anInt530] >> 8);
            class40.anInt555 = 0;
            class40.anInt552 = ParticleShader.anIntArray6228[class40.anInt552];
