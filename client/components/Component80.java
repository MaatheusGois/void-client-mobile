/* Component80 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

abstract class Component80
/**
 * RENAMED from `Class299` (JODE-obfuscated).
 ...
 */ {
    ...
    static final void method2255(int i, int i_3_, byte i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        ...
        while (i_11_ > i_9_) {
            ...
            i_12_ += i_15_;
            if (i_14_ >= 0 && i_13_ >= 1) {
                DisplayModeManagerContainer207.anIntArray9757[i_13_] = i_9_;
                i_13_--;
                i_14_ -= i_13_ << 1;
            }
            i_9_++;
            if (i_12_ >= 0) {
                ...
                i_12_ -= i_11_ << 1;
                if (i_10_ <= i_11_) {
                    int[] is_19_ = DisplayModeManagerContainer167.anIntArrayArray255[i_11_ + i_6_];
                    ...
                    int i_25_ = DisplayModeManagerContainer207.anIntArray9757[i_11_];
                    int i_26_ = i_9_ + i_3_;
                    int i_27_ = i_3_ - i_9_;
            ...
            int[] is_31_ = DisplayModeManagerContainer167.anIntArrayArray255[-i_9_ + i_6_];
