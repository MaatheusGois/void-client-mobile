/* Component235 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component235
/**
 * RENAMED from `Class264` (JODE-obfuscated).
 ...
 */ {
    ...
    static Component183 aClass114_3368 = new Component183(112, 4);
    static int anInt3369;
    int anInt3370;
    static Component183 aClass114_3371 = new Component183(63, 5);
    ...
    static Component24[] aClass105Array3378;

    static final boolean decodedOperation2015(int i, int i_0_, int i_1_) {
        anInt3375++;
        if (i_1_ != 7) return false;
        return ((InterfaceRenderer.decodedOperation2217(i_0_, i, i_1_ ^ 0x7) | ParametricDefinition.decodedOperation3056(115, i, i_0_) | DefinitionSub9.decodedOperation3073(i_0_, i, (byte) 50)) & DisplayModeManagerContainer254.decodedOperation1258(i, -9301, i_0_));
    }

    final void decodedOperation2016(int i, int i_2_) {
        if (i != 15615) decodedOperation2019((byte) 98);
        anInt3365 = 0;
        this.anInt3370 = i_2_;
        anInt3377++;
    }

    static final void decodedOperation2017(int i, DisplayModeManagerContainer167 class17, int i_3_) {
        anInt3367++;
        if (Component335.anInt2021 < 50 && (class17 != null && class17.anIntArrayArray264 != null && (class17.anIntArrayArray264.length > i) && class17.anIntArrayArray264[i] != null)) {
            ...
            if (i_3_ > 8) {
                int i_8_ = 256;
                if (class17.anIntArray236 != null && class17.anIntArray265 != null) i_8_ = Component40.decodedOperation2257((class17.anIntArray265[i]), (class17.anIntArray236[i]), (byte) -125);
                if (class17.aBoolean268) AudioLine.decodedOperation2090(i_7_, i_8_, false, (byte) -35, 255, 0, i_5_);
                else NodeSub20.decodedOperation2947(true, 255, i_5_, i_7_, 0, i_8_);
            }
        }
    }

    public static void decodedOperation2018(int i) {
        aClass105Array3378 = null;
        aClass114_3371 = null;
        aClass114_3368 = null;
        if (i != 0) decodedOperation2015(30, 1, -62);
    }

    final int decodedOperation2019(byte i) {
        if (i >= -18) anInt3373 = 32;
        anInt3369++;
        return this.anInt3370 & 0x3fff;
    }

    final boolean decodedOperation2020(int i, int i_9_, int i_10_, byte i_11_) {
        anInt3366++;
        int i_12_ = anInt3365;
    ...
    final void decodedOperation2021(byte i) {
        anInt3364++;
        this.anInt3370 &= 0x3fff;
        if (i < 77) decodedOperation2021((byte) 36);
    }
