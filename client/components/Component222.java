...
final class Component222
/**
 * RENAMED from `Class208` (JODE-obfuscated).
    ...
    final void method1528(byte i, int i_1_, int i_2_, byte[] is) throws IOException {
        ...
        synchronized (this) {
            ...
            if (i_1_ + anInt2713 > anInt2715) {
                ...
                Component313.method1577(is, i_2_, aByteArray2706, anInt2713, i_4_);
                Component313.method1577(is, i_2_ - -i_4_, aByteArray2706, 0, -i_4_ + i_1_);
            } else Component313.method1577(is, i_2_, aByteArray2706, anInt2713, i_1_);
