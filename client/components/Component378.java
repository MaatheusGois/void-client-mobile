/* Component378 - Decompiled by JODE
...
final class Component378
/**
 * RENAMED from `Class310_Sub3` (JODE-obfuscated).
 * Evidence: subclass of DisplayModeManagerContainer318 (hierarchy)
 */ extends DisplayModeManagerContainer318 implements Interface18_Impl1 {
    ...
    Component378(D3DToolkit class378, DisplayModeManagerContainer42 class304, int i, int i_0_, int i_1_, byte[] is) {
        super(class378, class304, Component342.aClass68_1183, false, i_1_ * i_0_ * i);
        anInt6338 = i;
        anInt6337 = i_1_;
        anInt6339 = i_0_;
