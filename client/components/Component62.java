 ...
 */ {
    ...
    final void decodedOperation1219(int i) {
        anInt2080++;
    ...
    final void decodedOperation1220(byte i, int i_0_, int i_1_) {
        anInt2081++;
    ...
    static final boolean decodedOperation1221(int i, int i_3_, int i_4_) {
        if (i != -3157) return false;
        anInt2088++;
        return Component40.decodedOperation2259(0, i_4_, i_3_) | (i_3_ & 0x70000) != 0 || Component118.decodedOperation2187(i_3_, -79, i_4_);
    }

    final void decodedOperation1222(boolean bool) {
        if (bool != true) decodedOperation1222(false);
        synchronized (aClass60_2083) {
    ...
    static final HashNodeSub19 decodedOperation1223(int i, int i_5_, int i_6_, Component224 class273) {
        anInt2086++;
        int i_7_ = class273.id | i << 10;
        HashNodeSub19 class348_sub42_sub19 = ((HashNodeSub19) ImageCacheStore.aClass308_4036.decodedOperation2302((long) i_7_ << 16, (byte) -91));
        ...
        if (is != null) {
            ...
            try {
                class348_sub42_sub19 = RenderableSub4.decodedOperation2502(is, -85);
            } catch (Exception exception) {
                throw new RuntimeException(exception.getMessage() + " S: " + i_7_);
            }
            class348_sub42_sub19.aClass273_9691 = class273;
            ImageCacheStore.aClass308_4036.decodedOperation2305((long) i_7_ << 16, class348_sub42_sub19, -1);
            return class348_sub42_sub19;
        }
        i_7_ = class273.id | 65536 + i_5_ << 10;
        class348_sub42_sub19 = ((HashNodeSub19) ImageCacheStore.aClass308_4036.decodedOperation2302((long) i_7_ << 16, (byte) -31));
        if (class348_sub42_sub19 != null) return class348_sub42_sub19;
        is = (Component22.aClass45_1743.getSingletonFile((byte) 73, Component22.aClass45_1743.getGroupIdByHash(i_7_, (byte) -107)));
        if (is != null) {
            if (is.length <= 1) return null;
            try {
                class348_sub42_sub19 = RenderableSub4.decodedOperation2502(is, -101);
            } catch (Exception exception) {
                throw new RuntimeException(exception.getMessage() + " S: " + i_7_);
            }
            class348_sub42_sub19.aClass273_9691 = class273;
        ...
        class348_sub42_sub19 = ((HashNodeSub19) ImageCacheStore.aClass308_4036.decodedOperation2302((long) i_7_ << 16, (byte) -107));
        if (class348_sub42_sub19 != null) return class348_sub42_sub19;
        is = (Component22.aClass45_1743.getSingletonFile((byte) 73, Component22.aClass45_1743.getGroupIdByHash(i_7_, (byte) 104)));
        if (is != null) {
            if (is.length <= 1) return null;
            try {
                class348_sub42_sub19 = RenderableSub4.decodedOperation2502(is, -110);
            } catch (Exception exception) {
                throw new RuntimeException(exception.getMessage() + " S: " + i_7_);
            }
            class348_sub42_sub19.aClass273_9691 = class273;
    ...
    final void decodedOperation1224(int i, byte i_8_) {
        synchronized (aClass60_2083) {
            if (i_8_ > -95) decodedOperation1225(-75, (byte) -61);
    ...
    final Component274 decodedOperation1225(int i, byte i_9_) {
        anInt2085++;
        ...
        class42.anInt581 = i;
        if (is != null) class42.decodedOperation379(new Buffer(is), 109);
        class42.decodedOperation372(-25359);
        synchronized (aClass60_2083) {
