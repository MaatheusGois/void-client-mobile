 ...
 */ {
    ...
    static final void method3489(int i) {
        NodeCache.aHa1098.xa(((float) Component192.aClass348_Sub51_3959.aClass239_Sub10_7232.method1764(-32350) * 0.1F + 0.7F) * 1.1523438F);
        anInt4413++;
    ...
    Component142(int[] is, int[] is_1_, int[] is_2_, float[][] fs) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("ew.<init>(" + (is != null ? "{...}" : "null") + ',' + (is_1_ != null ? "{...}" : "null") + ',' + (is_2_ != null ? "{...}" : "null") + ',' + (fs != null ? "{...}" : "null") + ')'));
        }
    }
}
