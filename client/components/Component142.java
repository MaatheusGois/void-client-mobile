 ...
 */ {
    ...
    public static void decodedOperation3488(int i) {
        if (i < 25) decodedOperation3489(30);
        aClass351_4418 = null;
        aClass60_4417 = null;
    }

    static final void decodedOperation3489(int i) {
        NodeCache.aHa1098.DualToolkit(((float) Component192.preferences.aClass239_Sub10_7232.decodedOperation1764(-32350) * 0.1F + 0.7F) * 1.1523438F);
        anInt4413++;
