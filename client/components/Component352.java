 ...
 */ {
    ...
    static final int decodedOperation384(int i, int i_0_, int i_1_) {
        anInt623++;
        int i_2_ = (Component296.decodedOperation1115(i - 1, i_1_ - 1, (byte) 91) - (-Component296.decodedOperation1115(i - -1, i_1_ + -1, (byte) -53) + -Component296.decodedOperation1115(-1 + i, 1 + i_1_, (byte) -90)) + Component296.decodedOperation1115(i - -1, i_1_ - -1, (byte) -82));
        int i_3_ = (Component296.decodedOperation1115(i + -1, i_1_, (byte) -118) + (Component296.decodedOperation1115(i - i_0_, i_1_, (byte) 118) - (-Component296.decodedOperation1115(i, -1 + i_1_, (byte) 109) + -Component296.decodedOperation1115(i, 1 + i_1_, (byte) 89))));
        int i_4_ = Component296.decodedOperation1115(i, i_1_, (byte) -59);
        return i_4_ / 4 + i_3_ / 8 + i_2_ / 16;
    }

    static final void decodedOperation385(boolean bool, Component251 class237_sub1, byte[][] is) {
        do {
            try {
                anInt622++;
                int[] is_5_ = {-1, 0, 0, 0, 0};
                                ...
                                if (!class237_sub1.aBoolean3109 || i_9_ == 0) {
                                    ...
                                    for (int i_14_ = 0; i_14_ < (OggStreamReader.anIntArray9042).length; i_14_++) {
                                        if ((i_13_ == (OggStreamReader.anIntArray9042[i_14_])) && is[i_14_] != null) {
                                            ...
                                            class237_sub1.decodedOperation1684(i_6_ * 8, i, -1, class348_sub49, i_12_, 8 * i_7_, i_11_, (NodeSub45.aClass361Array7108), i_10_, i_9_);
                                            class237_sub1.decodedOperation1696(class348_sub49, false, i_12_, i_11_, 8 * i_6_, i, i_10_, 8 * i_7_, NodeSub8.toolkit, is_5_[0] != -1 ? null : is_5_, i_9_);
                                            break;
                                        }
                                    }
                                }
                ...
                if (is_5_[0] != -1) {
                    Component293.aClass305_3304 = ComponentDownloader.aClass84_413.decodedOperation823(is_5_[2], is_5_[3], is_5_[1], -109, (Component132.aClass25_1813), is_5_[0]);
    ...
    static final void decodedOperation386(byte i) {
        anInt621++;
        if (i != -106) decodedOperation386((byte) 21);
    ...
    static final void decodedOperation388(int i, int i_18_, int i_19_, Component203 class318_sub1_sub5, Component203 class318_sub1_sub5_20_) {
        Component186 class357 = NodeSub46.decodedOperation3321(i, i_18_, i_19_);
        if (class357 != null) {
