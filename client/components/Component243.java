 ...
 */ {
    ...
    static final void decodedOperation352(int i) {
        anInt483++;
        DisplayModeManagerContainer133.decodedOperation1265(i + 15);
        ...
        HashNodeSub18.decodedOperation3273(true, i + -82, Component16.decodedOperation1326(null, 9));
        Component276.aClass279_2596 = Component321.decodedOperation1439(2048, OggUrlStream.aClass297_8992, DisplayModeManagerContainer50.gameCanvas, i, 7);
        Component276.aClass279_2596.decodedOperation2088(false, PlayerState.aClass348_Sub16_Sub4_7065);
    }

    static final int decodedOperation353(int i, int i_0_, int i_1_) {
        anInt485++;
