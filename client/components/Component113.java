/* Component113 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component113
/**
 * RENAMED from `Class181` (JODE-obfuscated).
 ...
 */ {
    ...
    static final void decodedOperation1367(int i, int i_0_, float f, int i_1_, float[] fs, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, float[] fs_7_) {
        try {
            ...
            throw NpcDefinition.wrapThrowable(runtimeexception, ("qb.E(" + i + ',' + i_0_ + ',' + f + ',' + i_1_ + ',' + (fs != null ? "{...}" : "null") + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + (fs_7_ != null ? "{...}" : "null") + ')'));
        }
    }
