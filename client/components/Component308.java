/* Component308 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component308
/**
 * RENAMED from `Class50_Sub2` (JODE-obfuscated).
 ...
 */ extends Component47 {
    ...
    Component308(int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_) {
