 ...
 */ {
    ...
    static final void decodedOperation1202(int i) {
        anInt2052++;
    ...
    final Component225 decodedOperation1203(byte i, int i_3_) {
        anInt2056++;
        ...
        if (is != null) class34.decodedOperation346(~i, new Buffer(is));
        synchronized (aClass60_2050) {
    ...
    final void decodedOperation1204(int i) {
        synchronized (aClass60_2050) {
    ...
    static final HashNodeSub14 decodedOperation1205(int i, boolean bool, CacheStore class45, int i_4_) {
        anInt2053++;
        Buffer class348_sub49 = new Buffer(class45.getFile(-1860, i_4_, i));
        if (bool != true) decodedOperation1208(102);
        ...
        class348_sub42_sub14.decodedOperation3240((byte) 37);
        return class348_sub42_sub14;
    }

    final void decodedOperation1206(byte i) {
    ...
    final void decodedOperation1207(int i, int i_7_) {
        anInt2055++;
        if (i == -17452) {
            synchronized (aClass60_2050) {
    ...
    public static void decodedOperation1208(int i) {
        aClass113_2047 = null;
        int i_8_ = -65 / ((i - -58) / 57);
    }
