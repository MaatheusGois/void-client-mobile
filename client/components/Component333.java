/* Component333 - Decompiled by JODE
...
final class Component333
/**
 * RENAMED from `Class280` (JODE-obfuscated).
 ...
 */ {
    ...
    private final RenderableSub9Sub2[][] aClass318_Sub9_Sub2ArrayArray3632;
    ...
    private final Component387 aClass130_3637;
    private final Interface5_Impl1 anInterface5_Impl1_3638;
    static int anInt3639;
    static int anInt3640;
    static Component183 aClass114_3641 = new Component183(79, 3);
        ...
        try {
            ...
            if (var_ha_Sub3.aClass101_Sub2_8080 != null) {
                ...
                try {
                    ...
                    for (RenderableSub9 class318_sub9_10_ = (class318_sub9.aClass318_Sub9_6469); class318_sub9 != class318_sub9_10_; class318_sub9_10_ = (class318_sub9_10_.aClass318_Sub9_6469)) {
                        RenderableSub9Sub2 class318_sub9_sub2 = (RenderableSub9Sub2) class318_sub9_10_;
                    ...
                    RenderableSub9 class318_sub9_14_ = class318_sub9.aClass318_Sub9_6469;
                    i_7_ = 0;
                    int i_15_ = -2;
                    boolean bool = true;
                    ...
                    while (class318_sub9_14_ != class318_sub9) {
                        ...
                        for (/**/; class318_sub9_14_ != class318_sub9; class318_sub9_14_ = (class318_sub9_14_.aClass318_Sub9_6469)) {
                            RenderableSub9Sub2 class318_sub9_sub2 = (RenderableSub9Sub2) class318_sub9_14_;
                            if (bool_16_) {
                ...
                for (int i_58_ = i + -1; i_58_ >= 0; i_58_--) {
                    ...
                    if (i_59_ > 0) {
                        for (int i_60_ = i_59_ + -1; i_60_ >= 0; i_60_--) {
                            RenderableSub9Sub2 class318_sub9_sub2 = (aClass318_Sub9_Sub2ArrayArray3632[i_58_][i_60_]);
                        ...
                        if (anIntArray3636[i_58_] > 64) {
                            ...
                            for (int i_71_ = -1 + anIntArray3627[i_70_]; i_71_ >= 0; i_71_--) {
                                RenderableSub9Sub2 class318_sub9_sub2 = (aClass318_Sub9_Sub2ArrayArray3642[i_70_][i_71_]);
                ...
                for (int i_35_ = -1 + i; i_35_ >= 0; i_35_--) {
                    ...
                    if (i_36_ > 0) {
                        for (int i_37_ = i_36_ + -1; i_37_ >= 0; i_37_--) {
                            RenderableSub9Sub2 class318_sub9_sub2 = (aClass318_Sub9_Sub2ArrayArray3632[i_35_][i_37_]);
                        ...
                        if (anIntArray3636[i_35_] > 64) {
                            ...
                            for (int i_48_ = anIntArray3627[i_47_] + -1; i_48_ >= 0; i_48_--) {
                                RenderableSub9Sub2 class318_sub9_sub2 = (aClass318_Sub9_Sub2ArrayArray3642[i_47_][i_48_]);
