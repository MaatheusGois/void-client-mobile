 ...
 */ {
    ...
    public static void decodedOperation815(boolean bool) {
        if (bool != false) decodedOperation815(true);
        friendNames = null;
    }
    ...
    Component178(GlToolkitSub2 var_ha_Sub2) {
        ...
        NodeSub37.decodedOperation3030(8, var_ha_Sub2);
        if (this.aBoolean1442) {
            ...
            if (class188.decodedOperation1414(35632)) {
                ...
                if (!class188.decodedOperation1413(this.aClass258_Sub1_1443, class258_sub1, -114, 2.0F)) {
                    this.aClass258_Sub1_1443.method1952(-19948);
                    this.aClass258_Sub1_1443 = null;
                } else this.aClass258_Sub1_1443.decodedOperation1950(-82);
                class258_sub1.method1952(-19948);
            }
        } else {
            this.aClass258_Sub3Array1444 = new GlTexture[16];
            for (int i = 0; i < 16; i++) {
                byte[] is = Component75.decodedOperation1331((byte) 97, Component244.anObject4177, 2 * (128 * i) * 128, 32768);
            ...
            for (int i = 0; i < 16; i++) {
                byte[] is = Component75.decodedOperation1331((byte) 110, Component144.anObject3985, 2 * i * 16384, 32768);
