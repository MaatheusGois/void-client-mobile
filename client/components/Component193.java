/* Component193 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component193
/**
 * RENAMED from `Class253` (JODE-obfuscated).
 ...
 */ {
    ...
    private final void method1923(int i, int i_13_, Buffer class348_sub49) {
        anInt3254++;
        if (i_13_ == 4) {
            if (i != 1) {
                if (i != 2) {
