/* Component256 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component256
/**
 * RENAMED from `Class239_Sub25` (JODE-obfuscated).
 ...
 */ extends Component339 {
    ...
    static RenderableSub9Sub2Sub1[] aClass318_Sub9_Sub2_Sub1Array6103;
        ...
        if (i == 1415665776) {
            for (int i_6_ = 0; i_6_ < 512; i_6_++) {
                ...
                for (int i_8_ = 0; i_8_ < 128; i_8_++) {
                    ...
                    Component380.anIntArray4983[i_5_++] = i_23_;
                }
            }
        }
    }
    ...
    Component256(int i, NodeSub51 class348_sub51) {
        super(i, class348_sub51);
    }

    Component256(NodeSub51 class348_sub51) {
