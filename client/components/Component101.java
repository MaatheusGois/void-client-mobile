 ...
 */ {
    ...
    final DisplayModeManagerContainer370 method1226(Interface17 interface17, DisplayModeManagerContainer167 class17, Component280[] class182s, boolean bool, DisplayModeManagerContainer320 class255, int i, DisplayModeManagerContainer167 class17_0_, int i_1_, boolean bool_2_, int i_3_, int[] is, int i_4_, Component324 class150, int i_5_, GraphicsToolkit var_ha, DisplayModeManagerContainer347 class278, Component344 class87, int i_6_, int i_7_, int i_8_, DisplayModeManagerContainer1 class261) {
        try {
            ...
            if (class17_0_ != null && (class17_0_.anInt249 >= 0 || class17_0_.anInt261 >= 0)) {
                ...
                if (class17_0_.anInt249 >= 0) {
                    if (class17_0_.anInt249 == 65535) {
                        ...
                        is_10_[5] = Component224.method2057((class17_0_.anInt249), 1073741824);
                        l ^= (long) is_10_[5] << 32;
                    }
                }
                if (class17_0_.anInt261 >= 0) {
                    if (class17_0_.anInt261 == 65535) {
                        ...
                        is_10_[3] = Component224.method2057((class17_0_.anInt261), 1073741824);
                        l ^= is_10_[3];
                    }
                }
            }
            ...
            for (int i_17_ = 0; i_16_ > i_17_; i_17_++) {
                ...
                if (class182s[i_17_] != null) {
                    ...
                    if (class17_18_.anIntArray237 != null) {
                        bool_15_ = true;
                        DisplayModeManagerContainer115.aClass17Array1048[i_17_] = class17_18_;
                ...
                if (bool_37_) {
                    ...
                    for (int i_40_ = 0; i_40_ < 12; i_40_++) {
                        ...
                        if ((0x40000000 & i_41_) == 0) {
                            ...
                            DisplayModeManagerContainer77 class124 = (class255.method1940(104, i_41_ & 0x3fffffff).method1558(this.aBoolean2100, !bool_2_));
                            if (class124 != null) class124s[i_40_] = class124;
                        }
                    }
            ...
            for (int i_60_ = 0; i_16_ > i_60_; i_60_++) {
                ...
                DisplayModeManagerContainer115.aClass17Array1048[i_60_] = null;
            }
            return class64_51_;
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("oo.C(" + (interface17 != null ? "{...}" : "null") + ',' + (class17 != null ? "{...}" : "null") + ',' + (class182s != null ? "{...}" : "null") + ',' + bool + ',' + (class255 != null ? "{...}" : "null") + ',' + i + ',' + (class17_0_ != null ? "{...}" : "null") + ',' + i_1_ + ',' + bool_2_ + ',' + i_3_ + ',' + (is != null ? "{...}" : "null") + ',' + i_4_ + ',' + (class150 != null ? "{...}" : "null") + ',' + i_5_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + (class278 != null ? "{...}" : "null") + ',' + (class87 != null ? "{...}" : "null") + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + (class261 != null ? "{...}" : "null") + ')'));
        }
    }

    final void method1227(byte i, int i_61_, int i_62_, DisplayModeManagerContainer320 class255) {
        try {
            if (i == 42) {
                anInt2099++;
                if (i_62_ == -1) anIntArray2092[i_61_] = 0;
                else if (class255.method1940(-125, i_62_) != null) {
                    anIntArray2092[i_61_] = Component224.method2057(1073741824, i_62_);
                    method1234(-100);
                }
            }
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("oo.H(" + i + ',' + i_61_ + ',' + i_62_ + ',' + (class255 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method1228(int i, int i_63_, int i_64_, int[] is, boolean bool, int[] is_65_) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("oo.F(" + i + ',' + i_63_ + ',' + i_64_ + ',' + (is != null ? "{...}" : "null") + ',' + bool + ',' + (is_65_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final DisplayModeManagerContainer370 method1230(DisplayModeManagerContainer320 class255, int i, Component344 class87, Component324 class150, Interface17 interface17, DisplayModeManagerContainer347 class278, int i_66_, int i_67_, int i_68_, DisplayModeManagerContainer167 class17, int i_69_, GraphicsToolkit var_ha) {
        try {
            ...
            if (class64 == null || var_ha.method3667(class64.ua(), i_70_) != 0) {
                ...
                for (int i_84_ = 0; i_84_ < 12; i_84_++) {
                    ...
                    if ((i_85_ & 0x40000000) == 0) {
                        ...
                        DisplayModeManagerContainer77 class124 = (class255.method1940(-107, i_85_ & 0x3fffffff).method1554(this.aBoolean2100, -14));
                        if (class124 != null) class124s[i_83_++] = class124;
                    }
                }
                i_80_ |= 0x4000;
            ...
            throw NpcDefinition.method2929(runtimeexception, ("oo.J(" + (class255 != null ? "{...}" : "null") + ',' + i + ',' + (class87 != null ? "{...}" : "null") + ',' + (class150 != null ? "{...}" : "null") + ',' + (interface17 != null ? "{...}" : "null") + ',' + (class278 != null ? "{...}" : "null") + ',' + i_66_ + ',' + i_67_ + ',' + i_68_ + ',' + (class17 != null ? "{...}" : "null") + ',' + i_69_ + ',' + (var_ha != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final DisplayModeManagerContainer370 method1232(int i, int i_91_, int i_92_, int i_93_, Component344 class87, Component324 class150, int i_94_, int i_95_, int i_96_, GraphicsToolkit var_ha, int i_97_, DisplayModeManagerContainer167 class17) {
        try {
            ...
            throw NpcDefinition.method2929(runtimeexception, ("oo.G(" + i + ',' + i_91_ + ',' + i_92_ + ',' + i_93_ + ',' + (class87 != null ? "{...}" : "null") + ',' + (class150 != null ? "{...}" : "null") + ',' + i_94_ + ',' + i_95_ + ',' + i_96_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_97_ + ',' + (class17 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method1233(Component324 class150, int i, int i_112_, int i_113_) {
        try {
            ...
            if (class150.method1203((byte) 33, i) != null) {
                ...
                anIntArray2092[i_114_] = Component224.method2057(i, -2147483648);
                method1234(-54);
            }
        } catch (RuntimeException runtimeexception) {
            throw NpcDefinition.method2929(runtimeexception, ("oo.D(" + (class150 != null ? "{...}" : "null") + ',' + i + ',' + i_112_ + ',' + i_113_ + ')'));
        }
    }
