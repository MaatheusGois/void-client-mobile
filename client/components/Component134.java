/* Component134 - Decompiled by JODE
...
final class Component134
/**
 * RENAMED from `Class186_Sub1` (JODE-obfuscated).
 * Evidence: subclass of DisplayModeManagerContainer51 (hierarchy)
 */ extends DisplayModeManagerContainer51 {
    private final int[] anIntArray5804 = new int[512];
    static int anInt5805;
    static int anInt5806;
    static int anInt5807 = 0;
    static DisplayModeManagerContainer196 aClass341_5808 = new DisplayModeManagerContainer196();
    static int anInt5809;
    static int anInt5810;
    static int anInt5811;
    static int anInt5812 = 100;
    static Component331 aClass111_5813;
