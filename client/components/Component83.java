 ...
 */ {
    ...
    static final float method1012(float f, float f_0_, float f_1_, float f_2_, int i, float f_3_, byte i_4_, float f_5_) {
        ...
        while (f_6_ < 1.1F) {
            ...
            if (i_16_ > 0 && i_17_ > 0 && AbstractShaderSub4.anInt7319 > i_16_ && (i_17_ < ParametricDefinition.anInt9109)) {
                ...
                int i_19_ = NodeSub1Sub1.aSArray8801[i_18_].method3986((int) f_13_, (int) f_15_, (byte) 109);
    ...
    static final void method1014(int i) {
        anInt1660++;
        for (PauseHandler class348_sub42_sub6 = (PauseHandler) r_Sub2.aClass262_10492.method1995(4); class348_sub42_sub6 != null; class348_sub42_sub6 = ((PauseHandler) r_Sub2.aClass262_10492.method1990((byte) 55))) {
