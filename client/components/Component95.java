/* Component95 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component95
/**
 * RENAMED from `Class115` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    static boolean[][][] aBooleanArrayArrayArray1751;
    static NodeSub1[] aClass348_Sub1Array1752 = new NodeSub1[8];
    static int anInt1753;
    static RenderableObject[] aClass318_Sub1Array1754;
    static int anInt1755;
    static int anInt1756;
    static int[] anIntArray1757 = {16776960, 16711680, 65280, 65535, 16711935, 16777215};

    static final int decodedOperation1060(int i, byte i_0_) {
        if (i_0_ != 69) aClass348_Sub1Array1752 = null;
        anInt1755++;
        return i >>> 7;
    }

    public static void decodedOperation1061(int i) {
