 ...
 */ {
    ...
    public static void decodedOperation1866(int i) {
        if (i != 0) aClass348_Sub42_Sub13_3152 = null;
        aClass348_Sub42_Sub13_3152 = null;
    }

    static final void decodedOperation1867(int i) {
        if (i < 44) decodedOperation1868((byte) -81, null);
        anInt3155++;
    ...
    protected final void finalize() throws Throwable {
        anInt3151++;
        aHa_Sub2_3153.decodedOperation3769(this.aLong3156, false);
        super.finalize();
    }

    static final void decodedOperation1868(byte i, HashNodeSub13 class348_sub42_sub13) {
        ...
        for (HashNodeSub13 class348_sub42_sub13_1_ = ((HashNodeSub13) Component237.aClass107_3022.first(-85)); class348_sub42_sub13_1_ != null; class348_sub42_sub13_1_ = ((HashNodeSub13) Component237.aClass107_3022.next((byte) 84))) {
            if (RenderableSub2.decodedOperation2496(class348_sub42_sub13_1_.decodedOperation3235(-17937), class348_sub42_sub13.decodedOperation3235(-17937), true)) {
                Component325.decodedOperation721(class348_sub42_sub13_1_, class348_sub42_sub13, -1);
                bool = true;
                break;
            }
        }
