/* Component143 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component143
/**
 * RENAMED from `Class175` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    static int anInt2310;
    private int anInt2311;
    private final LruCache aClass356_2312;
    static int anInt2313;
    static int anInt2314;
    static StringCache aClass351_2315;
    private HashTable aClass107_2316 = new HashTable();
    ...
    static CacheFileStore aClass340_2327;
    ...
    private final void method1342(ReferenceHolder class348_sub42_sub9, byte i) {
        anInt2317++;
    ...
    Component143(int i) {
        ...
        aClass356_2312 = new LruCache(i_22_);
    }

    static {
        aClass351_2315 = new StringCache(18, 3);
    }
}
