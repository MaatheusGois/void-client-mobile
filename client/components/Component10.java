 ...
 */ {
    ...
    static final int decodedOperation2250(int i, int i_0_, int i_1_, int i_2_) {
    ...
    public static void decodedOperation2251(int i) {
        if (i != 16711680) aClass114_3809 = null;
        aClass114_3809 = null;
    }

    static final boolean decodedOperation2252(boolean bool, int i, int i_4_, byte i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        anInt3808++;
        ...
        int i_13_ = (Component317.decodedOperation574(i, Component72.localPlayer.getSize((byte) 70), i_6_, DefinitionSub11.anIntArray9185, bool, (byte) 120, i_9_, i_11_, i_12_, HashNodeSub14.anIntArray9626, i_4_, (NodeSub45.aClass361Array7108[Component72.localPlayer.plane]), i_8_, i_7_, i_10_));
