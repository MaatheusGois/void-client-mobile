 ...
 */ {
    ...
    static final int decodedOperation2635(float f, boolean bool, float f_0_, float f_1_) {
        anInt4131++;
        float f_2_ = !(f_1_ < 0.0F) ? f_1_ : -f_1_;
        float f_3_ = f < 0.0F ? -f : f;
        if (bool != false) decodedOperation2637(-85);
    ...
    static final void decodedOperation2636(int i) {
    ...
    public static void decodedOperation2637(int i) {
    ...
    static final void decodedOperation2638(int i) {
    ...
    static final short[] decodedOperation2639(byte i, short[] is, int i_6_) {
        int i_7_ = 77 / ((i - -32) / 47);
        anInt4132++;
