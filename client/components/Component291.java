/* Component291 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Component291
/**
 * RENAMED from `Class189` (JODE-obfuscated).
 ...
 */ {
    ...
    int anInt2525;
    int anInt2526;
    static Component183 aClass114_2527 = new Component183(98, -2);
    static int anInt2528;
    static DisplayModeManagerContainer347 aClass278_2529;
    int anInt2530;
    ...
    private final void method1418(int i, int i_0_, Buffer class348_sub49, byte i_1_) {
    ...
    static final boolean method1420(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, TeleportHandler class361, int i_13_, int i_14_) {
        anInt2521++;
        int i_15_ = i_10_;
        int i_16_ = i_7_;
        int i_17_ = 64;
        ...
        int i_21_ = 0;
        OpenGlShader.anIntArray7397[i_21_] = i_15_;
        int i_22_ = 0;
        Component275.anIntArray2694[i_21_++] = i_16_;
        int[][] is = class361.anIntArrayArray4438;
        while_56_:
        while (i_22_ != i_21_) {
            i_16_ = Component275.anIntArray2694[i_22_];
            i_15_ = OpenGlShader.anIntArray7397[i_22_];
            i_17_ = i_15_ + -i_19_;
            i_18_ = -i_20_ + i_16_;
            i_22_ = 0xfff & i_22_ - -1;
            ...
            i_25_ = DisplayModeManagerContainer369.anIntArrayArray2900[i_17_][i_18_] + 1;
            while_49_:
            do {
                if (i_17_ > 0 && r.anIntArrayArray9723[-1 + i_17_][i_18_] == 0 && (is[-1 + i_23_][i_24_] & 0x43a40000) == 0 && ((is[-1 + i_23_][-1 + i_12_ + i_24_] & 0x4e240000) == 0)) {
                    ...
                    OpenGlShader.anIntArray7397[i_21_] = i_15_ - 1;
                    Component275.anIntArray2694[i_21_] = i_16_;
                    i_21_ = i_21_ - -1 & 0xfff;
                    r.anIntArrayArray9723[i_17_ - 1][i_18_] = 2;
                    DisplayModeManagerContainer369.anIntArrayArray2900[-1 + i_17_][i_18_] = i_25_;
                }
            } while (false);
            while_50_:
            do {
                if (i_17_ < -i_12_ + 128 && r.anIntArrayArray9723[i_17_ + 1][i_18_] == 0 && (is[i_23_ + i_12_][i_24_] & 0x60e40000) == 0 && ((is[i_12_ + i_23_][-1 + (i_24_ - -i_12_)] & 0x78240000) == 0)) {
                    ...
                    OpenGlShader.anIntArray7397[i_21_] = 1 + i_15_;
                    Component275.anIntArray2694[i_21_] = i_16_;
                    r.anIntArrayArray9723[1 + i_17_][i_18_] = 8;
                    i_21_ = 0xfff & i_21_ - -1;
                    DisplayModeManagerContainer369.anIntArrayArray2900[i_17_ + 1][i_18_] = i_25_;
                }
            } while (false);
            while_51_:
            do {
                if (i_18_ > 0 && r.anIntArrayArray9723[i_17_][-1 + i_18_] == 0 && (0x43a40000 & is[i_23_][i_24_ - 1]) == 0 && (0x60e40000 & is[-1 + (i_23_ + i_12_)][i_24_ - 1]) == 0) {
                    ...
                    OpenGlShader.anIntArray7397[i_21_] = i_15_;
                    Component275.anIntArray2694[i_21_] = -1 + i_16_;
            ...
            do {
                if (i_18_ < -i_12_ + 128 && (r.anIntArrayArray9723[i_17_][1 + i_18_] == 0) && ((0x4e240000 & is[i_23_][i_24_ - -i_12_]) == 0) && ((0x78240000 & is[-1 + i_12_ + i_23_][i_24_ + i_12_]) == 0)) {
                    ...
                    OpenGlShader.anIntArray7397[i_21_] = i_15_;
                    Component275.anIntArray2694[i_21_] = i_16_ - -1;
                    r.anIntArrayArray9723[i_17_][1 + i_18_] = 4;
                    i_21_ = i_21_ - -1 & 0xfff;
                    DisplayModeManagerContainer369.anIntArrayArray2900[i_17_][i_18_ + 1] = i_25_;
                }
            } while (false);
            while_53_:
            do {
                if (i_17_ > 0 && i_18_ > 0 && r.anIntArrayArray9723[i_17_ - 1][-1 + i_18_] == 0 && ((is[i_23_ + -1][-1 + i_24_] & 0x43a40000) == 0)) {
                    ...
                    DisplayModeManagerContainer369.anIntArrayArray2900[i_17_ + -1][-1 + i_18_] = i_25_;
                }
            } while (false);
            while_54_:
            do {
                if (128 - i_12_ > i_17_ && i_18_ > 0 && r.anIntArrayArray9723[1 + i_17_][i_18_ + -1] == 0 && (0x60e40000 & is[i_23_ + i_12_][-1 + i_24_]) == 0) {
                    ...
                    i_21_ = 0xfff & i_21_ - -1;
                    DisplayModeManagerContainer369.anIntArrayArray2900[1 + i_17_][-1 + i_18_] = i_25_;
                }
            } while (false);
            while_55_:
            do {
                if (i_17_ > 0 && i_18_ < -i_12_ + 128 && r.anIntArrayArray9723[-1 + i_17_][1 + i_18_] == 0 && (is[i_23_ - 1][i_12_ + i_24_] & 0x4e240000) == 0) {
                    ...
                    i_21_ = i_21_ - -1 & 0xfff;
                    DisplayModeManagerContainer369.anIntArrayArray2900[-1 + i_17_][i_18_ - -1] = i_25_;
                }
            } while (false);
            if (i_17_ < 128 + -i_12_ && i_18_ < 128 + -i_12_ && (r.anIntArrayArray9723[i_17_ + 1][1 + i_18_] == 0) && (0x78240000 & is[i_12_ + i_23_][i_24_ + i_12_]) == 0) {
                ...
                DisplayModeManagerContainer369.anIntArrayArray2900[i_17_ + 1][i_18_ - -1] = i_25_;
            }
        }
        Component95.anInt1753 = i_16_;
        DefinitionSub30.anInt9388 = i_15_;
