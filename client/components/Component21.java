    ...
    static final void decodedOperation2109(int i) {
        ...
        for (/**/; class348_sub42_sub18 != null; class348_sub42_sub18 = (HashNodeSub18) DefinitionSub17.aClass262_9240.next((byte) 56)) {
            ...
            if (OpenGlShader.clientCycle > class318_sub1_sub3_sub5.anInt10392) {
                ...
                class318_sub1_sub3_sub5.decodedOperation2472(-2159);
            } else if ((class318_sub1_sub3_sub5.anInt10411) <= OpenGlShader.clientCycle) {
                class318_sub1_sub3_sub5.decodedOperation2474((byte) 121);
                if ((class318_sub1_sub3_sub5.anInt10412) > 0) {
                    ...
                    if (class348_sub22 != null) {
                        ...
                        if ((npc.x) >= 0 && (AbstractShaderSub4.anInt7319 * 512 > npc.x) && (npc.y) >= 0 && (512 * ParametricDefinition.anInt9109 > npc.y))
                            class318_sub1_sub3_sub5.decodedOperation2471((byte) -103, ((Component300.decodedOperation2064(npc.x, (class318_sub1_sub3_sub5.plane), 11219, npc.y)) + -class318_sub1_sub3_sub5.anInt10366), npc.y, OpenGlShader.clientCycle, npc.x);
                    }
                }
                if ((class318_sub1_sub3_sub5.anInt10412) < 0) {
                    ...
                    if (player != null && (player.x) >= 0 && ((player.x) < 512 * AbstractShaderSub4.anInt7319) && (player.y) >= 0 && (player.y) < 512 * ParametricDefinition.anInt9109)
                        class318_sub1_sub3_sub5.decodedOperation2471((byte) -103, ((Component300.decodedOperation2064((player.x), (class318_sub1_sub3_sub5.plane), 11219, (player.y))) - class318_sub1_sub3_sub5.anInt10366), (player.y), OpenGlShader.clientCycle, (player.x));
                }
                class318_sub1_sub3_sub5.decodedOperation2475((byte) 75, NodeSub51.anInt7267);
                Component84.decodedOperation850(class318_sub1_sub3_sub5, true);
            }
        }
    }

    static final DisplayModeManagerContainer343 decodedOperation2110(int i, int i_1_, int i_2_) {
        ...
        Component191.decodedOperation1376(class318_sub1_sub2);
        return class318_sub1_sub2;
    }

    public static void decodedOperation2111(byte i) {
        aClass356_3654 = null;
        if (i <= 56) decodedOperation2111((byte) -49);
    }

    static final boolean decodedOperation2112(int i, int i_3_) {
        anInt3651++;
