/* Component338 - Decompiled by JODE
...
abstract class Component338
/**
 * RENAMED from `Class110` (JODE-obfuscated).
 * Evidence: root class; no distinctive extends/strings
 */ {
    static int anInt1699;
    static short aShort1700 = 256;
    static int anInt1701;
    static Component183 aClass114_1702;
    static int anInt1703;
    int anInt1704;
    static int anInt1705;
    static Component24 aClass105_1706;
    ...
    static final int method1032(int i) {
        ...
        for (int i_3_ = 0; fields_2_.length > i_3_; i_3_++) {
            ...
            if ((aClass1714 != null ? aClass1714 : (aClass1714 = Component339.class)).isAssignableFrom(field.getType())) i_1_++;
        }
        return i_1_ - -1;
    }
    ...
    static final void method1034(int i, Buffer class348_sub49, ReflectionInvoker class297, int i_5_) {
        try {
            ...
            class348_sub48.aClass144Array7127 = new Task[class348_sub48.anInt7126];
            if (i_5_ > 90) {
                class348_sub48.aClass144Array7135 = (new Task
                    ...
                    try {
                        ...
                        if (i_7_ != 0 && i_7_ != 1 && i_7_ != 2) {
                            if (i_7_ == 3 || i_7_ == 4) {
                                ...
                                class348_sub48.aClass144Array7127[i_6_] = (class297.method2230(var_classes, 76, PrimitiveTypeDefinition.method3052(11012, string), string_8_));
                            ...
                            class348_sub48.aClass144Array7135[i_6_] = (class297.method2243(0, string_14_, PrimitiveTypeDefinition.method3052(11012, string)));
                        }
    ...
    static final Sprite method1035(int i, int i_16_, Canvas canvas, int i_17_) {
        ...
        try {
            Sprite class348_sub31 = new BufferedImageSprite();
            class348_sub31.method3008(canvas, i_17_, -90, i_16_);
            return class348_sub31;
        } catch (Throwable throwable) {
            ImageProducerSprite class348_sub31_sub2 = new ImageProducerSprite();
    ...
    static {
        aClass114_1702 = new Component183(24, 6);
    }
}
