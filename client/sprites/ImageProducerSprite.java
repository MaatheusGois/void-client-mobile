/* ImageProducerSprite - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class348_Sub31_Sub2` (JODE-obfuscated).
 * Sprite that implements java.awt.image.ImageProducer (method3015/3017); produces an Image from sprite pixels.
 */
...
final class ImageProducerSprite extends Sprite implements ImageProducer {
    ...
    static Component186[][][] aClass357ArrayArrayArray9082;
