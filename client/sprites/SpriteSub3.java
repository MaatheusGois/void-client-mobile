/* SpriteSub3 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

abstract class SpriteSub3
/**
 * RENAMED from `Class105_Sub3` (JODE-obfuscated).
 * Evidence: subclass of Component24 (hierarchy).
 *
 * CPU sprite rasterizer (alpha-blend scanline). The hot 84xx state fields were
 * deobfuscated (lote 52):
 *   - {@code spriteAlpha}   (was anInt8477) — high byte of ARGB (`argb >>> 24`),
 *     gated as `== 255` for the opaque fast path.
 *   - {@code spriteWidth}   (was anInt8471) / {@code spriteHeight} (was anInt8470)
 *     — drawn dimensions.
 *   - {@code scanlineX/Y}   (was anInt8450/anInt8481) — fixed-point (×4096F)
 *     interpolated scanline coordinates.
 *   - {@code scanlineStepX/Y}(was anInt8451/anInt8453) — per-pixel advance.
 *   - {@code toolkit}       (was aHa_Sub1_8460) — the GlToolkitSub1 used for
 *     canvas-width math.
 */ extends Component24 {
    static int scanlineX;
    static int scanlineStepX;
    static int anInt8452;
    static int scanlineStepY;
    int anInt8454;
    ...
    private final boolean decodedOperation997(float f, float f_59_, float f_60_, float f_61_, float f_62_, float f_63_) {
        ...
        if (f_79_ < (float) (this.toolkit.anInt7496)) f_79_ = (float) (this.toolkit.anInt7496);
        if (f_80_ > (float) (this.toolkit.anInt7507)) f_80_ = (float) (this.toolkit.anInt7507);
        if (f_81_ < (float) (this.toolkit.anInt7476)) f_81_ = (float) (this.toolkit.anInt7476);
        if (f_82_ > (float) (this.toolkit.anInt7503)) f_82_ = (float) (this.toolkit.anInt7503);
        f_80_ = f_79_ - f_80_;
        if (f_80_ >= 0.0F) return false;
        f_82_ = f_81_ - f_82_;
        if (f_82_ >= 0.0F) return false;
        scanlineStepY = this.toolkit.anInt7477;
        scanlineStepX = (int) ((float) ((int) f_81_ * scanlineStepY) + f_79_);
        float f_83_ = (f_60_ - f) * (f_63_ - f_59_) - (f_61_ - f_59_) * (f_62_ - f);
        float f_84_ = (f_62_ - f) * (f_61_ - f_59_) - (f_63_ - f_59_) * (f_60_ - f);
        scanlineY = (int) ((f_63_ - f_59_) * 4096.0F * (float) this.spriteWidth / f_83_);
        scanlineX = (int) ((f_61_ - f_59_) * 4096.0F * (float) this.spriteHeight / f_84_);
        anInt8457 = (int) ((f_62_ - f) * 4096.0F * (float) this.spriteWidth / f_84_);
        anInt8452 = (int) ((f_60_ - f) * 4096.0F * (float) this.spriteHeight / f_83_);
        ...
        anInt8458 = ((this.spriteWidth >> 1 << 12) + (anInt8482 * anInt8457 >> 4));
        anInt8467 = ((this.spriteHeight >> 1 << 12) + (anInt8482 * anInt8452 >> 4));
        anInt8479 = anInt8476 * scanlineY >> 4;
        anInt8475 = anInt8476 * scanlineX >> 4;
        anInt8473 = (int) f_79_;
        anInt8478 = (int) f_80_;
        anInt8466 = (int) f_81_;
        anInt8468 = (int) f_82_;
