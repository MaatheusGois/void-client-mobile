/* InterfaceRenderer - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

/**
 * RENAMED from `Class294` (JODE-obfuscated).
 * 2D interface/widget skin renderer (implements Interface16). Loads skin images ('bar','background','left','right','top','bottom') via reflection from the applet class; holds StringCache, Player[], and Component103[] for widget drawing.
 */

import java.awt.*;
import java.lang.reflect.Field;

final class InterfaceRenderer implements Interface16 {
    ...
    private final Object method2213(Class var_class, int i, String string) throws IllegalAccessException, NoSuchFieldException {
        try {
            ...
            anInt5038++;
            Field field = var_class.getDeclaredField(string);
            Object object = field.get(ToolkitFactory.anApplet1530);
    ...
    public final void method58(boolean bool, int i) {
        ...
        if (aBoolean5022) method2219(33);
            ...
            } else DisplayModeManagerContainer50.gameCanvas.repaint();
        }
    }
